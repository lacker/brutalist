...
fof(fact_def__ectset,axiom,(
    ! [X,Xa] : scratc57161220nd_out(aa_TPTP_ind_TPTP_ind(scratc390608475_power,X),scratc2110288053d_anec(X,Xa)) = scratc1231495862ectset(X,Xa) )).
    ...
    ! [X0,X12,X22] :
      ( ( pp(aa_TPTP_ind_bool(aa_TPT43085870d_bool(scratc995845359bnd_in,X22),aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc113866315_Sigma,X0),X12)))
       => ( pp(aa_TPTP_ind_bool(aa_TPT43085870d_bool(scratc995845359bnd_in,aa_TPTP_ind_TPTP_ind(scratc519122314_proj1,X22)),aa_TPTP_ind_TPTP_ind(X12,aa_TPTP_ind_TPTP_ind(scratc519122313_proj0,X22))))
          ...
          & X22 = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc827056996d_pair,aa_TPTP_ind_TPTP_ind(scratc519122313_proj0,X22)),aa_TPTP_ind_TPTP_ind(scratc519122314_proj1,X22)) ) )
     <= gg_TPTP_ind(X22) ) )).
...
fof(fact_ATP_Olambda__176,axiom,(
    ! [Uu,Uua,Uub] : aa_TPTP_ind_TPTP_ind(scratc995845351bnd_if(aa_TPTP_ind_bool(Uua,Uub),Uub),scratc2121701822nd_eps(aa_fun1584354236d_bool(aTP_Lamm_bb(Uu),Uua))) = aa_TPTP_ind_TPTP_ind(aa_fun1235454963TP_ind(aTP_Lamm_bn(Uu),Uua),Uub) )).
...
fof(fact_def__cond1,axiom,(
    aa_TPT43085870d_bool(scratc456456521d_n_in,scratc1396187181nd_n_1) = scratc534239045_cond1 )).
...
fof(fact_def__inj__h,axiom,(
    ! [X,Xa,Xb,Xc,Xd] : aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc113866315_Sigma,X),aa_TPT1424761345TP_ind(aTP_Lamm_aw(Xc),Xd)) = aa_TPTP_ind_TPTP_ind(scratc840785325_inj_h(X,Xa,Xb,Xc),Xd) )).
...
fof(fact_def__n__is,axiom,(
    scratc937796165d_e_is(scratc47587735nd_nat) = scratc456456526d_n_is )).
...
fof(fact_if__i__or,axiom,(
    ! [X0,X12,X22] :
      ( ( X12 = aa_TPTP_ind_TPTP_ind(scratc995845351bnd_if(X0,X12),X22)
...
fof(fact_def__d__pair,axiom,(
    ! [X,Xa] : scratc827056996d_pair = scratc1681889716d_pair(X,Xa) )).
...
fof(fact_def__changef,axiom,(
    ! [X,Xa,Xb,Xc,Xd] : aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc113866315_Sigma,X),aa_TPT1424761345TP_ind(aa_TPT1791839040TP_ind(aa_TPT1781712639TP_ind(aTP_Lamm_av(X),Xb),Xc),Xd)) = aa_TPTP_ind_TPTP_ind(scratc56594156hangef(X,Xa,Xb,Xc),Xd) )).
...
fof(fact_ATP_Olambda__173,axiom,(
    ! [Uu,Uua] :
     ...
     => ( ? [X3] :
            ( gg_TPTP_ind(X3)
            & aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc827056996d_pair,Uu),X3) = Uua )
...
fof(fact_def__d__11__i,axiom,(
    ! [X,Xa,Xb] : scratc66037249_indeq(X,Xa,aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1944075539d_d_Pi,X),aTP_Lamm_ai(Xb))) = scratc1340649199d_11_i(X,Xa,Xb) )).
...
fof(fact_def__soft,axiom,(
    ! [X,Xa,Xb,Xc] : scratc7132981nd_ind(X,aa_TPT43085870d_bool(aa_TPT60673477d_bool(aTP_Lamm_ay(Xa),Xb),Xc)) = aa_TPTP_ind_TPTP_ind(scratc1136799220d_soft(X,Xa,Xb),Xc) )).
...
fof(fact_def__d__Sep,axiom,(
    ! [X,Xa] : aa_TPTP_ind_TPTP_ind(scratc995845351bnd_if(fEx_TPTP_ind(cOMBS_2003118649l_bool(cOMBB_658106424TP_ind(fconj,aa_TPT43085870d_bool(cOMBC_1555011498d_bool(scratc995845359bnd_in),X)),Xa)),aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc274252953d_repl,X),aa_fun1235454963TP_ind(aTP_Lamm_bn(X),Xa))),scratc149728127ptyset) = aa_fun1431113780TP_ind(scratc1119368612_d_Sep(X),Xa) )).
...
fof(fact_def__d__In__rec,axiom,(
    ! [X,Xa] : scratc2121701822nd_eps(aa_TPT43085870d_bool(scratc503222518_rec_G(X),Xa)) = aa_TPTP_ind_TPTP_ind(scratc1636783185In_rec(X),Xa) )).
...
fof(fact_def__d__24__g,axiom,(
    ! [X] : aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc113866315_Sigma,scratc47587735nd_nat),aTP_Lamm_ad(X)) = aa_TPTP_ind_TPTP_ind(scratc527007787d_24_g,X) )).
...
fof(fact_neq__ordsucc__0,axiom,(
    ! [X0] : scratc149728127ptyset != aa_TPTP_ind_TPTP_ind(scratc644387513rdsucc,X0) )).
...
fof(fact_def__l__or,axiom,(
    ! [X] : aa_boo1142376798l_bool(scratc7067394nd_imp,scratc1343085241_d_not(X)) = scratc325205189d_l_or(X) )).
...
fof(fact_def__proj1,axiom,(
    ! [X] : aa_fun277296641TP_ind(scratc1909019605eplSep(X,aTP_Lamm_bi),scratc1136482007_d_Unj) = aa_TPTP_ind_TPTP_ind(scratc519122314_proj1,X) )).
...
fof(fact_def__all,axiom,(
    ! [X] : scratc1561761582all_of(aa_TPT43085870d_bool(aTP_Lamm_aj,X)) = scratc2088393399nd_all(X) )).
...
fof(fact_nat__inv,axiom,(
    ! [X0] :
      ( ( pp(aa_TPTP_ind_bool(scratc2134808665_nat_p,X0))
       => ( ? [X13] :
              ( gg_TPTP_ind(X13)
              & aa_TPTP_ind_TPTP_ind(scratc644387513rdsucc,X13) = X0
              & pp(aa_TPTP_ind_bool(scratc2134808665_nat_p,X13)) )
          | scratc149728127ptyset = X0 ) )
     <= gg_TPTP_ind(X0) ) )).
...
fof(fact_ATP_Olambda__175,axiom,(
    ! [Uu,Uua,Uub] : aa_TPTP_ind_TPTP_ind(scratc995845351bnd_if(aa_TPTP_ind_bool(aa_TPT43085870d_bool(scratc995845359bnd_in,scratc149728127ptyset),Uub),Uu),Uua) = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(aTP_Lamm_bo(Uu),Uua),Uub) )).
...
fof(fact_def__ect,axiom,(
    ! [X,Xa] : aa_fun1431113780TP_ind(scratc1119368612_d_Sep(aa_TPTP_ind_TPTP_ind(scratc390608475_power,X)),scratc2110288053d_anec(X,Xa)) = scratc2120849036nd_ect(X,Xa) )).
...
fof(fact_def__second,axiom,(
    ! [X,Xa] : scratc519122314_proj1 = scratc1858738590second(X,Xa) )).
...
fof(fact_def__first,axiom,(
    ! [X,Xa] : scratc519122313_proj0 = scratc1450922438_first(X,Xa) )).
...
fof(fact_def__ecect,axiom,(
    ! [X,Xa] : scratc937796160d_e_in(aa_TPTP_ind_TPTP_ind(scratc390608475_power,X),scratc2110288053d_anec(X,Xa)) = scratc1961836750_ecect(X,Xa) )).
...
fof(fact_def__famunion,axiom,(
    ! [X,Xa] : aa_TPTP_ind_TPTP_ind(scratc897870341_union,aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc274252953d_repl,X),Xa)) = aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc515168679munion,X),Xa) )).
...
fof(fact_def__d__Pi,axiom,(
    ! [X,Xa] : aa_fun1431113780TP_ind(scratc1119368612_d_Sep(aa_TPTP_ind_TPTP_ind(scratc390608475_power,aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc113866315_Sigma,X),aTP_Lamm_be(Xa)))),aa_fun1913827119d_bool(aTP_Lamm_bf(X),Xa)) = aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1944075539d_d_Pi,X),Xa) )).
...
fof(fact_def__e__is,axiom,(
    ! [X] : fequal_TPTP_ind = scratc937796165d_e_is(X) )).
...
fof(fact_def__n__one,axiom,(
    scratc56702012nd_one(scratc47587735nd_nat) = scratc776386146_n_one )).
...
fof(fact_ATP_Olambda__171,axiom,(
    ! [Uu,Uua] : aa_TPTP_ind_TPTP_ind(scratc644387513rdsucc,aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc995320569bnd_ap,Uu),Uua)) = aa_TPTP_ind_TPTP_ind(aTP_Lamm_ad(Uu),Uua) )).
...
fof(fact_proj0__pair__eq,axiom,(
    ! [X0,X12] :
      ( X0 = aa_TPTP_ind_TPTP_ind(scratc519122313_proj0,aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc827056996d_pair,X0),X12))
     <= gg_TPTP_ind(X0) ) )).
...
fof(fact_def__nat,axiom,(
    aa_fun1431113780TP_ind(scratc1119368612_d_Sep(scratc1836261175_omega),aTP_Lamm_ah) = scratc47587735nd_nat )).
...
fof(fact_ATP_Olambda__90,axiom,(
    ! [Uu] :
      ( ( ? [X2] :
            ( gg_TPTP_ind(X2)
            & Uu = aa_TPTP_ind_TPTP_ind(scratc1411225125d_Inj0,X2) )
...
fof(fact_def__n__some,axiom,(
    scratc672422390l_some(scratc47587735nd_nat) = scratc1416247032n_some )).
...
fof(fact_def__pair,axiom,(
    ! [X,Xa] : aa_TPTP_ind_TPTP_ind(scratc1509025778nunion(aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc274252953d_repl,X),scratc1411225125d_Inj0)),aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc274252953d_repl,Xa),scratc1411225126d_Inj1)) = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc827056996d_pair,X),Xa) )).
...
fof(fact_def__n__all,axiom,(
    scratc2088393399nd_all(scratc47587735nd_nat) = scratc660593885_n_all )).
...
fof(fact_def__ecelt,axiom,(
    ! [X,Xa,Xb] : aa_fun1431113780TP_ind(scratc1119368612_d_Sep(X),aa_TPT43085870d_bool(Xa,Xb)) = aa_TPTP_ind_TPTP_ind(scratc1962427141_ecelt(X,Xa),Xb) )).
...
fof(fact_def__ordsucc,axiom,(
    ! [X] : aa_TPTP_ind_TPTP_ind(scratc1509025778nunion(X),aa_TPTP_ind_TPTP_ind(scratc586117449d_Sing,X)) = aa_TPTP_ind_TPTP_ind(scratc644387513rdsucc,X) )).

fof(fact_def__pair__p,axiom,(
    ! [X] :
      ( gg_TPTP_ind(X)
     => ( pp(aa_TPTP_ind_bool(scratc501137484pair_p,X))
      <=> X = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc827056996d_pair,aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc995320569bnd_ap,X),scratc149728127ptyset)),aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc995320569bnd_ap,X),aa_TPTP_ind_TPTP_ind(scratc644387513rdsucc,scratc149728127ptyset))) ) ) )).
...
fof(fact_beta,axiom,(
    ! [X0,X12,X22] :
      ( aa_TPTP_ind_TPTP_ind(X12,X22) = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc995320569bnd_ap,aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc113866315_Sigma,X0),X12)),X22)
     <= pp(aa_TPTP_ind_bool(aa_TPT43085870d_bool(scratc995845359bnd_in,X22),X0)) ) )).
...
fof(fact_def__d__Inj1,axiom,(
    scratc1636783185In_rec(aTP_Lamm_bl) = scratc1411225126d_Inj1 )).
...
fof(fact_def__ind,axiom,(
    ! [X,Xa] : scratc2121701822nd_eps(aa_fun1584354236d_bool(aTP_Lamm_bb(X),Xa)) = scratc7132981nd_ind(X,Xa) )).
...
fof(fact_def__d__Unj,axiom,(
    scratc1636783185In_rec(aTP_Lamm_bk) = scratc1136482007_d_Unj )).

fof(fact_def__proj0,axiom,(
    ! [X] : aa_fun277296641TP_ind(scratc1909019605eplSep(X,aTP_Lamm_bj),scratc1136482007_d_Unj) = aa_TPTP_ind_TPTP_ind(scratc519122313_proj0,X) )).
...
fof(fact_def__tofs,axiom,(
    ! [X,Xa] : scratc995320569bnd_ap = scratc1917386418d_tofs(X,Xa) )).
