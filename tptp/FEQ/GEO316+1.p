...
fof('holds(conjunct1(conjunct2(359)), 1319, 0)',axiom,(
    vangle(vd1287,vd1306,vd1288) = vangle(vd1287,vd1299,vd1289) )).
...
fof('holds(conjunct1(conjunct2(conjunct2(355))), 1311, 0)',axiom,(
    vd1299 != vd1287 )).
...
fof('holds(conjunct2(352), 1308, 0)',axiom,(
    vf(vd1287,vd1306) = vf(vd1287,vd1299) )).
...
fof('holds(conjunct1(359), 1318, 0)',axiom,(
    vf(vd1299,vd1289) = vf(vd1306,vd1288) )).
...
fof('pred(conjunct1(353), 0)',axiom,(
    ron(vd1306,vd1297) )).
...
fof('holds(conjunct1(conjunct2(355)), 1313, 0)',axiom,(
    vd1287 != vd1289 )).
...
fof('pred(conjunct2(conjunct2(conjunct2(conjunct2(conjunct2(354))))), 0)',axiom,(
    ron(vd1289,vd1297) )).
...
fof('holds(363, 1326, 0)',conjecture,(
...
fof('holds(361, 1323, 0)',axiom,(
    vf(vd1289,vd1306) = vf(vd1288,vd1299) )).

fof('holds(conjunct1(360), 1321, 0)',axiom,(
    vf(vd1288,vd1306) = vf(vd1299,vd1289) )).
...
fof('holds(358, 1317, 0)',axiom,(
    vangle(vd1288,vd1287,vd1289) = vangle(vd1299,vd1287,vd1289) )).

fof('holds(conjunct2(360), 1322, 0)',axiom,(
    vangle(vd1288,vd1299,vd1289) = vangle(vd1289,vd1306,vd1288) )).
...
fof('holds(conjunct2(362), 1325, 0)',axiom,(
    vangle(vd1288,vd1289,vd1299) = vangle(vd1289,vd1288,vd1306) )).
...
fof('holds(357, 1316, 0)',axiom,(
    vangle(vd1288,vd1287,vd1289) = vangle(vd1288,vd1287,vd1306) )).
...
fof('pred(conjunct1(conjunct2(conjunct2(conjunct2(conjunct2(354))))), 0)',axiom,(
    ron(vd1288,vd1295) )).
...
fof('holds(conjunct1(355), 1312, 0)',axiom,(
    vd1288 != vd1287 )).
...
fof('holds(conjunct2(conjunct2(359)), 1320, 0)',axiom,(
    vangle(vd1287,vd1289,vd1299) = vangle(vd1287,vd1288,vd1306) )).
...
fof('pred(conjunct1(354), 0)',axiom,(
    ron(vd1287,vd1295) )).
...
fof('pred(conjunct1(conjunct2(conjunct2(354))), 0)',axiom,(
    ron(vd1287,vd1297) )).
...
fof('holds(conjunct1(conjunct2(353)), 1309, 0)',axiom,(
    vd1287 != vd1306 )).
...
fof('holds(conjunct2(conjunct2(conjunct2(353))), 1311, 0)',axiom,(
    vd1299 != vd1287 )).
...
fof('holds(conjunct1(362), 1324, 0)',axiom,(
    vangle(vd1306,vd1289,vd1288) = vangle(vd1299,vd1288,vd1289) )).
...
fof('pred(conjunct1(conjunct2(354)), 0)',axiom,(
    ron(vd1299,vd1295) )).
