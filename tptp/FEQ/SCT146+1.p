...
fof(fact_Cons__listrel1E2,axiom,(
    ! [V_r_2,V_ys_2,V_y_2,V_xs_2,T_a] :
      ( ( ~ ! [B_zs] :
       ...
       <= ! [B_x] :
            ( hAPP(hAPP(c_List_Olist_OCons(T_a),B_x),V_ys_2) = V_xs_2
...
fof(fact_eq__Nil__appendI,axiom,(
    ! [T_a,V_ys,V_xs] :
      ( V_xs = V_ys
     => hAPP(hAPP(c_List_Oappend(T_a),c_List_Olist_ONil(T_a)),V_ys) = V_xs ) )).
...
fof(fact_list_Osimps_I5_J,axiom,(
    ! [V_list_2,V_aa_2,V_f2_2,V_f1_2,T_b,T_a] : hAPP(hAPP(V_f2_2,V_aa_2),V_list_2) = c_List_Olist_Olist__case(T_a,T_b,V_f1_2,V_f2_2,hAPP(hAPP(c_List_Olist_OCons(T_b),V_aa_2),V_list_2)) )).

fof(fact_less__irrefl__nat,axiom,(
    ! [V_n] : ~ c_Orderings_Oord__class_Oless(tc_Nat_Onat,V_n,V_n) )).

fof(fact_swap__product,axiom,(
    ! [V_B_2,V_A_2,T_a,T_b] : c_Product__Type_OSigma(T_a,T_b,V_B_2,c_COMBK(tc_fun(T_b,tc_HOL_Obool),T_a,V_A_2)) = c_Set_Oimage(tc_prod(T_b,T_a),tc_prod(T_a,T_b),hAPP(c_Product__Type_Oprod_Oprod__case(T_b,T_a,tc_prod(T_a,T_b)),hAPP(c_COMBC(T_a,T_b,tc_prod(T_a,T_b)),c_Product__Type_OPair(T_a,T_b))),c_Product__Type_OSigma(T_b,T_a,V_A_2,c_COMBK(tc_fun(T_a,tc_HOL_Obool),T_b,V_B_2))) )).
...
fof(fact_lexord__Nil__left,axiom,(
    ! [V_r_2,V_y_2,T_a] :
      ( ? [B_a,B_x] : hAPP(hAPP(c_List_Olist_OCons(T_a),B_a),B_x) = V_y_2
...
fof(fact_Cons__eq__appendI,axiom,(
    ! [V_zs,V_xs,V_ys,V_xs1,V_x,T_a] :
     ...
     => ( hAPP(hAPP(c_List_Oappend(T_a),V_ys),V_zs) = hAPP(hAPP(c_List_Olist_OCons(T_a),V_x),V_xs)
       <= hAPP(hAPP(c_List_Oappend(T_a),V_xs1),V_zs) = V_xs ) ) )).
...
fof(fact_neq__if__length__neq,axiom,(
    ! [V_ys,V_xs,T_a] :
      ( V_ys != V_xs
     <= c_Nat_Osize__class_Osize(tc_List_Olist(T_a),V_ys) != c_Nat_Osize__class_Osize(tc_List_Olist(T_a),V_xs) ) )).

fof(fact_maps__simps_I1_J,axiom,(
    ! [V_xs_2,V_x_2,V_f_2,T_a,T_b] : hAPP(hAPP(c_List_Oappend(T_a),hAPP(V_f_2,V_x_2)),c_List_Omaps(T_b,T_a,V_f_2,V_xs_2)) = c_List_Omaps(T_b,T_a,V_f_2,hAPP(hAPP(c_List_Olist_OCons(T_b),V_x_2),V_xs_2)) )).
...
fof(fact_dropWhile_Osimps_I1_J,axiom,(
    ! [V_Pa_2,T_a] : c_List_OdropWhile(T_a,V_Pa_2,c_List_Olist_ONil(T_a)) = c_List_Olist_ONil(T_a) )).
...
fof(fact_in__measures_I2_J,axiom,(
    ...
    <=> ( c_Orderings_Oord__class_Oless(tc_Nat_Onat,hAPP(V_f_2,V_x_2),hAPP(V_f_2,V_y_2))
        | ( hBOOL(hAPP(hAPP(c_member(tc_prod(T_a,T_a)),hAPP(hAPP(c_Product__Type_OPair(T_a,T_a),V_x_2),V_y_2)),c_List_Omeasures(T_a,V_fs_2)))
          & hAPP(V_f_2,V_y_2) = hAPP(V_f_2,V_x_2) ) ) ) )).
...
fof(fact_prod_Osimps_I2_J,axiom,(
    ! [V_ba_2,V_aa_2,V_f1_2,T_a,T_c,T_b] : hAPP(hAPP(c_Product__Type_Oprod_Oprod__case(T_b,T_c,T_a),V_f1_2),hAPP(hAPP(c_Product__Type_OPair(T_b,T_c),V_aa_2),V_ba_2)) = hAPP(hAPP(V_f1_2,V_aa_2),V_ba_2) )).
...
fof(fact_splice_Osimps_I3_J,axiom,(
    ! [V_ys,V_y,V_xs,V_x,T_a] : hAPP(hAPP(c_List_Olist_OCons(T_a),V_x),hAPP(hAPP(c_List_Olist_OCons(T_a),V_y),c_List_Osplice(T_a,V_xs,V_ys))) = c_List_Osplice(T_a,hAPP(hAPP(c_List_Olist_OCons(T_a),V_x),V_xs),hAPP(hAPP(c_List_Olist_OCons(T_a),V_y),V_ys)) )).
...
fof(fact_partition_Osimps_I1_J,axiom,(
    ! [V_Pa_2,T_a] : c_List_Opartition(T_a,V_Pa_2,c_List_Olist_ONil(T_a)) = hAPP(hAPP(c_Product__Type_OPair(tc_List_Olist(T_a),tc_List_Olist(T_a)),c_List_Olist_ONil(T_a)),c_List_Olist_ONil(T_a)) )).
...
fof(fact_append__eq__append__conv2,axiom,(
    ...
    <=> hAPP(hAPP(c_List_Oappend(T_a),V_zs_2),V_ts_2) = hAPP(hAPP(c_List_Oappend(T_a),V_xs_2),V_ys_2) ) )).
...
fof(fact_internal__split__conv,axiom,(
    ! [V_ba_2,V_aa_2,V_ca_2,T_a,T_c,T_b] : hAPP(hAPP(V_ca_2,V_aa_2),V_ba_2) = hAPP(hAPP(c_Product__Type_Ointernal__split(T_b,T_c,T_a),V_ca_2),hAPP(hAPP(c_Product__Type_OPair(T_b,T_c),V_aa_2),V_ba_2)) )).
...
fof(fact_takeWhile__tail,axiom,(
    ! [V_l_2,V_xs_2,T_a,V_x_2,V_Pa_2] :
      ( ~ hBOOL(hAPP(V_Pa_2,V_x_2))
     => c_List_OtakeWhile(T_a,V_Pa_2,hAPP(hAPP(c_List_Oappend(T_a),V_xs_2),hAPP(hAPP(c_List_Olist_OCons(T_a),V_x_2),V_l_2))) = c_List_OtakeWhile(T_a,V_Pa_2,V_xs_2) ) )).
...
fof(fact_dropWhile_Osimps_I2_J,axiom,(
    ! [V_xs_2,T_a,V_x_2,V_Pa_2] :
      ( ( c_List_OdropWhile(T_a,V_Pa_2,hAPP(hAPP(c_List_Olist_OCons(T_a),V_x_2),V_xs_2)) = hAPP(hAPP(c_List_Olist_OCons(T_a),V_x_2),V_xs_2)
       <= ~ hBOOL(hAPP(V_Pa_2,V_x_2)) )
      & ( hBOOL(hAPP(V_Pa_2,V_x_2))
       => c_List_OdropWhile(T_a,V_Pa_2,hAPP(hAPP(c_List_Olist_OCons(T_a),V_x_2),V_xs_2)) = c_List_OdropWhile(T_a,V_Pa_2,V_xs_2) ) ) )).
...
fof(fact_listrel1I,axiom,(
    ! [V_ys_2,V_vs_2,V_us_2,V_xs_2,V_r_2,V_y_2,V_x_2,T_a] :
     ...
     => ( ( hBOOL(hAPP(hAPP(c_member(tc_prod(tc_List_Olist(T_a),tc_List_Olist(T_a))),hAPP(hAPP(c_Product__Type_OPair(tc_List_Olist(T_a),tc_List_Olist(T_a)),V_xs_2),V_ys_2)),c_List_Olistrel1(T_a,V_r_2)))
       ...
       <= hAPP(hAPP(c_List_Oappend(T_a),V_us_2),hAPP(hAPP(c_List_Olist_OCons(T_a),V_x_2),V_vs_2)) = V_xs_2 ) ) )).
...
fof(fact_not__Cons__self2,axiom,(
    ! [V_xs,V_x,T_a] : V_xs != hAPP(hAPP(c_List_Olist_OCons(T_a),V_x),V_xs) )).
...
fof(fact_not__Cons__self,axiom,(
    ! [V_x,T_a,V_xs] : hAPP(hAPP(c_List_Olist_OCons(T_a),V_x),V_xs) != V_xs )).
...
fof(fact_append__butlast__last__id,axiom,(
    ! [T_a,V_xs] :
      ( V_xs != c_List_Olist_ONil(T_a)
     => V_xs = hAPP(hAPP(c_List_Oappend(T_a),c_List_Obutlast(T_a,V_xs)),hAPP(hAPP(c_List_Olist_OCons(T_a),c_List_Olast(T_a,V_xs)),c_List_Olist_ONil(T_a))) ) )).
...
fof(fact_listrel1E,axiom,(
    ! [V_r_2,V_ys_2,V_xs_2,T_a] :
     ...
     => ~ ! [B_x,B_y] :
            ( ! [B_us,B_vs] :
                ( V_ys_2 != hAPP(hAPP(c_List_Oappend(T_a),B_us),hAPP(hAPP(c_List_Olist_OCons(T_a),B_y),B_vs))
...
fof(fact_rotate__simps,axiom,(
    ! [V_xs,V_x,T_b,T_a] :
      ( c_List_Olist_ONil(T_a) = c_List_Orotate1(T_a,c_List_Olist_ONil(T_a))
...
fof(fact_maps__simps_I2_J,axiom,(
    ! [V_f_2,T_a,T_b] : c_List_Olist_ONil(T_a) = c_List_Omaps(T_b,T_a,V_f_2,c_List_Olist_ONil(T_b)) )).
...
fof(fact_takeWhile__nth,axiom,(
    ! [V_xs_2,V_Pa_2,T_a,V_j_2] :
     ...
     => c_List_Onth(T_a,V_xs_2,V_j_2) = c_List_Onth(T_a,c_List_OtakeWhile(T_a,V_Pa_2,V_xs_2),V_j_2) ) )).
...
fof(fact_listrel__rtrancl__eq__rtrancl__listrel1,axiom,(
    ! [V_r_2,T_a] : c_List_Olistrel(T_a,c_Transitive__Closure_Ortrancl(T_a,V_r_2)) = c_Transitive__Closure_Ortrancl(tc_List_Olist(T_a),c_List_Olistrel1(T_a,V_r_2)) )).

fof(fact_curry__def,axiom,(
    ! [V_y_2,V_x_2,V_ca_2,T_a,T_c,T_b] : hAPP(V_ca_2,hAPP(hAPP(c_Product__Type_OPair(T_b,T_c),V_x_2),V_y_2)) = hAPP(hAPP(c_Product__Type_Ocurry(T_b,T_c,T_a,V_ca_2),V_x_2),V_y_2) )).
    ...
    ! [V_r_2,V_ys_2,V_xs_2,V_x_2,T_a] :
     ...
     => ( ! [B_y] :
       ...
       => ~ ! [B_zs] :
             ...
             <= hAPP(hAPP(c_List_Olist_OCons(T_a),V_x_2),B_zs) = V_ys_2 ) ) ) )).
...
fof(fact_append__Nil2,axiom,(
    ! [V_xs,T_a] : V_xs = hAPP(hAPP(c_List_Oappend(T_a),V_xs),c_List_Olist_ONil(T_a)) )).
...
fof(fact_append__eq__appendI,axiom,(
    ! [V_us,V_ys,V_zs,V_xs1,V_xs,T_a] :
      ( ( hAPP(hAPP(c_List_Oappend(T_a),V_xs),V_ys) = hAPP(hAPP(c_List_Oappend(T_a),V_zs),V_us)
       <= hAPP(hAPP(c_List_Oappend(T_a),V_xs1),V_us) = V_ys )
...
fof(fact_lexord__append__rightI,axiom,(
    ! [V_r_2,V_x_2,T_a,V_y_2] :
     ...
     <= ? [B_b,B_z] : V_y_2 = hAPP(hAPP(c_List_Olist_OCons(T_a),B_b),B_z) ) )).

fof(fact_dropWhile__eq__Cons__conv,axiom,(
    ! [V_ys_2,V_y_2,V_xs_2,V_Pa_2,T_a] :
      ( ( V_xs_2 = hAPP(hAPP(c_List_Oappend(T_a),c_List_OtakeWhile(T_a,V_Pa_2,V_xs_2)),hAPP(hAPP(c_List_Olist_OCons(T_a),V_y_2),V_ys_2))
        & ~ hBOOL(hAPP(V_Pa_2,V_y_2)) )
    <=> c_List_OdropWhile(T_a,V_Pa_2,V_xs_2) = hAPP(hAPP(c_List_Olist_OCons(T_a),V_y_2),V_ys_2) ) )).
