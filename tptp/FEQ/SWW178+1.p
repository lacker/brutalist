...
fof(fact_scaleR_Opos__bounded,axiom,(
    ! [T_a] :
      ( ? [B_K] :
          ( c_Orderings_Oord__class_Oless(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),B_K)
          & ! [B_a,B_b] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,B_a,B_b)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(tc_RealDef_Oreal,B_a)),c_RealVector_Onorm__class_Onorm(T_a,B_b))),B_K)) )
...
fof(fact_complex__scaleR__def,axiom,(
    ! [V_x,V_r] : c_Complex_Ocomplex_OComplex(hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_r),c_Complex_ORe(V_x)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_r),c_Complex_OIm(V_x))) = c_RealVector_OscaleR__class_OscaleR(tc_Complex_Ocomplex,V_r,V_x) )).
...
fof(arity_Complex__Ocomplex__RealVector_Odist__norm,axiom,(
...
fof(fact_scaleR_Oadd__left,axiom,(
    ! [V_b,V_a_H,V_a,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => c_Groups_Oplus__class_Oplus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b),c_RealVector_OscaleR__class_OscaleR(T_a,V_a_H,V_b)) = c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,V_a,V_a_H),V_b) ) )).
...
fof(fact_Im_OscaleR,axiom,(
    ! [V_x,V_r] : c_RealVector_OscaleR__class_OscaleR(tc_RealDef_Oreal,V_r,c_Complex_OIm(V_x)) = c_Complex_OIm(c_RealVector_OscaleR__class_OscaleR(tc_Complex_Ocomplex,V_r,V_x)) )).
...
fof(fact_scaleR_OscaleR__right,axiom,(
    ! [V_b,V_r,V_a,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => c_RealVector_OscaleR__class_OscaleR(T_a,V_r,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b)) = c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_r,V_b)) ) )).
...
fof(fact_gr0__conv__Suc,axiom,(
    ! [V_n_2] :
      ( ? [B_m] : c_Nat_OSuc(B_m) = V_n_2
    <=> c_Orderings_Oord__class_Oless(tc_Nat_Onat,c_Groups_Ozero__class_Ozero(tc_Nat_Onat),V_n_2) ) )).

fof(fact_dist__eq__0__iff,axiom,(
    ! [V_y_2,V_x_2,T_a] :
      ( class_RealVector_Ometric__space(T_a)
     => ( c_RealVector_Odist__class_Odist(T_a,V_x_2,V_y_2) = c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal)
      <=> V_x_2 = V_y_2 ) ) )).
...
fof(fact_Re_OscaleR,axiom,(
    ! [V_x,V_r] : c_Complex_ORe(c_RealVector_OscaleR__class_OscaleR(tc_Complex_Ocomplex,V_r,V_x)) = c_RealVector_OscaleR__class_OscaleR(tc_RealDef_Oreal,V_r,c_Complex_ORe(V_x)) )).
...
fof(fact_scaleR__right_OscaleR,axiom,(
    ! [V_x,V_r,V_ra,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,V_r,c_RealVector_OscaleR__class_OscaleR(T_a,V_ra,V_x)) = c_RealVector_OscaleR__class_OscaleR(T_a,V_ra,c_RealVector_OscaleR__class_OscaleR(T_a,V_r,V_x))
     <= class_RealVector_Oreal__normed__vector(T_a) ) )).
...
fof(fact_complex__add__def,axiom,(
    ! [V_y,V_x] : c_Groups_Oplus__class_Oplus(tc_Complex_Ocomplex,V_x,V_y) = c_Complex_Ocomplex_OComplex(c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,c_Complex_ORe(V_x),c_Complex_ORe(V_y)),c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,c_Complex_OIm(V_x),c_Complex_OIm(V_y))) )).
...
fof(fact_scaleR__right_Obounded,axiom,(
    ! [V_r,T_a] :
      ( ? [B_K] :
        ! [B_x] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_r,B_x)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(T_a,B_x)),B_K))
     <= class_RealVector_Oreal__normed__vector(T_a) ) )).
...
fof(fact_complex__scaleR,axiom,(
    ! [V_b,V_a,V_r] : c_RealVector_OscaleR__class_OscaleR(tc_Complex_Ocomplex,V_r,c_Complex_Ocomplex_OComplex(V_a,V_b)) = c_Complex_Ocomplex_OComplex(hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_r),V_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_r),V_b)) )).
...
fof(fact_Suc__pred,axiom,(
    ! [V_n] :
      ( c_Orderings_Oord__class_Oless(tc_Nat_Onat,c_Groups_Ozero__class_Ozero(tc_Nat_Onat),V_n)
     => V_n = c_Nat_OSuc(c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_n,c_Nat_OSuc(c_Groups_Ozero__class_Ozero(tc_Nat_Onat)))) ) )).
...
fof(arity_Complex__Ocomplex__RealVector_Oreal__vector,axiom,(
...
fof(fact_complex__Re__one,axiom,(
    c_Groups_Oone__class_Oone(tc_RealDef_Oreal) = c_Complex_ORe(c_Groups_Oone__class_Oone(tc_Complex_Ocomplex)) )).
...
fof(fact_zero__le__dist,axiom,(
    ! [V_y,V_x,T_a] :
      ( class_RealVector_Ometric__space(T_a)
     => c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),c_RealVector_Odist__class_Odist(T_a,V_x,V_y)) ) )).
...
fof(fact_dist__triangle2,axiom,(
    ! [V_z,V_y,V_x,T_a] :
      ( class_RealVector_Ometric__space(T_a)
     => c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Odist__class_Odist(T_a,V_x,V_y),c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,c_RealVector_Odist__class_Odist(T_a,V_x,V_z),c_RealVector_Odist__class_Odist(T_a,V_y,V_z))) ) )).

fof(fact_dist__triangle3,axiom,(
    ! [V_a,V_y,V_x,T_a] :
      ( class_RealVector_Ometric__space(T_a)
     => c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Odist__class_Odist(T_a,V_x,V_y),c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,c_RealVector_Odist__class_Odist(T_a,V_a,V_x),c_RealVector_Odist__class_Odist(T_a,V_a,V_y))) ) )).

fof(fact_scaleR__minus__left,axiom,(
    ! [V_x,V_a,T_a] :
      ( c_Groups_Ouminus__class_Ouminus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x)) = c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ouminus__class_Ouminus(tc_RealDef_Oreal,V_a),V_x)
     <= class_RealVector_Oreal__vector(T_a) ) )).

fof(fact_minus__minus,axiom,(
    ! [V_a,T_a] :
      ( V_a = c_Groups_Ouminus__class_Ouminus(T_a,c_Groups_Ouminus__class_Ouminus(T_a,V_a))
     <= class_Groups_Ogroup__add(T_a) ) )).

fof(fact_bounded__bilinear_OscaleR__right,axiom,(
    ! [V_b_2,V_r_2,V_a_2,V_prod_2,T_b,T_c,T_a] :
      ( ( class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_c) )
     => ( c_RealVector_OscaleR__class_OscaleR(T_c,V_r_2,hAPP(hAPP(V_prod_2,V_a_2),V_b_2)) = hAPP(hAPP(V_prod_2,V_a_2),c_RealVector_OscaleR__class_OscaleR(T_b,V_r_2,V_b_2))
       <= c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2) ) ) )).
...
fof(fact_abs__real__def,axiom,(
    ! [V_a] :
      ( ( c_Groups_Ouminus__class_Ouminus(tc_RealDef_Oreal,V_a) = c_Groups_Oabs__class_Oabs(tc_RealDef_Oreal,V_a)
...
fof(fact_times_Oidem,axiom,(
    ! [V_a,T_a] :
     ...
     => V_a = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_a) ) )).

fof(fact_complex__surj,axiom,(
    ! [V_z] : V_z = c_Complex_Ocomplex_OComplex(c_Complex_ORe(V_z),c_Complex_OIm(V_z)) )).
...
fof(fact_dist__real__def,axiom,(
    ! [V_y,V_x] : c_Groups_Oabs__class_Oabs(tc_RealDef_Oreal,c_Groups_Ominus__class_Ominus(tc_RealDef_Oreal,V_x,V_y)) = c_RealVector_Odist__class_Odist(tc_RealDef_Oreal,V_x,V_y) )).
...
fof(fact_scaleR__right_Oadd,axiom,(
    ! [V_y,V_x,V_a,T_a] :
      ( c_Groups_Oplus__class_Oplus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x),c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_y)) = c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_Groups_Oplus__class_Oplus(T_a,V_x,V_y))
     <= class_RealVector_Oreal__vector(T_a) ) )).
...
fof(fact_scaleR__left_Oadd,axiom,(
    ! [V_xa,V_y,V_x,T_a] :
      ( class_RealVector_Oreal__vector(T_a)
     => c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,V_x,V_y),V_xa) = c_Groups_Oplus__class_Oplus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_x,V_xa),c_RealVector_OscaleR__class_OscaleR(T_a,V_y,V_xa)) ) )).
...
fof(fact_dist__self,axiom,(
    ! [V_x,T_a] :
      ( c_RealVector_Odist__class_Odist(T_a,V_x,V_x) = c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal)
     <= class_RealVector_Ometric__space(T_a) ) )).
...
fof(fact_bounded__bilinear_Ozero__left,axiom,(
    ! [V_b_2,V_prod_2,T_c,T_a,T_b] :
      ( ( c_Groups_Ozero__class_Ozero(T_c) = hAPP(hAPP(V_prod_2,c_Groups_Ozero__class_Ozero(T_a)),V_b_2)
       <= c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2) )
     <= ( class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_c) ) ) )).
...
fof(fact_dist__commute,axiom,(
    ! [V_y,V_x,T_a] :
      ( c_RealVector_Odist__class_Odist(T_a,V_x,V_y) = c_RealVector_Odist__class_Odist(T_a,V_y,V_x)
     <= class_RealVector_Ometric__space(T_a) ) )).
...
fof(fact_scaleR__right_Ozero,axiom,(
    ! [V_a,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_Groups_Ozero__class_Ozero(T_a)) = c_Groups_Ozero__class_Ozero(T_a)
     <= class_RealVector_Oreal__vector(T_a) ) )).
...
fof(fact_Re_Ozero,axiom,(
    c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal) = c_Complex_ORe(c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex)) )).
...
fof(fact_DeMoivre2,axiom,(
    ! [V_n,V_a,V_r] : hAPP(hAPP(c_Power_Opower__class_Opower(tc_Complex_Ocomplex),c_Complex_Orcis(V_r,V_a)),V_n) = c_Complex_Orcis(hAPP(hAPP(c_Power_Opower__class_Opower(tc_RealDef_Oreal),V_r),V_n),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealDef_Oreal(tc_Nat_Onat,V_n)),V_a)) )).
...
fof(fact_Complex__mult__i,axiom,(
    ! [V_b,V_a] : hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Complex_Ocomplex),c_Complex_Ocomplex_OComplex(V_a,V_b)),c_Complex_Oii) = c_Complex_Ocomplex_OComplex(c_Groups_Ouminus__class_Ouminus(tc_RealDef_Oreal,V_b),V_a) )).
...
fof(fact_real__vector_Oscale__one,axiom,(
    ! [V_x,T_a] :
      ( class_RealVector_Oreal__vector(T_a)
     => V_x = c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Oone__class_Oone(tc_RealDef_Oreal),V_x) ) )).
...
fof(fact_bounded__bilinear_OscaleR__left,axiom,(
    ! [V_b_2,V_a_2,V_r_2,V_prod_2,T_b,T_c,T_a] :
      ( ( c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2)
       => hAPP(hAPP(V_prod_2,c_RealVector_OscaleR__class_OscaleR(T_a,V_r_2,V_a_2)),V_b_2) = c_RealVector_OscaleR__class_OscaleR(T_c,V_r_2,hAPP(hAPP(V_prod_2,V_a_2),V_b_2)) )
     <= ( class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_c) ) ) )).
...
fof(fact_complex__equality,axiom,(
    ! [V_y,V_x] :
     ...
     => ( c_Complex_OIm(V_y) = c_Complex_OIm(V_x)
       => V_x = V_y ) ) )).
...
fof(fact_scaleR__right_Odiff,axiom,(
    ! [V_y,V_x,V_a,T_a] :
      ( class_RealVector_Oreal__vector(T_a)
     => c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_Groups_Ominus__class_Ominus(T_a,V_x,V_y)) = c_Groups_Ominus__class_Ominus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x),c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_y)) ) )).
...
fof(fact_scaleR__left_Odiff,axiom,(
    ! [V_xa,V_y,V_x,T_a] :
      ( class_RealVector_Oreal__vector(T_a)
     => c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ominus__class_Ominus(tc_RealDef_Oreal,V_x,V_y),V_xa) = c_Groups_Ominus__class_Ominus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_x,V_xa),c_RealVector_OscaleR__class_OscaleR(T_a,V_y,V_xa)) ) )).
...
fof(fact_Re_Odiff,axiom,(
    ! [V_y,V_x] : c_Groups_Ominus__class_Ominus(tc_RealDef_Oreal,c_Complex_ORe(V_x),c_Complex_ORe(V_y)) = c_Complex_ORe(c_Groups_Ominus__class_Ominus(tc_Complex_Ocomplex,V_x,V_y)) )).
...
fof(fact_mult__scaleR__right,axiom,(
    ! [V_y,V_a,V_x,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,V_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_x),V_y)) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_x),c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_y))
...
fof(fact_scaleR_Obounded,axiom,(
    ! [T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => ? [B_K] :
        ! [B_a,B_b] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,B_a,B_b)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(tc_RealDef_Oreal,B_a)),c_RealVector_Onorm__class_Onorm(T_a,B_b))),B_K)) ) )).
...
fof(fact_scaleR_Oprod__diff__prod,axiom,(
    ! [V_b,V_a,V_y,V_x,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => c_Groups_Oplus__class_Oplus(T_a,c_Groups_Oplus__class_Oplus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ominus__class_Ominus(tc_RealDef_Oreal,V_x,V_a),c_Groups_Ominus__class_Ominus(T_a,V_y,V_b)),c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ominus__class_Ominus(tc_RealDef_Oreal,V_x,V_a),V_b)),c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_Groups_Ominus__class_Ominus(T_a,V_y,V_b))) = c_Groups_Ominus__class_Ominus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_x,V_y),c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b)) ) )).
...
fof(fact_complex__Im__one,axiom,(
    c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal) = c_Complex_OIm(c_Groups_Oone__class_Oone(tc_Complex_Ocomplex)) )).
...
fof(fact_mult_OscaleR__left,axiom,(
    ! [V_b,V_a,V_r,T_a] :
      ( class_RealVector_Oreal__normed__algebra(T_a)
     => hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_RealVector_OscaleR__class_OscaleR(T_a,V_r,V_a)),V_b) = c_RealVector_OscaleR__class_OscaleR(T_a,V_r,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_b)) ) )).
...
fof(fact_Im_Ominus,axiom,(
    ! [V_x] : c_Groups_Ouminus__class_Ouminus(tc_RealDef_Oreal,c_Complex_OIm(V_x)) = c_Complex_OIm(c_Groups_Ouminus__class_Ouminus(tc_Complex_Ocomplex,V_x)) )).
...
fof(fact_bounded__bilinear_Opos__bounded,axiom,(
    ! [V_prod_2,T_a,T_b,T_c] :
      ( ( c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2)
       => ? [B_K] :
            ( c_Orderings_Oord__class_Oless(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),B_K)
            & ! [B_a,B_b] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_c,hAPP(hAPP(V_prod_2,B_a),B_b)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(T_a,B_a)),c_RealVector_Onorm__class_Onorm(T_b,B_b))),B_K)) ) )
     <= ( class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_c) ) ) )).

fof(fact_scaleR__right_Ononneg__bounded,axiom,(
    ! [V_r,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => ? [B_K] :
          ( ! [B_x] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_r,B_x)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(T_a,B_x)),B_K))
...
fof(fact_power_Opower_Opower__Suc,axiom,(
    ! [V_n_2,V_a_2,V_times_2,V_one_2,T_a] : hAPP(hAPP(V_times_2,V_a_2),hAPP(hAPP(c_Power_Opower_Opower(T_a,V_one_2,V_times_2),V_a_2),V_n_2)) = hAPP(hAPP(c_Power_Opower_Opower(T_a,V_one_2,V_times_2),V_a_2),c_Nat_OSuc(V_n_2)) )).
...
fof(fact_real__vector_Oscale__left__distrib,axiom,(
    ! [V_x,V_b,V_a,T_a] :
      ( class_RealVector_Oreal__vector(T_a)
     => c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,V_a,V_b),V_x) = c_Groups_Oplus__class_Oplus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x),c_RealVector_OscaleR__class_OscaleR(T_a,V_b,V_x)) ) )).
...
fof(fact_scaleR__right_Opos__bounded,axiom,(
    ! [V_r,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => ? [B_K] :
          ( ! [B_x] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_r,B_x)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(T_a,B_x)),B_K))
...
fof(fact_scaleR__left_Obounded,axiom,(
    ! [V_x,T_a] :
      ( ? [B_K] :
        ! [B_x] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,B_x,V_x)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(tc_RealDef_Oreal,B_x)),B_K))
     <= class_RealVector_Oreal__normed__vector(T_a) ) )).
...
fof(fact_bounded__bilinear_Ozero__right,axiom,(
    ! [V_a_2,V_prod_2,T_c,T_a,T_b] :
      ( ( class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_c)
        & class_RealVector_Oreal__normed__vector(T_b) )
     => ( c_Groups_Ozero__class_Ozero(T_c) = hAPP(hAPP(V_prod_2,V_a_2),c_Groups_Ozero__class_Ozero(T_b))
       <= c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2) ) ) )).
...
fof(fact_complex__Re__mult,axiom,(
    ! [V_y,V_x] : c_Complex_ORe(hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Complex_Ocomplex),V_x),V_y)) = c_Groups_Ominus__class_Ominus(tc_RealDef_Oreal,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_Complex_ORe(V_x)),c_Complex_ORe(V_y)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_Complex_OIm(V_x)),c_Complex_OIm(V_y))) )).
...
fof(fact_Im_Oadd,axiom,(
    ! [V_y,V_x] : c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,c_Complex_OIm(V_x),c_Complex_OIm(V_y)) = c_Complex_OIm(c_Groups_Oplus__class_Oplus(tc_Complex_Ocomplex,V_x,V_y)) )).
...
fof(arity_RealDef__Oreal__RealVector_Odist__norm,axiom,(
...
fof(fact_mult__is__0,axiom,(
    ! [V_n_2,V_m_2] :
      ( ( c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = V_n_2
        | V_m_2 = c_Groups_Ozero__class_Ozero(tc_Nat_Onat) )
    <=> c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_m_2),V_n_2) ) )).
...
fof(fact_scaleR__cancel__right,axiom,(
    ! [V_b_2,V_x_2,V_a_2,T_a] :
      ( class_RealVector_Oreal__vector(T_a)
     => ( ( V_a_2 = V_b_2
          | c_Groups_Ozero__class_Ozero(T_a) = V_x_2 )
      <=> c_RealVector_OscaleR__class_OscaleR(T_a,V_a_2,V_x_2) = c_RealVector_OscaleR__class_OscaleR(T_a,V_b_2,V_x_2) ) ) )).
...
fof(fact_scaleR__left_Ominus,axiom,(
    ! [V_xa,V_x,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ouminus__class_Ouminus(tc_RealDef_Oreal,V_x),V_xa) = c_Groups_Ouminus__class_Ouminus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_x,V_xa))
     <= class_RealVector_Oreal__vector(T_a) ) )).
...
fof(fact_complex_Osize_I1_J,axiom,(
    ! [V_real2,V_real1] : c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = c_Complex_Ocomplex_Ocomplex__size(c_Complex_Ocomplex_OComplex(V_real1,V_real2)) )).

fof(fact_scaleR__left_Opos__bounded,axiom,(
    ! [V_x,T_a] :
      ( ? [B_K] :
          ( c_Orderings_Oord__class_Oless(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),B_K)
          & ! [B_x] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,B_x,V_x)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(tc_RealDef_Oreal,B_x)),B_K)) )
...
fof(fact_mult__left_OscaleR,axiom,(
    ! [V_y,V_x,V_r,T_a] :
      ( hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_RealVector_OscaleR__class_OscaleR(T_a,V_r,V_x)),V_y) = c_RealVector_OscaleR__class_OscaleR(T_a,V_r,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_x),V_y))
     <= class_RealVector_Oreal__normed__algebra(T_a) ) )).
...
fof(fact_scaleR_Odiff__right,axiom,(
    ! [V_b_H,V_b,V_a,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_Groups_Ominus__class_Ominus(T_a,V_b,V_b_H)) = c_Groups_Ominus__class_Ominus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b),c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b_H)) ) )).
...
fof(fact_scaleR__left_OscaleR,axiom,(
    ! [V_xa,V_x,V_r,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,c_RealVector_OscaleR__class_OscaleR(tc_RealDef_Oreal,V_r,V_x),V_xa) = c_RealVector_OscaleR__class_OscaleR(T_a,V_r,c_RealVector_OscaleR__class_OscaleR(T_a,V_x,V_xa))
     <= class_RealVector_Oreal__normed__vector(T_a) ) )).
...
fof(fact_bounded__bilinear_Obounded,axiom,(
    ! [V_prod_2,T_a,T_b,T_c] :
      ( ( class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_c) )
...
fof(fact_norm__scaleR,axiom,(
    ! [V_x,V_a,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_Groups_Oabs__class_Oabs(tc_RealDef_Oreal,V_a)),c_RealVector_Onorm__class_Onorm(T_a,V_x)) = c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x)) ) )).
...
fof(fact_scaleR__right__imp__eq,axiom,(
    ! [V_b,V_a,V_x,T_a] :
      ( ( V_x != c_Groups_Ozero__class_Ozero(T_a)
       => ( V_a = V_b
         <= c_RealVector_OscaleR__class_OscaleR(T_a,V_b,V_x) = c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x) ) )
     <= class_RealVector_Oreal__vector(T_a) ) )).
...
fof(fact_scaleR__left__commute,axiom,(
    ! [V_x,V_b,V_a,T_a] :
      ( class_RealVector_Oreal__vector(T_a)
     => c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_b,V_x)) = c_RealVector_OscaleR__class_OscaleR(T_a,V_b,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x)) ) )).
...
fof(fact_dist__norm,axiom,(
    ! [V_y,V_x,T_a] :
      ( class_RealVector_Odist__norm(T_a)
     => c_RealVector_Onorm__class_Onorm(T_a,c_Groups_Ominus__class_Ominus(T_a,V_x,V_y)) = c_RealVector_Odist__class_Odist(T_a,V_x,V_y) ) )).
...
fof(fact_complex_Osize_I2_J,axiom,(
    ! [V_real2,V_real1] : c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = c_Nat_Osize__class_Osize(tc_Complex_Ocomplex,c_Complex_Ocomplex_OComplex(V_real1,V_real2)) )).
...
fof(fact_pos__zmult__eq__1__iff,axiom,(
    ! [V_n_2,V_m_2] :
      ( ( ( c_Groups_Oone__class_Oone(tc_Int_Oint) = V_n_2
          & c_Groups_Oone__class_Oone(tc_Int_Oint) = V_m_2 )
...
fof(fact_mult__left_Ozero,axiom,(
    ! [V_y,T_a] :
      ( c_Groups_Ozero__class_Ozero(T_a) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Groups_Ozero__class_Ozero(T_a)),V_y)
     <= class_RealVector_Oreal__normed__algebra(T_a) ) )).
...
fof(fact_bounded__bilinear_Oadd__left,axiom,(
    ! [V_b_2,V_a_H_2,V_a_2,V_prod_2,T_b,T_c,T_a] :
      ( ( class_RealVector_Oreal__normed__vector(T_c)
        & class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_a) )
     => ( c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2)
       => c_Groups_Oplus__class_Oplus(T_c,hAPP(hAPP(V_prod_2,V_a_2),V_b_2),hAPP(hAPP(V_prod_2,V_a_H_2),V_b_2)) = hAPP(hAPP(V_prod_2,c_Groups_Oplus__class_Oplus(T_a,V_a_2,V_a_H_2)),V_b_2) ) ) )).
...
fof(fact_dist__not__less__zero,axiom,(
    ! [V_y,V_x,T_a] :
      ( class_RealVector_Ometric__space(T_a)
     => ~ c_Orderings_Oord__class_Oless(tc_RealDef_Oreal,c_RealVector_Odist__class_Odist(T_a,V_x,V_y),c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal)) ) )).
...
fof(arity_Complex__Ocomplex__RealVector_Oreal__algebra,axiom,(
...
fof(fact_nat__diff__add__eq2,axiom,(
    ! [V_n,V_m,V_u,V_j,V_i] :
      ( c_Orderings_Oord__class_Oless__eq(tc_Nat_Onat,V_i,V_j)
     => c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_m,c_Groups_Oplus__class_Oplus(tc_Nat_Onat,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_j,V_i)),V_u),V_n)) = c_Groups_Ominus__class_Ominus(tc_Nat_Onat,c_Groups_Oplus__class_Oplus(tc_Nat_Onat,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_i),V_u),V_m),c_Groups_Oplus__class_Oplus(tc_Nat_Onat,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_j),V_u),V_n)) ) )).
...
fof(fact_scaleR_Ononneg__bounded,axiom,(
    ! [T_a] :
      ( ? [B_K] :
          ( c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),B_K)
          & ! [B_a,B_b] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,B_a,B_b)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(tc_RealDef_Oreal,B_a)),c_RealVector_Onorm__class_Onorm(T_a,B_b))),B_K)) )
...
fof(fact_real__scaleR__def,axiom,(
    ! [V_x,V_a] : hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_a),V_x) = c_RealVector_OscaleR__class_OscaleR(tc_RealDef_Oreal,V_a,V_x) )).
...
fof(fact_expand__complex__eq,axiom,(
    ...
    <=> ( c_Complex_ORe(V_x_2) = c_Complex_ORe(V_y_2)
        & c_Complex_OIm(V_y_2) = c_Complex_OIm(V_x_2) ) ) )).
...
fof(fact_power__inject__exp,axiom,(
    ! [V_n_2,V_m_2,V_a_2,T_a] :
      ( class_Rings_Olinordered__semidom(T_a)
     => ( ( V_n_2 = V_m_2
        <=> hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_a_2),V_n_2) = hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_a_2),V_m_2) )
...
fof(fact__096cmod_A_Iw_A_L_Az_A_L_A_N_Az_J_A_N_Acmod_A_Iw_A_L_Az_J_A_060_061_Acmod_A_I_N_Az_J_096,axiom,(
    c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_Groups_Ominus__class_Ominus(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(tc_Complex_Ocomplex,c_Groups_Oplus__class_Oplus(tc_Complex_Ocomplex,c_Groups_Oplus__class_Oplus(tc_Complex_Ocomplex,v_w,v_z),c_Groups_Ouminus__class_Ouminus(tc_Complex_Ocomplex,v_z))),c_RealVector_Onorm__class_Onorm(tc_Complex_Ocomplex,c_Groups_Oplus__class_Oplus(tc_Complex_Ocomplex,v_w,v_z))),c_RealVector_Onorm__class_Onorm(tc_Complex_Ocomplex,c_Groups_Ouminus__class_Ouminus(tc_Complex_Ocomplex,v_z))) )).

fof(fact_Complex__eq__1,axiom,(
    ! [V_b_2,V_a_2] :
      ( ( c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal) = V_b_2
        & c_Groups_Oone__class_Oone(tc_RealDef_Oreal) = V_a_2 )
...
fof(fact_dist__complex__def,axiom,(
    ! [V_y,V_x] : c_RealVector_Onorm__class_Onorm(tc_Complex_Ocomplex,c_Groups_Ominus__class_Ominus(tc_Complex_Ocomplex,V_x,V_y)) = c_RealVector_Odist__class_Odist(tc_Complex_Ocomplex,V_x,V_y) )).
...
fof(fact_complex__Im__i,axiom,(
    c_Groups_Oone__class_Oone(tc_RealDef_Oreal) = c_Complex_OIm(c_Complex_Oii) )).
...
fof(fact_scaleR_Ominus__left,axiom,(
    ! [V_b,V_a,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => c_Groups_Ouminus__class_Ouminus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b)) = c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ouminus__class_Ouminus(tc_RealDef_Oreal,V_a),V_b) ) )).
...
fof(arity_RealDef__Oreal__RealVector_Oreal__algebra,axiom,(
...
fof(fact_bounded__bilinear_Ominus__left,axiom,(
    ! [V_b_2,V_a_2,V_prod_2,T_b,T_c,T_a] :
      ( ( c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2)
       => c_Groups_Ouminus__class_Ouminus(T_c,hAPP(hAPP(V_prod_2,V_a_2),V_b_2)) = hAPP(hAPP(V_prod_2,c_Groups_Ouminus__class_Ouminus(T_a,V_a_2)),V_b_2) )
     <= ( class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_c) ) ) )).
...
fof(fact_crossproduct__eq,axiom,(
    ! [V_za_2,V_x_2,V_y_2,V_wa_2,T_a] :
      ( class_Semiring__Normalization_Ocomm__semiring__1__cancel__crossproduct(T_a)
     => ( c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_wa_2),V_y_2),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_x_2),V_za_2)) = c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_wa_2),V_za_2),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_x_2),V_y_2))
      <=> ( V_wa_2 = V_x_2
          | V_y_2 = V_za_2 ) ) ) )).

fof(fact_scaleR_Ominus__right,axiom,(
    ! [V_b,V_a,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => c_Groups_Ouminus__class_Ouminus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b)) = c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_Groups_Ouminus__class_Ouminus(T_a,V_b)) ) )).
...
fof(fact_ln__inj__iff,axiom,(
    ! [V_y_2,V_x_2] :
      ( ( ( V_y_2 = V_x_2
        <=> c_Transcendental_Oln(V_y_2) = c_Transcendental_Oln(V_x_2) )
       <= c_Orderings_Oord__class_Oless(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),V_y_2) )
     <= c_Orderings_Oord__class_Oless(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),V_x_2) ) )).
...
fof(fact_bounded__bilinear_Ononneg__bounded,axiom,(
    ! [V_prod_2,T_a,T_b,T_c] :
      ( ( class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_c) )
...
fof(fact_bounded__bilinear_Odiff__right,axiom,(
    ! [V_b_H_2,V_b_2,V_a_2,V_prod_2,T_b,T_c,T_a] :
      ( ( c_Groups_Ominus__class_Ominus(T_c,hAPP(hAPP(V_prod_2,V_a_2),V_b_2),hAPP(hAPP(V_prod_2,V_a_2),V_b_H_2)) = hAPP(hAPP(V_prod_2,V_a_2),c_Groups_Ominus__class_Ominus(T_b,V_b_2,V_b_H_2))
       <= c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2) )
     <= ( class_RealVector_Oreal__normed__vector(T_c)
        & class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_a) ) ) )).
...
fof(fact_mult__eq__1__iff,axiom,(
    ! [V_n_2,V_m_2] :
      ( c_Nat_OSuc(c_Groups_Ozero__class_Ozero(tc_Nat_Onat)) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_m_2),V_n_2)
    <=> ( c_Nat_OSuc(c_Groups_Ozero__class_Ozero(tc_Nat_Onat)) = V_m_2
        & V_n_2 = c_Nat_OSuc(c_Groups_Ozero__class_Ozero(tc_Nat_Onat)) ) ) )).
...
fof(fact_crossproduct__noteq,axiom,(
    ! [V_d_2,V_c_2,V_b_2,V_a_2,T_a] :
     ...
     => ( ( V_c_2 != V_d_2
          & V_a_2 != V_b_2 )
      <=> c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a_2),V_d_2),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b_2),V_c_2)) != c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a_2),V_c_2),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b_2),V_d_2)) ) ) )).
...
fof(fact_Complex__eq__i,axiom,(
    ! [V_y_2,V_x_2] :
      ( ( c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal) = V_x_2
        & V_y_2 = c_Groups_Oone__class_Oone(tc_RealDef_Oreal) )
...
fof(fact_scaleR__left_Ozero,axiom,(
    ! [V_x,T_a] :
      ( c_Groups_Ozero__class_Ozero(T_a) = c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),V_x)
     <= class_RealVector_Oreal__vector(T_a) ) )).
...
fof(fact_complex__Re__scaleR,axiom,(
    ! [V_x,V_r] : hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_r),c_Complex_ORe(V_x)) = c_Complex_ORe(c_RealVector_OscaleR__class_OscaleR(tc_Complex_Ocomplex,V_r,V_x)) )).

fof(fact_scaleR_Oadd__right,axiom,(
    ! [V_b_H,V_b,V_a,T_a] :
      ( c_Groups_Oplus__class_Oplus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b),c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b_H)) = c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_Groups_Oplus__class_Oplus(T_a,V_b,V_b_H))
     <= class_RealVector_Oreal__normed__vector(T_a) ) )).

fof(fact_norm__conv__dist,axiom,(
    ! [V_x,T_a] :
      ( c_RealVector_Onorm__class_Onorm(T_a,V_x) = c_RealVector_Odist__class_Odist(T_a,V_x,c_Groups_Ozero__class_Ozero(T_a))
     <= class_RealVector_Oreal__normed__vector(T_a) ) )).
...
fof(fact_dist__triangle,axiom,(
    ! [V_y,V_z,V_x,T_a] :
      ( class_RealVector_Ometric__space(T_a)
     => c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Odist__class_Odist(T_a,V_x,V_z),c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,c_RealVector_Odist__class_Odist(T_a,V_x,V_y),c_RealVector_Odist__class_Odist(T_a,V_y,V_z))) ) )).
...
fof(fact_scaleR__left__diff__distrib,axiom,(
    ! [V_x,V_b,V_a,T_a] :
      ( c_Groups_Ominus__class_Ominus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x),c_RealVector_OscaleR__class_OscaleR(T_a,V_b,V_x)) = c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ominus__class_Ominus(tc_RealDef_Oreal,V_a,V_b),V_x)
     <= class_RealVector_Oreal__vector(T_a) ) )).
...
fof(fact_Re_Ominus,axiom,(
    ! [V_x] : c_Complex_ORe(c_Groups_Ouminus__class_Ouminus(tc_Complex_Ocomplex,V_x)) = c_Groups_Ouminus__class_Ouminus(tc_RealDef_Oreal,c_Complex_ORe(V_x)) )).
...
fof(fact_scaleR__minus__right,axiom,(
    ! [V_x,V_a,T_a] :
      ( c_Groups_Ouminus__class_Ouminus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x)) = c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_Groups_Ouminus__class_Ouminus(T_a,V_x))
     <= class_RealVector_Oreal__vector(T_a) ) )).
...
fof(fact_mult__scaleR__left,axiom,(
    ! [V_y,V_x,V_a,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,V_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_x),V_y)) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x)),V_y)
     <= class_RealVector_Oreal__algebra(T_a) ) )).
...
fof(fact_complex__Im__mult,axiom,(
    ! [V_y,V_x] : c_Complex_OIm(hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Complex_Ocomplex),V_x),V_y)) = c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_Complex_ORe(V_x)),c_Complex_OIm(V_y)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_Complex_OIm(V_x)),c_Complex_ORe(V_y))) )).
...
fof(fact_scaleR_Ozero__left,axiom,(
    ! [V_b,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),V_b) = c_Groups_Ozero__class_Ozero(T_a) ) )).
...
fof(fact_scaleR__left__imp__eq,axiom,(
    ! [V_y,V_x,V_a,T_a] :
      ( ( c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal) != V_a
       => ( V_y = V_x
         <= c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_y) = c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_x) ) )
     <= class_RealVector_Oreal__vector(T_a) ) )).
...
fof(fact_bounded__bilinear_Odiff__left,axiom,(
    ! [V_b_2,V_a_H_2,V_a_2,V_prod_2,T_b,T_c,T_a] :
      ( ( class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_c)
        & class_RealVector_Oreal__normed__vector(T_b) )
     => ( c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2)
       => c_Groups_Ominus__class_Ominus(T_c,hAPP(hAPP(V_prod_2,V_a_2),V_b_2),hAPP(hAPP(V_prod_2,V_a_H_2),V_b_2)) = hAPP(hAPP(V_prod_2,c_Groups_Ominus__class_Ominus(T_a,V_a_2,V_a_H_2)),V_b_2) ) ) )).
...
fof(fact_mult_OscaleR__right,axiom,(
    ! [V_b,V_r,V_a,T_a] :
      ( hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),c_RealVector_OscaleR__class_OscaleR(T_a,V_r,V_b)) = c_RealVector_OscaleR__class_OscaleR(T_a,V_r,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_b))
     <= class_RealVector_Oreal__normed__algebra(T_a) ) )).
...
fof(fact_bounded__bilinear_Oadd__right,axiom,(
    ! [V_b_H_2,V_b_2,V_a_2,V_prod_2,T_b,T_c,T_a] :
      ( ( c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2)
       => hAPP(hAPP(V_prod_2,V_a_2),c_Groups_Oplus__class_Oplus(T_b,V_b_2,V_b_H_2)) = c_Groups_Oplus__class_Oplus(T_c,hAPP(hAPP(V_prod_2,V_a_2),V_b_2),hAPP(hAPP(V_prod_2,V_a_2),V_b_H_2)) )
     <= ( class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_c)
        & class_RealVector_Oreal__normed__vector(T_a) ) ) )).
...
fof(fact_natfloor__add,axiom,(
    ! [V_a,V_x] :
      ( c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),V_x)
     => c_Groups_Oplus__class_Oplus(tc_Nat_Onat,c_RComplete_Onatfloor(V_x),V_a) = c_RComplete_Onatfloor(c_Groups_Oplus__class_Oplus(tc_RealDef_Oreal,V_x,c_RealDef_Oreal(tc_Nat_Onat,V_a))) ) )).
...
fof(fact_comm__semiring__1__class_Onormalizing__semiring__rules_I31_J,axiom,(
    ! [V_q,V_p,V_x,T_a] :
      ( class_Rings_Ocomm__semiring__1(T_a)
     => hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_x),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_p),V_q)) = hAPP(hAPP(c_Power_Opower__class_Opower(T_a),hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_x),V_p)),V_q) ) )).
...
fof(fact_complex__Im__scaleR,axiom,(
    ! [V_x,V_r] : hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_r),c_Complex_OIm(V_x)) = c_Complex_OIm(c_RealVector_OscaleR__class_OscaleR(tc_Complex_Ocomplex,V_r,V_x)) )).
...
fof(fact_mult__right_OscaleR,axiom,(
    ! [V_x,V_r,V_xa,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,V_r,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_xa),V_x)) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_xa),c_RealVector_OscaleR__class_OscaleR(T_a,V_r,V_x))
     <= class_RealVector_Oreal__normed__algebra(T_a) ) )).
...
fof(arity_RealDef__Oreal__RealVector_Oreal__vector,axiom,(
...
fof(fact_scaleR_Odiff__left,axiom,(
    ! [V_b,V_a_H,V_a,T_a] :
      ( c_Groups_Ominus__class_Ominus(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b),c_RealVector_OscaleR__class_OscaleR(T_a,V_a_H,V_b)) = c_RealVector_OscaleR__class_OscaleR(T_a,c_Groups_Ominus__class_Ominus(tc_RealDef_Oreal,V_a,V_a_H),V_b)
     <= class_RealVector_Oreal__normed__vector(T_a) ) )).
...
fof(fact_dist__le__zero__iff,axiom,(
    ! [V_y_2,V_x_2,T_a] :
      ( ( V_x_2 = V_y_2
      <=> c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Odist__class_Odist(T_a,V_x_2,V_y_2),c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal)) )
     <= class_RealVector_Ometric__space(T_a) ) )).
...
fof(fact_scaleR_Ozero__right,axiom,(
    ! [V_a,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_Groups_Ozero__class_Ozero(T_a)) = c_Groups_Ozero__class_Ozero(T_a)
     <= class_RealVector_Oreal__normed__vector(T_a) ) )).
...
fof(fact_scaleR__eq__0__iff,axiom,(
    ! [V_x_2,V_a_2,T_a] :
      ( class_RealVector_Oreal__vector(T_a)
     => ( c_RealVector_OscaleR__class_OscaleR(T_a,V_a_2,V_x_2) = c_Groups_Ozero__class_Ozero(T_a)
      <=> ( c_Groups_Ozero__class_Ozero(T_a) = V_x_2
          | c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal) = V_a_2 ) ) ) )).
...
fof(fact_bounded__bilinear_Ominus__right,axiom,(
    ! [V_b_2,V_a_2,V_prod_2,T_b,T_c,T_a] :
      ( ( class_RealVector_Oreal__normed__vector(T_a)
        & class_RealVector_Oreal__normed__vector(T_c)
        & class_RealVector_Oreal__normed__vector(T_b) )
     => ( c_Groups_Ouminus__class_Ouminus(T_c,hAPP(hAPP(V_prod_2,V_a_2),V_b_2)) = hAPP(hAPP(V_prod_2,V_a_2),c_Groups_Ouminus__class_Ouminus(T_b,V_b_2))
       <= c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2) ) ) )).
...
fof(fact_zero__less__dist__iff,axiom,(
    ! [V_y_2,V_x_2,T_a] :
      ( class_RealVector_Ometric__space(T_a)
     => ( c_Orderings_Oord__class_Oless(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),c_RealVector_Odist__class_Odist(T_a,V_x_2,V_y_2))
      <=> V_y_2 != V_x_2 ) ) )).
...
fof(fact_scaleR__left_Ononneg__bounded,axiom,(
    ! [V_x,T_a] :
      ( ? [B_K] :
          ( c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),B_K)
          & ! [B_x] : c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_RealVector_Onorm__class_Onorm(T_a,c_RealVector_OscaleR__class_OscaleR(T_a,B_x,V_x)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(tc_RealDef_Oreal,B_x)),B_K)) )
...
fof(fact_real__vector_Oscale__scale,axiom,(
    ! [V_x,V_b,V_a,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_a),V_b),V_x) = c_RealVector_OscaleR__class_OscaleR(T_a,V_a,c_RealVector_OscaleR__class_OscaleR(T_a,V_b,V_x))
     <= class_RealVector_Oreal__vector(T_a) ) )).
...
fof(fact_scaleR__cancel__left,axiom,(
    ! [V_y_2,V_x_2,V_a_2,T_a] :
      ( class_RealVector_Oreal__vector(T_a)
     => ( c_RealVector_OscaleR__class_OscaleR(T_a,V_a_2,V_x_2) = c_RealVector_OscaleR__class_OscaleR(T_a,V_a_2,V_y_2)
...
fof(fact_bounded__bilinear_Oprod__diff__prod,axiom,(
    ! [V_b_2,V_a_2,V_y_2,V_x_2,V_prod_2,T_b,T_c,T_a] :
      ( ( c_RealVector_Obounded__bilinear(T_a,T_b,T_c,V_prod_2)
       => c_Groups_Ominus__class_Ominus(T_c,hAPP(hAPP(V_prod_2,V_x_2),V_y_2),hAPP(hAPP(V_prod_2,V_a_2),V_b_2)) = c_Groups_Oplus__class_Oplus(T_c,c_Groups_Oplus__class_Oplus(T_c,hAPP(hAPP(V_prod_2,c_Groups_Ominus__class_Ominus(T_a,V_x_2,V_a_2)),c_Groups_Ominus__class_Ominus(T_b,V_y_2,V_b_2)),hAPP(hAPP(V_prod_2,c_Groups_Ominus__class_Ominus(T_a,V_x_2,V_a_2)),V_b_2)),hAPP(hAPP(V_prod_2,V_a_2),c_Groups_Ominus__class_Ominus(T_b,V_y_2,V_b_2))) )
     <= ( class_RealVector_Oreal__normed__vector(T_b)
        & class_RealVector_Oreal__normed__vector(T_c)
        & class_RealVector_Oreal__normed__vector(T_a) ) ) )).
...
fof(fact_scaleR_OscaleR__left,axiom,(
    ! [V_b,V_a,V_r,T_a] :
      ( c_RealVector_OscaleR__class_OscaleR(T_a,V_r,c_RealVector_OscaleR__class_OscaleR(T_a,V_a,V_b)) = c_RealVector_OscaleR__class_OscaleR(T_a,c_RealVector_OscaleR__class_OscaleR(tc_RealDef_Oreal,V_r,V_a),V_b)
     <= class_RealVector_Oreal__normed__vector(T_a) ) )).
