...
fof(fact_def__invf,axiom,(
    ! [X,Xa,Xb] : aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1286379465_Sigma,Xa),scratc252546418d_soft(X,Xa,Xb)) = aa_TPTP_ind_TPTP_ind(scratc1029397085d_invf(X,Xa),Xb) )).

fof(fact_def__ind,axiom,(
    ! [X,Xa] : scratc1877310144nd_eps(aa_fun1584354236d_bool(aTP_Lamm_ba(X),Xa)) = scratc1910224951nd_ind(X,Xa) )).
...
fof(fact_ATP_Olambda__217,axiom,(
    ! [Uu,Uua,Uub] : aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc940712311bnd_ap,Uua),aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc940712311bnd_ap,Uu),Uub)) = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(aTP_Lamm_av(Uu),Uua),Uub) )).

fof(fact_def__proj0,axiom,(
    ! [X] : aa_fun277296641TP_ind(scratc1949800019eplSep(X,aTP_Lamm_bi),scratc525653845_d_Unj) = aa_TPTP_ind_TPTP_ind(scratc100380043_proj0,X) )).
...
fof(fact_def__first,axiom,(
    ! [X,Xa] : scratc100380043_proj0 = scratc1032180168_first(X,Xa) )).
...
fof(fact_xi__ext,axiom,(
    ! [X0,X12,X22] :
     ...
     => aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1286379465_Sigma,X0),X22) = aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1286379465_Sigma,X0),X12) ) )).
...
fof(fact_def__e__is,axiom,(
    ! [X] : fequal_TPTP_ind = scratc519053895d_e_is(X) )).
...
fof(fact_def__wissel__wa,axiom,(
    ! [X,Xa,Xb,Xc] : aa_TPTP_ind_TPTP_ind(scratc1910618546nd_ite(aa_TPTP_ind_bool(aa_TPT43085870d_bool(scratc519053895d_e_is(X),Xc),Xa),X,Xb),Xc) = aa_TPTP_ind_TPTP_ind(scratc1325709131sel_wa(X,Xa,Xb),Xc) )).
...
fof(fact_def__changef,axiom,(
    ! [X,Xa,Xb,Xc,Xd] : aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1286379465_Sigma,X),aa_TPT1424761345TP_ind(aa_TPT1791839040TP_ind(aa_TPT1781712639TP_ind(aTP_Lamm_au(X),Xb),Xc),Xd)) = aa_TPTP_ind_TPTP_ind(scratc237383150hangef(X,Xa,Xb,Xc),Xd) )).
...
fof(fact_def__d__Inj1,axiom,(
    scratc1677563599In_rec(aTP_Lamm_bk) = scratc1592014120d_Inj1 )).
...
fof(fact_if__i__1,axiom,(
    ! [X0,X12,X22] :
      ( ( X12 = aa_TPTP_ind_TPTP_ind(scratc941237093bnd_if(X0,X12),X22)
       <= pp(X0) )
     <= gg_TPTP_ind(X12) ) )).
...
fof(fact_def__n__in,axiom,(
    scratc95708267d_esti(scratc1950679705nd_nat) = scratc37714251d_n_in )).
...
fof(fact_ATP_Olambda__263,axiom,(
    ! [Uu,Uua,Uub,Uuc,Uud] : aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc940712311bnd_ap,Uua),aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc940712311bnd_ap,aa_TPTP_ind_TPTP_ind(scratc488694497wissel(Uu,Uub),Uuc)),Uud)) = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(aa_TPT1791839040TP_ind(aa_TPT1781712639TP_ind(aTP_Lamm_au(Uu),Uua),Uub),Uuc),Uud) )).
...
fof(fact_def__unmore,axiom,(
    ! [X,Xa,Xb] : aa_fun1431113780TP_ind(scratc508540450_d_Sep(X),aa_TPT43085870d_bool(aa_TPT60673477d_bool(aTP_Lamm_aq(X),Xa),Xb)) = aa_TPTP_ind_TPTP_ind(scratc726785046unmore(X,Xa),Xb) )).
...
fof(fact_ATP_Olambda__268,axiom,(
    ! [Uu] : scratc1950679705nd_nat = aa_TPTP_ind_TPTP_ind(aTP_Lamm_ab,Uu) )).
...
fof(fact_def__inj__h,axiom,(
    ! [X,Xa,Xb,Xc,Xd] : aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1286379465_Sigma,X),aa_TPT1424761345TP_ind(aTP_Lamm_av(Xc),Xd)) = aa_TPTP_ind_TPTP_ind(scratc229957163_inj_h(X,Xa,Xb,Xc),Xd) )).
...
fof(fact_ATP_Olambda__171,axiom,(
    ! [Uu,Uua,Uub] : aa_TPTP_ind_TPTP_ind(scratc941237093bnd_if(aa_TPTP_ind_bool(Uua,Uub),Uub),scratc1877310144nd_eps(aa_fun1584354236d_bool(aTP_Lamm_ba(Uu),Uua))) = aa_TPTP_ind_TPTP_ind(aa_fun1235454963TP_ind(aTP_Lamm_bm(Uu),Uua),Uub) )).
...
fof(fact_def__nat,axiom,(
    aa_fun1431113780TP_ind(scratc508540450_d_Sep(scratc1417518905_omega),aTP_Lamm_ag) = scratc1950679705nd_nat )).
...
fof(fact_ATP_Olambda__87,axiom,(
    ! [Uu] :
     ...
     => ( pp(aa_TPTP_ind_bool(aTP_Lamm_bi,Uu))
      <=> ? [X2] :
            ( gg_TPTP_ind(X2)
            & Uu = aa_TPTP_ind_TPTP_ind(scratc1592014119d_Inj0,X2) ) ) ) )).
...
fof(fact_def__if,axiom,(
    ! [X,Xa,Xb] : scratc1877310144nd_eps(aa_TPT43085870d_bool(aa_TPT60673477d_bool(aTP_Lamm_bo(X),Xa),Xb)) = aa_TPTP_ind_TPTP_ind(scratc941237093bnd_if(X,Xa),Xb) )).
...
fof(fact_def__indeq,axiom,(
    ! [X,Xa,Xb,Xc,Xd] : scratc1910224951nd_ind(Xb,aa_TPT43085870d_bool(scratc100773639_prop2(X,Xa,Xb,Xc),Xd)) = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc1794778627_indeq(X,Xa,Xb),Xc),Xd) )).
...
fof(fact_def__l__or,axiom,(
    ! [X] : aa_boo1142376798l_bool(scratc1910159364nd_imp,scratc732257079_d_not(X)) = scratc2053946567d_l_or(X) )).
...
fof(fact_def__cond1,axiom,(
    aa_TPT43085870d_bool(scratc37714251d_n_in,scratc511934379nd_n_1) = scratc115496775_cond1 )).

fof(fact_proj__Sigma__eta,axiom,(
    ! [X0,X12,X22] :
      ( ( pp(aa_TPTP_ind_bool(aa_TPT43085870d_bool(scratc941237101bnd_in,X22),aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1286379465_Sigma,X0),X12)))
       => X22 = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc2090287842d_pair,aa_TPTP_ind_TPTP_ind(scratc100380043_proj0,X22)),aa_TPTP_ind_TPTP_ind(scratc100380044_proj1,X22)) )
     <= gg_TPTP_ind(X22) ) )).
...
fof(fact_def__pair,axiom,(
    ! [X,Xa] : aa_TPTP_ind_TPTP_ind(scratc534055280nunion(aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1537483799d_repl,X),scratc1592014119d_Inj0)),aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1537483799d_repl,Xa),scratc1592014120d_Inj1)) = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc2090287842d_pair,X),Xa) )).
...
fof(fact_def__famunion,axiom,(
    ! [X,Xa] : aa_TPTP_ind_TPTP_ind(scratc479128071_union,aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1537483799d_repl,X),Xa)) = aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1687681829munion,X),Xa) )).
...
fof(fact_ATP_Olambda__170,axiom,(
    ! [Uu,Uua,Uub] : aa_TPTP_ind_TPTP_ind(scratc941237093bnd_if(aa_TPTP_ind_bool(aa_TPT43085870d_bool(scratc941237101bnd_in,scratc1322241277ptyset),Uub),Uu),Uua) = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(aTP_Lamm_bn(Uu),Uua),Uub) )).
...
fof(fact_def__all,axiom,(
    ! [X] : scratc1742550576all_of(aa_TPT43085870d_bool(aTP_Lamm_ai,X)) = scratc1844001721nd_all(X) )).
...
fof(fact_ATP_Olambda__84,axiom,(
    ! [Uu] : aa_TPT494704832TP_ind(scratc1537483799d_repl,aa_TPTP_ind_TPTP_ind(scratc450340822tminus(Uu),aa_TPTP_ind_TPTP_ind(scratc766906443d_Sing,scratc1322241277ptyset))) = aa_TPT494704832TP_ind(aTP_Lamm_bj,Uu) )).
...
fof(fact_def__omega,axiom,(
    aa_fun1431113780TP_ind(scratc508540450_d_Sep(aa_TPTP_ind_TPTP_ind(scratc1957037285univof,scratc1322241277ptyset)),scratc1523980503_nat_p) = scratc1417518905_omega )).
...
fof(fact_def__ecect,axiom,(
    ! [X,Xa] : scratc519053890d_e_in(aa_TPTP_ind_TPTP_ind(scratc2119349853_power,X),scratc1226035251d_anec(X,Xa)) = scratc1543094480_ecect(X,Xa) )).

fof(fact_def__ap,axiom,(
    ! [X,Xa] : aa_fun277296641TP_ind(scratc1949800019eplSep(X,aa_TPT43085870d_bool(aTP_Lamm_bf,Xa)),scratc100380044_proj1) = aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc940712311bnd_ap,X),Xa) )).
...
fof(fact_def__setprod,axiom,(
    ! [X,Xa] : aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1286379465_Sigma,X),aTP_Lamm_ah(Xa)) = aa_TPTP_ind_TPTP_ind(scratc459099601etprod(X),Xa) )).
...
fof(fact_def__wissel__wb,axiom,(
    ! [X,Xa,Xb,Xc] : aa_TPTP_ind_TPTP_ind(scratc1910618546nd_ite(aa_TPTP_ind_bool(aa_TPT43085870d_bool(scratc519053895d_e_is(X),Xc),Xb),X,Xa),aa_TPTP_ind_TPTP_ind(scratc1325709131sel_wa(X,Xa,Xb),Xc)) = aa_TPTP_ind_TPTP_ind(scratc1325709132sel_wb(X,Xa,Xb),Xc) )).
...
fof(fact_def__e__in,axiom,(
    ! [X,Xa,Xb] :
      ( gg_TPTP_ind(Xb)
     => Xb = aa_TPTP_ind_TPTP_ind(scratc519053890d_e_in(X,Xa),Xb) ) )).
...
fof(fact_def__imp,axiom,(
    fimplies = scratc1910159364nd_imp )).
...
fof(fact_def__second,axiom,(
    ! [X,Xa] : scratc100380044_proj1 = scratc1247910428second(X,Xa) )).
...
fof(fact_neq__ordsucc__0,axiom,(
    ! [X0] : scratc1322241277ptyset != aa_TPTP_ind_TPTP_ind(scratc825176507rdsucc,X0) )).
...
fof(fact_def__ect,axiom,(
    ! [X,Xa] : aa_fun1431113780TP_ind(scratc508540450_d_Sep(aa_TPTP_ind_TPTP_ind(scratc2119349853_power,X)),scratc1226035251d_anec(X,Xa)) = scratc1876457358nd_ect(X,Xa) )).
...
fof(fact_if__i__or,axiom,(
    ! [X0,X12,X22] :
      ( ( gg_TPTP_ind(X22)
        & gg_TPTP_ind(X12) )
     => ( X12 = aa_TPTP_ind_TPTP_ind(scratc941237093bnd_if(X0,X12),X22)
        | X22 = aa_TPTP_ind_TPTP_ind(scratc941237093bnd_if(X0,X12),X22) ) ) )).
...
fof(fact_def__n__some,axiom,(
    scratc853211384l_some(scratc1950679705nd_nat) = scratc1597036026n_some )).
...
fof(fact_def__plus,axiom,(
    ! [X] : scratc1910224951nd_ind(aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1525333269d_d_Pi,scratc1950679705nd_nat),aTP_Lamm_ab),aa_TPT43085870d_bool(scratc1787263345_prop2,X)) = aa_TPTP_ind_TPTP_ind(scratc34467938d_plus,X) )).
...
fof(fact_def__d__Pi,axiom,(
    ! [X,Xa] : aa_fun1431113780TP_ind(scratc508540450_d_Sep(aa_TPTP_ind_TPTP_ind(scratc2119349853_power,aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1286379465_Sigma,X),aTP_Lamm_bd(Xa)))),aa_fun1913827119d_bool(aTP_Lamm_be(X),Xa)) = aa_fun277296641TP_ind(aa_TPT494704832TP_ind(scratc1525333269d_d_Pi,X),Xa) )).
...
fof(fact_def__proj1,axiom,(
    ! [X] : aa_fun277296641TP_ind(scratc1949800019eplSep(X,aTP_Lamm_bh),scratc525653845_d_Unj) = aa_TPTP_ind_TPTP_ind(scratc100380044_proj1,X) )).
...
fof(fact_def__tofs,axiom,(
    ! [X,Xa] : scratc940712311bnd_ap = scratc1033133616d_tofs(X,Xa) )).
...
fof(fact_def__indeq2,axiom,(
    ! [X,Xa,Xb,Xc,Xd] : aa_TPT1424761345TP_ind(scratc1794778627_indeq(X,Xa,Xb),aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc365678701d_11_i(X,Xa,Xb),Xc),Xd)) = scratc2039634671indeq2(X,Xa,Xb,Xc,Xd) )).
...
fof(fact_proj1__pair__eq,axiom,(
    ! [X0,X12] :
      ( X12 = aa_TPTP_ind_TPTP_ind(scratc100380044_proj1,aa_TPTP_ind_TPTP_ind(aa_TPT1424761345TP_ind(scratc2090287842d_pair,X0),X12))
     <= gg_TPTP_ind(X12) ) )).
