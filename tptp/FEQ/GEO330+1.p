fof('ass(cond(conseq(348), 1), 0)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1287,vd1288,vd1289) = vangle(vd1287,vd1289,vd1288) )).

fof('ass(cond(conseq(348), 1), 22)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => ron(vd1299,vd1295) )).

fof('holds(conjunct2(376), 1346, 0)',axiom,(
    vangle(vd1289,vd1302,vd1288) = vangle(vd1288,vd1329,vd1289) )).
...
fof('holds(conjunct2(conjunct2(conjunct2(368))), 1334, 0)',axiom,(
    vd1302 != vd1287 )).

fof('ass(cond(conseq(348), 1), 11)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1288,vd1287,vskolem1306) = vangle(vd1288,vd1287,vd1289) )).
...
fof('ass(cond(conseq(348), 1), 10)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1299,vd1287,vd1289) = vangle(vd1288,vd1287,vd1289) )).
...
fof('pred(s2(plural(369)), 0)',axiom,(
    ron(vd1287,vd1297) )).

fof('ass(cond(conseq(348), 1), 23)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => ron(vd1287,vd1295) )).

fof('ass(cond(conseq(348), 1), 17)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vd1287 != vd1288 )).

fof('ass(cond(conseq(348), 1), 26)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vd1287 != vskolem1306 )).
...
fof('ass(cond(conseq(348), 1), 3)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1299,vd1288,vd1289) = vangle(vskolem1306,vd1289,vd1288) )).

fof('holds(conjunct1(conjunct2(conjunct2(371))), 1334, 0)',axiom,(
    vd1287 != vd1302 )).
...
fof('holds(377, 1347, 0)',axiom,(
    vf(vd1288,vd1329) = vf(vd1289,vd1302) )).
...
fof('ass(cond(conseq(348), 1), 9)',axiom,
    ( vf(vd1299,vd1289) = vf(vskolem1306,vd1288)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).

fof('ass(cond(conseq(348), 1), 30)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => rpoint(vskolem1306) )).

fof('ass(cond(conseq(348), 1), 1)',axiom,
    ( vangle(vd1287,vd1289,vd1299) = vplus(vangle(vd1288,vd1289,vd1299),vangle(vd1287,vd1289,vd1288))
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).

fof('pred(s1(plural(370)), 0)',axiom,(
    ron(vd1299,vd1295) )).
...
fof('holds(conjunct2(378), 1349, 0)',axiom,(
    vangle(vd1289,vd1288,vd1302) = vangle(vd1288,vd1289,vd1329) )).

fof('pred(s1(plural(369)), 0)',axiom,(
    ron(vd1287,vd1295) )).
...
fof('ass(cond(conseq(348), 1), 29)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => rR(vskolem1306,vd1287,vd1302) )).
...
fof('ass(cond(conseq(348), 1), 21)',axiom,
    ( ron(vd1287,vd1297)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).

fof('holds(380, 1351, 0)',conjecture,(
    vangle(vd1287,vd1289,vd1288) = vangle(vd1287,vd1288,vd1289) )).

fof('neg(neg(372))',axiom,(
    ~ rR(vd1287,vd1289,vd1302) )).

fof('holds(conjunct1(376), 1343, 0)',axiom,(
    vf(vd1329,vd1289) = vf(vd1302,vd1288) )).
...
fof('ass(cond(conseq(348), 1), 7)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1287,vd1288,vskolem1306) = vangle(vd1287,vd1289,vd1299) )).
...
fof('pred(conjunct2(369), 0)',axiom,(
    ron(vd1289,vd1297) )).

fof('holds(conjunct1(375), 1343, 0)',axiom,(
    vf(vd1329,vd1289) = vf(vd1302,vd1288) )).
...
fof('ass(cond(conseq(348), 1), 8)',axiom,
    ( vangle(vd1287,vskolem1306,vd1288) = vangle(vd1287,vd1299,vd1289)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).

fof('ass(cond(conseq(348), 1), 27)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => ron(vskolem1306,vd1297) )).
...
fof('holds(conjunct2(367), 1331, 0)',axiom,(
    vf(vd1287,vd1302) = vf(vd1287,vd1329) )).

fof('ass(cond(conseq(348), 1), 18)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => ron(vd1289,vd1297) )).
...
fof('holds(conjunct1(371), 1337, 0)',axiom,(
    vd1287 != vd1288 )).
...
fof('ass(cond(conseq(348), 1), 5)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1288,vd1299,vd1289) = vangle(vd1289,vskolem1306,vd1288) )).
...
fof('ass(cond(conseq(348), 1), 19)',axiom,
    ( ron(vd1288,vd1295)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).
...
fof('pred(conjunct1(368), 0)',axiom,(
    ron(vd1329,vd1295) )).

fof('holds(conjunct1(conjunct2(368)), 1332, 0)',axiom,(
    vd1287 != vd1329 )).
...
fof('holds(373, 1341, 0)',axiom,(
    vangle(vd1289,vd1287,vd1329) = vangle(vd1289,vd1287,vd1288) )).

fof('pred(s1(plural(346)), 0)',axiom,(
    ron(vd1287,vd1295) )).
...
fof('ass(cond(conseq(348), 1), 4)',axiom,
    ( vf(vd1288,vd1299) = vf(vd1289,vskolem1306)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).

fof('pred(s3(plural(370)), 0)',axiom,(
    ron(vd1288,vd1295) )).

fof('ass(cond(conseq(348), 1), 16)',axiom,
    ( vd1289 != vd1287
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).
...
fof('pred(s2(plural(370)), 0)',axiom,(
    ron(vd1329,vd1295) )).
...
fof('holds(conjunct1(conjunct2(conjunct2(368))), 1333, 0)',axiom,(
    vd1329 != vd1302 )).
...
fof('ass(cond(conseq(348), 1), 2)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1288,vd1289,vd1299) = vangle(vd1289,vd1288,vskolem1306) )).
...
fof('ass(cond(conseq(348), 1), 28)',axiom,
    ( vf(vd1287,vskolem1306) = vf(vd1287,vd1299)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).
...
fof('holds(379, 1350, 0)',axiom,(
    vplus(vangle(vd1289,vd1288,vd1302),vangle(vd1287,vd1288,vd1289)) = vangle(vd1287,vd1288,vd1302) )).

fof('holds(conjunct1(conjunct2(371)), 1338, 0)',axiom,(
    vd1289 != vd1287 )).

fof('ass(cond(conseq(348), 1), 14)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vd1287 != vskolem1306 )).
...
fof('ass(cond(conseq(348), 1), 6)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vf(vd1299,vd1289) = vf(vd1288,vskolem1306) )).
...
fof('ass(cond(conseq(348), 1), 15)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vd1287 != vd1299 )).

fof('pred(conjunct1(349), 0)',axiom,(
    ron(vd1299,vd1295) )).
...
fof('ass(cond(conseq(348), 1), 25)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vskolem1306 != vd1302 )).
...
fof('holds(conjunct1(conjunct2(375)), 1344, 0)',axiom,(
    vangle(vd1287,vd1302,vd1288) = vangle(vd1287,vd1329,vd1289) )).
...
fof('ass(cond(conseq(348), 1), 20)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => ron(vskolem1306,vd1297) )).

fof('pred(s2(plural(346)), 0)',axiom,(
    ron(vd1288,vd1295) )).

fof('ass(cond(conseq(348), 1), 24)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vd1287 != vd1299 )).

fof('neg(neg(conjunct2(372)))',axiom,(
...
fof('holds(conjunct1(378), 1348, 0)',axiom,(
    vangle(vd1302,vd1289,vd1288) = vangle(vd1329,vd1288,vd1289) )).

fof('holds(conjunct1(367), 1330, 0)',axiom,(
    rR(vd1329,vd1287,vd1299) )).
...
fof('ass(cond(conseq(348), 1), 13)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
...
fof('holds(conjunct2(conjunct2(375)), 1345, 0)',axiom,(
    vangle(vd1287,vd1288,vd1302) = vangle(vd1287,vd1289,vd1329) )).
...
fof('holds(conjunct2(conjunct2(conjunct2(371))), 1332, 0)',axiom,(
    vd1329 != vd1287 )).

fof('holds(374, 1342, 0)',axiom,(
    vangle(vd1302,vd1287,vd1288) = vangle(vd1289,vd1287,vd1288) )).
...
fof('ass(cond(conseq(348), 1), 12)',axiom,
    ( ~ rR(vd1287,vd1289,vskolem1306)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).
