...
fof(fact_372_empty__Diff,axiom,(
    ! [A] : hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,bot_bo1181479936a_bool),A) = bot_bo1181479936a_bool )).

fof(fact_64_empty__def,axiom,(
    collec268032053iple_a(hAPP_b119575286a_bool(cOMBK_151824839iple_a,fFalse)) = bot_bo1181479936a_bool )).
...
fof(fact_83_insert__commute,axiom,(
    ! [X_1,Y_7,A] : hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,Y_7),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,X_1),A)) = hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,X_1),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,Y_7),A)) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Hoare____Mirabelle____ddpglwnxwg__Otriple_It__a_J_00,axiom,(
    ! [P,Q,R] : hAPP_H1421470952a_bool(hAPP_H1190454433a_bool(P,R),Q) = hAPP_H1421470952a_bool(hAPP_H1190454433a_bool(hAPP_f1371755681a_bool(cOMBC_839220826a_bool,P),Q),R) )).
...
fof(fact_562_Un__insert__right,axiom,(
    ! [A,A_1,B] : hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila465093516t_bool,A),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),B)) = hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila465093516t_bool,A),B)) )).
...
fof(fact_153_nonempty__iff,axiom,(
    ! [A] :
      ( ? [X_2,B_15] :
          ( A = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_2),B_15)
...
fof(fact_687_inf__bot__left,axiom,(
    ! [X_1] : bot_bot_fun_nat_bool = hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila840543986t_bool,bot_bot_fun_nat_bool),X_1) )).
...
fof(fact_85_insert__absorb2,axiom,(
    ! [X_1,A] : hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),A)) = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),A) )).

fof(fact_390_Diff__insert2,axiom,(
    ! [A,A_1,B] : hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),bot_bo1055319631e_bool))),B) = hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),B)) )).
...
fof(fact_379_insert__Diff__if,axiom,(
    ! [A,X_1,B] :
      ( ( hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,A),B)) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),A)),B)
...
fof(fact_237_image__insert,axiom,(
    ! [F_1,A_1,B] : image_194810223_a_nat(F_1,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B)) = hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,hAPP_H738206399_a_nat(F_1,A_1)),image_194810223_a_nat(F_1,B)) )).

fof(fact_249_folding__one_Osingleton,axiom,(
    ! [X_1,F_1,F] :
      ( hBOOL(finite1669978781iple_a(F_1,F))
     => hAPP_f124283079iple_a(F,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),bot_bo1181479936a_bool)) = X_1 ) )).
...
fof(fact_563_Un__insert__right,axiom,(
    ! [A,A_1,B] : hAPP_f921536533e_bool(hAPP_f1583986009e_bool(semila447562797e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),B)) = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),hAPP_f921536533e_bool(hAPP_f1583986009e_bool(semila447562797e_bool,A),B)) )).
...
fof(fact_652_Int__insert__right__if0,axiom,(
    ! [B,A_1,A] :
      ( ~ hBOOL(hAPP_f1760790145l_bool(hAPP_H248360617l_bool(member1758697444_state,A_1),A))
     => hAPP_f921536533e_bool(hAPP_f1583986009e_bool(semila2145357127e_bool,A),B) = hAPP_f921536533e_bool(hAPP_f1583986009e_bool(semila2145357127e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),B)) ) )).
...
fof(fact_384_Diff__insert__absorb,axiom,(
    ! [X_1,A] :
      ( A = hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),A)),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),bot_bo1055319631e_bool))
...
fof(fact_65_empty__def,axiom,(
    collect_fun_nat_bool(hAPP_b1630757474l_bool(cOMBK_1994329625t_bool,fFalse)) = bot_bo1701429464l_bool )).

fof(fact_666_Collect__conj__eq,axiom,(
    ! [Pa,Q_1] : hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila840543986t_bool,collect_nat(Pa)),collect_nat(Q_1)) = collect_nat(hAPP_f800510211t_bool(hAPP_f561022312t_bool(cOMBS_nat_bool_bool,hAPP_f1146629647l_bool(hAPP_f1080886329l_bool(cOMBB_1015721476ol_nat,fconj),Pa)),Q_1)) )).

fof(fact_105_singleton__inject,axiom,(
    ! [A_1,Ba] :
      ( A_1 = Ba
     <= hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,Ba),bot_bo1055319631e_bool) = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),bot_bo1055319631e_bool) ) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Hoare____Mirabelle____ddpglwnxwg__Otriple_It__a_J_00_023,axiom,(
    ! [P,Q,R] : hAPP_f540970102l_bool(hAPP_H1840393229l_bool(P,R),Q) = hAPP_H1421470952a_bool(hAPP_f1591852335a_bool(hAPP_f672239281a_bool(cOMBC_1552014468l_bool,P),Q),R) )).
...
fof(fact_335_finite_Osimps,axiom,(
    ! [A_1] :
      ( ( A_1 = bot_bo1055319631e_bool
        | ? [A_19,A_7] :
            ( hBOOL(hAPP_f1760790145l_bool(finite784854244_state,A_19))
            & A_1 = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_7),A_19) ) )
    <=> hBOOL(hAPP_f1760790145l_bool(finite784854244_state,A_1)) ) )).

fof(fact_498_sup__bot__right,axiom,(
    ! [X_1] : hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila1498788770a_bool,X_1),bot_bo1181479936a_bool) = X_1 )).
...
fof(fact_235_insert__image,axiom,(
    ! [F_1,X_1,A] :
      ( hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,hAPP_n178040171iple_a(F_1,X_1)),image_1782127643iple_a(F_1,A)) = image_1782127643iple_a(F_1,A)
     <= hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),A)) ) )).
...
fof(fact_650_Int__insert__left__if0,axiom,(
    ! [B,A_1,C] :
     ...
     => hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B)),C) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,B),C) ) )).
...
fof(fact_347_folding__one_Oremove,axiom,(
    ! [X_1,A,F_1,F] :
     ...
     => ( hBOOL(hAPP_f540970102l_bool(finite1655202547iple_a,A))
       => ( hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,X_1),A))
         => ( ( hAPP_f124283079iple_a(F,A) = hAPP_H678412245iple_a(hAPP_H1455657330iple_a(F_1,X_1),hAPP_f124283079iple_a(F,hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,A),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),bot_bo1181479936a_bool))))
...
fof(fact_242_If__def,axiom,(
    ! [X_1,Y_7,Pa] :
      ( ( hAPP_f124283079iple_a(the_Ho746640593iple_a,hAPP_f1591852335a_bool(hAPP_f1203760810a_bool(cOMBS_1148211387l_bool,hAPP_f997599971l_bool(hAPP_f439164429l_bool(cOMBB_1782929690iple_a,fconj),hAPP_f1591852335a_bool(hAPP_f34030599a_bool(cOMBB_1799513916iple_a,hAPP_b589554111l_bool(fimplies,Pa)),hAPP_H1190454433a_bool(hAPP_f1371755681a_bool(cOMBC_839220826a_bool,fequal879838495iple_a),X_1)))),hAPP_f1591852335a_bool(hAPP_f34030599a_bool(cOMBB_1799513916iple_a,hAPP_b589554111l_bool(fimplies,hAPP_bool_bool(fNot,Pa))),hAPP_H1190454433a_bool(hAPP_f1371755681a_bool(cOMBC_839220826a_bool,fequal879838495iple_a),Y_7)))) = X_1
       <= hBOOL(Pa) )
      & ( ~ hBOOL(Pa)
       => hAPP_f124283079iple_a(the_Ho746640593iple_a,hAPP_f1591852335a_bool(hAPP_f1203760810a_bool(cOMBS_1148211387l_bool,hAPP_f997599971l_bool(hAPP_f439164429l_bool(cOMBB_1782929690iple_a,fconj),hAPP_f1591852335a_bool(hAPP_f34030599a_bool(cOMBB_1799513916iple_a,hAPP_b589554111l_bool(fimplies,Pa)),hAPP_H1190454433a_bool(hAPP_f1371755681a_bool(cOMBC_839220826a_bool,fequal879838495iple_a),X_1)))),hAPP_f1591852335a_bool(hAPP_f34030599a_bool(cOMBB_1799513916iple_a,hAPP_b589554111l_bool(fimplies,hAPP_bool_bool(fNot,Pa))),hAPP_H1190454433a_bool(hAPP_f1371755681a_bool(cOMBC_839220826a_bool,fequal879838495iple_a),Y_7)))) = Y_7 ) ) )).
...
fof(fact_658_Int__insert__left,axiom,(
    ! [B,A_1,C] :
      ...
      & ( ~ hBOOL(hAPP_f1760790145l_bool(hAPP_H248360617l_bool(member1758697444_state,A_1),C))
       => hAPP_f921536533e_bool(hAPP_f1583986009e_bool(semila2145357127e_bool,hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),B)),C) = hAPP_f921536533e_bool(hAPP_f1583986009e_bool(semila2145357127e_bool,B),C) ) ) )).
...
fof(fact_683_Int__empty__left,axiom,(
    ! [B] : hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila840543986t_bool,bot_bot_fun_nat_bool),B) = bot_bot_fun_nat_bool )).
...
fof(fact_391_Diff__insert2,axiom,(
    ! [A,A_1,B] : hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,A),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B)) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,A),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),bot_bo1181479936a_bool))),B) )).
...
fof(fact_192_rev__image__eqI,axiom,(
    ! [Ba,F_1,X_1,A] :
      ( ( hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,Ba),image_nat_nat(F_1,A)))
       <= hAPP_nat_nat(F_1,X_1) = Ba )
     <= hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),A)) ) )).

fof(fact_93_insert__compr,axiom,(
    ! [A_1,B] : collect_nat(hAPP_f800510211t_bool(hAPP_f561022312t_bool(cOMBS_nat_bool_bool,hAPP_f1146629647l_bool(hAPP_f1080886329l_bool(cOMBB_1015721476ol_nat,fdisj),hAPP_n1699378549t_bool(hAPP_f229349961t_bool(cOMBC_nat_nat_bool,fequal_nat),A_1))),hAPP_f800510211t_bool(hAPP_f1722879237t_bool(cOMBC_226598744l_bool,member_nat),B))) = hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),B) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Com__Ostate_000tc__fun_Itc__Com__Ostate_Mtc__Com__Os,axiom,(
    ! [P,Q,R] : hAPP_s1806633685e_bool(hAPP_f1838002347e_bool(hAPP_f1706273077e_bool(cOMBC_867582640e_bool,P),Q),R) = hAPP_f746301080e_bool(hAPP_s286259371e_bool(P,R),Q) )).
...
fof(fact_369_Diff__empty,axiom,(
    ! [A] : A = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,A),bot_bo1181479936a_bool) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Nat__Onat_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool__010,axiom,(
    ! [P,Q,R] : hAPP_f800510211t_bool(hAPP_n1512601776t_bool(P,R),Q) = hAPP_n1699378549t_bool(hAPP_f1570313510t_bool(hAPP_f688831301t_bool(cOMBC_178881787t_bool,P),Q),R) )).
...
fof(fact_174_image__constant,axiom,(
    ! [Ca,X_1,A] :
      ( hBOOL(hAPP_f1760790145l_bool(hAPP_H248360617l_bool(member1758697444_state,X_1),A))
     => hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,Ca),bot_bo1055319631e_bool) = image_650584225_state(hAPP_H521649881_state(cOMBK_690957994_state,Ca),A) ) )).
...
fof(fact_34_singleton__conv,axiom,(
    ! [A_1] : collec727977250_state(hAPP_H1645666623e_bool(hAPP_f262880489e_bool(cOMBC_1424981238e_bool,fequal1531560888_state),A_1)) = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),bot_bo1055319631e_bool) )).
...
fof(fact_324_vname_Osimps_I3_J,axiom,(
    ! [Glb_1,Loc_1] : loc(Loc_1) != glb(Glb_1) )).

fof(fact_84_insert__commute,axiom,(
    ! [X_1,Y_7,A] : hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,Y_7),A)) = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,Y_7),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),A)) )).

fof(fact_31_singleton__conv,axiom,(
    ! [A_1] : hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),bot_bo1181479936a_bool) = collec268032053iple_a(hAPP_H1190454433a_bool(hAPP_f1371755681a_bool(cOMBC_839220826a_bool,fequal879838495iple_a),A_1)) )).
...
fof(fact_433_folding__one__idem_Oeq__fold__idem_H,axiom,(
    ! [A_1,A,F_1,F] :
      ( hBOOL(finite506823037_state(F_1,F))
     => ( hAPP_f2143211163_state(F,hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),A)) = hAPP_f2143211163_state(finite202520804_state(F_1,A_1),A)
       <= hBOOL(hAPP_f1760790145l_bool(finite784854244_state,A)) ) ) )).
...
fof(fact_573_insert__def,axiom,(
    ! [A_1,B] : hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),B) = hAPP_f921536533e_bool(hAPP_f1583986009e_bool(semila447562797e_bool,collec727977250_state(hAPP_H1645666623e_bool(hAPP_f262880489e_bool(cOMBC_1424981238e_bool,fequal1531560888_state),A_1))),B) )).
...
fof(fact_382_insert__Diff,axiom,(
    ! [A_1,A] :
      ( hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,A_1),A))
     => hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,A),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),bot_bo1181479936a_bool))) = A ) )).
...
fof(fact_564_Un__insert__right,axiom,(
    ! [A,A_1,B] : hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila1498788770a_bool,A),B)) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila1498788770a_bool,A),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B)) )).
...
fof(fact_689_inf__bot__left,axiom,(
    ! [X_1] : bot_bo1181479936a_bool = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,bot_bo1181479936a_bool),X_1) )).
...
fof(fact_171_image__constant,axiom,(
    ! [Ca,X_1,A] :
      ( hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,Ca),bot_bot_fun_nat_bool) = image_nat_nat(hAPP_nat_fun_nat_nat(cOMBK_nat_nat,Ca),A)
     <= hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),A)) ) )).

fof(fact_225_image__empty,axiom,(
    ! [F_1] : bot_bo1181479936a_bool = image_1782127643iple_a(F_1,bot_bot_fun_nat_bool) )).

fof(fact_429_folding__one_Oeq__fold_H,axiom,(
    ! [X_1,A,F_1,F] :
      ( hBOOL(finite988810631ne_nat(F_1,F))
     => ( ( hAPP_f22106695ol_nat(finite_fold_nat_nat(F_1,X_1),A) = hAPP_f22106695ol_nat(F,hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,X_1),A))
         <= ~ hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),A)) )
       <= hBOOL(hAPP_f54304608l_bool(finite_finite_nat,A)) ) ) )).
...
fof(help_COMBK_1_1_COMBK_000tc__Nat__Onat_000tc__Hoare____Mirabelle____ddpglwnxwg__O,axiom,(
    ! [P,Q] : hAPP_H738206399_a_nat(hAPP_n1800114674_a_nat(cOMBK_944981412iple_a,P),Q) = P )).
...
fof(fact_139_mk__disjoint__insert,axiom,(
    ! [A_1,A] :
      ( ? [B_15] :
          ...
          & hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B_15) = A )
     <= hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,A_1),A)) ) )).
...
fof(fact_69_insert__absorb,axiom,(
    ! [A_1,A] :
      ( hBOOL(hAPP_f1760790145l_bool(hAPP_H248360617l_bool(member1758697444_state,A_1),A))
     => A = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),A) ) )).
...
fof(fact_229_empty__is__image,axiom,(
    ! [F_1,A] :
      ( bot_bot_fun_nat_bool = image_194810223_a_nat(F_1,A)
    <=> bot_bo1181479936a_bool = A ) )).
...
fof(fact_248_folding__one_Osingleton,axiom,(
    ! [X_1,F_1,F] :
      ( X_1 = hAPP_f22106695ol_nat(F,hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,X_1),bot_bot_fun_nat_bool))
     <= hBOOL(finite988810631ne_nat(F_1,F)) ) )).
...
fof(fact_584_subset__singletonD,axiom,(
    ! [A,X_1] :
     ...
     => ( bot_bo1181479936a_bool = A
        | hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),bot_bo1181479936a_bool) = A ) ) )).
...
fof(help_COMBI_1_1_COMBI_000tc__Hoare____Mirabelle____ddpglwnxwg__Otriple_Itc__Com__,axiom,(
    ! [P] : P = hAPP_H563960305_state(cOMBI_1367665338_state,P) )).
...
fof(fact_150_the__elem__def,axiom,(
    ! [X_35] : hAPP_f22106695ol_nat(the_elem_nat,X_35) = hAPP_f22106695ol_nat(the_nat,hAPP_f158894502t_bool(hAPP_f1777703707t_bool(cOMBB_955900739ol_nat,hAPP_f103356543l_bool(fequal_fun_nat_bool,X_35)),hAPP_f1570313510t_bool(hAPP_f688831301t_bool(cOMBC_178881787t_bool,insert_nat),bot_bot_fun_nat_bool))) )).
...
fof(fact_572_insert__def,axiom,(
    ! [A_1,B] : hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),B) = hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila465093516t_bool,collect_nat(hAPP_n1699378549t_bool(hAPP_f229349961t_bool(cOMBC_nat_nat_bool,fequal_nat),A_1))),B) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Com__Ostate_000tc__HOL__Obool_000tc__fun_Itc__Com__O,axiom,(
    ! [P,Q,R] : hAPP_b2019457360e_bool(hAPP_s1874344717e_bool(P,R),Q) = hAPP_s1806633685e_bool(hAPP_b1095269219e_bool(hAPP_f701449317e_bool(cOMBC_471052088e_bool,P),Q),R) )).

fof(fact_670_Int__def,axiom,(
    ! [A,B] : collect_nat(hAPP_f800510211t_bool(hAPP_f561022312t_bool(cOMBS_nat_bool_bool,hAPP_f1146629647l_bool(hAPP_f1080886329l_bool(cOMBB_1015721476ol_nat,fconj),hAPP_f800510211t_bool(hAPP_f1722879237t_bool(cOMBC_226598744l_bool,member_nat),A))),hAPP_f800510211t_bool(hAPP_f1722879237t_bool(cOMBC_226598744l_bool,member_nat),B))) = hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila840543986t_bool,A),B) )).
...
fof(fact_195_rev__image__eqI,axiom,(
    ! [Ba,F_1,X_1,A] :
      ( hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,X_1),A))
     => ( hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,Ba),image_306007685iple_a(F_1,A)))
       <= Ba = hAPP_H678412245iple_a(F_1,X_1) ) ) )).
...
fof(fact_505_Un__empty__left,axiom,(
    ! [B] : B = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila1498788770a_bool,bot_bo1181479936a_bool),B) )).
    ...
    ! [Z_2,X_1,A,V,F_1] :
      ( ( ( ~ hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,X_1),A))
         => ~ ! [Y_11] :
               ...
               <= hAPP_H678412245iple_a(hAPP_H1455657330iple_a(F_1,X_1),Y_11) = V ) )
...
fof(fact_348_folding__one_Oinsert__remove,axiom,(
    ! [X_1,A,F_1,F] :
      ( ( ( ( bot_bot_fun_nat_bool != hAPP_f800510211t_bool(hAPP_f1730770594t_bool(minus_2067140911t_bool,A),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,X_1),bot_bot_fun_nat_bool))
          ...
          & ( hAPP_f800510211t_bool(hAPP_f1730770594t_bool(minus_2067140911t_bool,A),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,X_1),bot_bot_fun_nat_bool)) = bot_bot_fun_nat_bool
           => X_1 = hAPP_f22106695ol_nat(F,hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,X_1),A)) ) )
       <= hBOOL(hAPP_f54304608l_bool(finite_finite_nat,A)) )
     <= hBOOL(finite988810631ne_nat(F_1,F)) ) )).
...
fof(fact_89_insert__Collect,axiom,(
    ! [A_1,Pa] : hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),collect_nat(Pa)) = collect_nat(hAPP_f800510211t_bool(hAPP_f561022312t_bool(cOMBS_nat_bool_bool,hAPP_f1146629647l_bool(hAPP_f1080886329l_bool(cOMBB_1015721476ol_nat,fimplies),hAPP_f800510211t_bool(hAPP_f894608603t_bool(cOMBB_bool_bool_nat,fNot),hAPP_n1699378549t_bool(hAPP_f229349961t_bool(cOMBC_nat_nat_bool,fequal_nat),A_1)))),Pa)) )).
...
fof(fact_216_com_Osimps_I8_J,axiom,(
    ! [Vname_1,Fun] : ass(Vname_1,Fun) != skip )).

fof(fact_380_insert__Diff,axiom,(
    ! [A_1,A] :
      ( A = hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),hAPP_f800510211t_bool(hAPP_f1730770594t_bool(minus_2067140911t_bool,A),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),bot_bot_fun_nat_bool)))
     <= hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,A_1),A)) ) )).
...
fof(fact_565_Un__insert__left,axiom,(
    ! [A_1,B,C] : hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila465093516t_bool,B),C)) = hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila465093516t_bool,hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),B)),C) )).
...
fof(fact_227_empty__is__image,axiom,(
    ! [F_1,A] :
      ( bot_bo1181479936a_bool = image_1782127643iple_a(F_1,A)
    <=> bot_bot_fun_nat_bool = A ) )).
...
fof(fact_662_Int__insert__right,axiom,(
    ! [B,A_1,A] :
      ( ( ~ hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,A_1),A))
       => hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,A),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B)) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,A),B) )
      & ( hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,A_1),A))
       => hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,A),B)) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,A),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B)) ) ) )).
...
fof(fact_238_image__insert,axiom,(
    ! [F_1,A_1,B] : hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,hAPP_H1600811558iple_a(F_1,A_1)),image_129517430iple_a(F_1,B)) = image_129517430iple_a(F_1,hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),B)) )).
...
fof(fact_175_image__constant,axiom,(
    ! [Ca,X_1,A] :
      ( image_1604514514_state(hAPP_H558669354_state(cOMBK_547979437iple_a,Ca),A) = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,Ca),bot_bo1055319631e_bool)
     <= hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,X_1),A)) ) )).
...
fof(fact_214_com_Osimps_I24_J,axiom,(
    ! [Vname,Fun_1,Com1,Com2] : semi(Com1,Com2) != ass(Vname,Fun_1) )).
...
fof(fact_581_union__fold__insert,axiom,(
    ! [B,A] :
      ( hAPP_f1591852335a_bool(finite1979045230a_bool(insert873085594iple_a,B),A) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila1498788770a_bool,A),B)
     <= hBOOL(hAPP_f540970102l_bool(finite1655202547iple_a,A)) ) )).
...
fof(fact_504_Un__empty__left,axiom,(
    ! [B] : B = hAPP_f921536533e_bool(hAPP_f1583986009e_bool(semila447562797e_bool,bot_bo1055319631e_bool),B) )).
...
fof(fact_502_sup__bot__left,axiom,(
    ! [X_1] : hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila1498788770a_bool,bot_bo1181479936a_bool),X_1) = X_1 )).
...
fof(fact_696_Diff__triv,axiom,(
    ! [A,B] :
     ...
     => A = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,A),B) ) )).
...
fof(help_COMBB_1_1_COMBB_000tc__fun_Itc__Com__Ostate_Mtc__HOL__Obool_J_000tc__fun_It_025,axiom,(
    ! [P,Q,R] : hAPP_f162060345e_bool(P,hAPP_s1806633685e_bool(Q,R)) = hAPP_s286259371e_bool(hAPP_f289738463e_bool(hAPP_f1151843515e_bool(cOMBB_1941618714_state,P),Q),R) )).
...
fof(fact_431_folding__one_Oeq__fold_H,axiom,(
    ! [X_1,A,F_1,F] :
      ( hBOOL(finite1669978781iple_a(F_1,F))
     => ( hBOOL(hAPP_f540970102l_bool(finite1655202547iple_a,A))
       => ( hAPP_f124283079iple_a(finite978536264iple_a(F_1,X_1),A) = hAPP_f124283079iple_a(F,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),A))
         <= ~ hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,X_1),A)) ) ) ) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Hoare____Mirabelle____ddpglwnxwg__Otriple_Itc__Com___027,axiom,(
    ! [P,Q,R] : hAPP_f1760790145l_bool(hAPP_H248360617l_bool(P,R),Q) = hAPP_H513860823e_bool(hAPP_f921536533e_bool(hAPP_f1262649863e_bool(cOMBC_764456866l_bool,P),Q),R) )).
...
fof(help_COMBS_1_1_COMBS_000tc__Hoare____Mirabelle____ddpglwnxwg__Otriple_It__a_J_00,axiom,(
    ! [P,Q,R] : hAPP_bool_bool(hAPP_H1017515220l_bool(P,R),hAPP_H1421470952a_bool(Q,R)) = hAPP_H1421470952a_bool(hAPP_f1591852335a_bool(hAPP_f1203760810a_bool(cOMBS_1148211387l_bool,P),Q),R) )).
...
fof(fact_166_image__constant__conv,axiom,(
    ! [Ca,A] :
      ( ( A != bot_bo1055319631e_bool
       => hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,Ca),bot_bo1055319631e_bool) = image_650584225_state(hAPP_H521649881_state(cOMBK_690957994_state,Ca),A) )
      & ( image_650584225_state(hAPP_H521649881_state(cOMBK_690957994_state,Ca),A) = bot_bo1055319631e_bool
       <= A = bot_bo1055319631e_bool ) ) )).
...
fof(fact_616_Sup__fin_Oeq__fold_H,axiom,(
    ! [X_1,A] :
      ( hBOOL(hAPP_f54304608l_bool(finite_finite_nat,A))
     => ( ~ hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),A))
       => hAPP_f22106695ol_nat(finite_fold_nat_nat(semila972727038up_nat,X_1),A) = hAPP_f22106695ol_nat(big_la43341705in_nat,hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,X_1),A)) ) ) )).

fof(fact_163_image__constant__conv,axiom,(
    ! [Ca,A] :
      ( ( image_194810223_a_nat(hAPP_n1800114674_a_nat(cOMBK_944981412iple_a,Ca),A) = hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,Ca),bot_bot_fun_nat_bool)
       <= bot_bo1181479936a_bool != A )
      & ( image_194810223_a_nat(hAPP_n1800114674_a_nat(cOMBK_944981412iple_a,Ca),A) = bot_bot_fun_nat_bool
       <= bot_bo1181479936a_bool = A ) ) )).
...
fof(fact_234_insert__image,axiom,(
    ! [F_1,X_1,A] :
      ( image_306007685iple_a(F_1,A) = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,hAPP_H678412245iple_a(F_1,X_1)),image_306007685iple_a(F_1,A))
     <= hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,X_1),A)) ) )).

fof(fact_656_insert__inter__insert,axiom,(
    ! [A_1,A,B] : hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),A)),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B)) = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,A),B)) )).
...
fof(fact_88_insert__Collect,axiom,(
    ! [A_1,Pa] : collec268032053iple_a(hAPP_f1591852335a_bool(hAPP_f1203760810a_bool(cOMBS_1148211387l_bool,hAPP_f997599971l_bool(hAPP_f439164429l_bool(cOMBB_1782929690iple_a,fimplies),hAPP_f1591852335a_bool(hAPP_f34030599a_bool(cOMBB_1799513916iple_a,fNot),hAPP_H1190454433a_bool(hAPP_f1371755681a_bool(cOMBC_839220826a_bool,fequal879838495iple_a),A_1)))),Pa)) = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),collec268032053iple_a(Pa)) )).
...
fof(fact_432_folding__one__idem_Oeq__fold__idem_H,axiom,(
    ! [A_1,A,F_1,F] :
      ( hBOOL(finite795500164em_nat(F_1,F))
     => ( hAPP_f22106695ol_nat(finite_fold_nat_nat(F_1,A_1),A) = hAPP_f22106695ol_nat(F,hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),A))
       <= hBOOL(hAPP_f54304608l_bool(finite_finite_nat,A)) ) ) )).
...
fof(fact_424_fold1__singleton__def,axiom,(
    ! [A_1,G,F_1] :
     ...
     <= finite1382394752iple_a(F_1) = G ) )).

fof(fact_210_image__iff,axiom,(
    ! [Z_2,F_1,A] :
      ( ? [X_2] :
          ( Z_2 = hAPP_H738206399_a_nat(F_1,X_2)
          & hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,X_2),A)) )
...
fof(help_COMBK_1_1_COMBK_000tc__HOL__Obool_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool,axiom,(
    ! [P,Q] :
      ( hAPP_f54304608l_bool(hAPP_b1630757474l_bool(cOMBK_1994329625t_bool,P),Q) = P
     <= is_bool(P) ) )).

fof(fact_681_Int__empty__right,axiom,(
    ! [A] : hAPP_f921536533e_bool(hAPP_f1583986009e_bool(semila2145357127e_bool,A),bot_bo1055319631e_bool) = bot_bo1055319631e_bool )).
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__fun_Itc__HOL__Obool_Mtc__HOL__Oboo_017,axiom,(
    ! [P,Q,R] : hAPP_H226398757l_bool(hAPP_f1558728829l_bool(hAPP_f1442918689l_bool(cOMBB_1382207997_state,P),Q),R) = hAPP_b589554111l_bool(P,hAPP_H513860823e_bool(Q,R)) )).
...
fof(fact_255_com_Osimps_I35_J,axiom,(
    ! [Com1,Com2,Loc_3,Fun_1,Com_1] : local(Loc_3,Fun_1,Com_1) != semi(Com1,Com2) )).

fof(fact_574_insert__def,axiom,(
    ! [A_1,B] : hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila1498788770a_bool,collec268032053iple_a(hAPP_H1190454433a_bool(hAPP_f1371755681a_bool(cOMBC_839220826a_bool,fequal879838495iple_a),A_1))),B) = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B) )).
...
fof(fact_134_triple_Oexhaust,axiom,(
    ! [Y_7] :
      ~ ! [Fun1,Com_2,Fun2] : hoare_1575745797_state(Fun1,Com_2,Fun2) != Y_7 )).
...
fof(fact_400_folding__one__idem_Ohom__commute,axiom,(
    ! [N,H,F_1,F] :
      ( hBOOL(finite795500164em_nat(F_1,F))
     => ( ! [X_2,Y_11] : hAPP_nat_nat(H,hAPP_nat_nat(hAPP_nat_fun_nat_nat(F_1,X_2),Y_11)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(F_1,hAPP_nat_nat(H,X_2)),hAPP_nat_nat(H,Y_11))
    ...
    ! [F_1,A_1,X_35,X_1] :
      ( ~ ! [A_7,A_19] :
            ( ( hBOOL(hAPP_H513860823e_bool(finite1935632226_state(F_1,A_7,A_19),X_1))
             => hBOOL(hAPP_f1760790145l_bool(hAPP_H248360617l_bool(member1758697444_state,A_7),A_19)) )
           <= hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_7),A_19) = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),X_35) )
...
fof(fact_169_image__constant,axiom,(
    ! [Ca,X_1,A] :
      ( hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,X_1),A))
     => image_306007685iple_a(hAPP_H1455657330iple_a(cOMBK_1824972302iple_a,Ca),A) = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,Ca),bot_bo1181479936a_bool) ) )).

fof(fact_30_singleton__conv2,axiom,(
    ! [A_1] : hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),bot_bo1055319631e_bool) = collec727977250_state(hAPP_H1645666623e_bool(fequal1531560888_state,A_1)) )).
     ...
     => ( hBOOL(hAPP_f1760790145l_bool(finite784854244_state,A))
       => ( B != bot_bo1055319631e_bool
         => ( hBOOL(hAPP_f1760790145l_bool(hAPP_f854625363l_bool(ord_le1720872323e_bool,B),A))
           => hAPP_f2143211163_state(F,A) = hAPP_H563960305_state(hAPP_H521649881_state(F_1,hAPP_f2143211163_state(F,B)),hAPP_f2143211163_state(F,A)) ) ) ) ) )).
...
fof(fact_162_image__constant__conv,axiom,(
    ! [Ca,A] :
      ( ( image_129517430iple_a(hAPP_H377435237iple_a(cOMBK_2022976521_state,Ca),A) = bot_bo1181479936a_bool
       <= bot_bo1055319631e_bool = A )
      & ( hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,Ca),bot_bo1181479936a_bool) = image_129517430iple_a(hAPP_H377435237iple_a(cOMBK_2022976521_state,Ca),A)
       <= bot_bo1055319631e_bool != A ) ) )).
...
fof(fact_283_evalc__elim__cases_I2_J,axiom,(
    ! [X_35,A_1,S_4,T_1] :
      ( hAPP_nat_state(hAPP_v594194232_state(hAPP_s712361723_state(update,S_4),X_35),hAPP_state_nat(A_1,S_4)) = T_1
...
fof(fact_437_minus__fold__remove,axiom,(
    ! [B,A] :
      ( hAPP_f800510211t_bool(finite1578363458t_bool(hAPP_f10625010t_bool(hAPP_f1115950719t_bool(cOMBB_1654519265ol_nat,hAPP_f1311642927t_bool(cOMBC_646315179t_bool,minus_2067140911t_bool)),hAPP_f1570313510t_bool(hAPP_f688831301t_bool(cOMBC_178881787t_bool,insert_nat),bot_bot_fun_nat_bool)),B),A) = hAPP_f800510211t_bool(hAPP_f1730770594t_bool(minus_2067140911t_bool,B),A)
     <= hBOOL(hAPP_f54304608l_bool(finite_finite_nat,A)) ) )).
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__HOL__Obool_000tc__Hoare____Mirabel,axiom,(
    ! [P,Q,R] : hAPP_H1421470952a_bool(hAPP_f1591852335a_bool(hAPP_f34030599a_bool(cOMBB_1799513916iple_a,P),Q),R) = hAPP_bool_bool(P,hAPP_H1421470952a_bool(Q,R)) )).

fof(fact_119_empty__not__insert,axiom,(
    ! [A_1,A] : hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),A) != bot_bot_fun_nat_bool )).
...
fof(fact_386_insert__Diff__single,axiom,(
    ! [A_1,A] : hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),A) = hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),hAPP_f800510211t_bool(hAPP_f1730770594t_bool(minus_2067140911t_bool,A),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),bot_bot_fun_nat_bool))) )).
...
fof(fact_121_the__elem__eq,axiom,(
    ! [X_1] : X_1 = hAPP_f124283079iple_a(the_el1436340927iple_a,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),bot_bo1181479936a_bool)) )).

fof(help_COMBK_1_1_COMBK_000tc__HOL__Obool_000tc__Com__Ostate_U,axiom,(
    ! [P,Q] :
      ( is_bool(P)
     => P = hAPP_state_bool(hAPP_b2019457360e_bool(cOMBK_bool_state,P),Q) ) )).
...
fof(fact_67_insert__absorb,axiom,(
    ! [A_1,A] :
      ( A = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),A)
     <= hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,A_1),A)) ) )).
...
fof(fact_542_Un__def,axiom,(
    ! [A,B] : hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila465093516t_bool,A),B) = collect_nat(hAPP_f800510211t_bool(hAPP_f561022312t_bool(cOMBS_nat_bool_bool,hAPP_f1146629647l_bool(hAPP_f1080886329l_bool(cOMBB_1015721476ol_nat,fdisj),hAPP_f800510211t_bool(hAPP_f1722879237t_bool(cOMBC_226598744l_bool,member_nat),A))),hAPP_f800510211t_bool(hAPP_f1722879237t_bool(cOMBC_226598744l_bool,member_nat),B))) )).
...
fof(fact_300_fold1Set_Osimps,axiom,(
    ! [F_1,A1,A2] :
      ( ? [A_7,A_19,X_2] :
          ...
          & ~ hBOOL(hAPP_f1760790145l_bool(hAPP_H248360617l_bool(member1758697444_state,A_7),A_19))
          & A2 = X_2
          & A1 = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_7),A_19) )
...
fof(fact_256_com_Osimps_I23_J,axiom,(
    ! [Loc_2,Fun,Com,Vname,Fun_1] : ass(Vname,Fun_1) != local(Loc_2,Fun,Com) )).
...
fof(help_COMBK_1_1_COMBK_000tc__Hoare____Mirabelle____ddpglwnxwg__Otriple_It__a_J_00_015,axiom,(
    ! [P,Q] : P = hAPP_H1600811558iple_a(hAPP_H377435237iple_a(cOMBK_2022976521_state,P),Q) )).
...
fof(fact_613_Sup__fin_Osubset__idem,axiom,(
    ! [B,A] :
      ( ( B != bot_bot_fun_nat_bool
       => ( hAPP_f22106695ol_nat(big_la43341705in_nat,A) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(semila972727038up_nat,hAPP_f22106695ol_nat(big_la43341705in_nat,B)),hAPP_f22106695ol_nat(big_la43341705in_nat,A))
         <= hBOOL(hAPP_f54304608l_bool(hAPP_f103356543l_bool(ord_le1568362934t_bool,B),A)) ) )
     <= hBOOL(hAPP_f54304608l_bool(finite_finite_nat,A)) ) )).
...
fof(fact_334_finite_Osimps,axiom,(
    ...
    <=> ( ? [A_19,A_7] :
            ...
            & hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_7),A_19) = A_1 )
        | bot_bot_fun_nat_bool = A_1 ) ) )).
...
fof(fact_95_insert__compr,axiom,(
    ! [A_1,B] : hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),B) = collec727977250_state(hAPP_f921536533e_bool(hAPP_f760664097e_bool(cOMBS_1248383340l_bool,hAPP_f1558728829l_bool(hAPP_f1442918689l_bool(cOMBB_1382207997_state,fdisj),hAPP_H1645666623e_bool(hAPP_f262880489e_bool(cOMBC_1424981238e_bool,fequal1531560888_state),A_1))),hAPP_f921536533e_bool(hAPP_f1262649863e_bool(cOMBC_764456866l_bool,member1758697444_state),B))) )).

fof(help_COMBI_1_1_COMBI_000tc__Hoare____Mirabelle____ddpglwnxwg__Otriple_It__a_J_U,axiom,(
    ! [P] : P = hAPP_H678412245iple_a(cOMBI_1218222237iple_a,P) )).

fof(fact_341_finite__ne__induct,axiom,(
    ! [Pa,F] :
      ( ( bot_bot_fun_nat_bool != F
       => ( ( ! [X_2,F_2] :
                ( hBOOL(hAPP_f54304608l_bool(finite_finite_nat,F_2))
               => ( bot_bot_fun_nat_bool != F_2
                 => ( ( hBOOL(hAPP_f54304608l_bool(Pa,F_2))
                     => hBOOL(hAPP_f54304608l_bool(Pa,hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,X_2),F_2))) )
                   <= ~ hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_2),F_2)) ) ) )
           => hBOOL(hAPP_f54304608l_bool(Pa,F)) )
...
fof(fact_583_subset__singletonD,axiom,(
    ! [A,X_1] :
     ...
     => ( bot_bo1055319631e_bool = A
        | hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),bot_bo1055319631e_bool) = A ) ) )).
...
fof(fact_428_folding__one_Oeq__fold,axiom,(
    ! [A,F_1,F] :
      ( hBOOL(finite1669978781iple_a(F_1,F))
     => ( hAPP_f124283079iple_a(F,A) = hAPP_f124283079iple_a(finite1382394752iple_a(F_1),A)
       <= hBOOL(hAPP_f540970102l_bool(finite1655202547iple_a,A)) ) ) )).
...
fof(fact_492_sup__eq__bot__iff,axiom,(
    ...
    <=> ( bot_bot_fun_nat_bool = X_1
        & bot_bot_fun_nat_bool = Y_7 ) ) )).
...
fof(fact_167_image__constant__conv,axiom,(
    ! [Ca,A] :
      ( ( bot_bo1181479936a_bool = image_306007685iple_a(hAPP_H1455657330iple_a(cOMBK_1824972302iple_a,Ca),A)
       <= A = bot_bo1181479936a_bool )
      & ( image_306007685iple_a(hAPP_H1455657330iple_a(cOMBK_1824972302iple_a,Ca),A) = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,Ca),bot_bo1181479936a_bool)
       <= A != bot_bo1181479936a_bool ) ) )).
...
fof(fact_365_Diff__cancel,axiom,(
    ! [A] : hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,A),A) = bot_bo1055319631e_bool )).

fof(fact_392_Diff__insert,axiom,(
    ! [A,A_1,B] : hAPP_f800510211t_bool(hAPP_f1730770594t_bool(minus_2067140911t_bool,A),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),B)) = hAPP_f800510211t_bool(hAPP_f1730770594t_bool(minus_2067140911t_bool,hAPP_f800510211t_bool(hAPP_f1730770594t_bool(minus_2067140911t_bool,A),B)),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),bot_bot_fun_nat_bool)) )).
...
fof(help_COMBC_1_1_COMBC_000tc__fun_Itc__Hoare____Mirabelle____ddpglwnxwg__Otriple_I,axiom,(
    ! [P,Q,R] : hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(P,R),Q) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(hAPP_f450029403a_bool(cOMBC_314077933a_bool,P),Q),R) )).
...
fof(fact_27_singleton__conv2,axiom,(
    ! [A_1] : hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),bot_bo1181479936a_bool) = collec268032053iple_a(hAPP_H1190454433a_bool(fequal879838495iple_a,A_1)) )).
...
fof(fact_32_singleton__conv,axiom,(
    ! [A_1] : collect_nat(hAPP_n1699378549t_bool(hAPP_f229349961t_bool(cOMBC_nat_nat_bool,fequal_nat),A_1)) = hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),bot_bot_fun_nat_bool) )).
...
fof(fact_511_Un__empty,axiom,(
    ! [A,B] :
      ( ( bot_bo1181479936a_bool = B
        & bot_bo1181479936a_bool = A )
    <=> hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila1498788770a_bool,A),B) = bot_bo1181479936a_bool ) )).
...
fof(fact_691_inf__bot__right,axiom,(
    ! [X_1] : hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila840543986t_bool,X_1),bot_bot_fun_nat_bool) = bot_bot_fun_nat_bool )).
...
fof(fact_376_insert__Diff1,axiom,(
    ! [A,X_1,B] :
      ( hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,X_1),A)),B) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(minus_469558085a_bool,A),B)
     <= hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,X_1),B)) ) )).
...
fof(fact_418_fold1__eq__fold,axiom,(
    ! [A_1,A] :
      ( hBOOL(hAPP_f54304608l_bool(finite_finite_nat,A))
     => ( ~ hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,A_1),A))
       => hAPP_f22106695ol_nat(finite_fold_nat_nat(times_times_nat,A_1),A) = hAPP_f22106695ol_nat(finite_fold1_nat(times_times_nat),hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),A)) ) ) )).

fof(fact_402_folding__one__idem_Ohom__commute,axiom,(
    ! [N,H,F_1,F] :
      ( ( ! [X_2,Y_11] : hAPP_H678412245iple_a(hAPP_H1455657330iple_a(F_1,hAPP_H678412245iple_a(H,X_2)),hAPP_H678412245iple_a(H,Y_11)) = hAPP_H678412245iple_a(H,hAPP_H678412245iple_a(hAPP_H1455657330iple_a(F_1,X_2),Y_11))
       => ( hBOOL(hAPP_f540970102l_bool(finite1655202547iple_a,N))
         => ( hAPP_H678412245iple_a(H,hAPP_f124283079iple_a(F,N)) = hAPP_f124283079iple_a(F,image_306007685iple_a(H,N))
           <= N != bot_bo1181479936a_bool ) ) )
     <= hBOOL(finite950012314iple_a(F_1,F)) ) )).

fof(fact_247_folding__one_Osingleton,axiom,(
    ! [X_1,F_1,F] :
      ( hAPP_f2143211163_state(F,hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),bot_bo1055319631e_bool)) = X_1
     <= hBOOL(finite774711482_state(F_1,F)) ) )).
       ...
       => ( hBOOL(hAPP_f1760790145l_bool(hAPP_H248360617l_bool(member1758697444_state,X_1),A))
         => ( ( bot_bo1055319631e_bool = hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),bot_bo1055319631e_bool))
            ...
            & ( hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),bot_bo1055319631e_bool)) != bot_bo1055319631e_bool
             => hAPP_f2143211163_state(F,A) = hAPP_H563960305_state(hAPP_H521649881_state(F_1,X_1),hAPP_f2143211163_state(F,hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),bot_bo1055319631e_bool)))) ) ) ) )
     <= hBOOL(finite774711482_state(F_1,F)) ) )).
...
fof(fact_246_the__equality,axiom,(
    ! [Pa,A_1] :
     ...
     => ( ! [X_2] :
            ( A_1 = X_2
           <= hBOOL(hAPP_H1421470952a_bool(Pa,X_2)) )
       => hAPP_f124283079iple_a(the_Ho746640593iple_a,Pa) = A_1 ) ) )).
...
fof(fact_222_image__empty,axiom,(
    ! [F_1] : bot_bo1055319631e_bool = image_1604514514_state(F_1,bot_bo1181479936a_bool) )).
...
fof(fact_438_minus__fold__remove,axiom,(
    ! [B,A] :
      ( hBOOL(hAPP_f1760790145l_bool(finite784854244_state,A))
     => hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,B),A) = hAPP_f921536533e_bool(finite512563852e_bool(hAPP_f531275309e_bool(hAPP_f1470644835e_bool(cOMBB_946224375_state,hAPP_f2049746453e_bool(cOMBC_872426556e_bool,minus_2076558538e_bool)),hAPP_f762269719e_bool(hAPP_f964290431e_bool(cOMBC_488258100e_bool,insert1835143293_state),bot_bo1055319631e_bool)),B),A) ) )).

fof(fact_506_Un__empty__right,axiom,(
    ! [A] : hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila465093516t_bool,A),bot_bot_fun_nat_bool) = A )).
...
fof(fact_28_singleton__conv2,axiom,(
    ! [A_1] : collect_nat(hAPP_n1699378549t_bool(fequal_nat,A_1)) = hAPP_f800510211t_bool(hAPP_n1512601776t_bool(insert_nat,A_1),bot_bot_fun_nat_bool) )).
...
fof(fact_296_insert__fold1SetE,axiom,(
    ! [F_1,A_1,X_35,X_1] :
      ( ~ ! [A_7,A_19] :
            ( hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_7),A_19) = hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),X_35)
           => ( hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,A_7),A_19))
...
fof(fact_42_Collect__conv__if,axiom,(
    ! [Pa,A_1] :
      ...
      & ( collec727977250_state(hAPP_f921536533e_bool(hAPP_f760664097e_bool(cOMBS_1248383340l_bool,hAPP_f1558728829l_bool(hAPP_f1442918689l_bool(cOMBB_1382207997_state,fconj),hAPP_H1645666623e_bool(hAPP_f262880489e_bool(cOMBC_1424981238e_bool,fequal1531560888_state),A_1))),Pa)) = bot_bo1055319631e_bool
       <= ~ hBOOL(hAPP_H513860823e_bool(Pa,A_1)) ) ) )).
...
fof(fact_75_insert__ident,axiom,(
    ! [B,X_1,A] :
      ( ~ hBOOL(hAPP_f1760790145l_bool(hAPP_H248360617l_bool(member1758697444_state,X_1),A))
     => ( ~ hBOOL(hAPP_f1760790145l_bool(hAPP_H248360617l_bool(member1758697444_state,X_1),B))
       => ( hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),A) = hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),B)
        <=> A = B ) ) ) )).
...
fof(fact_602_flat__lub__def,axiom,(
    ! [A,Ba] :
      ...
      & ( Ba = hAPP_f124283079iple_a(partia1866111638iple_a(Ba),A)
       <= hBOOL(hAPP_f540970102l_bool(hAPP_f430043647l_bool(ord_le1908022732a_bool,A),hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,Ba),bot_bo1181479936a_bool))) ) ) )).
...
fof(fact_659_Int__insert__left,axiom,(
    ! [B,A_1,C] :
      ( ( hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,A_1),C))
       => hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,B),C)) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B)),C) )
      & ( ~ hBOOL(hAPP_f540970102l_bool(hAPP_H1840393229l_bool(member1713797107iple_a,A_1),C))
       => hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),B)),C) = hAPP_f1591852335a_bool(hAPP_f1026156344a_bool(semila671163144a_bool,B),C) ) ) )).
...
fof(fact_36_Collect__conv__if2,axiom,(
    ! [Pa,A_1] :
      ( ( ~ hBOOL(hAPP_nat_bool(Pa,A_1))
       => bot_bot_fun_nat_bool = collect_nat(hAPP_f800510211t_bool(hAPP_f561022312t_bool(cOMBS_nat_bool_bool,hAPP_f1146629647l_bool(hAPP_f1080886329l_bool(cOMBB_1015721476ol_nat,fconj),hAPP_n1699378549t_bool(fequal_nat,A_1))),Pa)) )
      & ( hBOOL(hAPP_nat_bool(Pa,A_1))
...
fof(fact_349_folding__one_Oinsert__remove,axiom,(
    ! [X_1,A,F_1,F] :
      ( hBOOL(finite774711482_state(F_1,F))
     => ( ( ( hAPP_f2143211163_state(F,hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),A)) = X_1
           <= bot_bo1055319631e_bool = hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),bot_bo1055319631e_bool)) )
          & ( bot_bo1055319631e_bool != hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,X_1),bot_bo1055319631e_bool))
...
fof(help_COMBB_1_1_COMBB_000tc__fun_Itc__Com__Ostate_Mtc__HOL__Obool_J_000tc__fun_It_022,axiom,(
    ! [P,Q,R] : hAPP_f162060345e_bool(P,hAPP_a2036067514e_bool(Q,R)) = hAPP_a1224971408e_bool(hAPP_f1406200875e_bool(hAPP_f635443597e_bool(cOMBB_2139825703bool_a,P),Q),R) )).
...
fof(help_COMBK_1_1_COMBK_000tc__Nat__Onat_000tc__Nat__Onat_U,axiom,(
    ! [P,Q] : P = hAPP_nat_nat(hAPP_nat_fun_nat_nat(cOMBK_nat_nat,P),Q) )).
...
fof(fact_423_fold1__singleton__def,axiom,(
    ! [A_1,G,F_1] :
     ...
     => A_1 = hAPP_f2143211163_state(G,hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,A_1),bot_bo1055319631e_bool)) ) )).

fof(fact_39_Collect__conv__if,axiom,(
    ! [Pa,A_1] :
      ( ( hAPP_f1591852335a_bool(hAPP_H1641355846a_bool(insert873085594iple_a,A_1),bot_bo1181479936a_bool) = collec268032053iple_a(hAPP_f1591852335a_bool(hAPP_f1203760810a_bool(cOMBS_1148211387l_bool,hAPP_f997599971l_bool(hAPP_f439164429l_bool(cOMBB_1782929690iple_a,fconj),hAPP_H1190454433a_bool(hAPP_f1371755681a_bool(cOMBC_839220826a_bool,fequal879838495iple_a),A_1))),Pa))
       <= hBOOL(hAPP_H1421470952a_bool(Pa,A_1)) )
      & ( ~ hBOOL(hAPP_H1421470952a_bool(Pa,A_1))
...
fof(fact_66_empty__def,axiom,(
    collec727977250_state(hAPP_b1245957081e_bool(cOMBK_1079618832_state,fFalse)) = bot_bo1055319631e_bool )).

fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__fun_Itc__HOL__Obool_Mtc__HOL__Oboo_011,axiom,(
    ! [P,Q,R] : hAPP_b589554111l_bool(P,hAPP_f54304608l_bool(Q,R)) = hAPP_f1748468828l_bool(hAPP_f1974927549l_bool(hAPP_f857404385l_bool(cOMBB_444170502t_bool,P),Q),R) )).
...
fof(help_COMBB_1_1_COMBB_000tc__fun_Itc__Com__Ostate_Mtc__HOL__Obool_J_000tc__fun_It,axiom,(
    ! [P,Q,R] : hAPP_f1759915619e_bool(P,hAPP_a2036067514e_bool(Q,R)) = hAPP_a2036067514e_bool(hAPP_f769584981e_bool(hAPP_f1159960589e_bool(cOMBB_237455441bool_a,P),Q),R) )).
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__fun_Itc__HOL__Obool_Mtc__HOL__Oboo_014,axiom,(
    ! [P,Q,R] : hAPP_b589554111l_bool(P,hAPP_H1421470952a_bool(Q,R)) = hAPP_H1017515220l_bool(hAPP_f997599971l_bool(hAPP_f439164429l_bool(cOMBB_1782929690iple_a,P),Q),R) )).
...
fof(fact_697_Diff__disjoint,axiom,(
    ! [A,B] : bot_bot_fun_nat_bool = hAPP_f800510211t_bool(hAPP_f1730770594t_bool(semila840543986t_bool,A),hAPP_f800510211t_bool(hAPP_f1730770594t_bool(minus_2067140911t_bool,B),A)) )).
...
fof(fact_604_flat__lub__def,axiom,(
    ! [A,Ba] :
      ( ( Ba = hAPP_f2143211163_state(partia415982977_state(Ba),A)
      ...
      & ( hAPP_f2143211163_state(partia415982977_state(Ba),A) = hAPP_f2143211163_state(the_Ho10452358_state,hAPP_f921536533e_bool(hAPP_f1262649863e_bool(cOMBC_764456866l_bool,member1758697444_state),hAPP_f921536533e_bool(hAPP_f1583986009e_bool(minus_2076558538e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,Ba),bot_bo1055319631e_bool))))
       <= ~ hBOOL(hAPP_f1760790145l_bool(hAPP_f854625363l_bool(ord_le1720872323e_bool,A),hAPP_f921536533e_bool(hAPP_H727730819e_bool(insert1835143293_state,Ba),bot_bo1055319631e_bool))) ) ) )).
