...
fof(fact_90_singleton__conv2,axiom,(
    ! [X_a,A_3] : hAPP(fun(X_a,bool),fun(X_a,bool),hAPP(X_a,fun(fun(X_a,bool),fun(X_a,bool)),insert(X_a),A_3),bot_bot(fun(X_a,bool))) = hAPP(fun(X_a,bool),fun(X_a,bool),collect(X_a),hAPP(X_a,fun(X_a,bool),fequal(X_a),A_3)) )).
...
fof(fact_97_finite__subset__image,axiom,(
    ! [X_b,X_a,F,A_1,B] :
      ( ( ? [C] :
            ...
            & hAPP(fun(X_b,bool),fun(X_a,bool),hAPP(fun(X_b,X_a),fun(fun(X_b,bool),fun(X_a,bool)),image(X_b,X_a),F),C) = ti(fun(X_a,bool),B)
...
fof(fact_60_image__image,axiom,(
    ! [X_b,X_a,X_c,F,G_1,A_1] : hAPP(fun(X_c,bool),fun(X_a,bool),hAPP(fun(X_c,X_a),fun(fun(X_c,bool),fun(X_a,bool)),image(X_c,X_a),hAPP(fun(X_c,X_b),fun(X_c,X_a),hAPP(fun(X_b,X_a),fun(fun(X_c,X_b),fun(X_c,X_a)),combb(X_b,X_a,X_c),F),G_1)),A_1) = hAPP(fun(X_b,bool),fun(X_a,bool),hAPP(fun(X_b,X_a),fun(fun(X_b,bool),fun(X_a,bool)),image(X_b,X_a),F),hAPP(fun(X_c,bool),fun(X_b,bool),hAPP(fun(X_c,X_b),fun(fun(X_c,bool),fun(X_b,bool)),image(X_c,X_b),G_1),A_1)) )).
...
fof(fact_59_image__ident,axiom,(
    ! [X_a,Y_2] : ti(fun(X_a,bool),Y_2) = hAPP(fun(X_a,bool),fun(X_a,bool),hAPP(fun(X_a,X_a),fun(fun(X_a,bool),fun(X_a,bool)),image(X_a,X_a),combi(X_a)),Y_2) )).
...
fof(tsy_c_Hoare__Mirabelle__pjuwniqynr_Ohoare__derivs_res,axiom,(
    ! [X_a] : hoare_122391849derivs(X_a) = ti(fun(fun(hoare_509422987triple(X_a),bool),fun(fun(hoare_509422987triple(X_a),bool),bool)),hoare_122391849derivs(X_a)) )).
...
fof(fact_99_com_Osimps_I6_J,axiom,(
    ...
    <=> hAPP(pname,com,body_1,Pname) = hAPP(pname,com,body_1,Pname_1) ) )).
...
fof(fact_16_insert__dom,axiom,(
    ! [X_b,X_a,F,X_2,Y_3] :
      ( hAPP(X_a,option(X_a),some(X_a),Y_3) = hAPP(X_b,option(X_a),F,X_2)
...
fof(fact_43_insert__compr,axiom,(
    ! [X_a,A_3,B] : hAPP(fun(X_a,bool),fun(X_a,bool),collect(X_a),hAPP(fun(X_a,bool),fun(X_a,bool),hAPP(fun(X_a,fun(bool,bool)),fun(fun(X_a,bool),fun(X_a,bool)),combs(X_a,bool,bool),hAPP(fun(X_a,bool),fun(X_a,fun(bool,bool)),hAPP(fun(bool,fun(bool,bool)),fun(fun(X_a,bool),fun(X_a,fun(bool,bool))),combb(bool,fun(bool,bool),X_a),fdisj),hAPP(X_a,fun(X_a,bool),hAPP(fun(X_a,fun(X_a,bool)),fun(X_a,fun(X_a,bool)),combc(X_a,X_a,bool),fequal(X_a)),A_3))),hAPP(fun(X_a,bool),fun(X_a,bool),hAPP(fun(X_a,fun(fun(X_a,bool),bool)),fun(fun(X_a,bool),fun(X_a,bool)),combc(X_a,fun(X_a,bool),bool),member(X_a)),B))) = hAPP(fun(X_a,bool),fun(X_a,bool),hAPP(X_a,fun(fun(X_a,bool),fun(X_a,bool)),insert(X_a),A_3),B) )).
...
fof(fact_82_insert__image,axiom,(
    ! [X_b,X_a,F,X_2,A_1] :
      ( hAPP(fun(X_a,bool),fun(X_b,bool),hAPP(fun(X_a,X_b),fun(fun(X_a,bool),fun(X_b,bool)),image(X_a,X_b),F),A_1) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),hAPP(X_a,X_b,F,X_2)),hAPP(fun(X_a,bool),fun(X_b,bool),hAPP(fun(X_a,X_b),fun(fun(X_a,bool),fun(X_b,bool)),image(X_a,X_b),F),A_1))
     <= hBOOL(hAPP(fun(X_a,bool),bool,hAPP(X_a,fun(fun(X_a,bool),bool),member(X_a),X_2),A_1)) ) )).
...
fof(fact_75_ext,axiom,(
    ! [X_a,X_b,F,G_1] :
     ...
     => ti(fun(X_a,X_b),G_1) = ti(fun(X_a,X_b),F) ) )).
...
fof(fact_40_insert__commute,axiom,(
    ! [X_a,X_2,Y_3,A_1] : hAPP(fun(X_a,bool),fun(X_a,bool),hAPP(X_a,fun(fun(X_a,bool),fun(X_a,bool)),insert(X_a),Y_3),hAPP(fun(X_a,bool),fun(X_a,bool),hAPP(X_a,fun(fun(X_a,bool),fun(X_a,bool)),insert(X_a),X_2),A_1)) = hAPP(fun(X_a,bool),fun(X_a,bool),hAPP(X_a,fun(fun(X_a,bool),fun(X_a,bool)),insert(X_a),X_2),hAPP(fun(X_a,bool),fun(X_a,bool),hAPP(X_a,fun(fun(X_a,bool),fun(X_a,bool)),insert(X_a),Y_3),A_1)) )).
...
fof(tsy_c_Orderings_Obot__class_Obot_res,axiom,(
    ! [X_a] : bot_bot(fun(X_a,bool)) = ti(fun(X_a,bool),bot_bot(fun(X_a,bool))) )).
