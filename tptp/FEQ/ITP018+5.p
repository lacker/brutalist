    ...
    ! [A_27t] :
     ...
     => ! [A_27w] :
         ...
         => ! [V0fp__op] :
             ...
             => ap(ap(c_2Emin_2E_40(arr(ty_2Ebinary__ieee_2Efp__op(A_27t,A_27w),ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))),f3108(A_27t,A_27w,V0fp__op)),V0fp__op) = ap(c_2Ebinary__ieee_2Efloat__some__qnan(A_27t,A_27w),V0fp__op) ) ) ) )).
                              ...
                              ( ! [V6v0] :
                                  ( ! [V7v1] :
                                     ...
                                     => ! [V8v2] :
                                         ...
                                         => ! [V9v3] :
                                              ( mem(V9v3,A_27a)
                                             => ( ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erounding__CASE(A_27a),V5M_27),V0v0_27),V1v1_27),V2v2_27),V3v3_27) = ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erounding__CASE(A_27a),V4M),V6v0),V7v1),V8v2),V9v3)
                                               <= ( V4M = V5M_27
                                                  & ( V5M_27 = c_2Ebinary__ieee_2EroundTiesToEven
                                                   => V0v0_27 = V6v0 )
                                                  & ( V5M_27 = c_2Ebinary__ieee_2EroundTowardPositive
                                                   => V1v1_27 = V7v1 )
                                                  & ( c_2Ebinary__ieee_2EroundTowardZero = V5M_27
                                                   => V9v3 = V3v3_27 )
                                                  & ( c_2Ebinary__ieee_2EroundTowardNegative = V5M_27
                                                   => V8v2 = V2v2_27 ) ) ) ) ) )
                                 <= mem(V6v0,A_27a) )
                   ...
                   => ! [V6a0] :
                        ( ! [V7a1] :
                            ( ! [V8a2] :
                               ...
                               => ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Ebinary__ieee_2Erounding__size,V6a0)),ap(ap(c_2Earithmetic_2E_2B,ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V4f),V5f1),V7a1)),ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V4f),V5f1),V8a2)))) = ap(ap(ap(c_2Ebinary__ieee_2Efp__op__size(A_27t,A_27w),V4f),V5f1),ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V6a0),V7a1),V8a2)) )
            ...
            & ! [V9f] :
               ...
               => ! [V10f1] :
                    ( ! [V11a0] :
                        ( ! [V12a1] :
                            ( ! [V13a2] :
                                ( ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Ebinary__ieee_2Erounding__size,V11a0)),ap(ap(c_2Earithmetic_2E_2B,ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V9f),V10f1),V12a1)),ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V9f),V10f1),V13a2)))) = ap(ap(ap(c_2Ebinary__ieee_2Efp__op__size(A_27t,A_27w),V9f),V10f1),ap(ap(ap(c_2Ebinary__ieee_2EFP__Sub(A_27t,A_27w),V11a0),V12a1),V13a2))
                       ...
                       => ! [V33a1] :
                           ...
                           => ! [V34a2] :
                                ( ! [V35a3] :
                                   ...
                                   => ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Ebinary__ieee_2Erounding__size,V32a0)),ap(ap(c_2Earithmetic_2E_2B,ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V30f),V31f1),V33a1)),ap(ap(c_2Earithmetic_2E_2B,ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V30f),V31f1),V34a2)),ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V30f),V31f1),V35a3))))) = ap(ap(ap(c_2Ebinary__ieee_2Efp__op__size(A_27t,A_27w),V30f),V31f1),ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V32a0),V33a1),V34a2),V35a3)) )
                ...
                ( ! [V15f1] :
                   ...
                   => ! [V16a0] :
                        ( ! [V17a1] :
                           ...
                           => ! [V18a2] :
                                ( ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Ebinary__ieee_2Erounding__size,V16a0)),ap(ap(c_2Earithmetic_2E_2B,ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V14f),V15f1),V17a1)),ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V14f),V15f1),V18a2)))) = ap(ap(ap(c_2Ebinary__ieee_2Efp__op__size(A_27t,A_27w),V14f),V15f1),ap(ap(ap(c_2Ebinary__ieee_2EFP__Mul(A_27t,A_27w),V16a0),V17a1),V18a2))
         ...
         => ! [V0c] :
              ( ! [V1c0] :
                  ( ! [V2c1] :
                     ...
                     => V1c0 = ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V0c),V1c0),V2c1)) )
...
fof(conj_thm_2Ebinary__ieee_2Etop__properties,axiom,(
    ! [A_27t] :
      ( ! [A_27w] :
          ( ( ( ~ ( ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)) != ap(c_2Efcp_2Edimindex(A_27w),c_2Ebool_2Ethe__value(A_27w)) )
                     ...
                     => ! [V4a4] :
                          ( ! [V5a5] :
                              ( ! [V6f] :
                                 ...
                                 => ap(ap(ap(ap(ap(ap(V6f,V0a0),V1a1),V2a2),V3a3),V4a4),V5a5) = ap(ap(c_2Ebinary__ieee_2Eflags__CASE(A_27a),ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V0a0),V1a1),V2a2),V3a3),V4a4),V5a5)),V6f) )
                             <= mem(V5a5,bool) )
                         <= mem(V4a4,bool) ) )
                 <= mem(V2a2,bool) ) ) ) ) )).
                                     ...
                                     => ! [V5a1] :
                                          ( ! [V6a2] :
                                              ( ( ap(ap(ap(V3f,V4a0),V5a1),V6a2) = ap(ap(ap(V0f_27,V4a0),V5a1),V6a2)
                                               <= ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V4a0),V5a1),V6a2) = V2M_27 )
                  ...
                  ( ! [V1c] :
                     ...
                     => ! [V2c0] :
                          ( ! [V3c1] :
                             ...
                             => ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27x),V1c),ap(V0f,V2c0)),V3c1) = ap(ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27t,A_27w,A_27x),V0f),ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V1c),V2c0),V3c1)) )
         ...
         => ! [V0mode] :
             ...
             => ! [V1x] :
                 ...
                 => ! [V2y] :
                     ...
                     => ap(ap(c_2Epair_2Epair__CASE(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V1x)),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V2y))),f3121(A_27t,A_27w,V0mode,V1x,V2y)) = ap(ap(ap(c_2Ebinary__ieee_2Efloat__add(A_27t,A_27w),V0mode),V1x),V2y) ) ) ) )
     <= ne(A_27t) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Erounding2num__thm,axiom,
    ( ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)) = ap(c_2Ebinary__ieee_2Erounding2num,c_2Ebinary__ieee_2EroundTowardPositive)
...
fof(conj_thm_2Ebinary__ieee_2Enum2float__compare__11,axiom,(
    ! [V0r] :
      ( ! [V1r_27] :
          ( ( ( ( ap(c_2Ebinary__ieee_2Enum2float__compare,V1r_27) = ap(c_2Ebinary__ieee_2Enum2float__compare,V0r)
              <=> V0r = V1r_27 )
              ...
              ( ? [V3b1] :
                  ( ? [V4b2] :
                      ( ? [V5b3] :
                          ( ? [V6b4] :
                              ( mem(V6b4,bool)
                              & ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V1b),V2b0),V3b1),V4b2),V5b3),V6b4) = V0ff )
                          & mem(V5b3,bool) )
                      & mem(V4b2,bool) )
                  & mem(V3b1,bool) )
              & mem(V2b0,bool) ) ) ) )).
      ...
      ( ! [A_27w] :
         ...
         => ! [V0x] :
              ( ! [V1y] :
                  ...
                  <=> c_2Ebinary__ieee_2ELT = ap(ap(c_2Ebinary__ieee_2Efloat__compare(A_27t,A_27w),V0x),V1y) )
                                        ...
                                        ( ! [V25f3] :
                                           ...
                                           => ! [V26f4] :
                                                ( ! [V27f5] :
                                                   ...
                                                   => ! [V28f6] :
                                                        ( ap(ap(ap(V24f2,V19a0),V20a1),V21a2) = ap(ap(ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efp__op__CASE(A_27a,A_27t,A_27w),ap(ap(ap(c_2Ebinary__ieee_2EFP__Sub(A_27t,A_27w),V19a0),V20a1),V21a2)),V22f),V23f1),V24f2),V25f3),V26f4),V27f5),V28f6)
                               ...
                               => ! [V4f2] :
                                    ( ! [V5f3] :
                                       ...
                                       => ! [V6f4] :
                                           ...
                                           => ! [V7f5] :
                                                ( ! [V8f6] :
                                                    ( ap(ap(V2f,V0a0),V1a1) = ap(ap(ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efp__op__CASE(A_27a,A_27t,A_27w),ap(ap(c_2Ebinary__ieee_2EFP__Sqrt(A_27t,A_27w),V0a0),V1a1)),V2f),V3f1),V4f2),V5f3),V6f4),V7f5),V8f6)
...
fof(ax_thm_2Ebinary__ieee_2Erounding__size__def,axiom,(
    ! [V0x] :
      ( c_2Enum_2E0 = ap(c_2Ebinary__ieee_2Erounding__size,V0x)
                                 ...
                                 => ! [A_27i] :
                                      ( ! [A_27j] :
                                         ...
                                         => ! [A_27t] :
                                              ( ne(A_27t)
                                             => ! [A_27w] :
                                                  ( ( ap(c_2Ewords_2En2w(A_27t),c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__Significand(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    ...
                                                    & ap(c_2Ewords_2En2w(A_27t),c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__Significand(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    ...
                                                    & ap(c_2Ewords_2En2w(ty_2Eone_2Eone),c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__plus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    ...
                                                    & ap(c_2Ewords_2En2w(A_27t),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) = ap(c_2Ebinary__ieee_2Efloat__Significand(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__minus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    ...
                                                    & ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) = ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    & ap(ap(c_2Ewords_2Eword__sub(A_27w),c_2Ewords_2Eword__T(A_27w)),ap(c_2Ewords_2En2w(A_27w),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))) = ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    & c_2Ewords_2Eword__T(A_27t) = ap(c_2Ebinary__ieee_2Efloat__Significand(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    & ! [V1fp__op] :
                                                    ...
                                                    & ! [V0fp__op] :
                                                        ( mem(V0fp__op,ty_2Ebinary__ieee_2Efp__op(A_27a,A_27b))
                                                       => c_2Ewords_2Eword__T(A_27b) = ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27a,A_27b),ap(c_2Ebinary__ieee_2Efloat__some__qnan(A_27a,A_27b),V0fp__op)) )
                                                    ...
                                                    & ap(c_2Ewords_2En2w(ty_2Eone_2Eone),c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__top(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    ...
                                                    & ap(c_2Ewords_2En2w(A_27t),c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__Significand(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    & ap(c_2Ewords_2En2w(A_27w),c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    & ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) = ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    & ap(c_2Ewords_2En2w(ty_2Eone_2Eone),c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    & ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) = ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
                                                    & c_2Ewords_2Eword__T(A_27w) = ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
...
fof(ax_thm_2Ebinary__ieee_2Efloat__minus__zero__def,axiom,(
    ! [A_27t] :
      ( ! [A_27w] :
          ( ap(c_2Ebinary__ieee_2Efloat__negate(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w)))) = ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w)))
         <= ne(A_27w) )
     <= ne(A_27t) ) )).
...
fof(ax_thm_2Ebinary__ieee_2Efloat__compare__size__def,axiom,(
    ! [V0x] :
      ( c_2Enum_2E0 = ap(c_2Ebinary__ieee_2Efloat__compare__size,V0x)
          ...
          ( ! [V0p] :
              ( ! [V1s] :
                 ...
                 => ! [V2x] :
                     ...
                     => ap(c_2Emin_2E_40(ty_2Ebinary__ieee_2Efloat(A_27a,A_27b)),f3039(A_27a,A_27b,V0p,V1s,V2x)) = ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27b),V0p),V1s),V2x) ) )
                              ...
                              ( ! [V5a1] :
                                 ...
                                 => ! [V6a2] :
                                     ...
                                     => ! [V7a3] :
                                         ...
                                         => ! [V8a4] :
                                              ( ! [V9a5] :
                                                  ( ( ap(ap(ap(ap(ap(ap(V0f_27,V4a0),V5a1),V6a2),V7a3),V8a4),V9a5) = ap(ap(ap(ap(ap(ap(V3f,V4a0),V5a1),V6a2),V7a3),V8a4),V9a5)
                                                   <= ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V4a0),V5a1),V6a2),V7a3),V8a4),V9a5) = V2M_27 )
                                                 <= mem(V9a5,bool) )
                                             <= mem(V8a4,bool) ) ) ) )
                             <= mem(V4a0,bool) )
                          & V2M_27 = V1M )
...
fof(conj_thm_2Ebinary__ieee_2Esign__not__zero,axiom,(
    ! [V0s] :
     ...
     => ~ ( ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) != ap(ap(c_2Ereal_2Epow,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),ap(c_2Ewords_2Ew2n(ty_2Eone_2Eone),V0s)) ) ) )).
          ...
          ( ! [V1v0] :
             ...
             => ! [V2v1] :
                 ...
                 => ! [V3v2] :
                      ( mem(V3v2,A_27a)
                     => ! [V4v3] :
                          ( ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__compare__CASE(A_27a),V0x),V1v0),V2v1),V3v2),V4v3) = ap(f3037(A_27a,V2v1,V3v2,V4v3,V1v0),ap(c_2Ebinary__ieee_2Efloat__compare2num,V0x))
                         <= mem(V4v3,A_27a) ) ) ) )
         <= mem(V0x,ty_2Ebinary__ieee_2Efloat__compare) )
     <= ne(A_27a) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Efloat__is__zero,axiom,(
    ! [A_27a] :
      ( ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
              ( ( ( ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__Significand(A_27a,A_27b),V0x)
              ...
              ( ! [V2v1] :
                  ( ! [V3v2] :
                      ( ! [V4v3] :
                         ...
                         => ! [V5v] :
                              ( mem(V5v,A_27a)
                             => ( V5v = ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__compare__CASE(A_27a),V0x),V1v0),V2v1),V3v2),V4v3)
                              <=> ( ( V0x = c_2Ebinary__ieee_2ELT
                                    & V5v = V1v0 )
                                  | ( c_2Ebinary__ieee_2EUN = V0x
                                    & V4v3 = V5v )
                                  | ( V3v2 = V5v
                                    & c_2Ebinary__ieee_2EGT = V0x )
                                  | ( c_2Ebinary__ieee_2EEQ = V0x
                                    & V2v1 = V5v ) ) ) ) )
                     <= mem(V3v2,A_27a) )
                 <= mem(V2v1,A_27a) )
             <= mem(V1v0,A_27a) )
...
fof(ax_thm_2Ebinary__ieee_2Efloat__minus__infinity__def,axiom,(
    ! [A_27t] :
      ( ! [A_27w] :
          ( ne(A_27w)
         => ap(c_2Ebinary__ieee_2Efloat__negate(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w)))) = ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
     <= ne(A_27t) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Eflags__fupdcanon,axiom,
    ...
    & ! [V27g] :
       ...
       => ! [V28f0] :
            ( ! [V29f] :
                ( ap(ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V27g),ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__BeforeRounding__fupd,V28f0),V29f)) = ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__BeforeRounding__fupd,V28f0),ap(ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V27g),V29f))
               <= mem(V29f,ty_2Ebinary__ieee_2Eflags) )
           <= mem(V28f0,arr(bool,bool)) ) )
    & ! [V30g] :
        ( ! [V31f0] :
    ...
    & ! [V36g] :
        ( ! [V37f0] :
            ( ! [V38f] :
                ( ap(ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V36g),ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__AfterRounding__fupd,V37f0),V38f)) = ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__AfterRounding__fupd,V37f0),ap(ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V36g),V38f))
    ...
    & ! [V42g] :
        ( ! [V43f0] :
            ( ! [V44f] :
                ( ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__BeforeRounding__fupd,V42g),ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__AfterRounding__fupd,V43f0),V44f)) = ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__AfterRounding__fupd,V43f0),ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__BeforeRounding__fupd,V42g),V44f))
    ...
    & ! [V39g] :
        ( ! [V40f0] :
            ( mem(V40f0,arr(bool,bool))
           => ! [V41f] :
                ( ap(ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V39g),ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__AfterRounding__fupd,V40f0),V41f)) = ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__AfterRounding__fupd,V40f0),ap(ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V39g),V41f))
               <= mem(V41f,ty_2Ebinary__ieee_2Eflags) ) )
    ...
    & ! [V18g] :
       ...
       => ! [V19f0] :
            ( ! [V20f] :
               ...
               => ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V18g),ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__BeforeRounding__fupd,V19f0),V20f)) = ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__BeforeRounding__fupd,V19f0),ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V18g),V20f)) )
    ...
    & ! [V9g] :
        ( ! [V10f0] :
            ( ! [V11f] :
                ( mem(V11f,ty_2Ebinary__ieee_2Eflags)
               => ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V9g),ap(ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V10f0),V11f)) = ap(ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V10f0),ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V9g),V11f)) )
           <= mem(V10f0,arr(bool,bool)) )
    ...
    & ! [V3g] :
       ...
       => ! [V4f0] :
            ( mem(V4f0,arr(bool,bool))
           => ! [V5f] :
                ( ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V3g),ap(ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V4f0),V5f)) = ap(ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V4f0),ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V3g),V5f))
               <= mem(V5f,ty_2Ebinary__ieee_2Eflags) ) ) ) )).
      ...
      ( ! [A_27w] :
          ( ( ! [V0c] :
                ( ! [V1c0] :
                    ( mem(V1c0,ty_2Efcp_2Ecart(bool,A_27w))
                   => ! [V2c1] :
                        ( V0c = ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27w),ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V0c),V1c0),V2c1))
                       <= mem(V2c1,ty_2Efcp_2Ecart(bool,A_27t)) ) )
               <= mem(V0c,ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone)) )
            & ! [V3c] :
               ...
               => ! [V4c0] :
                   ...
                   => ! [V5c1] :
                        ( V4c0 = ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V3c),V4c0),V5c1))
                          ...
                          ( ! [A_27y] :
                             ...
                             => ( ! [V5g] :
                                ...
                                & ! [V7h] :
                                   ...
                                   => ! [V8g] :
                                        ( ! [V9f0] :
                                            ( ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Efloat(A_27t,A_27y),ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27t,A_27w,A_27y),ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,A_27w),ty_2Efcp_2Ecart(bool,A_27y),ty_2Efcp_2Ecart(bool,A_27x)),V9f0),V8g))),V7h) = ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Efloat(A_27t,A_27y),ty_2Ebinary__ieee_2Efloat(A_27t,A_27x)),ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27t,A_27x,A_27y),V9f0)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Efloat(A_27t,A_27x),ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27t,A_27w,A_27x),V8g)),V7h))
...
fof(ax_thm_2Ebinary__ieee_2Efloat__is__normal__def,axiom,(
    ! [A_27t] :
     ...
     => ! [A_27w] :
         ...
         => ! [V0x] :
              ( ( ( ~ ( ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),V0x) != ap(c_2Ewords_2En2w(A_27w),c_2Enum_2E0) )
                  & ~ ( c_2Ewords_2Eword__T(A_27w) != ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),V0x) ) )
                                                                               ...
                                                                               <= ( V7M = V8M_27
                                                                                  & ! [V30a0] :
                                                                                     ...
                                                                                     => ! [V31a1] :
                                                                                         ...
                                                                                         => ! [V32a2] :
                                                                                              ( ! [V33a3] :
                                                                                                  ( ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulAdd(A_27t,A_27w),V30a0),V31a1),V32a2),V33a3) = V8M_27
                                                                                      ...
                                                                                      ( ! [V35a1] :
                                                                                         ...
                                                                                         => ! [V36a2] :
                                                                                              ( ! [V37a3] :
                                                                                                 ...
                                                                                                 => ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V34a0),V35a1),V36a2),V37a3) = V8M_27
                                                                                                   => ap(ap(ap(ap(V6f6_27,V34a0),V35a1),V36a2),V37a3) = ap(ap(ap(ap(V15f6,V34a0),V35a1),V36a2),V37a3) ) )
                                                                                  ...
                                                                                  & ! [V27a0] :
                                                                                      ( ! [V28a1] :
                                                                                          ( ! [V29a2] :
                                                                                             ...
                                                                                             => ( ap(ap(ap(c_2Ebinary__ieee_2EFP__Div(A_27t,A_27w),V27a0),V28a1),V29a2) = V8M_27
                                                                                               => ap(ap(ap(V4f4_27,V27a0),V28a1),V29a2) = ap(ap(ap(V13f4,V27a0),V28a1),V29a2) ) )
                                                                                  ...
                                                                                  & ! [V24a0] :
                                                                                     ...
                                                                                     => ! [V25a1] :
                                                                                          ( ! [V26a2] :
                                                                                              ( ( ap(ap(ap(V3f3_27,V24a0),V25a1),V26a2) = ap(ap(ap(V12f3,V24a0),V25a1),V26a2)
                                                                                  ...
                                                                                  & ! [V21a0] :
                                                                                     ...
                                                                                     => ! [V22a1] :
                                                                                          ( ! [V23a2] :
                                                                                              ( ( ap(ap(ap(c_2Ebinary__ieee_2EFP__Sub(A_27t,A_27w),V21a0),V22a1),V23a2) = V8M_27
                                                                                     ...
                                                                                     => ! [V19a1] :
                                                                                         ...
                                                                                         => ! [V20a2] :
                                                                                              ( ( V8M_27 = ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V18a0),V19a1),V20a2)
                                                                                               => ap(ap(ap(V1f1_27,V18a0),V19a1),V20a2) = ap(ap(ap(V10f1,V18a0),V19a1),V20a2) )
    ...
    ! [A_27t] :
     ...
     => ! [A_27w] :
         ...
         => ! [V0mode] :
              ( ! [V1x] :
                  ( ! [V2y] :
                      ( ap(ap(ap(c_2Ebinary__ieee_2Efloat__mul(A_27t,A_27w),V0mode),V1x),V2y) = ap(ap(c_2Epair_2Epair__CASE(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V1x)),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V2y))),f3130(A_27t,A_27w,V0mode,V1x,V2y))
                     <= mem(V2y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                 <= mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
             <= mem(V0mode,ty_2Ebinary__ieee_2Erounding) ) ) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Enum2float__compare__float__compare2num,axiom,(
    ! [V0a] :
     ...
     => V0a = ap(c_2Ebinary__ieee_2Enum2float__compare,ap(c_2Ebinary__ieee_2Efloat__compare2num,V0a)) ) )).
                              ...
                              ( ! [V7a1_27] :
                                  ( ! [V8a2_27] :
                                     ...
                                     => ! [V9a3_27] :
                                          ( ! [V10a4_27] :
                                              ( ! [V11a5_27] :
                                                  ( ( ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V6a0_27),V7a1_27),V8a2_27),V9a3_27),V10a4_27),V11a5_27) = ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V0a0),V1a1),V2a2),V3a3),V4a4),V5a5)
                                                  <=> ( ( p(V0a0)
                                                      <=> p(V6a0_27) )
                                                      & ( p(V1a1)
                                                      <=> p(V7a1_27) )
...
fof(conj_thm_2Ebinary__ieee_2Efloat__compare2num__thm,axiom,
    ...
    & ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) = ap(c_2Ebinary__ieee_2Efloat__compare2num,c_2Ebinary__ieee_2EUN)
    & ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)) = ap(c_2Ebinary__ieee_2Efloat__compare2num,c_2Ebinary__ieee_2EEQ)
    & c_2Enum_2E0 = ap(c_2Ebinary__ieee_2Efloat__compare2num,c_2Ebinary__ieee_2ELT) )).
...
fof(conj_thm_2Ebinary__ieee_2Eflags__fupdfupds,axiom,
    ...
    & ! [V6g] :
        ( ! [V7f0] :
            ( ! [V8f] :
                ( ap(ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,ap(ap(c_2Ecombin_2Eo(bool,bool,bool),V7f0),V6g)),V8f) = ap(ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V7f0),ap(ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V6g),V8f))
               <= mem(V8f,ty_2Ebinary__ieee_2Eflags) )
           <= mem(V7f0,arr(bool,bool)) )
       <= mem(V6g,arr(bool,bool)) )
    & ! [V3g] :
        ( ! [V4f0] :
           ...
           => ! [V5f] :
                ( mem(V5f,ty_2Ebinary__ieee_2Eflags)
               => ap(ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,ap(ap(c_2Ecombin_2Eo(bool,bool,bool),V4f0),V3g)),V5f) = ap(ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V4f0),ap(ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V3g),V5f)) ) )
       <= mem(V3g,arr(bool,bool)) )
    & ! [V0g] :
        ( ! [V1f0] :
            ( mem(V1f0,arr(bool,bool))
           => ! [V2f] :
                ( ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,ap(ap(c_2Ecombin_2Eo(bool,bool,bool),V1f0),V0g)),V2f) = ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V1f0),ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V0g),V2f))
               <= mem(V2f,ty_2Ebinary__ieee_2Eflags) ) )
       <= mem(V0g,arr(bool,bool)) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Erounding2num__num2rounding,axiom,(
    ! [V0r] :
      ( ( V0r = ap(c_2Ebinary__ieee_2Erounding2num,ap(c_2Ebinary__ieee_2Enum2rounding,V0r))
      <=> p(ap(ap(c_2Eprim__rec_2E_3C,V0r),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) )
     <= mem(V0r,ty_2Enum_2Enum) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Efloat__infinities,axiom,(
    ! [A_27t] :
      ( ! [A_27w] :
          ( ! [V0x] :
              ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__infinite(A_27t,A_27w),V0x))
              <=> ( ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) = V0x
...
fof(conj_thm_2Ebinary__ieee_2Efloat__value__nchotomy,axiom,(
    ! [V0ff] :
     ...
     => ( c_2Ebinary__ieee_2EInfinity = V0ff
     ...
     => ! [A_27w] :
         ...
         => ! [V0mode] :
             ...
             => ! [V1x] :
                  ( mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))
                 => ! [V2y] :
                      ( ap(ap(c_2Epair_2Epair__CASE(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V1x)),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V2y))),f3125(A_27t,A_27w,V0mode,V1x,V2y)) = ap(ap(ap(c_2Ebinary__ieee_2Efloat__sub(A_27t,A_27w),V0mode),V1x),V2y)
                     <= mem(V2y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) ) ) ) ) ) )).
    ...
    ! [A_27a] :
      ( ! [V0f0] :
         ...
         => ! [V1f1] :
             ...
             => ! [V2f2] :
                  ( ? [V3fn] :
                      ( V1f1 = ap(V3fn,c_2Ebinary__ieee_2EInfinity)
                      & V2f2 = ap(V3fn,c_2Ebinary__ieee_2ENaN)
                      & ! [V4a] :
...
fof(ax_thm_2Ebinary__ieee_2Erounding__BIJ,axiom,
    ...
    & ! [V0a] :
        ( V0a = ap(c_2Ebinary__ieee_2Enum2rounding,ap(c_2Ebinary__ieee_2Erounding2num,V0a))
       <= mem(V0a,ty_2Ebinary__ieee_2Erounding) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Eflags__fupdfupds__comp,axiom,(
    ! [A_27a] :
      ( ( ! [V0g] :
        ...
        & ! [V10g] :
            ( ! [V11f0] :
                ( ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,ap(ap(c_2Ecombin_2Eo(bool,bool,bool),V11f0),V10g)) = ap(ap(c_2Ecombin_2Eo(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V11f0)),ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V10g))
        ...
        & ! [V17h] :
            ( ! [V18g] :
               ...
               => ! [V19f0] :
                    ( mem(V19f0,arr(bool,bool))
                   => ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,ap(ap(c_2Ecombin_2Eo(bool,bool,bool),V19f0),V18g))),V17h) = ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V19f0)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V18g)),V17h)) ) )
        ...
        & ! [V7h] :
           ...
           => ! [V8g] :
                ( ! [V9f0] :
                   ...
                   => ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,ap(ap(c_2Ecombin_2Eo(bool,bool,bool),V9f0),V8g))),V7h) = ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V9f0)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V8g)),V7h)) )
               <= mem(V8g,arr(bool,bool)) ) )
        & ! [V5g] :
            ( mem(V5g,arr(bool,bool))
           => ! [V6f0] :
                ( ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,ap(ap(c_2Ecombin_2Eo(bool,bool,bool),V6f0),V5g)) = ap(ap(c_2Ecombin_2Eo(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V6f0)),ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V5g))
               <= mem(V6f0,arr(bool,bool)) ) )
        & ! [V2h] :
            ( ! [V3g] :
                ( mem(V3g,arr(bool,bool))
               => ! [V4f0] :
                    ( ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,ap(ap(c_2Ecombin_2Eo(bool,bool,bool),V4f0),V3g))),V2h) = ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V4f0)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V3g)),V2h))
                   <= mem(V4f0,arr(bool,bool)) ) )
           <= mem(V2h,arr(A_27a,ty_2Ebinary__ieee_2Eflags)) ) )
     <= ne(A_27a) ) )).

fof(ax_thm_2Ebinary__ieee_2Einvalidop__flags__def,axiom,(
    ap(ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,ap(c_2Ecombin_2EK(bool,bool),c_2Ebool_2ET)),c_2Ebinary__ieee_2Eclear__flags) = c_2Ebinary__ieee_2Einvalidop__flags )).

fof(ax_thm_2Ebinary__ieee_2Efp__op__TY__DEF,axiom,(
    ! [A_27t] :
      ( ! [A_27w] :
          ( ? [V0rep] :
              ( p(ap(ap(c_2Ebool_2ETYPE__DEFINITION(ty_2Eind__type_2Erecspace(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Erounding,ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Efloat(A_27t,A_27w),ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Efloat(A_27t,A_27w),ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))))),ty_2Ebinary__ieee_2Efp__op(A_27t,A_27w)),f3106(A_27t,A_27w)),V0rep))
...
fof(ax_thm_2Ebinary__ieee_2Eflags__TY__DEF,axiom,(
    ? [V0rep] :
      ( p(ap(ap(c_2Ebool_2ETYPE__DEFINITION(ty_2Eind__type_2Erecspace(ty_2Epair_2Eprod(bool,ty_2Epair_2Eprod(bool,ty_2Epair_2Eprod(bool,ty_2Epair_2Eprod(bool,ty_2Epair_2Eprod(bool,bool)))))),ty_2Ebinary__ieee_2Eflags),f3034),V0rep))
    ...
    ! [A_27t] :
     ...
     => ! [A_27w] :
          ( ! [V0y] :
              ( ! [V1x] :
                  ( mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))
                 => ( ( ap(ap(c_2Earithmetic_2E_2B,ap(c_2Ewords_2Ew2n(A_27w),ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),V0y))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) = ap(c_2Ewords_2Ew2n(A_27w),ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),V1x))
                      & ~ ( ap(c_2Ewords_2En2w(A_27w),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) != ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),V1x) )
...
fof(ax_thm_2Ebinary__ieee_2Efloat__TY__DEF,axiom,(
    ! [A_27t] :
     ...
     => ! [A_27w] :
          ( ne(A_27w)
         => ? [V0rep] :
              ( p(ap(ap(c_2Ebool_2ETYPE__DEFINITION(ty_2Eind__type_2Erecspace(ty_2Epair_2Eprod(ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone),ty_2Epair_2Eprod(ty_2Efcp_2Ecart(bool,A_27w),ty_2Efcp_2Ecart(bool,A_27t)))),ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3012(A_27w,A_27t)),V0rep))
              ...
              ( ( ? [V9r] :
                ...
                | ? [V19r] :
                    ...
                    & ? [V20f] :
                        ( ? [V21f0] :
                            ( ? [V22f1] :
                                ( mem(V22f1,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))
                                & ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V19r),V20f),V21f0),V22f1) = V0ff )
                            & mem(V21f0,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                        & mem(V20f,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) ) )
                | ? [V15r] :
                    ( ? [V16f] :
                ...
                | ? [V3r] :
                    ( ? [V4f] :
                        ( ? [V5f0] :
                            ( mem(V5f0,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))
                            & ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V3r),V4f),V5f0) = V0ff )
                        & mem(V4f,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                    & mem(V3r,ty_2Ebinary__ieee_2Erounding) )
                | ? [V1r] :
                    ( ? [V2f] :
             ...
             => ! [V3b1] :
                  ( ! [V4b2] :
                     ...
                     => ! [V5b3] :
                         ...
                         => ! [V6b4] :
                              ( mem(V6b4,bool)
                             => ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V1b),V2b0),ap(V0f,V3b1)),V4b2),V5b3),V6b4) = ap(ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V0f),ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V1b),V2b0),V3b1),V4b2),V5b3),V6b4)) ) ) )
                 <= mem(V3b1,bool) ) ) )
     <= mem(V0f,arr(bool,bool)) ) )).
...
fof(ax_thm_2Ebinary__ieee_2Efloat__to__int__def,axiom,(
    ! [A_27t] :
     ...
     => ! [A_27w] :
         ...
         => ! [V0mode] :
              ( ! [V1x] :
                  ( ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(ty_2Eoption_2Eoption(ty_2Einteger_2Eint)),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V1x)),f3116(A_27w,A_27t,V1x,V0mode)),c_2Eoption_2ENONE(ty_2Einteger_2Eint)),c_2Eoption_2ENONE(ty_2Einteger_2Eint)) = ap(ap(c_2Ebinary__ieee_2Efloat__to__int(A_27t,A_27w),V0mode),V1x)
                 <= mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
             <= mem(V0mode,ty_2Ebinary__ieee_2Erounding) ) ) ) )).
     ...
     => ! [A_27w] :
          ( ! [V0x] :
              ( ~ ~ ( V0x = ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w)))
                    & ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) = V0x )
             <= mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
         <= ne(A_27w) ) ) )).
    ...
    ! [A_27t] :
      ( ! [A_27w] :
          ( ! [V0x] :
             ...
             => ! [V1y] :
                  ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))
                 => ap(ap(c_2Epair_2Epair__CASE(ty_2Ebinary__ieee_2Efloat__compare,ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V0x)),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V1y))),f3146(A_27w,A_27t,V1y,V0x)) = ap(ap(c_2Ebinary__ieee_2Efloat__compare(A_27t,A_27w),V0x),V1y) ) )
         <= ne(A_27w) )
     <= ne(A_27t) ) )).
...
fof(ax_thm_2Ebinary__ieee_2Efloat__compare__TY__DEF,axiom,(
    ? [V0rep] :
      ...
      & p(ap(ap(c_2Ebool_2ETYPE__DEFINITION(ty_2Enum_2Enum,ty_2Ebinary__ieee_2Efloat__compare),f3035),V0rep)) ) )).
         ...
         => ! [A_27t] :
             ...
             => ! [A_27w] :
                 ...
                 => ( ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w)))) = ap(c_2Ebinary__ieee_2EFloat,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))
                    ...
                    & ! [V0fp__op] :
                        ( c_2Ebinary__ieee_2ENaN = ap(c_2Ebinary__ieee_2Efloat__value(A_27a,A_27b),ap(c_2Ebinary__ieee_2Efloat__some__qnan(A_27a,A_27b),V0fp__op))
                       <= mem(V0fp__op,ty_2Ebinary__ieee_2Efp__op(A_27a,A_27b)) )
                                ...
                                & ? [V6b2] :
                                    ( ? [V7b3] :
                                        ( ? [V8b4] :
                                            ...
                                            & ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V3b),V4b0),V5b1),V6b2),V7b3),V8b4) = V0x )
                                        & mem(V7b3,bool) )
                                    & mem(V6b2,bool) ) )
                            & mem(V4b0,bool) ) ) )
                 <= mem(V2v,A_27a) )
...
fof(conj_thm_2Ebinary__ieee_2Efloat__compare__EQ__float__compare,axiom,(
    ! [V0a] :
     ...
     => ! [V1a_27] :
         ...
         => ( ap(c_2Ebinary__ieee_2Efloat__compare2num,V1a_27) = ap(c_2Ebinary__ieee_2Efloat__compare2num,V0a)
          <=> V0a = V1a_27 ) ) ) )).

fof(ax_thm_2Ebinary__ieee_2EULP__primitive__def,axiom,(
    ! [A_27t] :
      ( ! [A_27w] :
          ( c_2Ebinary__ieee_2EULP(A_27t,A_27w) = ap(ap(c_2Erelation_2EWFREC(ty_2Epair_2Eprod(ty_2Efcp_2Ecart(bool,A_27w),ty_2Ebool_2Eitself(A_27t)),ty_2Erealax_2Ereal),ap(c_2Emin_2E_40(arr(ty_2Epair_2Eprod(ty_2Efcp_2Ecart(bool,A_27w),ty_2Ebool_2Eitself(A_27t)),arr(ty_2Epair_2Eprod(ty_2Efcp_2Ecart(bool,A_27w),ty_2Ebool_2Eitself(A_27t)),bool))),f3040(A_27t,A_27w))),k(arr(ty_2Epair_2Eprod(ty_2Efcp_2Ecart(bool,A_27w),ty_2Ebool_2Eitself(A_27t)),ty_2Erealax_2Ereal),f3042(A_27w,A_27t)))
         <= ne(A_27w) )
     <= ne(A_27t) ) )).
                        ...
                        ( ! [V9c] :
                           ...
                           => ! [V10c0] :
                                ( ! [V11c1] :
                                   ...
                                   => ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27u,A_27w),V9c),V10c0),ap(V8f,V11c1)) = ap(ap(c_2Ebinary__ieee_2Efloat__Significand__fupd(A_27t,A_27u,A_27w),V8f),ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V9c),V10c0),V11c1)) )
                        ...
                        ( ! [V5c] :
                            ( ! [V6c0] :
                                ( ! [V7c1] :
                                   ...
                                   => ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27x),V5c),ap(V4f,V6c0)),V7c1) = ap(ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27t,A_27w,A_27x),V4f),ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V5c),V6c0),V7c1)) )
...
fof(conj_thm_2Ebinary__ieee_2Ezero__to__real,axiom,(
    ! [A_27t] :
     ...
     => ! [A_27w] :
          ( ne(A_27w)
         => ( ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))
            & ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) = ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27w),ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w)))) ) ) ) )).
    ...
    ! [A_27a] :
     ...
     => ( ! [V4f] :
           ...
           => ! [V5v] :
                ( ! [V6v1] :
                    ( mem(V6v1,A_27a)
                   => V5v = ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(A_27a),c_2Ebinary__ieee_2EInfinity),V4f),V5v),V6v1) )
               <= mem(V5v,A_27a) ) )
        & ! [V7f] :
            ( ! [V8v] :
                ( ! [V9v1] :
        ...
        & ! [V0a] :
           ...
           => ! [V1f] :
                ( ! [V2v] :
                   ...
                   => ! [V3v1] :
                        ( mem(V3v1,A_27a)
                       => ap(V1f,V0a) = ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(A_27a),ap(c_2Ebinary__ieee_2EFloat,V0a)),V1f),V2v),V3v1) ) )
         ...
         => ! [A_27w] :
             ...
             => ! [V0x] :
                 ...
                 => ! [V1f] :
                      ( ! [V2v] :
                          ( mem(V2v,A_27a)
                         => ( V2v = ap(ap(c_2Ebinary__ieee_2Efloat__CASE(A_27a,A_27t,A_27w),V0x),V1f)
                          <=> ? [V3c] :
                                ( mem(V3c,ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone))
                                & ? [V4c0] :
                                    ( mem(V4c0,ty_2Efcp_2Ecart(bool,A_27w))
                                    & ? [V5c1] :
                                        ( V2v = ap(ap(ap(V1f,V3c),V4c0),V5c1)
                                        & ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V3c),V4c0),V5c1) = V0x
                                        & mem(V5c1,ty_2Efcp_2Ecart(bool,A_27t)) ) ) ) ) )
    ...
    ! [A_27a] :
      ( ( ! [V2h] :
        ...
        & ! [V17h] :
           ...
           => ! [V18g] :
                ( ! [V19f0] :
                    ( ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V18g)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V19f0)),V17h)) = ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V19f0)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V18g)),V17h))
                   <= mem(V19f0,arr(bool,bool)) )
               <= mem(V18g,arr(bool,bool)) ) )
        & ! [V22h] :
            ( ! [V23g] :
        ...
        & ! [V27h] :
           ...
           => ! [V28g] :
                ( mem(V28g,arr(bool,bool))
               => ! [V29f0] :
                    ( ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V28g)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V29f0)),V27h)) = ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V29f0)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V28g)),V27h))
                   <= mem(V29f0,arr(bool,bool)) ) ) )
        & ! [V30g] :
            ( ! [V31f0] :
                ( mem(V31f0,arr(bool,bool))
        ...
        & ! [V20g] :
            ( ! [V21f0] :
                ( mem(V21f0,arr(bool,bool))
               => ap(ap(c_2Ecombin_2Eo(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V20g)),ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V21f0)) = ap(ap(c_2Ecombin_2Eo(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V21f0)),ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V20g)) )
           <= mem(V20g,arr(bool,bool)) )
        & ! [V7h] :
            ( ! [V8g] :
                ( mem(V8g,arr(bool,bool))
               => ! [V9f0] :
                    ( ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V8g)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V9f0)),V7h)) = ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V9f0)),ap(ap(c_2Ecombin_2Eo(A_27a,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V8g)),V7h))
                   <= mem(V9f0,arr(bool,bool)) ) )
           <= mem(V7h,arr(A_27a,ty_2Ebinary__ieee_2Eflags)) )
        & ! [V5g] :
            ( mem(V5g,arr(bool,bool))
           => ! [V6f0] :
                ( ap(ap(c_2Ecombin_2Eo(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V5g)),ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V6f0)) = ap(ap(c_2Ecombin_2Eo(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Eflags__Overflow__fupd,V6f0)),ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V5g))
               <= mem(V6f0,arr(bool,bool)) ) )
        & ! [V0g] :
            ( ! [V1f0] :
                ( mem(V1f0,arr(bool,bool))
        ...
        & ! [V4v0] :
            ( ! [V5v1] :
                ( ! [V6v2] :
                   ...
                   => ! [V7v3] :
                        ( mem(V7v3,A_27a)
                       => V5v1 = ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__compare__CASE(A_27a),c_2Ebinary__ieee_2EEQ),V4v0),V5v1),V6v2),V7v3) ) )
               <= mem(V5v1,A_27a) )
           <= mem(V4v0,A_27a) )
        & ! [V0v0] :
            ( mem(V0v0,A_27a)
           => ! [V1v1] :
               ...
               => ! [V2v2] :
                   ...
                   => ! [V3v3] :
                        ( mem(V3v3,A_27a)
                       => V0v0 = ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__compare__CASE(A_27a),c_2Ebinary__ieee_2ELT),V0v0),V1v1),V2v2),V3v3) ) ) ) ) )
     <= ne(A_27a) ) )).
         ...
         => ( ! [V0a2] :
               ...
               => ! [V1a1_27] :
                    ( ! [V2a1] :
                       ...
                       => ! [V3a0_27] :
                            ( ! [V4a0] :
                                ( ~ ( ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V3a0_27),V1a1_27),V0a2) != ap(ap(c_2Ebinary__ieee_2EFP__Sqrt(A_27t,A_27w),V4a0),V2a1) )
            ...
            & ! [V5a2] :
                ( ! [V6a1_27] :
                    ( ! [V7a1] :
                        ( ! [V8a0_27] :
                            ( ! [V9a0] :
                                ( ~ ( ap(ap(ap(c_2Ebinary__ieee_2EFP__Sub(A_27t,A_27w),V8a0_27),V6a1_27),V5a2) != ap(ap(c_2Ebinary__ieee_2EFP__Sqrt(A_27t,A_27w),V9a0),V7a1) )
                               <= mem(V9a0,ty_2Ebinary__ieee_2Erounding) )
                       ...
                       => ! [V41a1] :
                            ( ! [V42a0_27] :
                               ...
                               => ! [V43a0] :
                                   ...
                                   => ~ ( ap(ap(ap(c_2Ebinary__ieee_2EFP__Mul(A_27t,A_27w),V42a0_27),V40a1_27),V38a2_27) != ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V43a0),V41a1),V39a2) ) ) )
                   ...
                   => ! [V52a2] :
                        ( ! [V53a1_27] :
                            ( ! [V54a1] :
                               ...
                               => ! [V55a0_27] :
                                    ( ! [V56a0] :
                                        ( ~ ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulAdd(A_27t,A_27w),V55a0_27),V53a1_27),V51a2_27),V50a3) != ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V56a0),V54a1),V52a2) )
               ...
               => ! [V65a2] :
                    ( ! [V66a1_27] :
                       ...
                       => ! [V67a1] :
                            ( ! [V68a0_27] :
                                ( ! [V69a0] :
                                    ( ~ ( ap(ap(ap(c_2Ebinary__ieee_2EFP__Mul(A_27t,A_27w),V68a0_27),V66a1_27),V64a2_27) != ap(ap(ap(c_2Ebinary__ieee_2EFP__Sub(A_27t,A_27w),V69a0),V67a1),V65a2) )
                    ...
                    ( ! [V105a2] :
                        ( ! [V106a1_27] :
                           ...
                           => ! [V107a1] :
                                ( ! [V108a0_27] :
                                    ( ! [V109a0] :
                                        ( ~ ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V108a0_27),V106a1_27),V104a2_27),V103a3) != ap(ap(ap(c_2Ebinary__ieee_2EFP__Mul(A_27t,A_27w),V109a0),V107a1),V105a2) )
                            ...
                            ( ! [V128a1_27] :
                                ( ! [V129a1] :
                                   ...
                                   => ! [V130a0_27] :
                                       ...
                                       => ! [V131a0] :
                                            ( ~ ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V130a0_27),V128a1_27),V126a2_27),V124a3_27) != ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulAdd(A_27t,A_27w),V131a0),V129a1),V127a2),V125a3) )
                            ...
                            ( ! [V121a1] :
                               ...
                               => ! [V122a0_27] :
                                   ...
                                   => ! [V123a0] :
                                       ...
                                       => ~ ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V122a0_27),V120a1_27),V118a2_27),V117a3) != ap(ap(ap(c_2Ebinary__ieee_2EFP__Div(A_27t,A_27w),V123a0),V121a1),V119a2) ) ) ) )
                            ...
                            ( ! [V87a1] :
                                ( ! [V88a0_27] :
                                    ( ! [V89a0] :
                                       ...
                                       => ~ ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V88a0_27),V86a1_27),V84a2_27),V83a3) != ap(ap(ap(c_2Ebinary__ieee_2EFP__Sub(A_27t,A_27w),V89a0),V87a1),V85a2) ) )
                            ...
                            ( ! [V80a1] :
                               ...
                               => ! [V81a0_27] :
                                    ( ! [V82a0] :
                                       ...
                                       => ~ ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulAdd(A_27t,A_27w),V81a0_27),V79a1_27),V77a2_27),V76a3) != ap(ap(ap(c_2Ebinary__ieee_2EFP__Sub(A_27t,A_27w),V82a0),V80a1),V78a2) ) )
                       ...
                       => ! [V60a1_27] :
                           ...
                           => ! [V61a1] :
                               ...
                               => ! [V62a0_27] :
                                   ...
                                   => ! [V63a0] :
                                        ( ~ ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V62a0_27),V60a1_27),V58a2_27),V57a3) != ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V63a0),V61a1),V59a2) )
                   ...
                   => ! [V46a1_27] :
                        ( ! [V47a1] :
                            ( ! [V48a0_27] :
                                ( ! [V49a0] :
                                    ( mem(V49a0,ty_2Ebinary__ieee_2Erounding)
                                   => ~ ( ap(ap(ap(c_2Ebinary__ieee_2EFP__Div(A_27t,A_27w),V48a0_27),V46a1_27),V44a2_27) != ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V49a0),V47a1),V45a2) ) )
                        ...
                        ( ! [V29a1] :
                           ...
                           => ! [V30a0_27] :
                                ( ! [V31a0] :
                                   ...
                                   => ~ ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V30a0_27),V28a1_27),V27a2),V26a3) != ap(ap(c_2Ebinary__ieee_2EFP__Sqrt(A_27t,A_27w),V31a0),V29a1) ) )
                       ...
                       => ! [V23a1] :
                           ...
                           => ! [V24a0_27] :
                                ( ! [V25a0] :
                                   ...
                                   => ~ ( ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulAdd(A_27t,A_27w),V24a0_27),V22a1_27),V21a2),V20a3) != ap(ap(c_2Ebinary__ieee_2EFP__Sqrt(A_27t,A_27w),V25a0),V23a1) ) )
    ...
    ! [A_27t] :
      ( ! [A_27w] :
         ...
         => ! [V0mode] :
              ( mem(V0mode,ty_2Ebinary__ieee_2Erounding)
             => ! [V1x] :
                  ( ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27w),V0mode),V1x) = ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erounding__CASE(ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),V0mode),ap(ap(c_2Ebool_2ELET(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3044(A_27t,A_27w,V1x)),ap(c_2Ebinary__ieee_2Ethreshold(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))),ap(ap(c_2Ebool_2ELET(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3046(A_27w,A_27t,V1x)),ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))),ap(ap(c_2Ebool_2ELET(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3048(A_27w,A_27t,V1x)),ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))),ap(ap(c_2Ebool_2ELET(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3050(A_27t,A_27w,V1x)),ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w)))))
                 <= mem(V1x,ty_2Erealax_2Ereal) ) ) )
     <= ne(A_27t) ) )).
    ...
    ! [A_27t] :
      ( ! [A_27w] :
         ...
         => ! [V0mode] :
              ( ! [V1x] :
                  ( mem(V1x,ty_2Erealax_2Ereal)
                 => ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erounding__CASE(ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),V0mode),ap(ap(c_2Ebool_2ELET(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3053(A_27t,A_27w,V1x)),ap(c_2Ebinary__ieee_2Ethreshold(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))),ap(ap(c_2Ebool_2ELET(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3055(A_27w,A_27t,V1x)),ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))),ap(ap(c_2Ebool_2ELET(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3057(A_27w,A_27t,V1x)),ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))),ap(ap(c_2Ebool_2ELET(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3059(A_27t,A_27w,V1x)),ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))))) = ap(ap(c_2Ebinary__ieee_2Eintegral__round(A_27t,A_27w),V0mode),V1x) )
             <= mem(V0mode,ty_2Ebinary__ieee_2Erounding) ) )
     <= ne(A_27t) ) )).
...
fof(ax_thm_2Ebinary__ieee_2Erounding__TY__DEF,axiom,(
    ? [V0rep] :
      ...
      & p(ap(ap(c_2Ebool_2ETYPE__DEFINITION(ty_2Enum_2Enum,ty_2Ebinary__ieee_2Erounding),f3035),V0rep)) ) )).
              ...
              ( ! [V3b1] :
                 ...
                 => ! [V4b2] :
                      ( ! [V5b3] :
                          ( mem(V5b3,bool)
                         => ! [V6b4] :
                              ( ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V1b),V2b0),V3b1),V4b2),ap(V0f,V5b3)),V6b4) = ap(ap(c_2Ebinary__ieee_2Eflags__Underflow__BeforeRounding__fupd,V0f),ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V1b),V2b0),V3b1),V4b2),V5b3),V6b4))
                             <= mem(V6b4,bool) ) )
                     <= mem(V4b2,bool) ) )
             <= mem(V2b0,bool) )
         <= mem(V1b,bool) ) ) )).
    ...
    ! [A_27t] :
      ( ! [A_27w] :
          ( ! [V0mode] :
              ( ! [V1x] :
                  ( ! [V2y] :
                      ( ap(ap(c_2Epair_2Epair__CASE(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V1x)),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V2y))),f3134(A_27t,A_27w,V0mode,V1x,V2y)) = ap(ap(ap(c_2Ebinary__ieee_2Efloat__div(A_27t,A_27w),V0mode),V1x),V2y)
                     <= mem(V2y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                 <= mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
             <= mem(V0mode,ty_2Ebinary__ieee_2Erounding) )
         <= ne(A_27w) )
...
fof(conj_thm_2Ebinary__ieee_2Erounding__distinct,axiom,
    ( ~ ( c_2Ebinary__ieee_2EroundTowardZero != c_2Ebinary__ieee_2EroundTiesToEven )
    & ~ ( c_2Ebinary__ieee_2EroundTowardPositive != c_2Ebinary__ieee_2EroundTowardNegative )
    & ~ ( c_2Ebinary__ieee_2EroundTowardZero != c_2Ebinary__ieee_2EroundTowardPositive )
    & ~ ( c_2Ebinary__ieee_2EroundTowardNegative != c_2Ebinary__ieee_2EroundTowardZero )
    & ~ ( c_2Ebinary__ieee_2EroundTowardNegative != c_2Ebinary__ieee_2EroundTiesToEven )
    & ~ ( c_2Ebinary__ieee_2EroundTowardPositive != c_2Ebinary__ieee_2EroundTiesToEven ) )).
          ...
          ( ! [A_27w] :
              ( ! [A_27x] :
                 ...
                 => ( ! [V0f0] :
                    ...
                    & ! [V4f0] :
                        ( ! [V5f] :
                            ( ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),V5f) = ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27t,A_27w),V4f0),V5f))
                           <= mem(V5f,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                       <= mem(V4f0,arr(ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone),ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone))) )
                    & ! [V8f0] :
                    ...
                    & ! [V10f0] :
                        ( ! [V11f] :
                           ...
                           => ap(c_2Ebinary__ieee_2Efloat__Significand(A_27t,A_27w),V11f) = ap(c_2Ebinary__ieee_2Efloat__Significand(A_27t,A_27x),ap(ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27t,A_27w,A_27x),V10f0),V11f)) )
                       <= mem(V10f0,arr(ty_2Efcp_2Ecart(bool,A_27w),ty_2Efcp_2Ecart(bool,A_27x))) )
                    & ! [V16f0] :
                        ( ! [V17f] :
                            ( ap(V16f0,ap(c_2Ebinary__ieee_2Efloat__Significand(A_27t,A_27w),V17f)) = ap(c_2Ebinary__ieee_2Efloat__Significand(A_27u,A_27w),ap(ap(c_2Ebinary__ieee_2Efloat__Significand__fupd(A_27t,A_27u,A_27w),V16f0),V17f))
                    ...
                    & ! [V12f0] :
                        ( ! [V13f] :
                            ( mem(V13f,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))
                           => ap(V12f0,ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27w),V13f)) = ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27w),ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27t,A_27w),V12f0),V13f)) )
                       <= mem(V12f0,arr(ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone),ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone))) )
                    & ! [V6f0] :
                        ( ! [V7f] :
                            ( mem(V7f,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))
                           => ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27w),V7f) = ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27u,A_27w),ap(ap(c_2Ebinary__ieee_2Efloat__Significand__fupd(A_27t,A_27u,A_27w),V6f0),V7f)) )
                       <= mem(V6f0,arr(ty_2Efcp_2Ecart(bool,A_27t),ty_2Efcp_2Ecart(bool,A_27u))) ) ) )
             <= ne(A_27w) )
         <= ne(A_27u) )
     <= ne(A_27t) ) )).
                      ...
                      ( ! [V4v3] :
                         ...
                         => ! [V5v] :
                              ...
                              <=> ( ( V2v1 = V5v
                                  ...
                                  | ( c_2Ebinary__ieee_2EroundTowardNegative = V0x
                                    & V5v = V3v2 )
              ...
              ( ! [V2x2] :
                 ...
                 => ! [V3x3] :
                     ...
                     => ? [V4f] :
                          ...
                          & V2x2 = ap(V4f,c_2Ebinary__ieee_2EGT) ) ) )
             <= mem(V1x1,A_27a) ) ) ) )).
...
fof(ax_thm_2Ebinary__ieee_2Edividezero__flags__def,axiom,(
    ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,ap(c_2Ecombin_2EK(bool,bool),c_2Ebool_2ET)),c_2Ebinary__ieee_2Eclear__flags) = c_2Ebinary__ieee_2Edividezero__flags )).
               ...
               => ! [V10b1] :
                   ...
                   => ! [V11b2] :
                        ( ! [V12b3] :
                           ...
                           => ! [V13b4] :
                                ( mem(V13b4,bool)
                               => ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V8b),ap(V7f,V9b0)),V10b1),V11b2),V12b3),V13b4) = ap(ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V7f),ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V8b),V9b0),V10b1),V11b2),V12b3),V13b4)) ) )
                       <= mem(V11b2,bool) ) ) )
           <= mem(V8b,bool) )
               ...
               => ! [V24b1] :
                   ...
                   => ! [V25b2] :
                       ...
                       => ! [V26b3] :
                            ( mem(V26b3,bool)
                           => ! [V27b4] :
                                ( ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V22b),V23b0),V24b1),ap(V21f,V25b2)),V26b3),V27b4) = ap(ap(c_2Ebinary__ieee_2Eflags__Precision__fupd,V21f),ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V22b),V23b0),V24b1),V25b2),V26b3),V27b4))
                               <= mem(V27b4,bool) ) ) ) ) )
           <= mem(V22b,bool) ) )
    & ! [V0f] :
        ( ! [V1b] :
               ...
               => ! [V3b1] :
                    ( ! [V4b2] :
                        ( ! [V5b3] :
                           ...
                           => ! [V6b4] :
                                ( mem(V6b4,bool)
                               => ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,ap(V0f,V1b)),V2b0),V3b1),V4b2),V5b3),V6b4) = ap(ap(c_2Ebinary__ieee_2Eflags__DivideByZero__fupd,V0f),ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V1b),V2b0),V3b1),V4b2),V5b3),V6b4)) ) )
                       <= mem(V4b2,bool) )
                   <= mem(V3b1,bool) ) ) )
       <= mem(V0f,arr(bool,bool)) ) )).
...
fof(ax_thm_2Ebinary__ieee_2Efloat__value__TY__DEF,axiom,(
    ? [V0rep] :
      ...
      & p(ap(ap(c_2Ebool_2ETYPE__DEFINITION(ty_2Eind__type_2Erecspace(ty_2Erealax_2Ereal),ty_2Ebinary__ieee_2Efloat__value),f3017),V0rep)) ) )).
...
fof(ax_thm_2Ebinary__ieee_2Eis__integral__def,axiom,(
    ! [V0r] :
     ...
     => ( ? [V1n] :
            ( mem(V1n,ty_2Enum_2Enum)
            & ap(c_2Ereal_2Ereal__of__num,V1n) = ap(c_2Ereal_2Eabs,V0r) )
                                          ...
                                          ( ? [V7fn] :
                                              ...
                                              & ! [V26a0] :
                                                 ...
                                                 => ! [V27a1] :
                                                      ( ! [V28a2] :
                                                          ( ! [V29a3] :
                                                              ( ap(ap(ap(ap(V6f6,V26a0),V27a1),V28a2),V29a3) = ap(V7fn,ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V26a0),V27a1),V28a2),V29a3))
                                                             <= mem(V29a3,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                                                         <= mem(V28a2,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                                                     <= mem(V27a1,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) ) )
                                              & ! [V22a0] :
                                              ...
                                              & ! [V19a0] :
                                                  ( ! [V20a1] :
                                                      ( ! [V21a2] :
                                                          ( ap(ap(ap(V4f4,V19a0),V20a1),V21a2) = ap(V7fn,ap(ap(ap(c_2Ebinary__ieee_2EFP__Div(A_27t,A_27w),V19a0),V20a1),V21a2))
                                                         <= mem(V21a2,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                                                     <= mem(V20a1,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                                                 <= mem(V19a0,ty_2Ebinary__ieee_2Erounding) )
                                              & ! [V10a0] :
...
fof(ax_thm_2Ebinary__ieee_2Eclosest__def,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27b),ap(c_2Ecombin_2EK(bool,ty_2Ebinary__ieee_2Efloat(A_27a,A_27b)),c_2Ebool_2ET)) = c_2Ebinary__ieee_2Eclosest(A_27a,A_27b) ) ) )).
                      ...
                      & ! [V2a0] :
                         ...
                         => ! [V3a1] :
                              ( ! [V4a2] :
                                 ...
                                 => ap(ap(ap(V0f,V2a0),V3a1),V4a2) = ap(V1fn,ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V2a0),V3a1),V4a2)) )
             ...
             => ! [V3b1] :
                  ( ! [V4b2] :
                      ( ! [V5b3] :
                          ( mem(V5b3,bool)
                         => ! [V6b4] :
                              ( ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V1b),ap(V0f,V2b0)),V3b1),V4b2),V5b3),V6b4) = ap(ap(c_2Ebinary__ieee_2Eflags__InvalidOp__fupd,V0f),ap(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Eflags,V1b),V2b0),V3b1),V4b2),V5b3),V6b4))
                             <= mem(V6b4,bool) ) )
                     <= mem(V4b2,bool) )
                 <= mem(V3b1,bool) ) ) ) ) )).
          ...
          ( ! [V0f] :
             ...
             => ! [V1c] :
                  ( ! [V2c0] :
                      ( ! [V3c1] :
                          ( mem(V3c1,ty_2Efcp_2Ecart(bool,A_27t))
                         => ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),ap(V0f,V1c)),V2c0),V3c1) = ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27t,A_27w),V0f),ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V1c),V2c0),V3c1)) )
                     <= mem(V2c0,ty_2Efcp_2Ecart(bool,A_27w)) )
                 <= mem(V1c,ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone)) ) )
         <= ne(A_27w) )
     <= ne(A_27t) ) )).
             ...
             => ! [V2x2] :
                  ( ! [V3x3] :
                      ( ? [V4f] :
                          ...
                          & V2x2 = ap(V4f,c_2Ebinary__ieee_2EroundTowardNegative)
                          & V0x0 = ap(V4f,c_2Ebinary__ieee_2EroundTiesToEven) )
                     <= mem(V3x3,A_27a) )
                 <= mem(V2x2,A_27a) ) )
         <= mem(V0x0,A_27a) )
     <= ne(A_27a) ) )).
    ...
    ! [A_27t] :
     ...
     => ! [A_27w] :
          ( ! [V0mode] :
             ...
             => ! [V1x] :
                  ( mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w))
                 => ap(ap(c_2Ebinary__ieee_2Efloat__round__to__integral(A_27t,A_27w),V0mode),V1x) = ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V1x)),f3113(A_27w,A_27t,V0mode)),V1x),V1x) ) )
         <= ne(A_27w) ) ) )).
                           ...
                           => ! [V26a1_27] :
                               ...
                               => ! [V27a2_27] :
                                   ...
                                   => ( ( V22a0 = V25a0_27
                                        & V23a1 = V26a1_27
                                        & V24a2 = V27a2_27 )
                                    <=> ap(ap(ap(c_2Ebinary__ieee_2EFP__Div(A_27t,A_27w),V25a0_27),V26a1_27),V27a2_27) = ap(ap(ap(c_2Ebinary__ieee_2EFP__Div(A_27t,A_27w),V22a0),V23a1),V24a2) ) ) ) )
                       <= mem(V24a2,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                   <= mem(V23a1,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) ) )
            & ! [V16a0] :
                ( mem(V16a0,ty_2Ebinary__ieee_2Erounding)
                            ...
                            ( ! [V8a1_27] :
                               ...
                               => ! [V9a2_27] :
                                    ( ( ( V4a0 = V7a0_27
                                        & V9a2_27 = V6a2
                                        & V5a1 = V8a1_27 )
                                    <=> ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V7a0_27),V8a1_27),V9a2_27) = ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V4a0),V5a1),V6a2) )
                      ...
                      ( ! [A_27y] :
                         ...
                         => ( ! [V0g] :
                               ...
                               => ! [V1f0] :
                                    ( mem(V1f0,arr(ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone),ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone)))
                                   => ! [V2f] :
                                        ( ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27t,A_27w),ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone),ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone),ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone)),V1f0),V0g)),V2f) = ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27t,A_27w),V1f0),ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27t,A_27w),V0g),V2f))
                                       <= mem(V2f,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) ) ) )
                            & ! [V3g] :
                                ( ! [V4f0] :
                                    ( ! [V5f] :
                                        ( ap(ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27t,A_27w,A_27y),ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,A_27w),ty_2Efcp_2Ecart(bool,A_27y),ty_2Efcp_2Ecart(bool,A_27x)),V4f0),V3g)),V5f) = ap(ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27t,A_27x,A_27y),V4f0),ap(ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27t,A_27w,A_27x),V3g),V5f))
                                       <= mem(V5f,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) )
                                                  ...
                                                  <=> ( ? [V11r] :
                                                          ( ? [V12f_27] :
                                                              ( ? [V13f0] :
                                                                  ...
                                                                  & ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27w),V11r),V12f_27),V13f0) = V0x )
                                                      ...
                                                      | ? [V14r] :
                                                          ...
                                                          & ? [V15f_27] :
                                                              ( ? [V16f0] :
                                                                  ...
                                                                  & V8v = ap(ap(ap(V3f2,V14r),V15f_27),V16f0)
                                                      ...
                                                      | ? [V20r] :
                                                          ...
                                                          & ? [V21f_27] :
                                                              ( ? [V22f0] :
                                                                  ( ap(ap(ap(c_2Ebinary__ieee_2EFP__Div(A_27t,A_27w),V20r),V21f_27),V22f0) = V0x
                                                      ...
                                                      | ? [V23r] :
                                                          ...
                                                          & ? [V24f_27] :
                                                              ( ? [V25f0] :
                                                                  ...
                                                                  & ? [V26f1_27] :
                                                                      ( V8v = ap(ap(ap(ap(V6f5,V23r),V24f_27),V25f0),V26f1_27)
                                                                      & ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulAdd(A_27t,A_27w),V23r),V24f_27),V25f0),V26f1_27) = V0x
                                                          ...
                                                          ( ? [V28f_27] :
                                                              ( ? [V29f0] :
                                                                  ( ? [V30f1_27] :
                                                                      ...
                                                                      & ap(ap(ap(ap(c_2Ebinary__ieee_2EFP__MulSub(A_27t,A_27w),V27r),V28f_27),V29f0),V30f1_27) = V0x
                                                      ...
                                                      | ? [V9r] :
                                                          ...
                                                          & ? [V10f_27] :
                                                              ...
                                                              & ap(ap(c_2Ebinary__ieee_2EFP__Sqrt(A_27t,A_27w),V9r),V10f_27) = V0x
...
fof(conj_thm_2Ebinary__ieee_2Enum2rounding__thm,axiom,
    ...
    & c_2Ebinary__ieee_2EroundTowardNegative = ap(c_2Ebinary__ieee_2Enum2rounding,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))
...
fof(conj_thm_2Ebinary__ieee_2Efloat__value__distinct,axiom,
    ...
    & ! [V1a] :
       ...
       => ~ ( c_2Ebinary__ieee_2ENaN != ap(c_2Ebinary__ieee_2EFloat,V1a) ) )
    & ! [V0a] :
        ( ~ ( c_2Ebinary__ieee_2EInfinity != ap(c_2Ebinary__ieee_2EFloat,V0a) )
       <= mem(V0a,ty_2Erealax_2Ereal) ) )).
          ...
          ( ! [V0f] :
             ...
             => ! [V1f1] :
                 ...
                 => ! [V2a0] :
                     ...
                     => ! [V3a1] :
                          ( ! [V4a2] :
                              ( ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)) = ap(ap(ap(c_2Ebinary__ieee_2Efloat__size(A_27t,A_27w),V0f),V1f1),ap(ap(ap(c_2Ebinary__ieee_2Erecordtype_2Efloat(A_27t,A_27w),V2a0),V3a1),V4a2))
                             <= mem(V4a2,ty_2Efcp_2Ecart(bool,A_27t)) )
                         <= mem(V3a1,ty_2Efcp_2Ecart(bool,A_27w)) ) ) ) )
         <= ne(A_27w) )
     <= ne(A_27t) ) )).
     ...
     => ! [V0x] :
         ...
         => ! [V1f] :
             ...
             => ! [V2v] :
                  ( ! [V3v1] :
                      ( ! [V4v_27] :
                          ( ( V4v_27 = ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(A_27a),V0x),V1f),V2v),V3v1)
                          <=> ( ( V0x = c_2Ebinary__ieee_2ENaN
                                & V4v_27 = V3v1 )
                              | ( c_2Ebinary__ieee_2EInfinity = V0x
                                & V2v = V4v_27 )
                              | ? [V5r] :
                                  ( V4v_27 = ap(V1f,V5r)
...
fof(conj_thm_2Ebinary__ieee_2Efloat__distinct,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ! [A_27t] :
              ( ! [A_27w] :
                  ( ( ~ ( ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    ...
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__top(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    ...
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__plus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    & ! [V2fp__op] :
                    ...
                    & ! [V3fp__op] :
                        ( ~ ( ap(c_2Ebinary__ieee_2Efloat__some__qnan(A_27t,A_27w),V3fp__op) != ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    ...
                    & ! [V7fp__op] :
                        ( ~ ( ap(c_2Ebinary__ieee_2Efloat__some__qnan(A_27t,A_27w),V7fp__op) != ap(c_2Ebinary__ieee_2Efloat__minus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                       <= mem(V7fp__op,ty_2Ebinary__ieee_2Efp__op(A_27t,A_27w)) )
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__minus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__plus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    & ! [V6fp__op] :
                    ...
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__plus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    ...
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__minus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__top(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    ...
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__plus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    ...
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__top(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    ...
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__minus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    ...
                    & ! [V0fp__op] :
                       ...
                       <= mem(V0fp__op,ty_2Ebinary__ieee_2Efp__op(A_27t,A_27w)) )
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__minus__min(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
                    ...
                    & ~ ( ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) != ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27w),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27w))) )
...
fof(ax_thm_2Ebinary__ieee_2Efloat__abs__def,axiom,(
    ! [A_27t] :
      ( ! [A_27w] :
          ( ne(A_27w)
         => ! [V0x] :
              ( ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27t,A_27w),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone),ty_2Efcp_2Ecart(bool,ty_2Eone_2Eone)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),c_2Enum_2E0))),V0x) = ap(c_2Ebinary__ieee_2Efloat__abs(A_27t,A_27w),V0x)
             <= mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) ) )
     <= ne(A_27t) ) )).
...
fof(ax_thm_2Ebinary__ieee_2Efloat__is__integral__def,axiom,(
    ! [A_27t] :
      ( ! [A_27w] :
          ( ne(A_27w)
         => ! [V0x] :
              ( ( p(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(bool),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V0x)),f3019),c_2Ebool_2EF),c_2Ebool_2EF))
      ...
      ( ! [V0x] :
         ...
         => ! [V1v0] :
             ...
             => ! [V2v1] :
                  ( ! [V3v2] :
                      ( ! [V4v3] :
                          ( ap(f3037(A_27a,V2v1,V3v2,V4v3,V1v0),ap(c_2Ebinary__ieee_2Erounding2num,V0x)) = ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erounding__CASE(A_27a),V0x),V1v0),V2v1),V3v2),V4v3)
                         <= mem(V4v3,A_27a) )
                     <= mem(V3v2,A_27a) )
                 <= mem(V2v1,A_27a) ) ) )
     <= ne(A_27a) ) )).
    ...
    ! [A_27t] :
      ( ! [A_27w] :
         ...
         => ! [V0mode] :
             ...
             => ! [V1toneg] :
                  ( ! [V2r] :
                      ( ap(ap(c_2Ebool_2ELET(ty_2Ebinary__ieee_2Efloat(A_27t,A_27w),ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)),f3109(A_27t,A_27w,V1toneg)),ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27w),V0mode),V2r)) = ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27w),V0mode),V1toneg),V2r)
...
fof(conj_thm_2Ebinary__ieee_2Erounding__nchotomy,axiom,(
    ! [V0a] :
     ...
     => ( V0a = c_2Ebinary__ieee_2EroundTowardPositive
        ...
        | c_2Ebinary__ieee_2EroundTowardNegative = V0a
        | c_2Ebinary__ieee_2EroundTiesToEven = V0a ) ) )).
    ...
    ! [A_27t] :
     ...
     => ! [A_27w] :
         ...
         => ! [V0x] :
              ...
              <=> p(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(bool),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27w),V0x)),f3018),c_2Ebool_2EF),c_2Ebool_2EF)) )
             <= mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27w)) ) ) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Efloat__compare2num__ONTO,axiom,(
    ! [V0r] :
     ...
     => ( ? [V1a] :
            ( mem(V1a,ty_2Ebinary__ieee_2Efloat__compare)
            & ap(c_2Ebinary__ieee_2Efloat__compare2num,V1a) = V0r )
      <=> p(ap(ap(c_2Eprim__rec_2E_3C,V0r),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) )).
...
fof(ax_thm_2Ebinary__ieee_2Efloat__compare__BIJ,axiom,
    ( ! [V1r] :
        ( mem(V1r,ty_2Enum_2Enum)
       => ( p(ap(f3036,V1r))
        <=> V1r = ap(c_2Ebinary__ieee_2Efloat__compare2num,ap(c_2Ebinary__ieee_2Enum2float__compare,V1r)) ) )
    & ! [V0a] :
        ( V0a = ap(c_2Ebinary__ieee_2Enum2float__compare,ap(c_2Ebinary__ieee_2Efloat__compare2num,V0a))
       <= mem(V0a,ty_2Ebinary__ieee_2Efloat__compare) ) )).
