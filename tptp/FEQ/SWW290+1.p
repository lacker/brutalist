...
fof(fact_pdivmod__rel__pCons,axiom,(
    ! [V_a,V_b,V_r,V_q,V_y,V_x,T_a] :
      ( ( ( c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) != V_y
         => ( c_Rings_Oinverse__class_Odivide(T_a,hAPP(c_Polynomial_Ocoeff(T_a,c_Polynomial_OpCons(T_a,V_a,V_r)),c_Polynomial_Odegree(T_a,V_y)),hAPP(c_Polynomial_Ocoeff(T_a,V_y),c_Polynomial_Odegree(T_a,V_y))) = V_b
...
fof(fact_zdvd__period,axiom,(
    ! [V_c_2,V_t_2,V_x_2,V_d_2,V_aa_2] :
      ( ( c_Rings_Odvd__class_Odvd(tc_Int_Oint,V_aa_2,c_Groups_Oplus__class_Oplus(tc_Int_Oint,V_x_2,V_t_2))
      <=> c_Rings_Odvd__class_Odvd(tc_Int_Oint,V_aa_2,c_Groups_Oplus__class_Oplus(tc_Int_Oint,c_Groups_Oplus__class_Oplus(tc_Int_Oint,V_x_2,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Int_Oint),V_c_2),V_d_2)),V_t_2)) )
     <= c_Rings_Odvd__class_Odvd(tc_Int_Oint,V_aa_2,V_d_2) ) )).
...
fof(fact_pCons__eq__0__iff,axiom,(
    ! [V_pa_2,V_aa_2,T_a] :
     ...
     => ( c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) = c_Polynomial_OpCons(T_a,V_aa_2,V_pa_2)
...
fof(fact_synthetic__div__unique,axiom,(
    ! [V_r,V_q,V_c,V_p,T_a] :
      ( ( ( V_r = hAPP(c_Polynomial_Opoly(T_a,V_p),V_c)
          & c_Polynomial_Osynthetic__div(T_a,V_p,V_c) = V_q )
       <= c_Polynomial_OpCons(T_a,V_r,V_q) = c_Groups_Oplus__class_Oplus(tc_Polynomial_Opoly(T_a),V_p,c_Polynomial_Osmult(T_a,V_c,V_q)) )
     <= class_Rings_Ocomm__semiring__0(T_a) ) )).
...
fof(fact_le__divide__eq,axiom,(
    ! [V_c_2,V_b_2,V_aa_2,T_a] :
      ( ( ( ( c_Orderings_Oord__class_Oless(T_a,c_Groups_Ozero__class_Ozero(T_a),V_c_2)
           => c_Orderings_Oord__class_Oless__eq(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2),V_b_2) )
          & ( ( ( c_Orderings_Oord__class_Oless(T_a,V_c_2,c_Groups_Ozero__class_Ozero(T_a))
               => c_Orderings_Oord__class_Oless__eq(T_a,V_b_2,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2)) )
              & ( ~ c_Orderings_Oord__class_Oless(T_a,V_c_2,c_Groups_Ozero__class_Ozero(T_a))
               => c_Orderings_Oord__class_Oless__eq(T_a,V_aa_2,c_Groups_Ozero__class_Ozero(T_a)) ) )
           <= ~ c_Orderings_Oord__class_Oless(T_a,c_Groups_Ozero__class_Ozero(T_a),V_c_2) ) )
      <=> c_Orderings_Oord__class_Oless__eq(T_a,V_aa_2,c_Rings_Oinverse__class_Odivide(T_a,V_b_2,V_c_2)) )
     <= class_Fields_Olinordered__field__inverse__zero(T_a) ) )).

fof(fact_mult__smult__left,axiom,(
    ! [V_q,V_p,V_a,T_a] :
      ( class_Rings_Ocomm__semiring__0(T_a)
     => c_Polynomial_Osmult(T_a,V_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Polynomial_Opoly(T_a)),V_p),V_q)) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Polynomial_Opoly(T_a)),c_Polynomial_Osmult(T_a,V_a,V_p)),V_q) ) )).
...
fof(fact_less__iff__Suc__add,axiom,(
    ...
    <=> ? [B_k] : c_Nat_OSuc(c_Groups_Oplus__class_Oplus(tc_Nat_Onat,V_m_2,B_k)) = V_n_2 ) )).

fof(fact_pos__less__divide__eq,axiom,(
    ! [V_b_2,V_aa_2,V_c_2,T_a] :
      ( ( ( c_Orderings_Oord__class_Oless(T_a,V_aa_2,c_Rings_Oinverse__class_Odivide(T_a,V_b_2,V_c_2))
        <=> c_Orderings_Oord__class_Oless(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2),V_b_2) )
       <= c_Orderings_Oord__class_Oless(T_a,c_Groups_Ozero__class_Ozero(T_a),V_c_2) )
     <= class_Fields_Olinordered__field(T_a) ) )).
...
fof(fact_divide__less__eq,axiom,(
    ! [V_aa_2,V_c_2,V_b_2,T_a] :
      ( ( c_Orderings_Oord__class_Oless(T_a,c_Rings_Oinverse__class_Odivide(T_a,V_b_2,V_c_2),V_aa_2)
      <=> ( ( ( ( c_Orderings_Oord__class_Oless(T_a,c_Groups_Ozero__class_Ozero(T_a),V_aa_2)
               <= ~ c_Orderings_Oord__class_Oless(T_a,V_c_2,c_Groups_Ozero__class_Ozero(T_a)) )
              & ( c_Orderings_Oord__class_Oless(T_a,V_c_2,c_Groups_Ozero__class_Ozero(T_a))
               => c_Orderings_Oord__class_Oless(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2),V_b_2) ) )
           <= ~ c_Orderings_Oord__class_Oless(T_a,c_Groups_Ozero__class_Ozero(T_a),V_c_2) )
          & ( c_Orderings_Oord__class_Oless(T_a,V_b_2,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2))
           <= c_Orderings_Oord__class_Oless(T_a,c_Groups_Ozero__class_Ozero(T_a),V_c_2) ) ) )
     <= class_Fields_Olinordered__field__inverse__zero(T_a) ) )).
...
fof(fact_coeff__add,axiom,(
    ! [V_n,V_q,V_p,T_a] :
      ( class_Groups_Ocomm__monoid__add(T_a)
     => c_Groups_Oplus__class_Oplus(T_a,hAPP(c_Polynomial_Ocoeff(T_a,V_p),V_n),hAPP(c_Polynomial_Ocoeff(T_a,V_q),V_n)) = hAPP(c_Polynomial_Ocoeff(T_a,c_Groups_Oplus__class_Oplus(tc_Polynomial_Opoly(T_a),V_p,V_q)),V_n) ) )).
...
fof(fact_minus__add,axiom,(
    ! [V_b,V_a,T_a] :
      ( class_Groups_Ogroup__add(T_a)
     => c_Groups_Oplus__class_Oplus(T_a,c_Groups_Ouminus__class_Ouminus(T_a,V_b),c_Groups_Ouminus__class_Ouminus(T_a,V_a)) = c_Groups_Ouminus__class_Ouminus(T_a,c_Groups_Oplus__class_Oplus(T_a,V_a,V_b)) ) )).
...
fof(fact_dvd__iff__poly__eq__0,axiom,(
    ! [V_pa_2,V_c_2,T_a] :
      ...
      <=> c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(T_a),c_Polynomial_OpCons(T_a,V_c_2,c_Polynomial_OpCons(T_a,c_Groups_Oone__class_Oone(T_a),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)))),V_pa_2) )
...
fof(fact_poly__rec__pCons,axiom,(
    ! [V_pa_2,V_aa_2,T_a,V_z_2,V_f_2,T_b] :
     ...
     => ( hAPP(hAPP(hAPP(V_f_2,c_Groups_Ozero__class_Ozero(T_b)),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_b))),V_z_2) = V_z_2
       => c_Polynomial_Opoly__rec(T_a,T_b,V_z_2,V_f_2,c_Polynomial_OpCons(T_b,V_aa_2,V_pa_2)) = hAPP(hAPP(hAPP(V_f_2,V_aa_2),V_pa_2),c_Polynomial_Opoly__rec(T_a,T_b,V_z_2,V_f_2,V_pa_2)) ) ) )).
...
fof(fact_constant__def,axiom,(
    ...
    <=> ! [B_x,B_y] : hAPP(V_f_2,B_y) = hAPP(V_f_2,B_x) ) )).
...
fof(fact_zero__less__divide__iff,axiom,(
    ! [V_b_2,V_aa_2,T_a] :
      ( class_Fields_Olinordered__field__inverse__zero(T_a)
     => ( c_Orderings_Oord__class_Oless(T_a,c_Groups_Ozero__class_Ozero(T_a),c_Rings_Oinverse__class_Odivide(T_a,V_aa_2,V_b_2))
...
fof(fact_divide__eq__eq,axiom,(
    ! [V_aa_2,V_c_2,V_b_2,T_a] :
      ( ( V_aa_2 = c_Rings_Oinverse__class_Odivide(T_a,V_b_2,V_c_2)
      <=> ( ( V_c_2 = c_Groups_Ozero__class_Ozero(T_a)
           => c_Groups_Ozero__class_Ozero(T_a) = V_aa_2 )
          & ( V_c_2 != c_Groups_Ozero__class_Ozero(T_a)
           => V_b_2 = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2) ) ) )
     <= class_Fields_Ofield__inverse__zero(T_a) ) )).
...
fof(fact_mod__diff__left__eq,axiom,(
    ! [V_c,V_b,V_a,T_a] :
     ...
     => c_Divides_Odiv__class_Omod(T_a,c_Groups_Ominus__class_Ominus(T_a,c_Divides_Odiv__class_Omod(T_a,V_a,V_c),V_b),V_c) = c_Divides_Odiv__class_Omod(T_a,c_Groups_Ominus__class_Ominus(T_a,V_a,V_b),V_c) ) )).
...
fof(fact_power__diff,axiom,(
    ! [V_m,V_n,V_a,T_a] :
      ( class_Fields_Ofield(T_a)
     => ( ( c_Rings_Oinverse__class_Odivide(T_a,hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_a),V_m),hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_a),V_n)) = hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_a),c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_m,V_n))
         <= c_Orderings_Oord__class_Oless__eq(tc_Nat_Onat,V_n,V_m) )
       <= V_a != c_Groups_Ozero__class_Ozero(T_a) ) ) )).
...
fof(fact_poly__pad__rule,axiom,(
    ! [V_x,V_p] :
      ( c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex) = hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Polynomial_OpCons(tc_Complex_Ocomplex,c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex),V_p)),V_x)
     <= hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,V_p),V_x) = c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex) ) )).
...
fof(fact_mpoly__base__conv_I1_J,axiom,(
    ! [V_x] : hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex))),V_x) = c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex) )).

fof(fact_nonzero__eq__divide__eq,axiom,(
    ! [V_b_2,V_aa_2,V_c_2,T_a] :
      ( class_Rings_Odivision__ring(T_a)
     => ( V_c_2 != c_Groups_Ozero__class_Ozero(T_a)
       => ( c_Rings_Oinverse__class_Odivide(T_a,V_b_2,V_c_2) = V_aa_2
        <=> hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2) = V_b_2 ) ) ) )).
...
fof(fact_constant__degree,axiom,(
    ! [V_pa_2,T_a] :
      ( ( class_Int_Oring__char__0(T_a)
        & class_Rings_Oidom(T_a) )
     => ( c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = c_Polynomial_Odegree(T_a,V_pa_2)
      <=> c_Fundamental__Theorem__Algebra__Mirabelle_Oconstant(T_a,T_a,c_Polynomial_Opoly(T_a,V_pa_2)) ) ) )).

fof(fact_poly__offset__poly,axiom,(
    ! [V_x,V_h,V_p,T_a] :
      ( hAPP(c_Polynomial_Opoly(T_a,V_p),c_Groups_Oplus__class_Oplus(T_a,V_h,V_x)) = hAPP(c_Polynomial_Opoly(T_a,c_Fundamental__Theorem__Algebra__Mirabelle_Ooffset__poly(T_a,V_p,V_h)),V_x)
     <= class_Rings_Ocomm__semiring__0(T_a) ) )).
...
fof(fact_smult__minus__left,axiom,(
    ! [V_p,V_a,T_a] :
      ( c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),c_Polynomial_Osmult(T_a,V_a,V_p)) = c_Polynomial_Osmult(T_a,c_Groups_Ouminus__class_Ouminus(T_a,V_a),V_p)
     <= class_Rings_Ocomm__ring(T_a) ) )).
...
fof(fact_power__one__over,axiom,(
    ! [V_n,V_a,T_a] :
      ( hAPP(hAPP(c_Power_Opower__class_Opower(T_a),c_Rings_Oinverse__class_Odivide(T_a,c_Groups_Oone__class_Oone(T_a),V_a)),V_n) = c_Rings_Oinverse__class_Odivide(T_a,c_Groups_Oone__class_Oone(T_a),hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_a),V_n))
     <= class_Fields_Ofield__inverse__zero(T_a) ) )).
...
fof(fact_poly__eq__iff,axiom,(
    ! [V_qa_2,V_pa_2,T_a] :
      ( ( class_Int_Oring__char__0(T_a)
        & class_Rings_Oidom(T_a) )
     => ( c_Polynomial_Opoly(T_a,V_qa_2) = c_Polynomial_Opoly(T_a,V_pa_2)
      <=> V_qa_2 = V_pa_2 ) ) )).
...
fof(fact_synthetic__div__correct,axiom,(
    ! [V_c,V_p,T_a] :
      ( class_Rings_Ocomm__semiring__0(T_a)
     => c_Polynomial_OpCons(T_a,hAPP(c_Polynomial_Opoly(T_a,V_p),V_c),c_Polynomial_Osynthetic__div(T_a,V_p,V_c)) = c_Groups_Oplus__class_Oplus(tc_Polynomial_Opoly(T_a),V_p,c_Polynomial_Osmult(T_a,V_c,c_Polynomial_Osynthetic__div(T_a,V_p,V_c))) ) )).
...
fof(fact_minus__divide__right,axiom,(
    ! [V_b,V_a,T_a] :
      ( class_Fields_Ofield__inverse__zero(T_a)
     => c_Rings_Oinverse__class_Odivide(T_a,V_a,c_Groups_Ouminus__class_Ouminus(T_a,V_b)) = c_Groups_Ouminus__class_Ouminus(T_a,c_Rings_Oinverse__class_Odivide(T_a,V_a,V_b)) ) )).
...
fof(fact_dvd__smult__iff,axiom,(
    ! [V_qa_2,V_pa_2,V_aa_2,T_a] :
      ( ( ( c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(T_a),V_pa_2,V_qa_2)
        <=> c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(T_a),V_pa_2,c_Polynomial_Osmult(T_a,V_aa_2,V_qa_2)) )
       <= c_Groups_Ozero__class_Ozero(T_a) != V_aa_2 )
     <= class_Fields_Ofield(T_a) ) )).
...
fof(fact_monom__0,axiom,(
    ! [V_a,T_a] :
      ( class_Groups_Ozero(T_a)
     => c_Polynomial_OpCons(T_a,V_a,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a))) = c_Polynomial_Omonom(T_a,V_a,c_Groups_Ozero__class_Ozero(tc_Nat_Onat)) ) )).
...
fof(fact_poly__rec__0,axiom,(
    ! [T_a,V_z_2,V_f_2,T_b] :
      ( class_Groups_Ozero(T_b)
     => ( V_z_2 = c_Polynomial_Opoly__rec(T_a,T_b,V_z_2,V_f_2,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_b)))
       <= hAPP(hAPP(hAPP(V_f_2,c_Groups_Ozero__class_Ozero(T_b)),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_b))),V_z_2) = V_z_2 ) ) )).
...
fof(fact_add__right__cancel,axiom,(
    ! [V_c_2,V_aa_2,V_b_2,T_a] :
      ( class_Groups_Ocancel__semigroup__add(T_a)
     => ( V_b_2 = V_c_2
      <=> c_Groups_Oplus__class_Oplus(T_a,V_c_2,V_aa_2) = c_Groups_Oplus__class_Oplus(T_a,V_b_2,V_aa_2) ) ) )).
    ...
    ! [V_r_2,V_qa_2,V_y_2,V_x_2,T_a] :
      ...
      <=> ( ( ( c_Orderings_Oord__class_Oless(tc_Nat_Onat,c_Polynomial_Odegree(T_a,V_r_2),c_Polynomial_Odegree(T_a,V_y_2))
          ...
          & ( c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) = V_qa_2
           <= V_y_2 = c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) )
          & c_Groups_Oplus__class_Oplus(tc_Polynomial_Opoly(T_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Polynomial_Opoly(T_a)),V_qa_2),V_y_2),V_r_2) = V_x_2 ) )
     <= class_Fields_Ofield(T_a) ) )).
...
fof(fact_mpoly__base__conv_I3_J,axiom,(
    ! [V_x] : V_x = hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Polynomial_OpCons(tc_Complex_Ocomplex,c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex),c_Polynomial_OpCons(tc_Complex_Ocomplex,c_Groups_Oone__class_Oone(tc_Complex_Ocomplex),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex))))),V_x) )).
...
fof(fact_smult__add__left,axiom,(
    ! [V_p,V_b,V_a,T_a] :
      ( c_Groups_Oplus__class_Oplus(tc_Polynomial_Opoly(T_a),c_Polynomial_Osmult(T_a,V_a,V_p),c_Polynomial_Osmult(T_a,V_b,V_p)) = c_Polynomial_Osmult(T_a,c_Groups_Oplus__class_Oplus(T_a,V_a,V_b),V_p)
     <= class_Rings_Ocomm__semiring__0(T_a) ) )).
...
fof(fact_divide__le__0__iff,axiom,(
    ! [V_b_2,V_aa_2,T_a] :
      ( ( c_Orderings_Oord__class_Oless__eq(T_a,c_Rings_Oinverse__class_Odivide(T_a,V_aa_2,V_b_2),c_Groups_Ozero__class_Ozero(T_a))
      <=> ( ( c_Orderings_Oord__class_Oless__eq(T_a,c_Groups_Ozero__class_Ozero(T_a),V_aa_2)
            & c_Orderings_Oord__class_Oless__eq(T_a,V_b_2,c_Groups_Ozero__class_Ozero(T_a)) )
          | ( c_Orderings_Oord__class_Oless__eq(T_a,c_Groups_Ozero__class_Ozero(T_a),V_b_2)
            & c_Orderings_Oord__class_Oless__eq(T_a,V_aa_2,c_Groups_Ozero__class_Ozero(T_a)) ) ) )
...
fof(fact_neg__divide__le__eq,axiom,(
    ! [V_aa_2,V_b_2,V_c_2,T_a] :
      ( ( ( c_Orderings_Oord__class_Oless__eq(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2),V_b_2)
        <=> c_Orderings_Oord__class_Oless__eq(T_a,c_Rings_Oinverse__class_Odivide(T_a,V_b_2,V_c_2),V_aa_2) )
       <= c_Orderings_Oord__class_Oless(T_a,V_c_2,c_Groups_Ozero__class_Ozero(T_a)) )
     <= class_Fields_Olinordered__field(T_a) ) )).
...
fof(fact_pow__divides__eq__int,axiom,(
    ! [V_b_2,V_aa_2,V_n_2] :
      ( ( c_Rings_Odvd__class_Odvd(tc_Int_Oint,V_aa_2,V_b_2)
      <=> c_Rings_Odvd__class_Odvd(tc_Int_Oint,hAPP(hAPP(c_Power_Opower__class_Opower(tc_Int_Oint),V_aa_2),V_n_2),hAPP(hAPP(c_Power_Opower__class_Opower(tc_Int_Oint),V_b_2),V_n_2)) )
     <= V_n_2 != c_Groups_Ozero__class_Ozero(tc_Nat_Onat) ) )).
...
fof(fact_mpoly__norm__conv_I2_J,axiom,(
    ! [V_x,V_y] : hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex))),V_x) = hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Polynomial_OpCons(tc_Complex_Ocomplex,hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex))),V_y),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex)))),V_x) )).
...
fof(fact_psize__def,axiom,(
    ! [V_p,T_a] :
      ( class_Groups_Ozero(T_a)
     => ( ( c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = c_Fundamental__Theorem__Algebra__Mirabelle_Opsize(T_a,V_p)
         <= c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) = V_p )
...
fof(fact_poly__cancel__eq__conv,axiom,(
    ! [V_b_2,V_qa_2,V_aa_2,V_pa_2] :
      ( V_pa_2 = c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex)
     => ( V_aa_2 != c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex)
       => ( V_qa_2 = c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex)
        <=> c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex) = c_Groups_Ominus__class_Ominus(tc_Complex_Ocomplex,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Complex_Ocomplex),V_aa_2),V_qa_2),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Complex_Ocomplex),V_b_2),V_pa_2)) ) ) ) )).
...
fof(fact_pCons__eq__iff,axiom,(
    ! [V_qa_2,V_b_2,V_pa_2,V_aa_2,T_a] :
      ( ( c_Polynomial_OpCons(T_a,V_b_2,V_qa_2) = c_Polynomial_OpCons(T_a,V_aa_2,V_pa_2)
      <=> ( V_aa_2 = V_b_2
          & V_pa_2 = V_qa_2 ) )
     <= class_Groups_Ozero(T_a) ) )).
...
fof(fact_crossproduct__noteq,axiom,(
    ! [V_d_2,V_c_2,V_b_2,V_aa_2,T_a] :
      ( class_Semiring__Normalization_Ocomm__semiring__1__cancel__crossproduct(T_a)
     => ( c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_d_2),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b_2),V_c_2)) != c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b_2),V_d_2))
      <=> ( V_d_2 != V_c_2
          & V_aa_2 != V_b_2 ) ) ) )).
...
fof(fact_poly__replicate__append,axiom,(
    ! [V_x,V_p,V_n,T_a] :
      ( hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_x),V_n)),hAPP(c_Polynomial_Opoly(T_a,V_p),V_x)) = hAPP(c_Polynomial_Opoly(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Polynomial_Opoly(T_a)),c_Polynomial_Omonom(T_a,c_Groups_Oone__class_Oone(T_a),V_n)),V_p)),V_x)
     <= class_Rings_Ocomm__ring__1(T_a) ) )).
...
fof(fact_nullstellensatz__lemma,axiom,(
    ! [V_n,V_q,V_p] :
      ( ( ( V_n != c_Groups_Ozero__class_Ozero(tc_Nat_Onat)
         => c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(tc_Complex_Ocomplex),V_p,hAPP(hAPP(c_Power_Opower__class_Opower(tc_Polynomial_Opoly(tc_Complex_Ocomplex)),V_q),V_n)) )
       <= c_Polynomial_Odegree(tc_Complex_Ocomplex,V_p) = V_n )
     <= ! [B_x] :
...
fof(fact_mpoly__norm__conv_I1_J,axiom,(
    ! [V_x] : hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Polynomial_OpCons(tc_Complex_Ocomplex,c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex)))),V_x) = hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex))),V_x) )).
...
fof(fact_pos__poly__pCons,axiom,(
    ! [V_pa_2,V_aa_2,T_a] :
      ( class_Rings_Olinordered__idom(T_a)
     => ( c_Polynomial_Opos__poly(T_a,c_Polynomial_OpCons(T_a,V_aa_2,V_pa_2))
      <=> ( ( c_Orderings_Oord__class_Oless(T_a,c_Groups_Ozero__class_Ozero(T_a),V_aa_2)
            & V_pa_2 = c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) )
...
fof(fact_pow__divides__eq__nat,axiom,(
    ! [V_b_2,V_aa_2,V_n_2] :
      ( c_Groups_Ozero__class_Ozero(tc_Nat_Onat) != V_n_2
     => ( c_Rings_Odvd__class_Odvd(tc_Nat_Onat,hAPP(hAPP(c_Power_Opower__class_Opower(tc_Nat_Onat),V_aa_2),V_n_2),hAPP(hAPP(c_Power_Opower__class_Opower(tc_Nat_Onat),V_b_2),V_n_2))
      <=> c_Rings_Odvd__class_Odvd(tc_Nat_Onat,V_aa_2,V_b_2) ) ) )).
...
fof(fact_square__eq__iff,axiom,(
    ! [V_b_2,V_aa_2,T_a] :
      ( ( ( V_b_2 = V_aa_2
          | V_aa_2 = c_Groups_Ouminus__class_Ouminus(T_a,V_b_2) )
      <=> hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b_2),V_b_2) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_aa_2) )
     <= class_Rings_Oidom(T_a) ) )).
...
fof(fact_power_Opower_Opower__Suc,axiom,(
    ! [V_n_2,V_aa_2,V_times_2,V_one_2,T_a] : hAPP(hAPP(V_times_2,V_aa_2),hAPP(hAPP(c_Power_Opower_Opower(T_a,V_one_2,V_times_2),V_aa_2),V_n_2)) = hAPP(hAPP(c_Power_Opower_Opower(T_a,V_one_2,V_times_2),V_aa_2),c_Nat_OSuc(V_n_2)) )).
...
fof(fact_order__root,axiom,(
    ! [V_aa_2,V_pa_2,T_a] :
      ( ( ( c_Groups_Ozero__class_Ozero(tc_Nat_Onat) != c_Polynomial_Oorder(T_a,V_aa_2,V_pa_2)
          | V_pa_2 = c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) )
      <=> c_Groups_Ozero__class_Ozero(T_a) = hAPP(c_Polynomial_Opoly(T_a,V_pa_2),V_aa_2) )
     <= class_Rings_Oidom(T_a) ) )).
...
fof(fact_resolve__eq__raw_I2_J,axiom,(
    ! [V_x,V_c] : V_c = hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Polynomial_OpCons(tc_Complex_Ocomplex,V_c,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex)))),V_x) )).
...
fof(fact_nat_Oinject,axiom,(
    ! [V_nat_H_2,V_nat_2] :
      ( c_Nat_OSuc(V_nat_H_2) = c_Nat_OSuc(V_nat_2)
    <=> V_nat_2 = V_nat_H_2 ) )).
...
fof(fact_add__frac__eq,axiom,(
    ! [V_w,V_x,V_z,V_y,T_a] :
      ( ( V_y != c_Groups_Ozero__class_Ozero(T_a)
       => ( c_Rings_Oinverse__class_Odivide(T_a,c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_x),V_z),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_w),V_y)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_y),V_z)) = c_Groups_Oplus__class_Oplus(T_a,c_Rings_Oinverse__class_Odivide(T_a,V_x,V_y),c_Rings_Oinverse__class_Odivide(T_a,V_w,V_z))
         <= V_z != c_Groups_Ozero__class_Ozero(T_a) ) )
     <= class_Fields_Ofield(T_a) ) )).

fof(fact_zero__le__divide__iff,axiom,(
    ! [V_b_2,V_aa_2,T_a] :
      ( ( c_Orderings_Oord__class_Oless__eq(T_a,c_Groups_Ozero__class_Ozero(T_a),c_Rings_Oinverse__class_Odivide(T_a,V_aa_2,V_b_2))
      <=> ( ( c_Orderings_Oord__class_Oless__eq(T_a,c_Groups_Ozero__class_Ozero(T_a),V_b_2)
            & c_Orderings_Oord__class_Oless__eq(T_a,c_Groups_Ozero__class_Ozero(T_a),V_aa_2) )
          | ( c_Orderings_Oord__class_Oless__eq(T_a,V_b_2,c_Groups_Ozero__class_Ozero(T_a))
            & c_Orderings_Oord__class_Oless__eq(T_a,V_aa_2,c_Groups_Ozero__class_Ozero(T_a)) ) ) )
...
fof(fact_right__inverse__eq,axiom,(
    ! [V_aa_2,V_b_2,T_a] :
     ...
     => ( c_Groups_Ozero__class_Ozero(T_a) != V_b_2
       => ( V_aa_2 = V_b_2
        <=> c_Groups_Oone__class_Oone(T_a) = c_Rings_Oinverse__class_Odivide(T_a,V_aa_2,V_b_2) ) ) ) )).
...
fof(fact_divide__less__0__iff,axiom,(
    ! [V_b_2,V_aa_2,T_a] :
      ( ( ( ( c_Orderings_Oord__class_Oless(T_a,V_b_2,c_Groups_Ozero__class_Ozero(T_a))
          ...
          | ( c_Orderings_Oord__class_Oless(T_a,c_Groups_Ozero__class_Ozero(T_a),V_b_2)
            & c_Orderings_Oord__class_Oless(T_a,V_aa_2,c_Groups_Ozero__class_Ozero(T_a)) ) )
      <=> c_Orderings_Oord__class_Oless(T_a,c_Rings_Oinverse__class_Odivide(T_a,V_aa_2,V_b_2),c_Groups_Ozero__class_Ozero(T_a)) )
     <= class_Fields_Olinordered__field__inverse__zero(T_a) ) )).
...
fof(fact_poly__divides__pad__rule,axiom,(
    ! [V_q,V_p] :
...
fof(fact_mult_Oadd__left,axiom,(
    ! [V_b,V_a_H,V_a,T_a] :
      ( class_RealVector_Oreal__normed__algebra(T_a)
     => c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_b),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a_H),V_b)) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Groups_Oplus__class_Oplus(T_a,V_a,V_a_H)),V_b) ) )).
...
fof(fact_dvd__mult__cancel__right,axiom,(
    ! [V_b_2,V_c_2,V_aa_2,T_a] :
      ( ( c_Rings_Odvd__class_Odvd(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_aa_2),V_c_2),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b_2),V_c_2))
      <=> ( c_Rings_Odvd__class_Odvd(T_a,V_aa_2,V_b_2)
          | c_Groups_Ozero__class_Ozero(T_a) = V_c_2 ) )
     <= class_Rings_Oidom(T_a) ) )).
...
fof(fact_resolve__eq__raw_I1_J,axiom,(
    ! [V_x] : hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex))),V_x) = c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex) )).
...
fof(fact_eq__add__iff2,axiom,(
    ! [V_d_2,V_b_2,V_c_2,V_e_2,V_aa_2,T_a] :
      ( class_Rings_Oring(T_a)
     => ( c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Groups_Ominus__class_Ominus(T_a,V_b_2,V_aa_2)),V_e_2),V_d_2) = V_c_2
...
fof(fact_smult__dvd__iff,axiom,(
    ! [V_qa_2,V_pa_2,V_aa_2,T_a] :
      ( ( ( ( V_qa_2 = c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a))
          ...
          & ( V_aa_2 != c_Groups_Ozero__class_Ozero(T_a)
           => c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(T_a),V_pa_2,V_qa_2) ) )
      <=> c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(T_a),c_Polynomial_Osmult(T_a,V_aa_2,V_pa_2),V_qa_2) )
     <= class_Fields_Ofield(T_a) ) )).
...
fof(fact_poly__rec_Osimps,axiom,(
    ! [V_pa_2,V_aa_2,V_f_2,V_z_2,T_a,T_b] :
      ( hAPP(hAPP(hAPP(V_f_2,V_aa_2),V_pa_2),c_If(T_a,c_fequal(V_pa_2,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_b))),V_z_2,c_Polynomial_Opoly__rec(T_a,T_b,V_z_2,V_f_2,V_pa_2))) = c_Polynomial_Opoly__rec(T_a,T_b,V_z_2,V_f_2,c_Polynomial_OpCons(T_b,V_aa_2,V_pa_2))
     <= class_Groups_Ozero(T_b) ) )).
...
fof(fact_monom__eq__iff,axiom,(
    ! [V_b_2,V_n_2,V_aa_2,T_a] :
      ( class_Groups_Ozero(T_a)
     => ( c_Polynomial_Omonom(T_a,V_b_2,V_n_2) = c_Polynomial_Omonom(T_a,V_aa_2,V_n_2)
      <=> V_b_2 = V_aa_2 ) ) )).
...
fof(fact_dvd__mult__cancel__left,axiom,(
    ! [V_b_2,V_aa_2,V_c_2,T_a] :
      ( ( ( c_Rings_Odvd__class_Odvd(T_a,V_aa_2,V_b_2)
          | V_c_2 = c_Groups_Ozero__class_Ozero(T_a) )
      <=> c_Rings_Odvd__class_Odvd(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_c_2),V_aa_2),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_c_2),V_b_2)) )
     <= class_Rings_Oidom(T_a) ) )).
      ...
      ( ( c_Groups_Ozero__class_Ozero(T_a) != V_y_2
       => ( V_z_2 != c_Groups_Ozero__class_Ozero(T_a)
         => ( c_Rings_Oinverse__class_Odivide(T_a,V_x_2,V_y_2) = c_Rings_Oinverse__class_Odivide(T_a,V_w_2,V_z_2)
          <=> hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_x_2),V_z_2) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_w_2),V_y_2) ) ) )
     <= class_Fields_Ofield(T_a) ) )).
...
fof(fact_poly__eq__0__iff__dvd,axiom,(
    ! [V_c_2,V_pa_2,T_a] :
      ( ( c_Groups_Ozero__class_Ozero(T_a) = hAPP(c_Polynomial_Opoly(T_a,V_pa_2),V_c_2)
      <=> c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(T_a),c_Polynomial_OpCons(T_a,c_Groups_Ouminus__class_Ouminus(T_a,V_c_2),c_Polynomial_OpCons(T_a,c_Groups_Oone__class_Oone(T_a),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)))),V_pa_2) )
     <= class_Rings_Oidom(T_a) ) )).

fof(fact_degree__pCons__0,axiom,(
    ! [V_a,T_a] :
      ( c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = c_Polynomial_Odegree(T_a,c_Polynomial_OpCons(T_a,V_a,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a))))
     <= class_Groups_Ozero(T_a) ) )).
...
fof(fact_nullstellensatz__univariate,axiom,(
    ! [V_qa_2,V_pa_2] :
      ( ! [B_x] :
          ( hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,V_qa_2),B_x) = c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex)
         <= c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex) = hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,V_pa_2),B_x) )
    <=> ( ( c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex)) = V_qa_2
          & c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex)) = V_pa_2 )
        | c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(tc_Complex_Ocomplex),V_pa_2,hAPP(hAPP(c_Power_Opower__class_Opower(tc_Polynomial_Opoly(tc_Complex_Ocomplex)),V_qa_2),c_Polynomial_Odegree(tc_Complex_Ocomplex,V_pa_2))) ) ) )).
...
fof(fact_divides__degree,axiom,(
    ! [V_q,V_p] :
      ( c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(tc_Complex_Ocomplex),V_p,V_q)
     => ( V_q = c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex))
        | c_Orderings_Oord__class_Oless__eq(tc_Nat_Onat,c_Polynomial_Odegree(tc_Complex_Ocomplex,V_p),c_Polynomial_Odegree(tc_Complex_Ocomplex,V_q)) ) ) )).
...
fof(fact_mult__pCons__left,axiom,(
    ! [V_q,V_p,V_a,T_a] :
      ( class_Rings_Ocomm__semiring__0(T_a)
     => c_Groups_Oplus__class_Oplus(tc_Polynomial_Opoly(T_a),c_Polynomial_Osmult(T_a,V_a,V_q),c_Polynomial_OpCons(T_a,c_Groups_Ozero__class_Ozero(T_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Polynomial_Opoly(T_a)),V_p),V_q))) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Polynomial_Opoly(T_a)),c_Polynomial_OpCons(T_a,V_a,V_p)),V_q) ) )).
...
fof(fact_mpoly__base__conv_I2_J,axiom,(
    ! [V_x,V_c] : hAPP(c_Polynomial_Opoly(tc_Complex_Ocomplex,c_Polynomial_OpCons(tc_Complex_Ocomplex,V_c,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex)))),V_x) = V_c )).
...
fof(fact_diff__monom,axiom,(
    ! [V_b,V_n,V_a,T_a] :
      ( c_Polynomial_Omonom(T_a,c_Groups_Ominus__class_Ominus(T_a,V_a,V_b),V_n) = c_Groups_Ominus__class_Ominus(tc_Polynomial_Opoly(T_a),c_Polynomial_Omonom(T_a,V_a,V_n),c_Polynomial_Omonom(T_a,V_b,V_n))
     <= class_Groups_Oab__group__add(T_a) ) )).
...
fof(fact_smult__eq__0__iff,axiom,(
    ! [V_pa_2,V_aa_2,T_a] :
      ( ( ( V_aa_2 = c_Groups_Ozero__class_Ozero(T_a)
          | V_pa_2 = c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) )
      <=> c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) = c_Polynomial_Osmult(T_a,V_aa_2,V_pa_2) )
     <= class_Rings_Oidom(T_a) ) )).
...
fof(fact_monom__eq__0,axiom,(
    ! [V_n,T_a] :
      ( c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) = c_Polynomial_Omonom(T_a,c_Groups_Ozero__class_Ozero(T_a),V_n)
     <= class_Groups_Ozero(T_a) ) )).
