...
fof(t7_filter_2,axiom,(
    ! [A] :
      ( g3_lattices(u1_struct_0(A),u2_lattices(A),u1_lattices(A)) = k1_lattice2(k1_lattice2(A))
     <= ( l3_lattices(A)
        & v10_lattices(A)
        & ~ v3_struct_0(A) ) ) )).
      ...
      ( ! [B] :
         ...
         => ! [C] :
              ( ( ~ v1_xboole_0(C)
                & m1_subset_1(C,k1_zfmisc_1(u1_struct_0(A))) )
             => ! [D] :
                  ( ( ( k19_filter_2(B,D) = k19_filter_2(A,C)
                      & k3_filter_2(B,D) = k3_filter_2(A,C) )
          ...
          ( ! [C] :
              ( ! [D] :
                 ...
                 => ! [E] :
                     ...
                     => ( k4_lattices(k1_lattice2(A),k5_filter_2(A,B),k5_filter_2(A,C)) = k3_lattices(A,B,C)
                    ...
                    ( ! [E] :
                        ( ! [F] :
                            ( ( ( ( r1_lattices(B,E,F)
                                ...
                                & ( r1_lattices(B,E,F)
                                 => r1_lattices(A,C,D) )
                                & k2_lattices(B,E,F) = k2_lattices(A,C,D)
...
fof(t55_filter_2,axiom,(
    ! [A] :
      ( ! [B] :
          ( m1_subset_1(B,u1_struct_0(A))
         => ! [C] :
              ( ( k7_lattices(k1_lattice2(A),C) = k7_lattices(A,k6_filter_2(A,C))
                & k7_lattices(k1_lattice2(A),k5_filter_2(A,B)) = k7_lattices(A,B) )
...
fof(d14_filter_2,axiom,(
    ! [A] :
      ( ! [B] :
          ( ! [C] :
              ( m1_subset_1(C,u1_struct_0(A))
             => ( a_3_2_filter_2(A,B,C) = k22_filter_2(A,B,C)
               <= r3_lattices(A,B,C) ) )
         <= m1_subset_1(B,u1_struct_0(A)) )
     <= ( l3_lattices(A)
        & v10_lattices(A)
...
fof(t30_filter_2,axiom,(
    ! [A] :
      ( ! [B] :
          ( m1_subset_1(B,u1_struct_0(A))
         => ( k2_filter_2(A,B) = k18_filter_2(k1_lattice2(A),k5_filter_2(A,B))
            & k2_filter_2(k1_lattice2(A),k5_filter_2(A,B)) = k18_filter_2(A,B) ) )
     <= ( v10_lattices(A)
        & l3_lattices(A)
        & ~ v3_struct_0(A) ) ) )).
...
fof(redefinition_k9_filter_2,axiom,(
    ! [A,B] :
      ( ( ~ v3_struct_0(A)
        ...
        & m2_lattice4(B,A)
        & l3_lattices(A) )
     => k7_filter_2(A,B) = k9_filter_2(A,B) ) )).
              ...
              ( ! [D] :
                  ( ! [E] :
                      ( ! [F] :
                         ...
                         => ( k5_filter_0(B,E,F) = k5_filter_0(A,C,D)
                           <= ( D = F
                              & E = C
                              & g3_lattices(u1_struct_0(B),u2_lattices(B),u1_lattices(B)) = g3_lattices(u1_struct_0(A),u2_lattices(A),u1_lattices(A)) ) ) )
...
fof(redefinition_k10_filter_2,axiom,(
    ! [A,B] :
      ( ( v10_lattices(A)
        ...
        & ~ v1_xboole_0(B)
        & ~ v3_struct_0(A) )
     => k7_filter_2(A,B) = k10_filter_2(A,B) ) )).
      ...
      ( ! [B] :
          ( ! [C] :
             ...
             => ( k3_filter_2(k1_lattice2(A),k7_filter_2(A,B)) = k19_filter_2(A,B)
                & k19_filter_2(k1_lattice2(A),C) = k3_filter_2(A,k8_filter_2(A,C))
                & k3_filter_2(k1_lattice2(A),C) = k19_filter_2(A,k8_filter_2(A,C))
                & k19_filter_2(k1_lattice2(A),k7_filter_2(A,B)) = k3_filter_2(A,B) ) )
         <= ( m1_subset_1(B,k1_zfmisc_1(u1_struct_0(A)))
            & ~ v1_xboole_0(B) ) )
     <= ( v10_lattices(A)
        & l3_lattices(A)
    ...
    ! [A] :
      ( ! [B] :
         ...
         => ! [C] :
              ( ! [D] :
                  ( ! [E] :
                      ( ( k5_filter_0(k1_lattice2(A),k7_filter_2(A,B),k7_filter_2(A,C)) = k20_filter_2(A,B,C)
                        & k20_filter_2(k1_lattice2(A),k7_filter_2(A,B),k7_filter_2(A,C)) = k5_filter_0(A,B,C)
                        & k5_filter_0(A,k8_filter_2(A,D),k8_filter_2(A,E)) = k20_filter_2(k1_lattice2(A),D,E)
    ...
    ! [A] :
      ( ! [B] :
         ...
         => ( ! [C] :
                ( ! [D] :
                    ( ( C = D
                     => k7_lattices(B,D) = k7_lattices(A,C) )
...
fof(redefinition_k21_filter_2,axiom,(
    ! [A,B,C] :
      ( k20_filter_2(A,B,C) = k21_filter_2(A,B,C)
     <= ( ~ v3_struct_0(A)
        & v10_lattices(A)
        & v11_lattices(A)
        & l3_lattices(A)
...
fof(t18_filter_2,axiom,(
    ! [A] :
      ( ! [B] :
          ( ! [C] :
              ( ( C = k5_filter_2(A,k6_filter_2(A,C))
                & B = k6_filter_2(A,k5_filter_2(A,B)) )
             <= m1_subset_1(C,u1_struct_0(k1_lattice2(A))) )
         <= m1_subset_1(B,u1_struct_0(A)) )
     <= ( v10_lattices(A)
        & l3_lattices(A)
...
fof(t42_filter_2,axiom,(
    ! [A] :
      ( ( v10_lattices(A)
        ...
        & ~ v3_struct_0(A) )
     => ! [B] :
          ( ( ( u1_struct_0(A) = k19_filter_2(A,B)
    ...
    ! [A] :
      ( ! [B] :
          ( ( m1_subset_1(B,k1_zfmisc_1(u1_struct_0(A)))
            & ~ v1_xboole_0(B) )
         => ! [C] :
              ( a_3_0_filter_2(A,B,C) = k20_filter_2(A,B,C)
             <= ( m1_subset_1(C,k1_zfmisc_1(u1_struct_0(A)))
                & ~ v1_xboole_0(C) ) ) )
     <= ( l3_lattices(A)
        & v10_lattices(A)
