...
fof(fact_16_triple_Orecs,axiom,(
    ! [X_c,X_b,F1,Fun1_1,Com_1,Fun2_1] : hAPP(fun(X_c,fun(state,bool)),X_b,hAPP(com,fun(fun(X_c,fun(state,bool)),X_b),hAPP(fun(X_c,fun(state,bool)),fun(com,fun(fun(X_c,fun(state,bool)),X_b)),F1,Fun1_1),Com_1),Fun2_1) = hAPP(hoare_509422987triple(X_c),X_b,hAPP(fun(fun(X_c,fun(state,bool)),fun(com,fun(fun(X_c,fun(state,bool)),X_b))),fun(hoare_509422987triple(X_c),X_b),hoare_728318379le_rec(X_c,X_b),F1),hAPP(fun(X_c,fun(state,bool)),hoare_509422987triple(X_c),hAPP(com,fun(fun(X_c,fun(state,bool)),hoare_509422987triple(X_c)),hAPP(fun(X_c,fun(state,bool)),fun(com,fun(fun(X_c,fun(state,bool)),hoare_509422987triple(X_c))),hoare_1008221573triple(X_c),Fun1_1),Com_1),Fun2_1)) )).
...
fof(fact_97_finite__ne__induct,axiom,(
    ! [X_b,Pa,F] :
      ( hBOOL(hAPP(fun(X_b,bool),bool,finite_finite_1(X_b),F))
     => ( bot_bot(fun(X_b,bool)) != ti(fun(X_b,bool),F)
       => ( ! [X_2] : hBOOL(hAPP(fun(X_b,bool),bool,Pa,hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_2),bot_bot(fun(X_b,bool)))))
         => ( ! [X_2,F_2] :
                ( ( bot_bot(fun(X_b,bool)) != ti(fun(X_b,bool),F_2)
                 => ( ~ hBOOL(hAPP(fun(X_b,bool),bool,hAPP(X_b,fun(fun(X_b,bool),bool),member(X_b),X_2),F_2))
                   => ( hBOOL(hAPP(fun(X_b,bool),bool,Pa,hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_2),F_2)))
                     <= hBOOL(hAPP(fun(X_b,bool),bool,Pa,F_2)) ) ) )
               <= hBOOL(hAPP(fun(X_b,bool),bool,finite_finite_1(X_b),F_2)) )
...
fof(tsy_c_Hoare__Mirabelle__pjuwniqynr_Otriple_Otriple_res,axiom,(
    ! [X_b] : hoare_1008221573triple(X_b) = ti(fun(fun(X_b,fun(state,bool)),fun(com,fun(fun(X_b,fun(state,bool)),hoare_509422987triple(X_b)))),hoare_1008221573triple(X_b)) )).
...
fof(fact_32_insert__compr,axiom,(
    ! [X_b,A_4,B_1] : hAPP(fun(X_b,bool),fun(X_b,bool),collect(X_b),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,fun(bool,bool)),fun(fun(X_b,bool),fun(X_b,bool)),combs(X_b,bool,bool),hAPP(fun(X_b,bool),fun(X_b,fun(bool,bool)),hAPP(fun(bool,fun(bool,bool)),fun(fun(X_b,bool),fun(X_b,fun(bool,bool))),combb(bool,fun(bool,bool),X_b),fdisj),hAPP(X_b,fun(X_b,bool),hAPP(fun(X_b,fun(X_b,bool)),fun(X_b,fun(X_b,bool)),combc(X_b,X_b,bool),fequal(X_b)),A_4))),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,fun(fun(X_b,bool),bool)),fun(fun(X_b,bool),fun(X_b,bool)),combc(X_b,fun(X_b,bool),bool),member(X_b)),B_1))) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),A_4),B_1) )).
...
fof(tsy_c_Hoare__Mirabelle__pjuwniqynr_Otriple_Otriple__case_res,axiom,(
    ! [X_c,X_b] : hoare_885240885e_case(X_c,X_b) = ti(fun(fun(fun(X_c,fun(state,bool)),fun(com,fun(fun(X_c,fun(state,bool)),X_b))),fun(hoare_509422987triple(X_c),X_b)),hoare_885240885e_case(X_c,X_b)) )).
...
fof(tsy_c_hAPP_arg2,axiom,(
    ! [X_a,X_c,B_1_1,B_2] : hAPP(X_a,X_c,B_1_1,B_2) = hAPP(X_a,X_c,B_1_1,ti(X_a,B_2)) )).
...
fof(tsy_c_Finite__Set_Ofold__graph_res,axiom,(
    ! [X_b,X_c] : finite_fold_graph(X_b,X_c) = ti(fun(fun(X_b,fun(X_c,X_c)),fun(X_c,fun(fun(X_b,bool),fun(X_c,bool)))),finite_fold_graph(X_b,X_c)) )).
...
fof(fact_31_insert__Collect,axiom,(
    ! [X_b,A_4,Pa] : hAPP(fun(X_b,bool),fun(X_b,bool),collect(X_b),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,fun(bool,bool)),fun(fun(X_b,bool),fun(X_b,bool)),combs(X_b,bool,bool),hAPP(fun(X_b,bool),fun(X_b,fun(bool,bool)),hAPP(fun(bool,fun(bool,bool)),fun(fun(X_b,bool),fun(X_b,fun(bool,bool))),combb(bool,fun(bool,bool),X_b),fimplies),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(bool,bool),fun(fun(X_b,bool),fun(X_b,bool)),combb(bool,bool,X_b),fNot),hAPP(X_b,fun(X_b,bool),hAPP(fun(X_b,fun(X_b,bool)),fun(X_b,fun(X_b,bool)),combc(X_b,X_b,bool),fequal(X_b)),A_4)))),Pa)) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),A_4),hAPP(fun(X_b,bool),fun(X_b,bool),collect(X_b),Pa)) )).
...
fof(tsy_v_G_res,hypothesis,(
    g = ti(fun(hoare_509422987triple(x_a),bool),g) )).
...
fof(fact_35_singleton__inject,axiom,(
    ! [X_b,A_4,Ba] :
      ( hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),Ba),bot_bot(fun(X_b,bool))) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),A_4),bot_bot(fun(X_b,bool)))
     => ti(X_b,Ba) = ti(X_b,A_4) ) )).
...
fof(fact_63_nonempty__iff,axiom,(
    ! [X_b,A_1] :
      ( ? [X_2,B] :
          ( hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_2),B) = ti(fun(X_b,bool),A_1)
...
fof(fact_52_mk__disjoint__insert,axiom,(
    ! [X_b,A_4,A_1] :
      ( ? [B] :
          ( hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),A_4),B) = ti(fun(X_b,bool),A_1)
