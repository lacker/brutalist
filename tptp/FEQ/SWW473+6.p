...
fof(fact_118_singleton__inject,axiom,(
    ! [X_b,A_2,B] :
      ( ti(X_b,A_2) = ti(X_b,B)
     <= hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),B),bot_bot(fun(X_b,bool))) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),A_2),bot_bot(fun(X_b,bool))) ) )).
...
fof(fact_134_image__constant__conv,axiom,(
    ! [X_c,X_b,C_1,A_3] :
      ...
      & ( bot_bot(fun(X_c,bool)) = hAPP(fun(X_b,bool),fun(X_c,bool),hAPP(fun(X_b,X_c),fun(fun(X_b,bool),fun(X_c,bool)),image(X_b,X_c),hAPP(X_c,fun(X_b,X_c),combk(X_c,X_b),C_1)),A_3)
       <= bot_bot(fun(X_b,bool)) = ti(fun(X_b,bool),A_3) ) ) )).
...
fof(fact_480_right__minus__eq,axiom,(
    ! [X_b] :
      ( ! [A_2,B] :
          ( ti(X_b,B) = ti(X_b,A_2)
        <=> zero_zero(X_b) = hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),minus_minus(X_b),A_2),B) )
     <= group_add(X_b) ) )).
...
fof(fact_66_insert__absorb,axiom,(
    ! [X_b,A_2,A_3] :
     ...
     => ti(fun(X_b,bool),A_3) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),A_2),A_3) ) )).
...
fof(fact_83_image__image,axiom,(
    ! [X_c,X_b,X_d,F,G,A_3] : hAPP(fun(X_d,bool),fun(X_b,bool),hAPP(fun(X_d,X_b),fun(fun(X_d,bool),fun(X_b,bool)),image(X_d,X_b),hAPP(fun(X_d,X_c),fun(X_d,X_b),hAPP(fun(X_c,X_b),fun(fun(X_d,X_c),fun(X_d,X_b)),combb(X_c,X_b,X_d),F),G)),A_3) = hAPP(fun(X_c,bool),fun(X_b,bool),hAPP(fun(X_c,X_b),fun(fun(X_c,bool),fun(X_b,bool)),image(X_c,X_b),F),hAPP(fun(X_d,bool),fun(X_c,bool),hAPP(fun(X_d,X_c),fun(fun(X_d,bool),fun(X_c,bool)),image(X_d,X_c),G),A_3)) )).
...
fof(tsy_c_Groups_Oone__class_Oone_res,axiom,(
    ! [X_b] :
      ( one(X_b)
     => one_one(X_b) = ti(X_b,one_one(X_b)) ) )).
...
fof(fact_429_lessE,axiom,(
    ! [I,K] :
      ( ( hAPP(nat,nat,suc,I) != K
       => ~ ! [J] :
              ( hAPP(nat,nat,suc,J) != K
...
fof(fact_412_psubset__eq,axiom,(
    ! [X_b,A_3,B_2] :
      ( ( ti(fun(X_b,bool),B_2) != ti(fun(X_b,bool),A_3)
        & hBOOL(hAPP(fun(X_b,bool),bool,hAPP(fun(X_b,bool),fun(fun(X_b,bool),bool),ord_less_eq(fun(X_b,bool)),A_3),B_2)) )
    <=> hBOOL(hAPP(fun(X_b,bool),bool,hAPP(fun(X_b,bool),fun(fun(X_b,bool),bool),ord_less(fun(X_b,bool)),A_3),B_2)) ) )).
...
fof(fact_211_folding__image__simple_Oneutral,axiom,(
    ! [X_c,X_b,A_3,F,Z_1,G,F_2] :
     ...
     => ( ( ti(X_b,Z_1) = hAPP(fun(X_c,bool),X_b,F_2,A_3)
         <= ! [X_2] :
              ( ti(X_b,Z_1) = hAPP(X_c,X_b,G,X_2)
             <= hBOOL(hAPP(fun(X_c,bool),bool,hAPP(X_c,fun(fun(X_c,bool),bool),member(X_c),X_2),A_3)) ) )
       <= hBOOL(hAPP(fun(X_c,bool),bool,finite_finite(X_c),A_3)) ) ) )).

fof(fact_165_Diff__cancel,axiom,(
    ! [X_b,A_3] : bot_bot(fun(X_b,bool)) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,bool),fun(fun(X_b,bool),fun(X_b,bool)),minus_minus(fun(X_b,bool)),A_3),A_3) )).
...
fof(fact_276_le__add__diff__inverse,axiom,(
    ! [N,M] :
     ...
     => M = hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),N),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),N)) ) )).

fof(fact_212_fun__diff__def,axiom,(
    ! [X_b,X_c] :
      ( minus(X_c)
     => ! [A_3,B_2,X_2] : hAPP(X_c,X_c,hAPP(X_c,fun(X_c,X_c),minus_minus(X_c),hAPP(X_b,X_c,A_3,X_2)),hAPP(X_b,X_c,B_2,X_2)) = hAPP(X_b,X_c,hAPP(fun(X_b,X_c),fun(X_b,X_c),hAPP(fun(X_b,X_c),fun(fun(X_b,X_c),fun(X_b,X_c)),minus_minus(fun(X_b,X_c)),A_3),B_2),X_2) ) )).
...
fof(fact_8_card__insert__if,axiom,(
    ! [X_b,X_1,A_3] :
     ...
     => ( ( hAPP(fun(X_b,bool),nat,finite_card(X_b),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_1),A_3)) = hAPP(nat,nat,suc,hAPP(fun(X_b,bool),nat,finite_card(X_b),A_3))
         <= ~ hBOOL(hAPP(fun(X_b,bool),bool,hAPP(X_b,fun(fun(X_b,bool),bool),member(X_b),X_1),A_3)) )
        & ( hAPP(fun(X_b,bool),nat,finite_card(X_b),A_3) = hAPP(fun(X_b,bool),nat,finite_card(X_b),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_1),A_3))
         <= hBOOL(hAPP(fun(X_b,bool),bool,hAPP(X_b,fun(fun(X_b,bool),bool),member(X_b),X_1),A_3)) ) ) ) )).
...
fof(fact_251_diff__add__inverse,axiom,(
    ! [N,M] : M = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),N),M)),N) )).
...
fof(tsy_c_Finite__Set_Ocard_res,axiom,(
    ! [X_c] : finite_card(X_c) = ti(fun(fun(X_c,bool),nat),finite_card(X_c)) )).
...
fof(fact_64_insert__ident,axiom,(
    ! [X_b,B_2,X_1,A_3] :
      ( ( ~ hBOOL(hAPP(fun(X_b,bool),bool,hAPP(X_b,fun(fun(X_b,bool),bool),member(X_b),X_1),B_2))
       => ( hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_1),B_2) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_1),A_3)
        <=> ti(fun(X_b,bool),B_2) = ti(fun(X_b,bool),A_3) ) )
     <= ~ hBOOL(hAPP(fun(X_b,bool),bool,hAPP(X_b,fun(fun(X_b,bool),bool),member(X_b),X_1),A_3)) ) )).
...
fof(fact_283_diff__Suc__diff__eq2,axiom,(
    ! [M,K,J_2] :
      ( hBOOL(hAPP(nat,bool,hAPP(nat,fun(nat,bool),ord_less_eq(nat),K),J_2))
     => hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,suc,J_2)),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),K),M)) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,suc,hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),J_2),K))),M) ) )).
...
fof(fact_473_diffs0__imp__equal,axiom,(
    ! [M,N] :
      ( ( zero_zero(nat) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),N),M)
       => N = M )
...
fof(fact_451_card_Oempty,axiom,(
    ! [X_b] : zero_zero(nat) = hAPP(fun(X_b,bool),nat,finite_card(X_b),bot_bot(fun(X_b,bool))) )).
...
fof(fact_246_add__left__imp__eq,axiom,(
    ! [X_a] :
      ( ! [A_1,B_1,C] :
          ( hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),plus_plus(X_a),A_1),C) = hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),plus_plus(X_a),A_1),B_1)
         => ti(X_a,B_1) = ti(X_a,C) )
     <= cancel_semigroup_add(X_a) ) )).
...
fof(fact_284_diff__Suc__diff__eq1,axiom,(
    ! [M,K,J_2] :
      ( hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),M),K)),hAPP(nat,nat,suc,J_2)) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),hAPP(nat,nat,suc,hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),J_2),K)))
     <= hBOOL(hAPP(nat,bool,hAPP(nat,fun(nat,bool),ord_less_eq(nat),K),J_2)) ) )).
...
fof(fact_42_diff__diff__cancel,axiom,(
    ! [I,N] :
      ( I = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),N),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),N),I))
...
fof(fact_37_Suc__diff__diff,axiom,(
    ! [M,N,K] : hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),N)),K) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,suc,M)),N)),hAPP(nat,nat,suc,K)) )).

fof(fact_174_folding__one_Oremove,axiom,(
    ! [X_b,X_1,A_3,F,F_2] :
      ( hBOOL(hAPP(fun(fun(X_b,bool),X_b),bool,hAPP(fun(X_b,fun(X_b,X_b)),fun(fun(fun(X_b,bool),X_b),bool),finite_folding_one(X_b),F),F_2))
     => ( ( hBOOL(hAPP(fun(X_b,bool),bool,hAPP(X_b,fun(fun(X_b,bool),bool),member(X_b),X_1),A_3))
         => ( ( hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),F,X_1),hAPP(fun(X_b,bool),X_b,F_2,hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,bool),fun(fun(X_b,bool),fun(X_b,bool)),minus_minus(fun(X_b,bool)),A_3),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_1),bot_bot(fun(X_b,bool)))))) = hAPP(fun(X_b,bool),X_b,F_2,A_3)
            ...
            & ( hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,bool),fun(fun(X_b,bool),fun(X_b,bool)),minus_minus(fun(X_b,bool)),A_3),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_1),bot_bot(fun(X_b,bool)))) = bot_bot(fun(X_b,bool))
             => ti(X_b,X_1) = hAPP(fun(X_b,bool),X_b,F_2,A_3) ) ) )
       <= hBOOL(hAPP(fun(X_b,bool),bool,finite_finite(X_b),A_3)) ) ) )).
...
fof(tsy_c_Groups_Ozero__class_Ozero_res,axiom,(
    ! [X_b] :
      ( zero(X_b)
     => zero_zero(X_b) = ti(X_b,zero_zero(X_b)) ) )).

fof(fact_242_nat__add__left__commute,axiom,(
    ! [X,Y,Z] : hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),Y),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),X),Z)) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),X),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),Y),Z)) )).
...
fof(fact_272_le__imp__diff__is__add,axiom,(
    ! [K_2,I_1,J_1] :
      ...
      <=> K_2 = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),J_1),I_1) )
...
fof(fact_158_folding__one__idem_Osubset__idem,axiom,(
    ! [X_b,B_2,A_3,F,F_2] :
     ...
     => ( ( ( hBOOL(hAPP(fun(X_b,bool),bool,hAPP(fun(X_b,bool),fun(fun(X_b,bool),bool),ord_less_eq(fun(X_b,bool)),B_2),A_3))
           => hAPP(fun(X_b,bool),X_b,F_2,A_3) = hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),F,hAPP(fun(X_b,bool),X_b,F_2,B_2)),hAPP(fun(X_b,bool),X_b,F_2,A_3)) )
...
fof(fact_126_image__empty,axiom,(
    ! [X_c,X_b,F] : bot_bot(fun(X_b,bool)) = hAPP(fun(X_c,bool),fun(X_b,bool),hAPP(fun(X_c,X_b),fun(fun(X_c,bool),fun(X_b,bool)),image(X_c,X_b),F),bot_bot(fun(X_c,bool))) )).
...
fof(fact_267_add__diff__cancel,axiom,(
    ! [X_a] :
      ( ! [A_1,B_1] : ti(X_a,A_1) = hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),minus_minus(X_a),hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),plus_plus(X_a),A_1),B_1)),B_1)
     <= group_add(X_a) ) )).

fof(fact_475_minus__nat_Odiff__0,axiom,(
    ! [M] : M = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),zero_zero(nat)) )).
...
fof(fact_213_minus__apply,axiom,(
    ! [X_c,X_b] :
      ( ! [A_3,B_2,X_1] : hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),minus_minus(X_b),hAPP(X_c,X_b,A_3,X_1)),hAPP(X_c,X_b,B_2,X_1)) = hAPP(X_c,X_b,hAPP(fun(X_c,X_b),fun(X_c,X_b),hAPP(fun(X_c,X_b),fun(fun(X_c,X_b),fun(X_c,X_b)),minus_minus(fun(X_c,X_b)),A_3),B_2),X_1)
     <= minus(X_b) ) )).
...
fof(fact_167_empty__Diff,axiom,(
    ! [X_b,A_3] : bot_bot(fun(X_b,bool)) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,bool),fun(fun(X_b,bool),fun(X_b,bool)),minus_minus(fun(X_b,bool)),bot_bot(fun(X_b,bool))),A_3) )).
...
fof(fact_468_one__is__add,axiom,(
    ...
    <=> ( ( Na = hAPP(nat,nat,suc,zero_zero(nat))
          & zero_zero(nat) = M_1 )
        | ( hAPP(nat,nat,suc,zero_zero(nat)) = M_1
          & Na = zero_zero(nat) ) ) ) )).
...
fof(fact_40_Nat_Odiff__diff__eq,axiom,(
    ! [N,K,M] :
     ...
     => ( hBOOL(hAPP(nat,bool,hAPP(nat,fun(nat,bool),ord_less_eq(nat),K),N))
       => hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),N) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),K)),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),N),K)) ) ) )).
    ...
    ! [X_b,Pa,F_2] :
     ...
     => ( ti(fun(X_b,bool),F_2) != bot_bot(fun(X_b,bool))
       => ( ! [X_2] : hBOOL(hAPP(fun(X_b,bool),bool,Pa,hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_2),bot_bot(fun(X_b,bool)))))
         => ( ! [X_2,F_3] :
                ( hBOOL(hAPP(fun(X_b,bool),bool,finite_finite(X_b),F_3))
               => ( bot_bot(fun(X_b,bool)) != ti(fun(X_b,bool),F_3)
                 => ( ( hBOOL(hAPP(fun(X_b,bool),bool,Pa,hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_2),F_3)))
                     <= hBOOL(hAPP(fun(X_b,bool),bool,Pa,F_3)) )
                   <= ~ hBOOL(hAPP(fun(X_b,bool),bool,hAPP(X_b,fun(fun(X_b,bool),bool),member(X_b),X_2),F_3)) ) ) )
           => hBOOL(hAPP(fun(X_b,bool),bool,Pa,F_2)) ) ) ) ) )).
...
fof(fact_257_le__iff__add,axiom,(
    ! [M_1,Na] :
      ( hBOOL(hAPP(nat,bool,hAPP(nat,fun(nat,bool),ord_less_eq(nat),M_1),Na))
    <=> ? [K_1] : hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),M_1),K_1) = Na ) )).
...
fof(fact_445_Plus__eq__empty__conv,axiom,(
    ...
    <=> ( ti(fun(X_b,bool),A_3) = bot_bot(fun(X_b,bool))
        & bot_bot(fun(X_c,bool)) = ti(fun(X_c,bool),B_2) ) ) )).
...
fof(fact_41_eq__diff__iff,axiom,(
    ! [Na,K_2,M_1] :
      ( ( ( M_1 = Na
        <=> hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),Na),K_2) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M_1),K_2) )
       <= hBOOL(hAPP(nat,bool,hAPP(nat,fun(nat,bool),ord_less_eq(nat),K_2),Na)) )
     <= hBOOL(hAPP(nat,bool,hAPP(nat,fun(nat,bool),ord_less_eq(nat),K_2),M_1)) ) )).
...
fof(fact_493_add__0,axiom,(
    ! [X_a] :
      ( ! [A_1] : ti(X_a,A_1) = hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),plus_plus(X_a),zero_zero(X_a)),A_1)
     <= comm_monoid_add(X_a) ) )).
...
fof(fact_311_diff__eq__diff__less,axiom,(
    ! [X_b] :
     ...
     => ! [A_2,B,C_1,D_1] :
         ...
         <= hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),minus_minus(X_b),C_1),D_1) = hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),minus_minus(X_b),A_2),B) ) ) )).
...
fof(fact_470_diff__is__0__eq_H,axiom,(
    ! [M,N] :
      ( zero_zero(nat) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),N)
     <= hBOOL(hAPP(nat,bool,hAPP(nat,fun(nat,bool),ord_less_eq(nat),M),N)) ) )).
...
fof(fact_266_diff__add__cancel,axiom,(
    ! [X_a] :
      ( group_add(X_a)
     => ! [A_1,B_1] : ti(X_a,A_1) = hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),plus_plus(X_a),hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),minus_minus(X_a),A_1),B_1)),B_1) ) )).
...
fof(fact_296_less__add__eq__less,axiom,(
    ! [M,N,K,L] :
      ( ( hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),K),N) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),M),L)
       => hBOOL(hAPP(nat,bool,hAPP(nat,fun(nat,bool),ord_less(nat),M),N)) )
...
fof(fact_249_ab__semigroup__add__class_Oadd__ac_I1_J,axiom,(
    ! [X_a] :
      ( ab_semigroup_add(X_a)
     => ! [A_1,B_1,C] : hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),plus_plus(X_a),A_1),hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),plus_plus(X_a),B_1),C)) = hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),plus_plus(X_a),hAPP(X_a,X_a,hAPP(X_a,fun(X_a,X_a),plus_plus(X_a),A_1),B_1)),C) ) )).
...
fof(fact_217_flat__lub__def,axiom,(
    ! [X_b,A_3,B] :
      ( ( ti(X_b,B) = hAPP(fun(X_b,bool),X_b,hAPP(X_b,fun(fun(X_b,bool),X_b),partial_flat_lub(X_b),B),A_3)
...
fof(fact_254_diff__cancel2,axiom,(
    ! [M,K,N] : hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),N) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),M),K)),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),N),K)) )).
...
fof(fact_25_diff__commute,axiom,(
    ! [I,J_2,K] : hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),I),K)),J_2) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),I),J_2)),K) )).
...
fof(fact_243_nat__add__commute,axiom,(
    ! [M,N] : hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),N),M) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),M),N) )).
...
fof(fact_183_folding__one__idem_Oin__idem,axiom,(
    ! [X_b,X_1,A_3,F,F_2] :
      ( ( ( hAPP(fun(X_b,bool),X_b,F_2,A_3) = hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),F,X_1),hAPP(fun(X_b,bool),X_b,F_2,A_3))
         <= hBOOL(hAPP(fun(X_b,bool),bool,hAPP(X_b,fun(fun(X_b,bool),bool),member(X_b),X_1),A_3)) )
       <= hBOOL(hAPP(fun(X_b,bool),bool,finite_finite(X_b),A_3)) )
     <= hBOOL(hAPP(fun(fun(X_b,bool),X_b),bool,hAPP(fun(X_b,fun(X_b,X_b)),fun(fun(fun(X_b,bool),X_b),bool),finite2073411215e_idem(X_b),F),F_2)) ) )).
...
fof(fact_491_nat__case__0,axiom,(
    ! [X_b,F1,F2] : ti(X_b,F1) = hAPP(nat,X_b,hAPP(fun(nat,X_b),fun(nat,X_b),hAPP(X_b,fun(fun(nat,X_b),fun(nat,X_b)),nat_case(X_b),F1),F2),zero_zero(nat)) )).
...
fof(fact_161_the__elem__def,axiom,(
    ! [X_b,X_3] : hAPP(fun(X_b,bool),X_b,the(X_b),hAPP(fun(X_b,fun(X_b,bool)),fun(X_b,bool),hAPP(fun(fun(X_b,bool),bool),fun(fun(X_b,fun(X_b,bool)),fun(X_b,bool)),combb(fun(X_b,bool),bool,X_b),hAPP(fun(X_b,bool),fun(fun(X_b,bool),bool),fequal(fun(X_b,bool)),X_3)),hAPP(fun(X_b,bool),fun(X_b,fun(X_b,bool)),hAPP(fun(X_b,fun(fun(X_b,bool),fun(X_b,bool))),fun(fun(X_b,bool),fun(X_b,fun(X_b,bool))),combc(X_b,fun(X_b,bool),fun(X_b,bool)),insert(X_b)),bot_bot(fun(X_b,bool))))) = hAPP(fun(X_b,bool),X_b,the_elem(X_b),X_3) )).
...
fof(fact_239_nat__add__right__cancel,axiom,(
    ! [M_1,K_2,Na] :
      ( hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),Na),K_2) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),M_1),K_2)
    <=> M_1 = Na ) )).
...
fof(fact_241_nat__add__assoc,axiom,(
    ! [M,N,K] : hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),M),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),N),K)) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),M),N)),K) )).
...
fof(fact_90_image__insert,axiom,(
    ! [X_c,X_b,F,A_2,B_2] : hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),hAPP(X_c,X_b,F,A_2)),hAPP(fun(X_c,bool),fun(X_b,bool),hAPP(fun(X_c,X_b),fun(fun(X_c,bool),fun(X_b,bool)),image(X_c,X_b),F),B_2)) = hAPP(fun(X_c,bool),fun(X_b,bool),hAPP(fun(X_c,X_b),fun(fun(X_c,bool),fun(X_b,bool)),image(X_c,X_b),F),hAPP(fun(X_c,bool),fun(X_c,bool),hAPP(X_c,fun(fun(X_c,bool),fun(X_c,bool)),insert(X_c),A_2),B_2)) )).
...
fof(fact_180_insert__Diff,axiom,(
    ! [X_b,A_2,A_3] :
      ( ti(fun(X_b,bool),A_3) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),A_2),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,bool),fun(fun(X_b,bool),fun(X_b,bool)),minus_minus(fun(X_b,bool)),A_3),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),A_2),bot_bot(fun(X_b,bool)))))
     <= hBOOL(hAPP(fun(X_b,bool),bool,hAPP(X_b,fun(fun(X_b,bool),bool),member(X_b),A_2),A_3)) ) )).
...
fof(fact_385_card__Collect__less__nat,axiom,(
    ! [Na] : Na = hAPP(fun(nat,bool),nat,finite_card(nat),hAPP(fun(nat,bool),fun(nat,bool),collect(nat),hAPP(nat,fun(nat,bool),hAPP(fun(nat,fun(nat,bool)),fun(nat,fun(nat,bool)),combc(nat,nat,bool),ord_less(nat)),Na))) )).
...
fof(fact_159_folding__one__idem_Oinsert__idem,axiom,(
    ! [X_b,X_1,A_3,F,F_2] :
      ( hBOOL(hAPP(fun(fun(X_b,bool),X_b),bool,hAPP(fun(X_b,fun(X_b,X_b)),fun(fun(fun(X_b,bool),X_b),bool),finite2073411215e_idem(X_b),F),F_2))
     => ( hBOOL(hAPP(fun(X_b,bool),bool,finite_finite(X_b),A_3))
       => ( hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),F,X_1),hAPP(fun(X_b,bool),X_b,F_2,A_3)) = hAPP(fun(X_b,bool),X_b,F_2,hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(X_b,fun(fun(X_b,bool),fun(X_b,bool)),insert(X_b),X_1),A_3))
         <= ti(fun(X_b,bool),A_3) != bot_bot(fun(X_b,bool)) ) ) ) )).
...
fof(fact_188_card__Diff__subset,axiom,(
    ! [X_b,A_3,B_2] :
      ( ( hBOOL(hAPP(fun(X_b,bool),bool,hAPP(fun(X_b,bool),fun(fun(X_b,bool),bool),ord_less_eq(fun(X_b,bool)),B_2),A_3))
       => hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(fun(X_b,bool),nat,finite_card(X_b),A_3)),hAPP(fun(X_b,bool),nat,finite_card(X_b),B_2)) = hAPP(fun(X_b,bool),nat,finite_card(X_b),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,bool),fun(fun(X_b,bool),fun(X_b,bool)),minus_minus(fun(X_b,bool)),A_3),B_2)) )
     <= hBOOL(hAPP(fun(X_b,bool),bool,finite_finite(X_b),B_2)) ) )).
...
fof(fact_252_diff__diff__left,axiom,(
    ! [I,J_2,K] : hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),I),hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),J_2),K)) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),I),J_2)),K) )).
...
fof(fact_92_subset__image__iff,axiom,(
    ! [X_b,X_c,B_2,F,A_3] :
      ( ? [AA] :
          ...
          & hAPP(fun(X_c,bool),fun(X_b,bool),hAPP(fun(X_c,X_b),fun(fun(X_c,bool),fun(X_b,bool)),image(X_c,X_b),F),AA) = ti(fun(X_b,bool),B_2) )
    <=> hBOOL(hAPP(fun(X_b,bool),bool,hAPP(fun(X_b,bool),fun(fun(X_b,bool),bool),ord_less_eq(fun(X_b,bool)),B_2),hAPP(fun(X_c,bool),fun(X_b,bool),hAPP(fun(X_c,X_b),fun(fun(X_c,bool),fun(X_b,bool)),image(X_c,X_b),F),A_3))) ) )).
...
fof(fact_206_folding__image__simple_Oempty,axiom,(
    ! [X_c,X_b,F,Z_1,G,F_2] :
      ( ti(X_b,Z_1) = hAPP(fun(X_c,bool),X_b,F_2,bot_bot(fun(X_c,bool)))
     <= hBOOL(hAPP(fun(fun(X_c,bool),X_b),bool,hAPP(fun(X_c,X_b),fun(fun(fun(X_c,bool),X_b),bool),hAPP(X_b,fun(fun(X_c,X_b),fun(fun(fun(X_c,bool),X_b),bool)),hAPP(fun(X_b,fun(X_b,X_b)),fun(X_b,fun(fun(X_c,X_b),fun(fun(fun(X_c,bool),X_b),bool))),finite1357897459simple(X_b,X_c),F),Z_1),G),F_2)) ) )).
...
fof(fact_221_diff__Suc__eq__diff__pred,axiom,(
    ! [M,N] : hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),one_one(nat))),N) = hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),hAPP(nat,nat,suc,N)) )).

fof(fact_273_le__add__diff__inverse2,axiom,(
    ! [N,M] :
      ( hBOOL(hAPP(nat,bool,hAPP(nat,fun(nat,bool),ord_less_eq(nat),N),M))
     => M = hAPP(nat,nat,hAPP(nat,fun(nat,nat),plus_plus(nat),hAPP(nat,nat,hAPP(nat,fun(nat,nat),minus_minus(nat),M),N)),N) ) )).
    ...
    ! [X_b,N_1,H,F,F_2] :
     ...
     => ( ! [X_2,Y_2] : hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),F,hAPP(X_b,X_b,H,X_2)),hAPP(X_b,X_b,H,Y_2)) = hAPP(X_b,X_b,H,hAPP(X_b,X_b,hAPP(X_b,fun(X_b,X_b),F,X_2),Y_2))
       => ( hBOOL(hAPP(fun(X_b,bool),bool,finite_finite(X_b),N_1))
         => ( bot_bot(fun(X_b,bool)) != ti(fun(X_b,bool),N_1)
           => hAPP(fun(X_b,bool),X_b,F_2,hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,X_b),fun(fun(X_b,bool),fun(X_b,bool)),image(X_b,X_b),H),N_1)) = hAPP(X_b,X_b,H,hAPP(fun(X_b,bool),X_b,F_2,N_1)) ) ) ) ) )).
...
fof(fact_171_double__diff,axiom,(
    ! [X_b,C_2,A_3,B_2] :
      ( hBOOL(hAPP(fun(X_b,bool),bool,hAPP(fun(X_b,bool),fun(fun(X_b,bool),bool),ord_less_eq(fun(X_b,bool)),A_3),B_2))
     => ( ti(fun(X_b,bool),A_3) = hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,bool),fun(fun(X_b,bool),fun(X_b,bool)),minus_minus(fun(X_b,bool)),B_2),hAPP(fun(X_b,bool),fun(X_b,bool),hAPP(fun(X_b,bool),fun(fun(X_b,bool),fun(X_b,bool)),minus_minus(fun(X_b,bool)),C_2),A_3))
       <= hBOOL(hAPP(fun(X_b,bool),bool,hAPP(fun(X_b,bool),fun(fun(X_b,bool),bool),ord_less_eq(fun(X_b,bool)),B_2),C_2)) ) ) )).
