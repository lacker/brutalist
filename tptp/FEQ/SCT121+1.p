...
fof(conj_0,hypothesis,(
    ! [B_P] :
      ( ! [B_x] :
          ( c_Relation_Otrans(tc_Arrow__Order__Mirabelle_Oalt,hAPP(B_P,B_x))
          & c_Relation_Ototal__on(tc_Arrow__Order__Mirabelle_Oalt,c_Orderings_Otop__class_Otop(tc_fun(tc_Arrow__Order__Mirabelle_Oalt,tc_HOL_Obool)),hAPP(B_P,B_x))
          & c_Relation_Oirrefl(tc_Arrow__Order__Mirabelle_Oalt,hAPP(B_P,B_x)) )
     => ! [B_a,B_b] :
          ( B_b != B_a
         => ( c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,B_a,B_b),hAPP(B_P,v_i))
           => c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,B_a,B_b),v_F(B_P)) ) ) ) )).
...
fof(fact_tfl__cut__apply,axiom,(
    ! [T_b,V_a_2,V_x_2,T_a,B_f,B_R] :
     ...
     => hAPP(B_f,V_x_2) = hAPP(c_Recdef_Ocut(T_a,T_b,B_f,B_R,V_a_2),V_x_2) ) )).
...
fof(fact_quotient__empty,axiom,(
    ! [V_r_2,T_a] : c_Orderings_Obot__class_Obot(tc_fun(tc_fun(T_a,tc_HOL_Obool),tc_HOL_Obool)) = c_Equiv__Relations_Oquotient(T_a,c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)),V_r_2) )).
...
fof(fact_Diff__disjoint,axiom,(
    ! [V_B_2,V_A_2,T_a] : c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)) = c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool),V_A_2,c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool),V_B_2,V_A_2)) )).
...
fof(fact_rtrancl__r__diff__Id,axiom,(
    ! [V_r_2,T_a] : c_Transitive__Closure_Ortrancl(T_a,V_r_2) = c_Transitive__Closure_Ortrancl(T_a,c_Groups_Ominus__class_Ominus(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool),V_r_2,c_Relation_OId(T_a))) )).
...
fof(fact_Un__left__commute,axiom,(
    ! [V_C_2,V_B_2,V_A_2,T_a] : c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),V_B_2,c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),V_A_2,V_C_2)) = c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),V_A_2,c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),V_B_2,V_C_2)) )).
...
fof(fact_sup__apply,axiom,(
    ! [V_x_2,V_g_2,V_f_2,T_b,T_a] :
      ( c_Lattices_Osemilattice__sup__class_Osup(T_a,hAPP(V_f_2,V_x_2),hAPP(V_g_2,V_x_2)) = hAPP(c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_b,T_a),V_f_2,V_g_2),V_x_2)
     <= class_Lattices_Olattice(T_a) ) )).
...
fof(fact_Int__absorb2,axiom,(
    ! [V_B_2,V_A_2,T_a] :
      ( V_A_2 = c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool),V_A_2,V_B_2)
     <= c_Orderings_Oord__class_Oless__eq(tc_fun(T_a,tc_HOL_Obool),V_A_2,V_B_2) ) )).
...
fof(fact_Un__UNIV__left,axiom,(
    ! [V_B_2,T_a] : c_Orderings_Otop__class_Otop(tc_fun(T_a,tc_HOL_Obool)) = c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),c_Orderings_Otop__class_Otop(tc_fun(T_a,tc_HOL_Obool)),V_B_2) )).
...
fof(fact_sup__top__left,axiom,(
    ! [V_x,T_a] :
      ( class_Lattices_Obounded__lattice__top(T_a)
     => c_Orderings_Otop__class_Otop(T_a) = c_Lattices_Osemilattice__sup__class_Osup(T_a,c_Orderings_Otop__class_Otop(T_a),V_x) ) )).
