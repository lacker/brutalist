      ...
      ( ! [B] :
          ( ! [C] :
              ( ! [D] :
                  ( ? [E] :
                      ( m1_group_2(E,A)
                      & k3_funct_2(u1_struct_0(A),u1_struct_0(B),C,u1_struct_0(D)) = u1_struct_0(E)
                      & v1_group_1(E) )
                 <= m1_group_2(D,B) )
             <= ( v1_funct_2(C,u1_struct_0(A),u1_struct_0(B))
                & v1_group_6(C,A,B)
                          ...
                          ( ! [G] :
                              ( ( m1_group_6(F,B,G)
                               <= ( u1_struct_0(F) = k2_funct_2(u1_struct_0(A),u1_struct_0(B),C,u1_struct_0(D))
                                  & k2_funct_2(u1_struct_0(A),u1_struct_0(B),C,u1_struct_0(E)) = u1_struct_0(G)
                                  & m1_group_6(D,A,E) ) )
                             <= m1_group_2(G,B) )
                         <= m1_group_2(F,B) ) ) ) ) ) ) )).
...
fof(t1_latsubgr,axiom,(
    ! [A] :
      ( ! [B] :
          ( ! [C] :
              ( k3_xboole_0(u1_struct_0(B),u1_struct_0(C)) = u1_struct_0(k9_group_2(A,B,C))
             <= m1_group_2(C,A) )
         <= m1_group_2(B,A) )
     <= ( v3_group_1(A)
        & l1_group_1(A)
                  ...
                  ( ! [E] :
                     ...
                     => ! [F] :
                         ...
                         => ! [G] :
                              ( ( m1_group_6(F,A,G)
                               <= ( m1_group_6(D,B,E)
                                  & k3_funct_2(u1_struct_0(A),u1_struct_0(B),C,u1_struct_0(E)) = u1_struct_0(G)
                                  & k3_funct_2(u1_struct_0(A),u1_struct_0(B),C,u1_struct_0(D)) = u1_struct_0(F) ) )
                             <= m1_group_2(G,A) ) ) )
                 <= m1_group_2(D,B) )
             <= ( v1_group_6(C,A,B)
                & m2_relset_1(C,u1_struct_0(A),u1_struct_0(B))
         ...
         => ! [C] :
             ...
             => ! [D] :
                 ...
                 => ? [E] :
                      ( v1_group_1(E)
                      & m1_group_2(E,B)
                      & k2_funct_2(u1_struct_0(A),u1_struct_0(B),C,u1_struct_0(D)) = u1_struct_0(E) ) ) ) ) ) )).
