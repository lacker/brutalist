fof(ax46,axiom,(
    ! [VAR_K_0X30,VAR_M_0X30] : VAR_M_0X30 = constr_comm_dec(constr_comm_enc(VAR_M_0X30,VAR_K_0X30),VAR_K_0X30) )).

fof(ax7,axiom,(
    name_m_9 != constr_CONST_0x30 )).
...
fof(ax31,axiom,(
    name_Kb != constr_CONST_4 )).

fof(ax26,axiom,(
    name_Kb != constr_CONST_3 )).
...
fof(ax45,axiom,(
    ! [VAR_K_8,VAR_M_7] : VAR_M_7 = constr_dec(constr_enc(VAR_M_7,VAR_K_8),VAR_K_8) )).
...
fof(ax22,axiom,(
    name_m_9 != constr_CONST_2 )).

fof(ax19,axiom,(
    name_Ka != constr_CONST_2 )).
