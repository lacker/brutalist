...
fof(aVSUMu_EQu_SUPERSET,axiom,(
    ! [A,Q106306,F0,S0,T0] :
      ( ( p(s(bool,i(s(fun(fun(A,bool),bool),finite),s(fun(A,bool),T0))))
        ...
        & ! [X] :
            ( s(cart(real,Q106306),i(s(fun(A,cart(real,Q106306)),g),s(A,X))) = s(cart(real,Q106306),i(s(fun(A,cart(real,Q106306)),F0),s(A,X)))
           <= p(s(bool,i(s(fun(fun(A,bool),bool),i(s(fun(A,fun(fun(A,bool),bool)),in),s(A,X))),s(fun(A,bool),T0)))) ) )
...
fof(aVSUMu_DIFFSu_ALT,axiom,(
    ! [Q107910,U_0] :
     ...
     <= ! [K0] : s(cart(real,Q107910),i(s(fun(cart(real,Q107910),cart(real,Q107910)),i(s(fun(cart(real,Q107910),fun(cart(real,Q107910),cart(real,Q107910))),vectoru_sub),s(cart(real,Q107910),i(s(fun(num,cart(real,Q107910)),f),s(num,i(s(fun(num,num),i(s(fun(num,fun(num,num)),p_),s(num,K0))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))))),s(cart(real,Q107910),i(s(fun(num,cart(real,Q107910)),f),s(num,K0))))) = s(cart(real,Q107910),i(s(fun(num,cart(real,Q107910)),U_0),s(num,K0))) ) )).
...
fof(aNORMu_LEu_L1,axiom,(
    ! [N,U_0] :
      ( ! [X,I0] : s(real,i(s(fun(real,real),realu_abs),s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),X))),s(num,I0))))) = s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),U_0),s(cart(real,N),X))),s(num,I0)))
...
fof(aREALu_DIVu_SQRT,axiom,(
    ! [X] :
      ( p(s(bool,i(s(fun(real,bool),i(s(fun(real,fun(real,bool)),realu_le),s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))),s(real,X))))
     => s(real,i(s(fun(real,real),sqrt),s(real,X))) = s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_div),s(real,X))),s(real,i(s(fun(real,real),sqrt),s(real,X))))) ) )).
...
fof(aNORMu_BASISu_1,axiom,(
    ! [Q110060] : s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))) = s(real,i(s(fun(cart(real,Q110060),real),vectoru_norm),s(cart(real,Q110060),i(s(fun(num,cart(real,Q110060)),basis),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))) )).
...
fof(aVECTORu_EQu_LDOT,axiom,(
    ...
    <=> s(cart(real,Q110589),Z0) = s(cart(real,Q110589),Y) ) )).
...
fof(aDOTu_SQUAREu_NORM,axiom,(
    ! [Q103415,X] : s(real,i(s(fun(num,real),i(s(fun(real,fun(num,real)),realu_pow),s(real,i(s(fun(cart(real,Q103415),real),vectoru_norm),s(cart(real,Q103415),X))))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit0),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))) = s(real,i(s(fun(cart(real,Q103415),real),i(s(fun(cart(real,Q103415),fun(cart(real,Q103415),real)),dot),s(cart(real,Q103415),X))),s(cart(real,Q103415),X))) )).
