...
fof(fact_1074_le__iff__add,axiom,(
    ! [M_2,N_2] :
      ( ? [K_1] : N_2 = hAPP_nat_nat(plus_plus_nat(M_2),K_1)
...
fof(fact_473_listrel1E,axiom,(
    ! [Xs_1,Ys_1,R_2] :
      ( ~ ! [X_1,Y_9] :
            ( ! [Us,Vs] :
                ( hAPP_l1891879573le_alt(hAPP_l1570526551le_alt(append1181015317le_alt,Us),hAPP_l1891879573le_alt(hAPP_l656323104le_alt(cons_l650111674le_alt,Y_9),Vs)) != Ys_1
               <= hAPP_l1891879573le_alt(hAPP_l1570526551le_alt(append1181015317le_alt,Us),hAPP_l1891879573le_alt(hAPP_l656323104le_alt(cons_l650111674le_alt,X_1),Vs)) = Xs_1 )
...
fof(fact_510_not__distinct__decomp,axiom,(
    ! [Ws] :
      ( ? [Xs_17,Ys,Zs,Y_9] :
          ( Ws = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_17),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_9),nil_Ar126264853le_alt)),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_9),nil_Ar126264853le_alt)),Zs))))
...
fof(fact_589_hd__dropWhile,axiom,(
    ! [Pa,Xs_1] :
     ...
     <= nil_Ar126264853le_alt != hAPP_l726444215le_alt(dropWh156852662le_alt(Pa),Xs_1) ) )).
...
fof(fact_795_dropWhile__append2,axiom,(
    ! [Ys_1,Pa,Xs_1] :
      ( hAPP_l1189022293t_bool(dropWhile_bool(Pa),Ys_1) = hAPP_l1189022293t_bool(dropWhile_bool(Pa),hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,Xs_1),Ys_1))
     <= ! [X_1] :
...
fof(fact_472_listrel1I,axiom,(
    ! [Ys_1,Xs_1,Us_1,Vs_1,X_2,Y_2,R_2] :
     ...
     => ( ( Ys_1 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Us_1),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_2),Vs_1))
       ...
       <= Xs_1 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Us_1),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),Vs_1)) ) ) )).
...
fof(fact_531_listrel__eq__len,axiom,(
    ! [Xs_1,Ys_1,R_2] :
      ( hAPP_l1872264749lt_nat(size_s1873794948le_alt,Ys_1) = hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_1)
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__HOL__Obool_Mtc__HOL__Obool_J_000tc__fun_Itc_118,axiom,(
    ! [P,Q] :
      ( P = hAPP_f839832464l_bool(hAPP_f746617550l_bool(cOMBK_370033373t_bool,P),Q)
     <= is_fun_bool_bool(P) ) )).
...
fof(fact_499_internal__split__def,axiom,(
    produc1817385812t_bool = produc2022255647t_bool )).
...
fof(fact_43_not__Cons__self2,axiom,(
    ! [X_39,Xs_53] : Xs_53 != hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_39),Xs_53) )).
...
fof(fact_393_append__eq__appendI,axiom,(
    ! [Ys_18,Us_2,Xs_41,Xs1_1,Zs_4] :
     ...
     => ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Zs_4),Us_2) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_41),Ys_18)
       <= Ys_18 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs1_1),Us_2) ) ) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool_J_000tc__fun_Itc__143,axiom,(
    ! [P,Q] : P = hAPP_f1593910865t_bool(hAPP_f1362748656t_bool(cOMBK_208474378t_bool,P),Q) )).
...
fof(fact_1151_diff__Suc,axiom,(
    ! [M_2,N_2] : hAPP_nat_nat(minus_minus_nat(M_2),hAPP_nat_nat(suc,N_2)) = hAPP_nat_nat(nat_case_nat(zero_zero_nat,cOMBI_nat),hAPP_nat_nat(minus_minus_nat(M_2),N_2)) )).
...
fof(help_COMBB_1_1_COMBB_000tc__fun_Itc__Arrow____Order____Mirabelle____tpnfnnbpuu___154,axiom,(
    ! [P,Q,R] : hAPP_A572596845t_bool(hAPP_f1324249913t_bool(hAPP_f1267389329t_bool(cOMBB_747702273le_alt,P),Q),R) = hAPP_f653880381t_bool(P,hAPP_A1553574765l_bool(Q,R)) )).
...
fof(fact_503_cond__split__eta,axiom,(
    ! [G,F] :
     ...
     => ( ! [X_1,Y_9] :
       ...
       => hAPP_f791205069t_bool(produc2022255647t_bool,F) = G ) ) )).
...
fof(fact_697_set__rotate1,axiom,(
    ! [Xs_1] : set_Ar1565008694le_alt(hAPP_l726444215le_alt(rotate1322903650le_alt,Xs_1)) = set_Ar1565008694le_alt(Xs_1) )).
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__HOL__Obool_000tc__Arrow____Order__,axiom,(
    ! [P,Q,R] : hAPP_bool_bool(P,hAPP_A862370221t_bool(Q,R)) = hAPP_A862370221t_bool(hAPP_f2014742713t_bool(hAPP_f27970449t_bool(cOMBB_2104979073le_alt,P),Q),R) )).
...
fof(fact_721_takeWhile__append1,axiom,(
    ! [Ys_1,Pa,X_2,Xs_1] :
     ...
     => ( ~ hBOOL(hAPP_f312250286l_bool(Pa,X_2))
       => hAPP_l210315413t_bool(takeWh169821797t_bool(Pa),hAPP_l210315413t_bool(hAPP_l583487011t_bool(append381950793t_bool,Xs_1),Ys_1)) = hAPP_l210315413t_bool(takeWh169821797t_bool(Pa),Xs_1) ) ) )).
...
fof(fact_18_Pair__inject,axiom,(
    ! [A_12,B_9,A_11,B_8] :
      ( ( ~ ( A_12 = A_11
           => B_8 != B_9 )
       <= hAPP_A702847159le_alt(hAPP_A1505516597le_alt(produc1400112471le_alt,A_12),B_9) = hAPP_A702847159le_alt(hAPP_A1505516597le_alt(produc1400112471le_alt,A_11),B_8) )
...
fof(help_If_2_1_If_000tc__prod_Itc__List__Olist_Itc__Arrow____Order____Mirabelle____,axiom,(
    ! [X,Y] : hAPP_P1056860425le_alt(hAPP_P864444517le_alt(if_Pro1306781203le_alt(fFalse),X),Y) = Y )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__prod_Itc__List__Olist_Itc__Arrow____Order___142,axiom,(
    ! [P,Q] : P = hAPP_f996881846t_bool(hAPP_f372103450t_bool(cOMBK_1411148035t_bool,P),Q) )).
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__HOL__Obool_000tc__prod_Itc__List__,axiom,(
    ! [P,Q,R] : hAPP_P1327827171t_bool(hAPP_f1642286869t_bool(hAPP_f62793075t_bool(cOMBB_1604919143le_alt,P),Q),R) = hAPP_bool_bool(P,hAPP_P1327827171t_bool(Q,R)) )).
...
fof(fact_796_dropWhile__append2,axiom,(
    ! [Ys_1,Pa,Xs_1] :
      ( hAPP_l210315413t_bool(dropWh23362493t_bool(Pa),Ys_1) = hAPP_l210315413t_bool(dropWh23362493t_bool(Pa),hAPP_l210315413t_bool(hAPP_l583487011t_bool(append381950793t_bool,Xs_1),Ys_1))
     <= ! [X_1] :
...
fof(fact_495_split__curry,axiom,(
    ! [F] :
      ( hAPP_f791205069t_bool(produc2022255647t_bool,produc212588606t_bool(F)) = F
...
fof(fact_848_takeWhile__cong,axiom,(
    ! [Q_1,Pa,L_1,K] :
      ( ( hAPP_l1493873365le_alt(takeWh416411546le_alt(Pa),L_1) = hAPP_l1493873365le_alt(takeWh416411546le_alt(Q_1),K)
       <= ! [X_1] :
...
fof(help_COMBB_1_1_COMBB_000tc__prod_Itc__List__Olist_Itc__Arrow____Order____Mirabel,axiom,(
    ! [P,Q,R] : hAPP_l391088160le_alt(hAPP_f1514103381le_alt(hAPP_f500394983le_alt(cOMBB_500037706le_alt,P),Q),R) = hAPP_P1056860425le_alt(P,hAPP_l391088160le_alt(Q,R)) )).
...
fof(fact_358_last__ConsR,axiom,(
    ! [X_30,Xs_43] :
      ( last_A57386030le_alt(Xs_43) = last_A57386030le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_30),Xs_43))
     <= nil_Ar126264853le_alt != Xs_43 ) )).
...
fof(help_COMBC_1_1_COMBC_000tc__prod_Itc__Arrow____Order____Mirabelle____tpnfnnbpuu_,axiom,(
    ! [P,Q,R] : hAPP_P606313927t_bool(hAPP_P1267694911t_bool(P,R),Q) = hAPP_P606313927t_bool(hAPP_P1267694911t_bool(hAPP_f135580393t_bool(cOMBC_607108822t_bool,P),Q),R) )).
...
fof(fact_474_listrel1E,axiom,(
    ! [Xs_1,Ys_1,R_2] :
     ...
     => ~ ! [X_1,Y_9] :
            ( ( ! [Us,Vs] :
                  ( Xs_1 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Us),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Vs))
...
fof(fact_307_PairE,axiom,(
    ! [P_2] :
     ...
     => ~ ! [X_1,Y_9] :
            ( hAPP_A702847159le_alt(hAPP_A1505516597le_alt(produc1400112471le_alt,X_1),Y_9) != P_2
           <= ( is_Arr1861959080le_alt(Y_9)
              & is_Arr1861959080le_alt(X_1) ) ) ) )).
...
fof(fact_815_in__set__conv__decomp__first,axiom,(
    ...
    <=> ? [Ys,Zs] :
          ( ~ hBOOL(hAPP_f250445784l_bool(hAPP_f1253375959l_bool(member520425275t_bool,X_2),set_fu335223357t_bool(Ys)))
          & Xs_1 = hAPP_l210315413t_bool(hAPP_l583487011t_bool(append381950793t_bool,Ys),hAPP_l210315413t_bool(hAPP_f1812326636t_bool(cons_f14678382t_bool,X_2),Zs)) ) ) )).
...
fof(help_COMBC_1_1_COMBC_000tc__fun_Itc__prod_Itc__Arrow____Order____Mirabelle____tp,axiom,(
    ! [P,Q,R] : hAPP_f592646513l_bool(hAPP_f863359027l_bool(P,R),Q) = hAPP_f592646513l_bool(hAPP_f863359027l_bool(hAPP_f495827653l_bool(cOMBC_1136104858l_bool,P),Q),R) )).
...
fof(fact_1092_less__iff__Suc__add,axiom,(
    ! [M_2,N_2] :
      ( ? [K_1] : hAPP_nat_nat(suc,hAPP_nat_nat(plus_plus_nat(M_2),K_1)) = N_2
    <=> hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,M_2),N_2)) ) )).
...
fof(fact_396_append__eq__append__conv2,axiom,(
    ! [Xs_1,Ys_1,Zs_1,Ts] :
      ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_1),Ys_1) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Zs_1),Ts)
    <=> ? [Us] :
          ( ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Zs_1),Us) = Xs_1
...
fof(fact_1009_nat_Oinject,axiom,(
    ! [Nat_5,Nat_4] :
      ( Nat_4 = Nat_5
    <=> hAPP_nat_nat(suc,Nat_4) = hAPP_nat_nat(suc,Nat_5) ) )).

fof(fact_477_Cons__listrel1E2,axiom,(
    ! [Xs_1,Y_2,Ys_1,R_2] :
      ( ( ~ ! [Zs] :
              ( hAPP_l1891879573le_alt(hAPP_l656323104le_alt(cons_l650111674le_alt,Y_2),Zs) = Xs_1
       ...
       <= ! [X_1] :
           ...
           <= hAPP_l1891879573le_alt(hAPP_l656323104le_alt(cons_l650111674le_alt,X_1),Ys_1) = Xs_1 ) )
...
fof(fact_490_dropWhile_Osimps_I2_J,axiom,(
    ! [Xs_1,Pa,X_2] :
      ( ( ~ hBOOL(hAPP_A862370221t_bool(Pa,X_2))
       => hAPP_l726444215le_alt(dropWh156852662le_alt(Pa),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),Xs_1)) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),Xs_1) )
...
fof(fact_765_List_Oinsert__def,axiom,(
    ! [X_2,Xs_1] :
      ( ( hAPP_l54953109e_indi(hAPP_A974963564e_indi(insert915800584e_indi,X_2),Xs_1) = Xs_1
       <= hBOOL(hAPP_f1599966040l_bool(hAPP_A1602262231l_bool(member1493247163e_indi,X_2),set_Ar219761597e_indi(Xs_1))) )
      & ( ~ hBOOL(hAPP_f1599966040l_bool(hAPP_A1602262231l_bool(member1493247163e_indi,X_2),set_Ar219761597e_indi(Xs_1)))
...
fof(fact_601_rev__swap,axiom,(
    ...
    <=> hAPP_l726444215le_alt(rev_Ar2093961333le_alt,Xs_1) = Ys_1 ) )).

fof(fact_390_partition_Osimps_I1_J,axiom,(
    ! [Pa] : hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,nil_Ar126264853le_alt),nil_Ar126264853le_alt) = partit327648526le_alt(Pa,nil_Ar126264853le_alt) )).
...
fof(fact_438_rev__cases,axiom,(
    ! [Xs_29] :
     ...
     => ~ ! [Ys,Y_9] :
            ( Xs_29 != hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_9),nil_Ar126264853le_alt))
           <= is_Arr1861959080le_alt(Y_9) ) ) )).
...
fof(fact_475_Cons__listrel1E1,axiom,(
    ! [X_2,Xs_1,Ys_1,R_2] :
     ...
     => ( ! [Y_9] :
            ( hAPP_l1891879573le_alt(hAPP_l656323104le_alt(cons_l650111674le_alt,Y_9),Xs_1) = Ys_1
...
fof(fact_998_top__le,axiom,(
    ! [Aa] :
      ( is_fun288122577l_bool(Aa)
     => ( hBOOL(hAPP_f777333846l_bool(hAPP_f1146952189l_bool(ord_le1069525464l_bool,top_to522745736l_bool),Aa))
       => top_to522745736l_bool = Aa ) ) )).

fof(fact_1018_le__refl,axiom,(
    ! [N] : hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,N),N)) )).

fof(fact_353_Pi__UNIV,axiom,(
    ! [A_1] : pi_Arr990697634t_bool(A_1,hAPP_f1659309744l_bool(cOMBK_657557929e_indi,top_to1853035173l_bool)) = top_to522745736l_bool )).
...
fof(fact_306_PairE,axiom,(
    ! [P_2] :
      ~ ! [X_1,Y_9] : hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,X_1),Y_9) != P_2 )).
...
fof(help_COMBB_1_1_COMBB_000tc__prod_Itc__List__Olist_Itc__Arrow____Order____Mirabel_158,axiom,(
    ! [P,Q,R] : hAPP_P864444517le_alt(P,hAPP_l391088160le_alt(Q,R)) = hAPP_l693571982le_alt(hAPP_f2001490223le_alt(hAPP_f1939049849le_alt(cOMBB_723746886le_alt,P),Q),R) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__fun_Itc__Arrow____Order____Mirabelle____tpn_119,axiom,(
    ! [P,Q] :
      ( is_fun288122577l_bool(P)
     => P = hAPP_b1048178734l_bool(hAPP_f823172443l_bool(cOMBK_1021277149l_bool,P),Q) ) )).
...
fof(fact_807_takeWhile__append2,axiom,(
    ! [Ys_1,Pa,Xs_1] :
     ...
     => hAPP_l1660244757t_bool(takeWh1309019107t_bool(Pa),hAPP_l1660244757t_bool(hAPP_l776124325t_bool(append1995644103t_bool,Xs_1),Ys_1)) = hAPP_l1660244757t_bool(hAPP_l776124325t_bool(append1995644103t_bool,Xs_1),hAPP_l1660244757t_bool(takeWh1309019107t_bool(Pa),Ys_1)) ) )).
    ...
    ! [Xs_1,Y_2,Ys_1,R_2] :
      ( ~ ! [X_1,Xs_17] :
           ...
           => ( ( hBOOL(hAPP_f592646513l_bool(hAPP_P229966473l_bool(member1441201108le_alt,hAPP_A702847159le_alt(hAPP_A1505516597le_alt(produc1400112471le_alt,X_1),Y_2)),R_2))
             ...
             <= hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Xs_17) = Xs_1 ) )
...
fof(fact_494_split__eta,axiom,(
    ! [F] :
      ( F = hAPP_f791205069t_bool(produc2022255647t_bool,hAPP_f231379647t_bool(hAPP_f1460305297t_bool(cOMBB_2048157563le_alt,hAPP_f724700817t_bool(cOMBB_164218871le_alt,F)),produc1400112471le_alt))
     <= is_fun961089132t_bool(F) ) )).
...
fof(fact_1096_less__imp__Suc__add,axiom,(
    ! [M,N] :
      ( ? [K_1] : hAPP_nat_nat(suc,hAPP_nat_nat(plus_plus_nat(M),K_1)) = N
     <= hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,M),N)) ) )).
...
fof(fact_896_converse__rtranclE2,axiom,(
    ! [Xa_1,Xb,Za,Zb,R_2] :
     ...
     => ( ~ ! [A_7,B_6] :
       ...
       <= hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,Za),Zb) != hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,Xa_1),Xb) ) ) )).
...
fof(fact_1105_diff__cancel2,axiom,(
    ! [M,K_2,N] : hAPP_nat_nat(minus_minus_nat(M),N) = hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(plus_plus_nat(M),K_2)),hAPP_nat_nat(plus_plus_nat(N),K_2)) )).
...
fof(fact_779_not__in__set__insert,axiom,(
    ! [X_2,Xs_1] :
      ( ~ hBOOL(hAPP_f592646513l_bool(hAPP_P229966473l_bool(member1441201108le_alt,X_2),set_Pr604701398le_alt(Xs_1)))
     => hAPP_l1766111573le_alt(hAPP_P1057207891le_alt(cons_P993230855le_alt,X_2),Xs_1) = hAPP_l1766111573le_alt(hAPP_P1057207891le_alt(insert256706849le_alt,X_2),Xs_1) ) )).
...
fof(fact_791_dropWhile__append2,axiom,(
    ! [Ys_1,Pa,Xs_1] :
      ( ! [X_1] :
          ( hBOOL(hAPP_nat_bool(Pa,X_1))
         <= hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),set_nat(Xs_1))) )
     => hAPP_l248265089st_nat(dropWhile_nat(Pa),Ys_1) = hAPP_l248265089st_nat(dropWhile_nat(Pa),hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs_1),Ys_1)) ) )).
...
fof(fact_15_Pair__eq,axiom,(
    ! [Aa,Ba,A_8,B_7] :
      ( hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,Aa),Ba) = hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,A_8),B_7)
    <=> ( A_8 = Aa
        & Ba = B_7 ) ) )).
...
fof(fact_1114_plus__nat_Oadd__0,axiom,(
    ! [N] : hAPP_nat_nat(plus_plus_nat(zero_zero_nat),N) = N )).
...
fof(fact_434_lexord__append__rightI,axiom,(
    ! [X_2,R_2,Y_2] :
     ...
     <= ? [B_6,Z_4] : Y_2 = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,B_6),Z_4) ) )).
...
fof(fact_442_rotate__simps,axiom,(
    ! [X_25,Xs_28] :
      ( hAPP_l726444215le_alt(rotate1322903650le_alt,nil_Ar126264853le_alt) = nil_Ar126264853le_alt
      & hAPP_l726444215le_alt(rotate1322903650le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_25),Xs_28)) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_28),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_25),nil_Ar126264853le_alt)) ) )).
...
fof(fact_1103_add__eq__self__zero,axiom,(
    ! [M,N] :
      ( zero_zero_nat = N
     <= M = hAPP_nat_nat(plus_plus_nat(M),N) ) )).

fof(fact_138_splice__Nil2,axiom,(
    ! [Xs_50] : hAPP_l726444215le_alt(splice360969192le_alt(Xs_50),nil_Ar126264853le_alt) = Xs_50 )).
...
fof(fact_423_last__snoc,axiom,(
    ! [Xs_30,X_26] :
     ...
     => last_A57386030le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_30),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_26),nil_Ar126264853le_alt))) = X_26 ) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Arrow____Order____Mirabelle____tpnfnnbpuu__Oindi_000_120,axiom,(
    ! [P,Q,R] : hAPP_A568203993t_bool(hAPP_A1625428400t_bool(P,R),Q) = hAPP_A1677245848t_bool(hAPP_A1805174428t_bool(hAPP_f1808153265t_bool(cOMBC_1353880399t_bool,P),Q),R) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__fun_Itc__Arrow____Order____Mirabelle____tpn,axiom,(
    ! [P,Q] :
      ( is_fun288122577l_bool(P)
     => P = hAPP_n2095207769l_bool(hAPP_f584002568l_bool(cOMBK_532713098ol_nat,P),Q) ) )).
...
fof(fact_1150_diff__0__eq__0,axiom,(
    ! [N] : zero_zero_nat = hAPP_nat_nat(minus_minus_nat(zero_zero_nat),N) )).
...
fof(fact_1089_nat__add__assoc,axiom,(
    ! [M,N,K_2] : hAPP_nat_nat(plus_plus_nat(M),hAPP_nat_nat(plus_plus_nat(N),K_2)) = hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(plus_plus_nat(M),N)),K_2) )).
...
fof(fact_530_neq__if__length__neq,axiom,(
    ! [Xs_27,Ys_7] :
      ( Xs_27 != Ys_7
     <= hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_27) != hAPP_l1872264749lt_nat(size_s1873794948le_alt,Ys_7) ) )).
...
fof(fact_595_map__pair__def,axiom,(
    ! [F,G] : produc1449729469le_alt(F,G) = hAPP_f1078809103le_alt(produc748227559le_alt,hAPP_f1790240989le_alt(hAPP_f1792349771le_alt(cOMBC_1330649024le_alt,hAPP_f1318121625le_alt(hAPP_f634775919le_alt(cOMBB_576205818le_alt,cOMBB_1818168801le_alt),hAPP_f1790240989le_alt(hAPP_f1013417831le_alt(cOMBB_2052911494le_alt,produc237774329le_alt),F))),G)) )).
...
fof(fact_41_dictator__def,axiom,(
    ! [Fa,I_1] :
      ( ! [X_1] :
          ( ( hAPP_A1677245848t_bool(X_1,I_1) = hAPP_f412050202t_bool(Fa,X_1)
           <= hBOOL(hAPP_f777333846l_bool(hAPP_f461621971l_bool(member760917689t_bool,X_1),arrow_1721807329e_Prof)) )
         <= is_fun760276937t_bool(X_1) )
    <=> hBOOL(hAPP_A1785763630i_bool(hAPP_f1552576127i_bool(arrow_610963188ctator,Fa),I_1)) ) )).
...
fof(help_COMBB_1_1_COMBB_000tc__fun_Itc__List__Olist_Itc__Arrow____Order____Mirabell_161,axiom,(
    ! [P,Q,R] : hAPP_l489874441le_alt(hAPP_f1318121625le_alt(hAPP_f634775919le_alt(cOMBB_576205818le_alt,P),Q),R) = hAPP_f1349184697le_alt(P,hAPP_l1869074853le_alt(Q,R)) )).
...
fof(help_COMBC_1_1_COMBC_000tc__List__Olist_Itc__Arrow____Order____Mirabelle____tpnf_137,axiom,(
    ! [P,Q,R] : hAPP_l1747810175t_bool(hAPP_f311173987t_bool(hAPP_f66177535t_bool(cOMBC_672290030t_bool,P),Q),R) = hAPP_f318645548t_bool(hAPP_l1288188215t_bool(P,R),Q) )).

fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__prod_Itc__Arrow____Order____Mirabelle____tp_108,axiom,(
    ! [P,Q] :
      ( is_fun961089132t_bool(P)
     => hAPP_A568203993t_bool(hAPP_f393984045t_bool(cOMBK_673344138le_alt,P),Q) = P ) )).
...
fof(fact_485_split__weak__cong,axiom,(
    ! [Ca,P_1,Q_2] :
      ( hAPP_P1056860425le_alt(hAPP_f1078809103le_alt(produc748227559le_alt,Ca),P_1) = hAPP_P1056860425le_alt(hAPP_f1078809103le_alt(produc748227559le_alt,Ca),Q_2)
     <= P_1 = Q_2 ) )).

fof(fact_583_hd_Osimps,axiom,(
    ! [X_19,Xs_21] :
      ( is_Arr1861959080le_alt(X_19)
     => hd_Arr805754088le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_19),Xs_21)) = X_19 ) )).
...
fof(fact_840_dropWhile__cong,axiom,(
    ! [Q_1,Pa,L_1,K] :
      ( K = L_1
     => ( hAPP_l54953109e_indi(dropWh601337149e_indi(Pa),L_1) = hAPP_l54953109e_indi(dropWh601337149e_indi(Q_1),K)
       <= ! [X_1] :
            ( is_Arr43961803e_indi(X_1)
...
fof(fact_131_splice_Osimps_I2_J,axiom,(
    ! [V_2,Va] : hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,V_2),Va) = hAPP_l726444215le_alt(splice360969192le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,V_2),Va)),nil_Ar126264853le_alt) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__fun_Itc__Arrow____Order____Mirabelle____tpn_126,axiom,(
    ! [P,Q] :
      ( is_fun288122577l_bool(P)
     => hAPP_A1928120382l_bool(hAPP_f1739666797l_bool(cOMBK_8746725le_alt,P),Q) = P ) )).
...
fof(fact_549_list__induct2,axiom,(
    ! [Pa,Xs_1,Ys_1] :
     ...
     => ( ( hBOOL(hAPP_l1386638586t_bool(hAPP_l1747810175t_bool(Pa,Xs_1),Ys_1))
         <= ! [X_1,Xs_17,Y_9,Ys] :
              ( ( hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_17) = hAPP_l1872264749lt_nat(size_s1873794948le_alt,Ys)
...
fof(fact_617_drop__butlast,axiom,(
    ! [N_7,Xs_6] : hAPP_l726444215le_alt(hAPP_n2139729636le_alt(drop_A186780501le_alt,N_7),hAPP_l726444215le_alt(butlas1262502241le_alt,Xs_6)) = hAPP_l726444215le_alt(butlas1262502241le_alt,hAPP_l726444215le_alt(hAPP_n2139729636le_alt(drop_A186780501le_alt,N_7),Xs_6)) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__Arrow____Order____Mirabelle____tpnfnnbpuu___147,axiom,(
    ! [P,Q] :
      ( is_fun1393352280t_bool(P)
     => hAPP_f239852716t_bool(hAPP_f1438487600t_bool(cOMBK_488408421t_bool,P),Q) = P ) )).
...
fof(fact_391_append__butlast__last__id,axiom,(
    ! [Xs_42] :
     ...
     => hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(butlas1262502241le_alt,Xs_42)),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,last_A57386030le_alt(Xs_42)),nil_Ar126264853le_alt)) = Xs_42 ) )).
...
fof(help_If_1_1_If_000tc__prod_Itc__List__Olist_Itc__Arrow____Order____Mirabelle____,axiom,(
    ! [X,Y] : hAPP_P1056860425le_alt(hAPP_P864444517le_alt(if_Pro1306781203le_alt(fTrue),X),Y) = X )).
...
fof(fact_359_lexord__Nil__left,axiom,(
    ! [Y_2,R_2] :
      ( ? [A_7,X_1] :
          ( hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,A_7),X_1) = Y_2
          & is_Arr1861959080le_alt(A_7) )
...
fof(fact_603_listrel__rtrancl__eq__rtrancl__listrel1,axiom,(
    ! [R_2] : hAPP_f1865483825t_bool(listre760726333le_alt,transi1256616594le_alt(R_2)) = transi992120749le_alt(hAPP_f1865483825t_bool(listre904073838le_alt,R_2)) )).

fof(fact_587_hd__append,axiom,(
    ! [Ys_5,Xs_19] :
      ( ( hd_Arr805754088le_alt(Xs_19) = hd_Arr805754088le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_19),Ys_5))
       <= nil_Ar126264853le_alt != Xs_19 )
      & ( hd_Arr805754088le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_19),Ys_5)) = hd_Arr805754088le_alt(Ys_5)
       <= nil_Ar126264853le_alt = Xs_19 ) ) )).
...
fof(help_COMBK_1_1_COMBK_000tc__HOL__Obool_000tc__Arrow____Order____Mirabelle____tpn_102,axiom,(
    ! [P,Q] :
      ( is_bool(P)
     => P = hAPP_A1785763630i_bool(hAPP_b1337486384i_bool(cOMBK_575487463e_indi,P),Q) ) )).
...
fof(fact_504_splitE2,axiom,(
    ! [Q_1,Pa,Z_3] :
      ( ~ ! [X_1,Y_9] :
            ( Z_3 = hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,X_1),Y_9)
...
fof(help_COMBC_1_1_COMBC_000tc__HOL__Obool_000tc__HOL__Obool_000tc__HOL__Obool_U,axiom,(
    ! [P,Q,R] : hAPP_bool_bool(hAPP_b589554111l_bool(P,R),Q) = hAPP_bool_bool(hAPP_b589554111l_bool(hAPP_f1897201897l_bool(cOMBC_bool_bool_bool,P),Q),R) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool_J_000tc__fun_Itc_,axiom,(
    ! [P,Q] : P = hAPP_f856106132t_bool(hAPP_f932544453t_bool(cOMBK_1773325549t_bool,P),Q) )).
...
fof(fact_764_List_Oinsert__def,axiom,(
    ! [X_2,Xs_1] :
      ( ( hAPP_l1493873365le_alt(hAPP_P734992695le_alt(cons_P893004579le_alt,X_2),Xs_1) = hAPP_l1493873365le_alt(hAPP_P734992695le_alt(insert178756925le_alt,X_2),Xs_1)
       <= ~ hBOOL(hAPP_f1634113933l_bool(hAPP_P1610428353l_bool(member1020705648le_alt,X_2),set_Pr1404309362le_alt(Xs_1))) )
      & ( hBOOL(hAPP_f1634113933l_bool(hAPP_P1610428353l_bool(member1020705648le_alt,X_2),set_Pr1404309362le_alt(Xs_1)))
       => hAPP_l1493873365le_alt(hAPP_P734992695le_alt(insert178756925le_alt,X_2),Xs_1) = Xs_1 ) ) )).
...
fof(fact_657_dropWhile__neq__rev,axiom,(
    ! [X_2,Xs_1] :
      ( ( hBOOL(hAPP_f777333846l_bool(hAPP_f461621971l_bool(member760917689t_bool,X_2),set_fu1865467835t_bool(Xs_1)))
       => hAPP_l1660244757t_bool(hAPP_f726713198t_bool(cons_f1803648492t_bool,X_2),hAPP_l1660244757t_bool(rev_fu1957290812t_bool,hAPP_l1660244757t_bool(takeWh1309019107t_bool(hAPP_f146009813l_bool(hAPP_f356431923l_bool(cOMBB_871930928t_bool,fNot),hAPP_f1577179519l_bool(hAPP_f1688301673l_bool(cOMBC_2105056416l_bool,fequal785189517t_bool),X_2))),Xs_1))) = hAPP_l1660244757t_bool(dropWh1552197947t_bool(hAPP_f146009813l_bool(hAPP_f356431923l_bool(cOMBB_871930928t_bool,fNot),hAPP_f1577179519l_bool(hAPP_f1688301673l_bool(cOMBC_2105056416l_bool,fequal785189517t_bool),X_2))),hAPP_l1660244757t_bool(rev_fu1957290812t_bool,Xs_1)) )
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__HOL__Obool_Mtc__HOL__Obool_J_000tc__fun_Itc,axiom,(
    ! [P,Q] :
      ( is_fun_bool_bool(P)
     => hAPP_f210572555l_bool(hAPP_f1460506473l_bool(cOMBK_1693871704t_bool,P),Q) = P ) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__Arrow____Order____Mirabelle____tpnfnnbpuu__,axiom,(
    ! [P,Q] :
      ( is_fun1393352280t_bool(P)
     => hAPP_P1711233733t_bool(hAPP_f1609079369t_bool(cOMBK_1369841150le_alt,P),Q) = P ) )).
...
fof(fact_500_internal__split__def,axiom,(
    produc49943708le_alt = produc748227559le_alt )).
...
fof(fact_309_prod_Oexhaust,axiom,(
    ! [Y_13] :
     ...
     => ~ ! [A_7,B_6] :
            ( hAPP_A702847159le_alt(hAPP_A1505516597le_alt(produc1400112471le_alt,A_7),B_6) != Y_13
           <= ( is_Arr1861959080le_alt(B_6)
              & is_Arr1861959080le_alt(A_7) ) ) ) )).
...
fof(fact_498_curry__split,axiom,(
    ! [F] : F = produc335266950le_alt(hAPP_f1078809103le_alt(produc748227559le_alt,F)) )).
...
fof(fact_424_UNIV__def,axiom,(
    collect_nat(hAPP_b1013836512t_bool(cOMBK_bool_nat,fTrue)) = top_top_fun_nat_bool )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__fun_Itc__fun_Itc__Arrow____Order____Mirabel_148,axiom,(
    ! [P,Q] :
      ( hAPP_A366518464l_bool(hAPP_f1874082285l_bool(cOMBK_1778599651le_alt,P),Q) = P
     <= is_fun158382675l_bool(P) ) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__prod_Itc__Arrow____Order____Mirabelle____tp,axiom,(
    ! [P,Q] :
      ( P = hAPP_n588788980t_bool(hAPP_f1328016200t_bool(cOMBK_856666543ol_nat,P),Q)
     <= is_fun961089132t_bool(P) ) )).

fof(fact_699_in__set__insert,axiom,(
    ! [X_2,Xs_1] :
      ( Xs_1 = hAPP_l726444215le_alt(hAPP_A408086601le_alt(insert960637483le_alt,X_2),Xs_1)
     <= hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_2),set_Ar1565008694le_alt(Xs_1))) ) )).
...
fof(fact_559_mem__splitI2,axiom,(
    ! [Z_3,Ca,P_1] :
      ( ! [A_7,B_6] :
          ( hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,A_7),B_6) = P_1
...
fof(fact_1106_diff__cancel,axiom,(
    ! [K_2,M,N] : hAPP_nat_nat(minus_minus_nat(M),N) = hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(plus_plus_nat(K_2),M)),hAPP_nat_nat(plus_plus_nat(K_2),N)) )).
...
fof(fact_655_dropWhile__neq__rev,axiom,(
    ! [X_2,Xs_1] :
     ...
     => ( hBOOL(hAPP_f250445784l_bool(hAPP_f1253375959l_bool(member520425275t_bool,X_2),set_fu335223357t_bool(Xs_1)))
       => hAPP_l210315413t_bool(hAPP_f1812326636t_bool(cons_f14678382t_bool,X_2),hAPP_l210315413t_bool(rev_fu1629171390t_bool,hAPP_l210315413t_bool(takeWh169821797t_bool(hAPP_f1765205l_bool(hAPP_f152453811l_bool(cOMBB_1459698610t_bool,fNot),hAPP_f1577576703l_bool(hAPP_f1556356969l_bool(cOMBC_1576836772l_bool,fequal1596628751t_bool),X_2))),Xs_1))) = hAPP_l210315413t_bool(dropWh23362493t_bool(hAPP_f1765205l_bool(hAPP_f152453811l_bool(cOMBB_1459698610t_bool,fNot),hAPP_f1577576703l_bool(hAPP_f1556356969l_bool(cOMBC_1576836772l_bool,fequal1596628751t_bool),X_2))),hAPP_l210315413t_bool(rev_fu1629171390t_bool,Xs_1)) ) ) )).
...
fof(fact_471_listrel1I,axiom,(
    ! [Ys_1,Xs_1,Us_1,Vs_1,X_2,Y_2,R_2] :
      ( ( ( hAPP_l1891879573le_alt(hAPP_l1570526551le_alt(append1181015317le_alt,Us_1),hAPP_l1891879573le_alt(hAPP_l656323104le_alt(cons_l650111674le_alt,Y_2),Vs_1)) = Ys_1
         => hBOOL(hAPP_f1757554033l_bool(hAPP_P753566857l_bool(member1208501972le_alt,hAPP_l190821901le_alt(hAPP_l1508829665le_alt(produc26555607le_alt,Xs_1),Ys_1)),hAPP_f1662382841t_bool(listre635569361le_alt,R_2))) )
...
fof(fact_399_append__Cons,axiom,(
    ! [X_29,Xs_39,Ys_16] : hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_29),Xs_39)),Ys_16) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_29),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_39),Ys_16)) )).
...
fof(help_COMBB_1_1_COMBB_000tc__fun_Itc__prod_Itc__Arrow____Order____Mirabelle____tp,axiom,(
    ! [P,Q,R] : hAPP_f344580165t_bool(P,hAPP_A1677245848t_bool(Q,R)) = hAPP_A621939144t_bool(hAPP_f210227915t_bool(hAPP_f758198165t_bool(cOMBB_1769989562e_indi,P),Q),R) )).
...
fof(fact_651_dropWhile__neq__rev,axiom,(
    ! [X_2,Xs_1] :
      ( ( hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_2),hAPP_l248265089st_nat(rev_nat,hAPP_l248265089st_nat(takeWhile_nat(hAPP_f800510211t_bool(hAPP_f894608603t_bool(cOMBB_bool_bool_nat,fNot),hAPP_n1699378549t_bool(hAPP_f229349961t_bool(cOMBC_nat_nat_bool,fequal_nat),X_2))),Xs_1))) = hAPP_l248265089st_nat(dropWhile_nat(hAPP_f800510211t_bool(hAPP_f894608603t_bool(cOMBB_bool_bool_nat,fNot),hAPP_n1699378549t_bool(hAPP_f229349961t_bool(cOMBC_nat_nat_bool,fequal_nat),X_2))),hAPP_l248265089st_nat(rev_nat,Xs_1))
       <= hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_2),set_nat(Xs_1))) )
     <= hBOOL(hAPP_list_nat_bool(distinct_nat,Xs_1)) ) )).
...
fof(fact_400_Cons__eq__appendI,axiom,(
    ! [Xs_38,Zs_2,X_28,Xs1,Ys_15] :
     ...
     => ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys_15),Zs_2) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_28),Xs_38)
...
fof(fact_403_append__Nil2,axiom,(
    ! [Xs_37] : Xs_37 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_37),nil_Ar126264853le_alt) )).
...
fof(fact_598_list__update__swap,axiom,(
    ! [Xs_13,X_16,X_15,I_10,I_9] :
      ( I_9 != I_10
     => hAPP_A832564074le_alt(hAPP_n49391885le_alt(list_u1050032253le_alt(hAPP_A832564074le_alt(hAPP_n49391885le_alt(list_u1050032253le_alt(Xs_13),I_9),X_15)),I_10),X_16) = hAPP_A832564074le_alt(hAPP_n49391885le_alt(list_u1050032253le_alt(hAPP_A832564074le_alt(hAPP_n49391885le_alt(list_u1050032253le_alt(Xs_13),I_10),X_16)),I_9),X_15) ) )).
...
fof(fact_1176_min__Suc2,axiom,(
    ! [M_2,N_2] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,M_2),hAPP_nat_nat(suc,N_2)) = hAPP_nat_nat(nat_case_nat(zero_zero_nat,hAPP_f1914919701at_nat(hAPP_f1585078997at_nat(cOMBB_nat_nat_nat,suc),hAPP_nat_fun_nat_nat(hAPP_f416620757at_nat(cOMBC_nat_nat_nat,ord_min_nat),N_2))),M_2) )).

fof(fact_1180_less__imp__add__positive,axiom,(
    ! [I_2,J] :
      ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,I_2),J))
     => ? [K_1] :
          ( J = hAPP_nat_nat(plus_plus_nat(I_2),K_1)
...
fof(fact_761_dropWhile__append1,axiom,(
    ! [Ys_1,Pa,X_2,Xs_1] :
      ( ( hAPP_l1766111573le_alt(hAPP_l1892800522le_alt(append308931554le_alt,hAPP_l1766111573le_alt(dropWh1907450966le_alt(Pa),Xs_1)),Ys_1) = hAPP_l1766111573le_alt(dropWh1907450966le_alt(Pa),hAPP_l1766111573le_alt(hAPP_l1892800522le_alt(append308931554le_alt,Xs_1),Ys_1))
       <= ~ hBOOL(hAPP_P606313927t_bool(Pa,X_2)) )
     <= hBOOL(hAPP_f592646513l_bool(hAPP_P229966473l_bool(member1441201108le_alt,X_2),set_Pr604701398le_alt(Xs_1))) ) )).
...
fof(fact_843_dropWhile__cong,axiom,(
    ! [Q_1,Pa,L_1,K] :
      ( ( hAPP_l1075146559t_bool(dropWh1133555834t_bool(Q_1),K) = hAPP_l1075146559t_bool(dropWh1133555834t_bool(Pa),L_1)
       <= ! [X_1] :
            ( ( hBOOL(hAPP_f1749234559l_bool(hAPP_f566237389l_bool(member496995196t_bool,X_1),set_fu1384968698t_bool(L_1)))
             => ( hBOOL(hAPP_f592646513l_bool(Pa,X_1))
              <=> hBOOL(hAPP_f592646513l_bool(Q_1,X_1)) ) )
...
fof(fact_344_last_Osimps,axiom,(
    ! [X_33,Xs_46] :
     ...
     => ( ( Xs_46 = nil_Ar126264853le_alt
         => X_33 = last_A57386030le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_33),Xs_46)) )
        & ( nil_Ar126264853le_alt != Xs_46
         => last_A57386030le_alt(Xs_46) = last_A57386030le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_33),Xs_46)) ) ) ) )).
...
fof(fact_668_set__rev,axiom,(
    ! [Xs_1] : set_Ar1565008694le_alt(Xs_1) = set_Ar1565008694le_alt(hAPP_l726444215le_alt(rev_Ar2093961333le_alt,Xs_1)) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Nat__Onat_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool_,axiom,(
    ! [P,Q,R] : hAPP_f54304608l_bool(hAPP_n215258509l_bool(P,R),Q) = hAPP_nat_bool(hAPP_f800510211t_bool(hAPP_f1722879237t_bool(cOMBC_226598744l_bool,P),Q),R) )).
...
fof(fact_401_append__Nil,axiom,(
    ! [Ys_14] : hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,nil_Ar126264853le_alt),Ys_14) = Ys_14 )).

fof(fact_838_dropWhile__cong,axiom,(
    ! [Q_1,Pa,L_1,K] :
      ( ( hAPP_l726444215le_alt(dropWh156852662le_alt(Pa),L_1) = hAPP_l726444215le_alt(dropWh156852662le_alt(Q_1),K)
       <= ! [X_1] :
            ( ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_1),set_Ar1565008694le_alt(L_1)))
             => ( hBOOL(hAPP_A862370221t_bool(Pa,X_1))
              <=> hBOOL(hAPP_A862370221t_bool(Q_1,X_1)) ) )
...
fof(fact_506_split__cong,axiom,(
    ! [P_1,F,G,Q_2] :
      ( ! [X_1,Y_9] :
          ( Q_2 = hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,X_1),Y_9)
         => hAPP_l391088160le_alt(hAPP_l1869074853le_alt(G,X_1),Y_9) = hAPP_l391088160le_alt(hAPP_l1869074853le_alt(F,X_1),Y_9) )
...
fof(fact_891_split__list,axiom,(
    ! [X_2,Xs_1] :
      ( ? [Ys,Zs] : hAPP_l1766111573le_alt(hAPP_l1892800522le_alt(append308931554le_alt,Ys),hAPP_l1766111573le_alt(hAPP_P1057207891le_alt(cons_P993230855le_alt,X_2),Zs)) = Xs_1
     <= hBOOL(hAPP_f592646513l_bool(hAPP_P229966473l_bool(member1441201108le_alt,X_2),set_Pr604701398le_alt(Xs_1))) ) )).
...
fof(fact_415_butlast__append,axiom,(
    ! [Xs_35,Ys_11] :
      ...
      & ( Ys_11 = nil_Ar126264853le_alt
       => hAPP_l726444215le_alt(butlas1262502241le_alt,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_35),Ys_11)) = hAPP_l726444215le_alt(butlas1262502241le_alt,Xs_35) ) ) )).
...
fof(fact_718_takeWhile__append1,axiom,(
    ! [Ys_1,Pa,X_2,Xs_1] :
      ( ( hAPP_l1493873365le_alt(takeWh416411546le_alt(Pa),hAPP_l1493873365le_alt(hAPP_l1686876398le_alt(append1415857790le_alt,Xs_1),Ys_1)) = hAPP_l1493873365le_alt(takeWh416411546le_alt(Pa),Xs_1)
       <= ~ hBOOL(hAPP_P1327827171t_bool(Pa,X_2)) )
     <= hBOOL(hAPP_f1634113933l_bool(hAPP_P1610428353l_bool(member1020705648le_alt,X_2),set_Pr1404309362le_alt(Xs_1))) ) )).
...
fof(fact_654_dropWhile__neq__rev,axiom,(
    ! [X_2,Xs_1] :
      ( hBOOL(hAPP_list_bool_bool(distinct_bool,Xs_1))
     => ( hBOOL(hAPP_f387058535l_bool(hAPP_b1787118453l_bool(member_bool,X_2),set_bool(Xs_1)))
       => hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_2),hAPP_l1189022293t_bool(rev_bool,hAPP_l1189022293t_bool(takeWhile_bool(hAPP_f961197973l_bool(hAPP_f1172769267l_bool(cOMBB_bool_bool_bool,fNot),hAPP_b589554111l_bool(hAPP_f1897201897l_bool(cOMBC_bool_bool_bool,fequal_bool),X_2))),Xs_1))) = hAPP_l1189022293t_bool(dropWhile_bool(hAPP_f961197973l_bool(hAPP_f1172769267l_bool(cOMBB_bool_bool_bool,fNot),hAPP_b589554111l_bool(hAPP_f1897201897l_bool(cOMBC_bool_bool_bool,fequal_bool),X_2))),hAPP_l1189022293t_bool(rev_bool,Xs_1)) ) ) )).
...
fof(fact_441_rotate1__def,axiom,(
    ! [Xs_1] : hAPP_l726444215le_alt(rotate1322903650le_alt,Xs_1) = hAPP_l726444215le_alt(list_c380068407le_alt(nil_Ar126264853le_alt,hAPP_f1777336662le_alt(hAPP_f939319677le_alt(cOMBB_881934114le_alt,hAPP_f1294513379le_alt(cOMBC_1058495865le_alt,append1166636842le_alt)),hAPP_l618618165le_alt(hAPP_f657005563le_alt(cOMBC_1919297930le_alt,cons_A1216297413le_alt),nil_Ar126264853le_alt))),Xs_1) )).

fof(help_COMBK_1_1_COMBK_000tc__HOL__Obool_000tc__Arrow____Order____Mirabelle____tpn,axiom,(
    ! [P,Q] :
      ( P = hAPP_A862370221t_bool(hAPP_b30302907t_bool(cOMBK_1646462604le_alt,P),Q)
     <= is_bool(P) ) )).
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__HOL__Obool_000tc__HOL__Obool_U,axiom,(
    ! [P,Q,R] : hAPP_bool_bool(P,hAPP_bool_bool(Q,R)) = hAPP_bool_bool(hAPP_f961197973l_bool(hAPP_f1172769267l_bool(cOMBB_bool_bool_bool,P),Q),R) )).
...
fof(fact_547_listrel__Cons1,axiom,(
    ! [Y_2,Ys_1,Xs_1,R_2] :
     ...
     => ~ ! [Y_9,Ys] :
           ...
           <= Xs_1 = hAPP_l1891879573le_alt(hAPP_l656323104le_alt(cons_l650111674le_alt,Y_9),Ys) ) ) )).
...
fof(fact_792_dropWhile__append2,axiom,(
    ! [Ys_1,Pa,Xs_1] :
      ( hAPP_l726444215le_alt(dropWh156852662le_alt(Pa),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_1),Ys_1)) = hAPP_l726444215le_alt(dropWh156852662le_alt(Pa),Ys_1)
     <= ! [X_1] :
          ( is_Arr1861959080le_alt(X_1)
         => ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_1),set_Ar1565008694le_alt(Xs_1)))
           => hBOOL(hAPP_A862370221t_bool(Pa,X_1)) ) ) ) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Nat__Onat_000tc__Nat__Onat_000tc__Nat__Onat_U,axiom,(
    ! [P,Q,R] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(P,R),Q) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(hAPP_f416620757at_nat(cOMBC_nat_nat_nat,P),Q),R) )).
...
fof(fact_837_dropWhile__cong,axiom,(
    ! [Q_1,Pa,L_1,K] :
      ( ( ! [X_1] :
       ...
       => hAPP_l248265089st_nat(dropWhile_nat(Q_1),K) = hAPP_l248265089st_nat(dropWhile_nat(Pa),L_1) )
     <= L_1 = K ) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Arrow____Order____Mirabelle____tpnfnnbpuu__Oalt_000t_112,axiom,(
    ! [P,Q,R] : hAPP_f592646513l_bool(hAPP_A187815023l_bool(P,R),Q) = hAPP_A862370221t_bool(hAPP_f1663053423t_bool(hAPP_f653880381t_bool(cOMBC_1635684702l_bool,P),Q),R) )).
...
fof(fact_413_Cons__eq__append__conv,axiom,(
    ! [X_2,Xs_1,Ys_1,Zs_1] :
      ( ( ( hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),Xs_1) = Zs_1
        ...
        | ? [Ys_12] :
            ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys_12),Zs_1) = Xs_1
...
fof(fact_534_length__rotate1,axiom,(
    ! [Xs_26] : hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_26) = hAPP_l1872264749lt_nat(size_s1873794948le_alt,hAPP_l726444215le_alt(rotate1322903650le_alt,Xs_26)) )).
...
fof(fact_577_listrel_Osimps,axiom,(
    ! [A1,A2,R_2] :
      ( ( ? [X_1,Y_9,Xs_17,Ys] :
            ( A1 = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Xs_17)
            & hBOOL(hAPP_f592646513l_bool(hAPP_P229966473l_bool(member1441201108le_alt,hAPP_A702847159le_alt(hAPP_A1505516597le_alt(produc1400112471le_alt,X_1),Y_9)),R_2))
    ...
    ! [Ys_1,Pa,Xs_1] :
      ( ! [X_1] :
          ( ( hBOOL(hAPP_f1599966040l_bool(hAPP_A1602262231l_bool(member1493247163e_indi,X_1),set_Ar219761597e_indi(Xs_1)))
           => hBOOL(hAPP_A1785763630i_bool(Pa,X_1)) )
         <= is_Arr43961803e_indi(X_1) )
     => hAPP_l54953109e_indi(dropWh601337149e_indi(Pa),hAPP_l54953109e_indi(hAPP_l367315107e_indi(append153154761e_indi,Xs_1),Ys_1)) = hAPP_l54953109e_indi(dropWh601337149e_indi(Pa),Ys_1) ) )).
...
fof(fact_89_neq__Nil__conv,axiom,(
    ...
    <=> ? [Y_9,Ys] :
          ( is_Arr1861959080le_alt(Y_9)
          & hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_9),Ys) = Xs_1 ) ) )).
...
fof(fact_629_rev__eq__Cons__iff,axiom,(
    ! [Xs_1,Y_2,Ys_1] :
      ( hAPP_l726444215le_alt(rev_Ar2093961333le_alt,Xs_1) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_2),Ys_1)
    ...
    ! [Xs_1,Y_2,Ys_1,R_2] :
      ( ( ! [X_1] :
       ...
       => ~ ! [Zs] :
             ...
             <= Xs_1 = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_2),Zs) ) )
...
fof(fact_854_takeWhile__cong,axiom,(
    ! [Q_1,Pa,L_1,K] :
      ( K = L_1
     => ( hAPP_l1766111573le_alt(takeWh1529274110le_alt(Q_1),K) = hAPP_l1766111573le_alt(takeWh1529274110le_alt(Pa),L_1)
       <= ! [X_1] :
            ( is_Pro1725146340le_alt(X_1)
           => ( ( hBOOL(hAPP_P606313927t_bool(Pa,X_1))
...
fof(fact_44_not__Cons__self,axiom,(
    ! [Xs_52,X_38] : Xs_52 != hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_38),Xs_52) )).
...
fof(fact_433_snoc__eq__iff__butlast,axiom,(
    ! [Xs_1,X_2,Ys_1] :
      ( ( Ys_1 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_1),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),nil_Ar126264853le_alt))
      <=> ( X_2 = last_A57386030le_alt(Ys_1)
          & Xs_1 = hAPP_l726444215le_alt(butlas1262502241le_alt,Ys_1)
          & Ys_1 != nil_Ar126264853le_alt ) )
     <= is_Arr1861959080le_alt(X_2) ) )).

fof(help_COMBB_1_1_COMBB_000tc__fun_Itc__List__Olist_Itc__Arrow____Order____Mirabell_159,axiom,(
    ! [P,Q,R] : hAPP_l1629075165l_bool(hAPP_f370419053l_bool(hAPP_f1953650287l_bool(cOMBB_283473102le_alt,P),Q),R) = hAPP_f170721165l_bool(P,hAPP_l1869074853le_alt(Q,R)) )).
     ...
     => ( hBOOL(hAPP_bool_bool(Q_1,hAPP_P606313927t_bool(hAPP_f791205069t_bool(produc2022255647t_bool,Pa),Z_3)))
       => ~ ! [X_1,Y_9] :
              ( ( ~ hBOOL(hAPP_bool_bool(Q_1,hAPP_A862370221t_bool(hAPP_A1664620203t_bool(Pa,X_1),Y_9)))
               <= Z_3 = hAPP_A702847159le_alt(hAPP_A1505516597le_alt(produc1400112471le_alt,X_1),Y_9) )
             <= ( is_Arr1861959080le_alt(X_1)
                & is_Arr1861959080le_alt(Y_9) ) ) ) ) )).
...
fof(fact_703_in__set__insert,axiom,(
    ! [X_2,Xs_1] :
      ( hBOOL(hAPP_f250445784l_bool(hAPP_f1253375959l_bool(member520425275t_bool,X_2),set_fu335223357t_bool(Xs_1)))
     => hAPP_l210315413t_bool(hAPP_f1812326636t_bool(insert1946138248t_bool,X_2),Xs_1) = Xs_1 ) )).
...
fof(fact_38_list_Osimps_I3_J,axiom,(
    ! [A_9,List_3] : nil_Ar126264853le_alt != hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,A_9),List_3) )).
...
fof(fact_428_UNIV__def,axiom,(
    top_to1576102282i_bool = collec1611109369e_indi(hAPP_b1337486384i_bool(cOMBK_575487463e_indi,fTrue)) )).
...
fof(fact_755_dropWhile__append1,axiom,(
    ! [Ys_1,Pa,X_2,Xs_1] :
      ( ( ~ hBOOL(hAPP_P1327827171t_bool(Pa,X_2))
       => hAPP_l1493873365le_alt(dropWh1604595954le_alt(Pa),hAPP_l1493873365le_alt(hAPP_l1686876398le_alt(append1415857790le_alt,Xs_1),Ys_1)) = hAPP_l1493873365le_alt(hAPP_l1686876398le_alt(append1415857790le_alt,hAPP_l1493873365le_alt(dropWh1604595954le_alt(Pa),Xs_1)),Ys_1) )
     <= hBOOL(hAPP_f1634113933l_bool(hAPP_P1610428353l_bool(member1020705648le_alt,X_2),set_Pr1404309362le_alt(Xs_1))) ) )).

fof(help_COMBB_1_1_COMBB_000tc__fun_Itc__Arrow____Order____Mirabelle____tpnfnnbpuu__,axiom,(
    ! [P,Q,R] : hAPP_A1664620203t_bool(hAPP_f825175477t_bool(hAPP_f57507985t_bool(cOMBB_1171600517le_alt,P),Q),R) = hAPP_f2014742713t_bool(P,hAPP_A1664620203t_bool(Q,R)) )).
...
fof(fact_340_Prof__def,axiom,(
    pi_Arr990697634t_bool(top_to1576102282i_bool,hAPP_f1659309744l_bool(cOMBK_657557929e_indi,arrow_1681063817le_Lin)) = arrow_1721807329e_Prof )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__fun_Itc__prod_Itc__Arrow____Order____Mirabe,axiom,(
    ! [P,Q] :
      ( P = hAPP_n1674354836l_bool(hAPP_f11902820l_bool(cOMBK_39620975ol_nat,P),Q)
     <= is_fun279392540l_bool(P) ) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__HOL__Obool_Mtc__HOL__Obool_J_000tc__prod_It,axiom,(
    ! [P,Q] :
      ( P = hAPP_P324742453l_bool(hAPP_f2068374643l_bool(cOMBK_246631416le_alt,P),Q)
     <= is_fun_bool_bool(P) ) )).
...
fof(fact_756_dropWhile__append1,axiom,(
    ! [Ys_1,Pa,X_2,Xs_1] :
      ( hBOOL(hAPP_f1599966040l_bool(hAPP_A1602262231l_bool(member1493247163e_indi,X_2),set_Ar219761597e_indi(Xs_1)))
     => ( hAPP_l54953109e_indi(hAPP_l367315107e_indi(append153154761e_indi,hAPP_l54953109e_indi(dropWh601337149e_indi(Pa),Xs_1)),Ys_1) = hAPP_l54953109e_indi(dropWh601337149e_indi(Pa),hAPP_l54953109e_indi(hAPP_l367315107e_indi(append153154761e_indi,Xs_1),Ys_1))
...
fof(fact_418_last__append,axiom,(
    ! [Xs_32,Ys_8] :
      ( ( last_A57386030le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_32),Ys_8)) = last_A57386030le_alt(Ys_8)
       <= nil_Ar126264853le_alt != Ys_8 )
      & ( nil_Ar126264853le_alt = Ys_8
       => last_A57386030le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_32),Ys_8)) = last_A57386030le_alt(Xs_32) ) ) )).
...
fof(fact_723_takeWhile__append1,axiom,(
    ! [Ys_1,Pa,X_2,Xs_1] :
     ...
     => ( ~ hBOOL(hAPP_f965095724l_bool(Pa,X_2))
       => hAPP_l1660244757t_bool(takeWh1309019107t_bool(Pa),Xs_1) = hAPP_l1660244757t_bool(takeWh1309019107t_bool(Pa),hAPP_l1660244757t_bool(hAPP_l776124325t_bool(append1995644103t_bool,Xs_1),Ys_1)) ) ) )).
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__HOL__Obool_000tc__fun_Itc__fun_Itc,axiom,(
    ! [P,Q,R] : hAPP_f312250286l_bool(hAPP_f1765205l_bool(hAPP_f152453811l_bool(cOMBB_1459698610t_bool,P),Q),R) = hAPP_bool_bool(P,hAPP_f312250286l_bool(Q,R)) )).
...
fof(fact_427_UNIV__def,axiom,(
    top_to565915683t_bool = collec2096990994le_alt(hAPP_b1703662281t_bool(cOMBK_306730240le_alt,fTrue)) )).
...
fof(fact_613_list__update__code_I1_J,axiom,(
    ! [I_5,Y_10] : nil_Ar126264853le_alt = hAPP_A832564074le_alt(hAPP_n49391885le_alt(list_u1050032253le_alt(nil_Ar126264853le_alt),I_5),Y_10) )).

fof(fact_508_Cons__in__lex,axiom,(
    ! [X_2,Xs_1,Y_2,Ys_1,R_2] :
      ( ( ( hBOOL(hAPP_f1634113933l_bool(hAPP_P1610428353l_bool(member1020705648le_alt,hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,X_2),Y_2)),R_2))
          & hAPP_l1071513828lt_nat(size_s1310206929le_alt,Xs_1) = hAPP_l1071513828lt_nat(size_s1310206929le_alt,Ys_1) )
...
fof(fact_972_take__Nil,axiom,(
    ! [N_3] : nil_Ar126264853le_alt = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_3),nil_Ar126264853le_alt) )).
...
fof(fact_388_takeWhile__not__last,axiom,(
    ! [Xs_1] :
      ( Xs_1 != nil_Ar126264853le_alt
     => ( hAPP_l726444215le_alt(takeWh536362254le_alt(hAPP_f2014742713t_bool(hAPP_f27970449t_bool(cOMBB_2104979073le_alt,fNot),hAPP_A1664620203t_bool(hAPP_f825175477t_bool(cOMBC_1628726426t_bool,fequal1160105444le_alt),last_A57386030le_alt(Xs_1)))),Xs_1) = hAPP_l726444215le_alt(butlas1262502241le_alt,Xs_1)
       <= hBOOL(hAPP_l1386638586t_bool(distin1223878664le_alt,Xs_1)) ) ) )).
...
fof(fact_833_in__set__conv__decomp,axiom,(
    ! [X_2,Xs_1] :
      ( hBOOL(hAPP_f250445784l_bool(hAPP_f1253375959l_bool(member520425275t_bool,X_2),set_fu335223357t_bool(Xs_1)))
    <=> ? [Ys,Zs] : hAPP_l210315413t_bool(hAPP_l583487011t_bool(append381950793t_bool,Ys),hAPP_l210315413t_bool(hAPP_f1812326636t_bool(cons_f14678382t_bool,X_2),Zs)) = Xs_1 ) )).

fof(fact_1134_diff__diff__cancel,axiom,(
    ! [I_2,N] :
      ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,I_2),N))
     => I_2 = hAPP_nat_nat(minus_minus_nat(N),hAPP_nat_nat(minus_minus_nat(N),I_2)) ) )).
...
fof(fact_758_dropWhile__append1,axiom,(
    ! [Ys_1,Pa,X_2,Xs_1] :
      ( ( hAPP_l210315413t_bool(dropWh23362493t_bool(Pa),hAPP_l210315413t_bool(hAPP_l583487011t_bool(append381950793t_bool,Xs_1),Ys_1)) = hAPP_l210315413t_bool(hAPP_l583487011t_bool(append381950793t_bool,hAPP_l210315413t_bool(dropWh23362493t_bool(Pa),Xs_1)),Ys_1)
       <= ~ hBOOL(hAPP_f312250286l_bool(Pa,X_2)) )
     <= hBOOL(hAPP_f250445784l_bool(hAPP_f1253375959l_bool(member520425275t_bool,X_2),set_fu335223357t_bool(Xs_1))) ) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool_J_000tc__prod_Itc,axiom,(
    ! [P,Q] : P = hAPP_P2136891882t_bool(hAPP_f1809347209t_bool(cOMBK_1632198563le_alt,P),Q) )).
...
fof(fact_1199_add__eq__if,axiom,(
    ! [N,M] :
      ( ( N = hAPP_nat_nat(plus_plus_nat(M),N)
       <= zero_zero_nat = M )
...
fof(fact_486_prod_Osimps_I2_J,axiom,(
    ! [F1,Aa,Ba] : hAPP_l391088160le_alt(hAPP_l1869074853le_alt(F1,Aa),Ba) = hAPP_P1056860425le_alt(hAPP_f1078809103le_alt(produc748227559le_alt,F1),hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,Aa),Ba)) )).

fof(help_COMBC_1_1_COMBC_000tc__Arrow____Order____Mirabelle____tpnfnnbpuu__Oindi_000_105,axiom,(
    ! [P,Q,R] : hAPP_A1785763630i_bool(hAPP_f580451669i_bool(hAPP_f712459161i_bool(cOMBC_1781321570l_bool,P),Q),R) = hAPP_f1599966040l_bool(hAPP_A1602262231l_bool(P,R),Q) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Nat__Onat_000tc__Arrow____Order____Mirabelle____tpnf,axiom,(
    ! [P,Q,R] : hAPP_n1875670159le_alt(hAPP_A1043896845le_alt(hAPP_f1956511609le_alt(cOMBC_1697899890le_alt,P),Q),R) = hAPP_A832564074le_alt(hAPP_n49391885le_alt(P,R),Q) )).
...
fof(fact_902_take__Cons,axiom,(
    ! [N_2,X_2,Xs_1] : hAPP_n1875670159le_alt(nat_ca14895078le_alt(nil_Ar126264853le_alt,hAPP_f402821245le_alt(hAPP_f548810715le_alt(cOMBB_903467948lt_nat,hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2)),hAPP_l382792410le_alt(hAPP_f2068969285le_alt(cOMBC_1511969967le_alt,take_A1601602045le_alt),Xs_1))),N_2) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_2),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),Xs_1)) )).
...
fof(fact_897_converse__rtranclE2,axiom,(
    ! [Xa_1,Xb,Za,Zb,R_2] :
      ( ( ~ ! [A_7,B_6] :
             ...
             <= ( is_Arr1861959080le_alt(B_6)
                & is_Arr1861959080le_alt(A_7) ) )
       <= hAPP_A702847159le_alt(hAPP_A1505516597le_alt(produc1400112471le_alt,Za),Zb) != hAPP_A702847159le_alt(hAPP_A1505516597le_alt(produc1400112471le_alt,Xa_1),Xb) )
...
fof(fact_706_in__set__insert,axiom,(
    ! [X_2,Xs_1] :
      ( hAPP_l1766111573le_alt(hAPP_P1057207891le_alt(insert256706849le_alt,X_2),Xs_1) = Xs_1
     <= hBOOL(hAPP_f592646513l_bool(hAPP_P229966473l_bool(member1441201108le_alt,X_2),set_Pr604701398le_alt(Xs_1))) ) )).
...
fof(fact_410_takeWhile_Osimps_I1_J,axiom,(
    ! [Pa] : hAPP_l726444215le_alt(takeWh536362254le_alt(Pa),nil_Ar126264853le_alt) = nil_Ar126264853le_alt )).
...
fof(help_COMBC_1_1_COMBC_000tc__fun_Itc__Arrow____Order____Mirabelle____tpnfnnbpuu___151,axiom,(
    ! [P,Q,R] : hAPP_f777333846l_bool(hAPP_f461621971l_bool(P,R),Q) = hAPP_f965095724l_bool(hAPP_f146009813l_bool(hAPP_f1956380189l_bool(cOMBC_574836706l_bool,P),Q),R) )).
...
fof(fact_354_butlast_Osimps_I1_J,axiom,(
    hAPP_l726444215le_alt(butlas1262502241le_alt,nil_Ar126264853le_alt) = nil_Ar126264853le_alt )).
...
fof(fact_480_dropWhile__eq__Cons__conv,axiom,(
    ! [Pa,Xs_1,Y_2,Ys_1] :
      ( hAPP_l726444215le_alt(dropWh156852662le_alt(Pa),Xs_1) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_2),Ys_1)
    <=> ( ~ hBOOL(hAPP_A862370221t_bool(Pa,Y_2))
        & Xs_1 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(takeWh536362254le_alt(Pa),Xs_1)),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_2),Ys_1)) ) ) )).
...
fof(fact_829_in__set__conv__decomp,axiom,(
    ! [X_2,Xs_1] :
      ( ? [Ys,Zs] : Xs_1 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),Zs))
    <=> hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_2),set_Ar1565008694le_alt(Xs_1))) ) )).
...
fof(fact_578_lexn__length,axiom,(
    ! [Xs_1,Ys_1,R_2,N_2] :
     ...
     => ( hAPP_l1872264749lt_nat(size_s1873794948le_alt,Ys_1) = N_2
        & N_2 = hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_1) ) ) )).
...
fof(help_COMBK_1_1_COMBK_000tc__HOL__Obool_000tc__fun_Itc__Arrow____Order____Mirabel,axiom,(
    ! [P,Q] :
      ( P = hAPP_f965095724l_bool(hAPP_b1048178734l_bool(cOMBK_272667621t_bool,P),Q)
     <= is_bool(P) ) )).
...
fof(fact_803_takeWhile__append2,axiom,(
    ! [Ys_1,Pa,Xs_1] :
      ( hAPP_l54953109e_indi(takeWh273131493e_indi(Pa),hAPP_l54953109e_indi(hAPP_l367315107e_indi(append153154761e_indi,Xs_1),Ys_1)) = hAPP_l54953109e_indi(hAPP_l367315107e_indi(append153154761e_indi,Xs_1),hAPP_l54953109e_indi(takeWh273131493e_indi(Pa),Ys_1))
     <= ! [X_1] :
          ( ( hBOOL(hAPP_f1599966040l_bool(hAPP_A1602262231l_bool(member1493247163e_indi,X_1),set_Ar219761597e_indi(Xs_1)))
           => hBOOL(hAPP_A1785763630i_bool(Pa,X_1)) )
         <= is_Arr43961803e_indi(X_1) ) ) )).
...
fof(fact_581_length__replicate,axiom,(
    ! [N_12,X_21] : hAPP_l1872264749lt_nat(size_s1873794948le_alt,hAPP_A832564074le_alt(replic351609551le_alt(N_12),X_21)) = N_12 )).
...
fof(help_COMBB_1_1_COMBB_000tc__List__Olist_Itc__Arrow____Order____Mirabelle____tpnf_124,axiom,(
    ! [P,Q,R] : hAPP_l568342716le_alt(P,hAPP_A832564074le_alt(Q,R)) = hAPP_A408086601le_alt(hAPP_f1777336662le_alt(hAPP_f939319677le_alt(cOMBB_881934114le_alt,P),Q),R) )).

fof(fact_591_last__rev,axiom,(
    ! [Xs_16] :
      ( nil_Ar126264853le_alt != Xs_16
     => last_A57386030le_alt(hAPP_l726444215le_alt(rev_Ar2093961333le_alt,Xs_16)) = hd_Arr805754088le_alt(Xs_16) ) )).
...
fof(fact_417_last__appendR,axiom,(
    ! [Xs_33,Ys_9] :
      ( last_A57386030le_alt(Ys_9) = last_A57386030le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_33),Ys_9))
     <= Ys_9 != nil_Ar126264853le_alt ) )).
...
fof(fact_895_drop__Cons,axiom,(
    ! [N_2,X_2,Xs_1] : hAPP_l726444215le_alt(hAPP_n2139729636le_alt(drop_A186780501le_alt,N_2),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),Xs_1)) = hAPP_n1875670159le_alt(nat_ca14895078le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),Xs_1),hAPP_l382792410le_alt(hAPP_f2068969285le_alt(cOMBC_1511969967le_alt,drop_A186780501le_alt),Xs_1)),N_2) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Arrow____Order____Mirabelle____tpnfnnbpuu__Oindi_000_132,axiom,(
    ! [P,Q,R] : hAPP_A1941004017t_bool(hAPP_A621939144t_bool(P,R),Q) = hAPP_A1625428400t_bool(hAPP_A1906441908t_bool(hAPP_f248867553t_bool(cOMBC_898791271t_bool,P),Q),R) )).
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__HOL__Obool_000tc__fun_Itc__Arrow__,axiom,(
    ! [P,Q,R] : hAPP_f965095724l_bool(hAPP_f146009813l_bool(hAPP_f356431923l_bool(cOMBB_871930928t_bool,P),Q),R) = hAPP_bool_bool(P,hAPP_f965095724l_bool(Q,R)) )).
...
fof(fact_502_cond__split__eta,axiom,(
    ! [F,G] :
     ...
     => hAPP_f1078809103le_alt(produc748227559le_alt,F) = G ) )).
...
fof(fact_594_list__update__length,axiom,(
    ! [Xs_14,X_17,Ys_3,Y_12] : hAPP_A832564074le_alt(hAPP_n49391885le_alt(list_u1050032253le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_14),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_17),Ys_3))),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_14)),Y_12) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_14),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_12),Ys_3)) )).
...
fof(fact_308_prod_Oexhaust,axiom,(
    ! [Y_13] :
      ~ ! [A_7,B_6] : Y_13 != hAPP_l391088160le_alt(hAPP_l1869074853le_alt(produc237774329le_alt,A_7),B_6) )).

fof(help_COMBC_1_1_COMBC_000tc__Nat__Onat_000tc__List__Olist_Itc__Arrow____Order____,axiom,(
    ! [P,Q,R] : hAPP_l726444215le_alt(hAPP_n2139729636le_alt(P,R),Q) = hAPP_n1875670159le_alt(hAPP_l382792410le_alt(hAPP_f2068969285le_alt(cOMBC_1511969967le_alt,P),Q),R) )).

fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__prod_Itc__Arrow____Order____Mirabelle____tp_129,axiom,(
    ! [P,Q] :
      ( hAPP_P1861769507t_bool(hAPP_f1783828715t_bool(cOMBK_1901607710le_alt,P),Q) = P
     <= is_fun961089132t_bool(P) ) )).
...
fof(help_COMBC_1_1_COMBC_000tc__List__Olist_Itc__Arrow____Order____Mirabelle____tpnf_121,axiom,(
    ! [P,Q,R] : hAPP_f1634113933l_bool(hAPP_l578398296l_bool(P,R),Q) = hAPP_l1386638586t_bool(hAPP_f318645548t_bool(hAPP_f1728064559t_bool(cOMBC_1740746827l_bool,P),Q),R) )).
...
fof(fact_133_list_Osimps_I5_J,axiom,(
    ! [F1,F2,Aa,List] : hAPP_l726444215le_alt(list_c380068407le_alt(F1,F2),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Aa),List)) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(F2,Aa),List) )).
...
fof(fact_851_takeWhile__cong,axiom,(
    ! [Q_1,Pa,L_1,K] :
      ( ( ! [X_1] :
       ...
       => hAPP_l210315413t_bool(takeWh169821797t_bool(Pa),L_1) = hAPP_l210315413t_bool(takeWh169821797t_bool(Q_1),K) )
     <= K = L_1 ) )).
...
fof(fact_719_takeWhile__append1,axiom,(
    ! [Ys_1,Pa,X_2,Xs_1] :
      ( ( ~ hBOOL(hAPP_A1785763630i_bool(Pa,X_2))
       => hAPP_l54953109e_indi(takeWh273131493e_indi(Pa),hAPP_l54953109e_indi(hAPP_l367315107e_indi(append153154761e_indi,Xs_1),Ys_1)) = hAPP_l54953109e_indi(takeWh273131493e_indi(Pa),Xs_1) )
     <= hBOOL(hAPP_f1599966040l_bool(hAPP_A1602262231l_bool(member1493247163e_indi,X_2),set_Ar219761597e_indi(Xs_1))) ) )).
...
fof(help_COMBK_1_1_COMBK_000tc__fun_Itc__fun_Itc__fun_Itc__Arrow____Order____Mirabel_145,axiom,(
    ! [P,Q] :
      ( P = hAPP_b517355696l_bool(hAPP_f779223135l_bool(cOMBK_1305974367l_bool,P),Q)
     <= is_fun158382675l_bool(P) ) )).

fof(fact_1087_nat__add__right__cancel,axiom,(
    ! [M_2,K,N_2] :
      ( hAPP_nat_nat(plus_plus_nat(N_2),K) = hAPP_nat_nat(plus_plus_nat(M_2),K)
    <=> N_2 = M_2 ) )).
...
fof(fact_416_last__appendL,axiom,(
    ! [Xs_34,Ys_10] :
      ( Ys_10 = nil_Ar126264853le_alt
     => last_A57386030le_alt(Xs_34) = last_A57386030le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_34),Ys_10)) ) )).
...
fof(fact_624_singleton__rev__conv,axiom,(
    ! [X_2,Xs_1] :
      ( hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),nil_Ar126264853le_alt) = Xs_1
    <=> hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_2),nil_Ar126264853le_alt) = hAPP_l726444215le_alt(rev_Ar2093961333le_alt,Xs_1) ) )).
...
fof(fact_88_list_Oexhaust,axiom,(
    ! [Y_15] :
      ( nil_Ar126264853le_alt != Y_15
     => ~ ! [A_7,List_1] :
            ( is_Arr1861959080le_alt(A_7)
           => hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,A_7),List_1) != Y_15 ) ) )).
...
fof(fact_493_split__eta,axiom,(
    ! [F] : F = hAPP_f1078809103le_alt(produc748227559le_alt,hAPP_f746471349le_alt(hAPP_f1532338415le_alt(cOMBB_2017209238le_alt,hAPP_f500394983le_alt(cOMBB_500037706le_alt,F)),produc237774329le_alt)) )).
...
fof(fact_513_tl__append,axiom,(
    ! [Xs_1,Ys_1] : hAPP_l726444215le_alt(list_c380068407le_alt(hAPP_l726444215le_alt(tl_Arr1453005548le_alt,Ys_1),hAPP_f1608056749le_alt(cOMBK_1696648346le_alt,hAPP_l568342716le_alt(hAPP_f1294513379le_alt(cOMBC_1058495865le_alt,append1166636842le_alt),Ys_1))),Xs_1) = hAPP_l726444215le_alt(tl_Arr1453005548le_alt,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_1),Ys_1)) )).
