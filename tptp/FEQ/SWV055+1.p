...
fof(cl5_nebula_norm_0037,conjecture,
    ( ( leq(n0,pv10)
      & ! [C,D] :
          ( ( leq(n0,C)
            & leq(C,minus(n0,n1)) )
         => divide(sqrt(times(minus(a_select3(center,C,n0),a_select2(x,pv10)),minus(a_select3(center,C,n0),a_select2(x,pv10)))),sum(n0,minus(n5,n1),sqrt(times(minus(a_select3(center,D,n0),a_select2(x,pv10)),minus(a_select3(center,D,n0),a_select2(x,pv10)))))) = a_select3(q,pv10,C) )
      & ! [E,F] :
   ...
   <= ( leq(n0,pv10)
      ...
      & ! [A,B] :
          ( ( leq(n0,A)
            & leq(A,minus(pv10,n1)) )
         => n1 = sum(n0,minus(n5,n1),a_select3(q,A,B)) ) ) )).
