...
fof(fact_reals__Archimedean4,axiom,(
    ! [V_x,V_y] :
      ( ( ? [B_n] :
            ( c_Orderings_Oord__class_Oless(tc_RealDef_Oreal,V_x,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealDef_Oreal(tc_Nat_Onat,c_Nat_OSuc(B_n))),V_y))
            & c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),c_RealDef_Oreal(tc_Nat_Onat,B_n)),V_y),V_x) )
...
fof(fact_norm__sgn,axiom,(
    ! [V_x,T_a] :
      ( class_RealVector_Oreal__normed__vector(T_a)
     => ( ( c_Groups_Oone__class_Oone(tc_RealDef_Oreal) = c_RealVector_Onorm__class_Onorm(T_a,c_Groups_Osgn__class_Osgn(T_a,V_x))
...
fof(fact_mult__eq__1__iff,axiom,(
    ...
    <=> hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_ma_2),V_n_2) = c_Nat_OSuc(c_Groups_Ozero__class_Ozero(tc_Nat_Onat)) ) )).
...
fof(fact_eq__diff__iff,axiom,(
    ! [V_n_2,V_ma_2,V_k_2] :
      ( ( ( V_n_2 = V_ma_2
        <=> c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_n_2,V_k_2) = c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_ma_2,V_k_2) )
...
fof(fact_Nat_Oadd__0__right,axiom,(
    ! [V_m] : V_m = c_Groups_Oplus__class_Oplus(tc_Nat_Onat,V_m,c_Groups_Ozero__class_Ozero(tc_Nat_Onat)) )).
...
fof(fact_zdiv__zminus__zminus,axiom,(
    ! [V_b,V_a] : c_Divides_Odiv__class_Odiv(tc_Int_Oint,V_a,V_b) = c_Divides_Odiv__class_Odiv(tc_Int_Oint,c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,V_a),c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,V_b)) )).
...
fof(fact_eq__add__iff2,axiom,(
    ! [V_d_2,V_b_2,V_ca_2,V_e_2,V_a_2,T_a] :
      ...
      <=> c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Groups_Ominus__class_Ominus(T_a,V_b_2,V_a_2)),V_e_2),V_d_2) = V_ca_2 )
     <= class_Rings_Oring(T_a) ) )).
...
fof(fact_less__iff__Suc__add,axiom,(
    ! [V_n_2,V_ma_2] :
      ( ? [B_k] : c_Nat_OSuc(c_Groups_Oplus__class_Oplus(tc_Nat_Onat,V_ma_2,B_k)) = V_n_2
    <=> c_Orderings_Oord__class_Oless(tc_Nat_Onat,V_ma_2,V_n_2) ) )).
...
fof(fact_power__inject__exp,axiom,(
    ! [V_n_2,V_ma_2,V_a_2,T_a] :
     ...
     => ( c_Orderings_Oord__class_Oless(T_a,c_Groups_Oone__class_Oone(T_a),V_a_2)
       => ( V_ma_2 = V_n_2
        <=> hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_a_2),V_n_2) = hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_a_2),V_ma_2) ) ) ) )).
...
fof(fact__0960_A_060_061_Aabs_A_Ir_A_K_Am_J_096,axiom,(
    c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),c_Groups_Oabs__class_Oabs(tc_RealDef_Oreal,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),v_r),v_m____))) )).
...
fof(fact_z3div__def,axiom,(
    ! [V_k,V_l] :
      ( ( c_Divides_Odiv__class_Odiv(tc_Int_Oint,V_k,V_l) = c_SMT_Oz3div(V_k,V_l)
...
fof(fact_ab__semigroup__mult__class_Omult__ac_I1_J,axiom,(
    ! [V_c,V_b,V_a,T_a] :
     ...
     => hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b),V_c)) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_b)),V_c) ) )).
...
fof(fact_nat__add__left__cancel,axiom,(
    ! [V_n_2,V_ma_2,V_k_2] :
      ( c_Groups_Oplus__class_Oplus(tc_Nat_Onat,V_k_2,V_n_2) = c_Groups_Oplus__class_Oplus(tc_Nat_Onat,V_k_2,V_ma_2)
    <=> V_ma_2 = V_n_2 ) )).
...
fof(fact_div__mult__self1,axiom,(
    ! [V_c,V_a,V_b,T_a] :
      ( ( c_Groups_Oplus__class_Oplus(T_a,V_c,c_Divides_Odiv__class_Odiv(T_a,V_a,V_b)) = c_Divides_Odiv__class_Odiv(T_a,c_Groups_Oplus__class_Oplus(T_a,V_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_c),V_b)),V_b)
       <= c_Groups_Ozero__class_Ozero(T_a) != V_b )
     <= class_Divides_Osemiring__div(T_a) ) )).
...
fof(fact_mult__sgn__abs,axiom,(
    ! [V_x,T_a] :
      ( class_Rings_Olinordered__idom(T_a)
     => V_x = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Groups_Osgn__class_Osgn(T_a,V_x)),c_Groups_Oabs__class_Oabs(T_a,V_x)) ) )).
...
fof(fact_div__geq,axiom,(
    ! [V_m,V_n] :
      ( ( ~ c_Orderings_Oord__class_Oless(tc_Nat_Onat,V_m,V_n)
       => c_Nat_OSuc(c_Divides_Odiv__class_Odiv(tc_Nat_Onat,c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_m,V_n),V_n)) = c_Divides_Odiv__class_Odiv(tc_Nat_Onat,V_m,V_n) )
     <= c_Orderings_Oord__class_Oless(tc_Nat_Onat,c_Groups_Ozero__class_Ozero(tc_Nat_Onat),V_n) ) )).
...
fof(fact_div__add__self2,axiom,(
    ! [V_a,V_b,T_a] :
      ( ( V_b != c_Groups_Ozero__class_Ozero(T_a)
       => c_Groups_Oplus__class_Oplus(T_a,c_Divides_Odiv__class_Odiv(T_a,V_a,V_b),c_Groups_Oone__class_Oone(T_a)) = c_Divides_Odiv__class_Odiv(T_a,c_Groups_Oplus__class_Oplus(T_a,V_a,V_b),V_b) )
     <= class_Divides_Osemiring__div(T_a) ) )).
...
fof(fact_divmod__int__rel__div__eq,axiom,(
    ! [V_r_1,V_y,V_b_1,V_a_1] :
     ...
     <= c_Groups_Oplus__class_Oplus(tc_Int_Oint,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Int_Oint),V_b_1),V_y),V_r_1) = V_a_1 ) )).
...
fof(fact_pos__zmult__eq__1__iff,axiom,(
    ! [V_n_2,V_ma_2] :
      ...
      <=> ( V_n_2 = c_Groups_Oone__class_Oone(tc_Int_Oint)
          & c_Groups_Oone__class_Oone(tc_Int_Oint) = V_ma_2 ) )
...
fof(fact_expand__poly__eq,axiom,(
    ! [V_q_2,V_pa_2,T_a] :
      ( ( V_q_2 = V_pa_2
      <=> ! [B_n] : hAPP(c_Polynomial_Ocoeff(T_a,V_q_2),B_n) = hAPP(c_Polynomial_Ocoeff(T_a,V_pa_2),B_n) )
     <= class_Groups_Ozero(T_a) ) )).
...
fof(fact_int__power__div__base,axiom,(
    ! [V_k,V_m] :
      ( ( hAPP(hAPP(c_Power_Opower__class_Opower(tc_Int_Oint),V_k),c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_m,c_Nat_OSuc(c_Groups_Ozero__class_Ozero(tc_Nat_Onat)))) = c_Divides_Odiv__class_Odiv(tc_Int_Oint,hAPP(hAPP(c_Power_Opower__class_Opower(tc_Int_Oint),V_k),V_m),V_k)
...
fof(fact_nat__mult__div__cancel__disj,axiom,(
    ! [V_n,V_m,V_k] :
      ...
      & ( c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = c_Divides_Odiv__class_Odiv(tc_Nat_Onat,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_k),V_m),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_k),V_n))
       <= c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = V_k ) ) )).
...
fof(fact_poly__div__minus__right,axiom,(
    ! [V_y,V_x,T_a] :
      ( c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),c_Divides_Odiv__class_Odiv(tc_Polynomial_Opoly(T_a),V_x,V_y)) = c_Divides_Odiv__class_Odiv(tc_Polynomial_Opoly(T_a),V_x,c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),V_y))
...
fof(fact_real__of__nat__inject,axiom,(
    ! [V_ma_2,V_n_2] :
      ( V_ma_2 = V_n_2
    <=> c_RealDef_Oreal(tc_Nat_Onat,V_ma_2) = c_RealDef_Oreal(tc_Nat_Onat,V_n_2) ) )).
...
fof(fact_div__add__self1,axiom,(
    ! [V_a,V_b,T_a] :
      ( ( c_Groups_Oplus__class_Oplus(T_a,c_Divides_Odiv__class_Odiv(T_a,V_a,V_b),c_Groups_Oone__class_Oone(T_a)) = c_Divides_Odiv__class_Odiv(T_a,c_Groups_Oplus__class_Oplus(T_a,V_b,V_a),V_b)
       <= V_b != c_Groups_Ozero__class_Ozero(T_a) )
     <= class_Divides_Osemiring__div(T_a) ) )).
...
fof(fact_real__mult__left__cancel,axiom,(
    ! [V_b_2,V_a_2,V_ca_2] :
      ( ( hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_ca_2),V_a_2) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_ca_2),V_b_2)
      <=> V_a_2 = V_b_2 )
...
fof(fact_div__mult__mult1__if,axiom,(
    ! [V_b,V_a,V_c,T_a] :
      ( ( ( V_c = c_Groups_Ozero__class_Ozero(T_a)
        ...
        & ( V_c != c_Groups_Ozero__class_Ozero(T_a)
         => c_Divides_Odiv__class_Odiv(T_a,V_a,V_b) = c_Divides_Odiv__class_Odiv(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_c),V_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_c),V_b)) ) )
     <= class_Divides_Osemiring__div(T_a) ) )).
...
fof(fact__0960_A_060_061_Acmod_Ac_096,axiom,(
    c_Orderings_Oord__class_Oless__eq(tc_RealDef_Oreal,c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),c_RealVector_Onorm__class_Onorm(tc_Complex_Ocomplex,v_c____)) )).
...
fof(fact_real__mult__right__cancel,axiom,(
    ! [V_b_2,V_a_2,V_ca_2] :
      ( ( V_a_2 = V_b_2
      <=> hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_a_2),V_ca_2) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_RealDef_Oreal),V_b_2),V_ca_2) )
     <= V_ca_2 != c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal) ) )).
...
fof(fact_div__1,axiom,(
    ! [V_m] : V_m = c_Divides_Odiv__class_Odiv(tc_Nat_Onat,V_m,c_Nat_OSuc(c_Groups_Ozero__class_Ozero(tc_Nat_Onat))) )).
...
fof(fact_mult__cancel2,axiom,(
    ! [V_n_2,V_k_2,V_ma_2] :
      ( ( V_k_2 = c_Groups_Ozero__class_Ozero(tc_Nat_Onat)
        | V_n_2 = V_ma_2 )
    <=> hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_n_2),V_k_2) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_ma_2),V_k_2) ) )).
