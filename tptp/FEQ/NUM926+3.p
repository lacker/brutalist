...
fof(fact_173_comm__semiring__1__class_Onormalizing__semiring__rules_I1_J,axiom,(
    ! [A_102,M_13,B_59] : hAPP_int_int(times_times_int(hAPP_int_int(plus_plus_int(A_102),B_59)),M_13) = hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(A_102),M_13)),hAPP_int_int(times_times_int(B_59),M_13)) )).
...
fof(fact_389_add__scale__eq__noteq,axiom,(
    ! [C_27,D_8,A_72,B_50,R_4] :
     ...
     => ( ( C_27 != D_8
          & B_50 = A_72 )
       => hAPP_real_real(plus_plus_real(B_50),hAPP_real_real(times_times_real(R_4),D_8)) != hAPP_real_real(plus_plus_real(A_72),hAPP_real_real(times_times_real(R_4),C_27)) ) ) )).
...
fof(fact_10_power2__sum,axiom,(
    ! [X_2,Y_2] : hAPP_nat_nat(power_power_nat(hAPP_nat_nat(plus_plus_nat(X_2),Y_2)),number_number_of_nat(bit0(bit1(pls)))) = hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(power_power_nat(X_2),number_number_of_nat(bit0(bit1(pls))))),hAPP_nat_nat(power_power_nat(Y_2),number_number_of_nat(bit0(bit1(pls)))))),hAPP_nat_nat(times_times_nat(hAPP_nat_nat(times_times_nat(number_number_of_nat(bit0(bit1(pls)))),X_2)),Y_2)) )).
...
fof(fact_236_add__numeral__0,axiom,(
    ! [A_95] : hAPP_real_real(plus_plus_real(number267125858f_real(pls)),A_95) = A_95 )).
...
fof(fact_226_comm__semiring__1__class_Onormalizing__semiring__rules_I2_J,axiom,(
    ! [A_97,M_12] : hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(A_97),M_12)),M_12) = hAPP_int_int(times_times_int(hAPP_int_int(plus_plus_int(A_97),one_one_int)),M_12) )).
...
fof(fact_41_comm__semiring__1__class_Onormalizing__semiring__rules_I31_J,axiom,(
    ! [X_24,P_7,Q_7] : hAPP_nat_int(power_power_int(hAPP_nat_int(power_power_int(X_24),P_7)),Q_7) = hAPP_nat_int(power_power_int(X_24),hAPP_nat_nat(times_times_nat(P_7),Q_7)) )).
...
fof(fact_761_real__mult__right__cancel,axiom,(
    ! [A_2,B_2,C_2] :
      ( ( B_2 = A_2
      <=> hAPP_real_real(times_times_real(B_2),C_2) = hAPP_real_real(times_times_real(A_2),C_2) )
     <= C_2 != zero_zero_real ) )).
...
fof(fact_492_power__inject__exp,axiom,(
    ! [Ma,N,A_2] :
      ( ( Ma = N
      <=> hAPP_nat_nat(power_power_nat(A_2),N) = hAPP_nat_nat(power_power_nat(A_2),Ma) )
...
fof(fact_216_semiring__add__number__of,axiom,(
    ! [V_18,V_17] :
     ...
     => ( number_number_of_int(hAPP_int_int(plus_plus_int(V_17),V_18)) = hAPP_int_int(plus_plus_int(number_number_of_int(V_17)),number_number_of_int(V_18))
...
fof(fact_968_diff__is__0__eq,axiom,(
    ...
    <=> zero_zero_nat = hAPP_nat_nat(minus_minus_nat(Ma),N) ) )).
...
fof(fact_280_semiring__mult__2__right,axiom,(
    ! [Z_4] : hAPP_int_int(plus_plus_int(Z_4),Z_4) = hAPP_int_int(times_times_int(Z_4),number_number_of_int(bit0(bit1(pls)))) )).

fof(fact_174_comm__semiring__1__class_Onormalizing__semiring__rules_I1_J,axiom,(
    ! [A_102,M_13,B_59] : hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(A_102),M_13)),hAPP_nat_nat(times_times_nat(B_59),M_13)) = hAPP_nat_nat(times_times_nat(hAPP_nat_nat(plus_plus_nat(A_102),B_59)),M_13) )).

fof(fact_126_comm__semiring__1__class_Onormalizing__semiring__rules_I25_J,axiom,(
    ! [A_106,C_32,D_10] : hAPP_int_int(plus_plus_int(A_106),hAPP_int_int(plus_plus_int(C_32),D_10)) = hAPP_int_int(plus_plus_int(hAPP_int_int(plus_plus_int(A_106),C_32)),D_10) )).

fof(fact_709_mult__zero__left,axiom,(
    ! [A_47] : zero_zero_real = hAPP_real_real(times_times_real(zero_zero_real),A_47) )).
...
fof(fact_699_divisors__zero,axiom,(
    ! [A_50,B_44] :
      ( ( B_44 = zero_zero_nat
        | zero_zero_nat = A_50 )
     <= zero_zero_nat = hAPP_nat_nat(times_times_nat(A_50),B_44) ) )).
...
fof(fact_238_add__numeral__0__right,axiom,(
    ! [A_94] : A_94 = hAPP_real_real(plus_plus_real(A_94),number267125858f_real(pls)) )).
...
fof(fact_465_power__add,axiom,(
    ! [A_65,M_5,N_16] : hAPP_int_int(times_times_int(hAPP_nat_int(power_power_int(A_65),M_5)),hAPP_nat_int(power_power_int(A_65),N_16)) = hAPP_nat_int(power_power_int(A_65),hAPP_nat_nat(plus_plus_nat(M_5),N_16)) )).
...
fof(fact_441_zero__eq__power2,axiom,(
    ! [A_2] :
      ( zero_zero_real = hAPP_nat_real(power_power_real(A_2),number_number_of_nat(bit0(bit1(pls))))
    <=> A_2 = zero_zero_real ) )).
...
fof(fact_257_mult__numeral__1,axiom,(
    ! [A_93] : hAPP_real_real(times_times_real(number267125858f_real(bit1(pls))),A_93) = A_93 )).

fof(fact_224_right__distrib__number__of,axiom,(
    ! [V_15,B_56,C_28] : hAPP_nat_nat(times_times_nat(number_number_of_nat(V_15)),hAPP_nat_nat(plus_plus_nat(B_56),C_28)) = hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(number_number_of_nat(V_15)),B_56)),hAPP_nat_nat(times_times_nat(number_number_of_nat(V_15)),C_28)) )).
...
fof(fact_44_comm__semiring__1__class_Onormalizing__semiring__rules_I33_J,axiom,(
    ! [X_23] :
      ( is_int(X_23)
     => hAPP_nat_int(power_power_int(X_23),one_one_nat) = X_23 ) )).
...
fof(fact_696_power__eq__if,axiom,(
    ! [P_1,M] :
      ( ( hAPP_nat_nat(times_times_nat(P_1),hAPP_nat_nat(power_power_nat(P_1),hAPP_nat_nat(minus_minus_nat(M),one_one_nat))) = hAPP_nat_nat(power_power_nat(P_1),M)
       <= M != zero_zero_nat )
      & ( one_one_nat = hAPP_nat_nat(power_power_nat(P_1),M)
       <= zero_zero_nat = M ) ) )).
...
fof(fact_544_power__0,axiom,(
    ! [A_57] : hAPP_nat_real(power_power_real(A_57),zero_zero_nat) = one_one_real )).
...
fof(fact_12_power2__eq__square__number__of,axiom,(
    ! [W_16] : hAPP_int_int(times_times_int(number_number_of_int(W_16)),number_number_of_int(W_16)) = hAPP_nat_int(power_power_int(number_number_of_int(W_16)),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_247_add__number__of__eq,axiom,(
    ! [V_10,W_9] : hAPP_int_int(plus_plus_int(number_number_of_int(V_10)),number_number_of_int(W_9)) = number_number_of_int(hAPP_int_int(plus_plus_int(V_10),W_9)) )).
...
fof(fact_21_comm__semiring__1__class_Onormalizing__semiring__rules_I29_J,axiom,(
    ! [X_26] : hAPP_nat_nat(power_power_nat(X_26),number_number_of_nat(bit0(bit1(pls)))) = hAPP_nat_nat(times_times_nat(X_26),X_26) )).
...
fof(fact_949_nat__mult__assoc,axiom,(
    ! [M,N_1,K_1] : hAPP_nat_nat(times_times_nat(M),hAPP_nat_nat(times_times_nat(N_1),K_1)) = hAPP_nat_nat(times_times_nat(hAPP_nat_nat(times_times_nat(M),N_1)),K_1) )).
...
fof(fact_591_power__0__left__number__of,axiom,(
    ! [W_4] :
      ...
      & ( one_one_real = hAPP_nat_real(power_power_real(zero_zero_real),number_number_of_nat(W_4))
...
fof(fact_19_comm__semiring__1__class_Onormalizing__semiring__rules_I29_J,axiom,(
    ! [X_26] : hAPP_nat_int(power_power_int(X_26),number_number_of_nat(bit0(bit1(pls)))) = hAPP_int_int(times_times_int(X_26),X_26) )).
...
fof(fact_719_combine__common__factor,axiom,(
    ! [A_46,E,B_42,C_23] : hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(A_46),E)),hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(B_42),E)),C_23)) = hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(hAPP_nat_nat(plus_plus_nat(A_46),B_42)),E)),C_23) )).
...
fof(fact_711_mult__zero__left,axiom,(
    ! [A_47] : zero_zero_int = hAPP_int_int(times_times_int(zero_zero_int),A_47) )).
...
fof(fact_58_comm__semiring__1__class_Onormalizing__semiring__rules_I26_J,axiom,(
    ! [X_22,P_6,Q_6] : hAPP_nat_nat(power_power_nat(X_22),hAPP_nat_nat(plus_plus_nat(P_6),Q_6)) = hAPP_nat_nat(times_times_nat(hAPP_nat_nat(power_power_nat(X_22),P_6)),hAPP_nat_nat(power_power_nat(X_22),Q_6)) )).
...
fof(fact_722_comm__semiring__class_Odistrib,axiom,(
    ! [A_45,B_41,C_22] : hAPP_nat_nat(times_times_nat(hAPP_nat_nat(plus_plus_nat(A_45),B_41)),C_22) = hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(A_45),C_22)),hAPP_nat_nat(times_times_nat(B_41),C_22)) )).
...
fof(fact_971_mult__is__0,axiom,(
    ! [Ma,N] :
      ( ( zero_zero_nat = Ma
        | N = zero_zero_nat )
    <=> zero_zero_nat = hAPP_nat_nat(times_times_nat(Ma),N) ) )).
...
fof(fact_422_number__of__Bit0,axiom,(
    ! [W_5] : hAPP_real_real(plus_plus_real(hAPP_real_real(plus_plus_real(zero_zero_real),number267125858f_real(W_5))),number267125858f_real(W_5)) = number267125858f_real(bit0(W_5)) )).
...
fof(fact_449_power2__eq__imp__eq,axiom,(
    ! [X_14,Y_11] :
      ( hAPP_nat_nat(power_power_nat(Y_11),number_number_of_nat(bit0(bit1(pls)))) = hAPP_nat_nat(power_power_nat(X_14),number_number_of_nat(bit0(bit1(pls))))
...
fof(fact_546_power__0,axiom,(
    ! [A_57] : one_one_int = hAPP_nat_int(power_power_int(A_57),zero_zero_nat) )).
...
fof(fact_235_add__numeral__0,axiom,(
    ! [A_95] :
      ( is_int(A_95)
     => hAPP_int_int(plus_plus_int(number_number_of_int(pls)),A_95) = A_95 ) )).
...
fof(fact_350_comm__semiring__1__class_Onormalizing__semiring__rules_I6_J,axiom,(
    ! [A_79] :
      ( A_79 = hAPP_int_int(plus_plus_int(A_79),zero_zero_int)
     <= is_int(A_79) ) )).
...
fof(fact_221_left__distrib__number__of,axiom,(
    ! [A_98,B_57,V_16] : hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(A_98),number_number_of_nat(V_16))),hAPP_nat_nat(times_times_nat(B_57),number_number_of_nat(V_16))) = hAPP_nat_nat(times_times_nat(hAPP_nat_nat(plus_plus_nat(A_98),B_57)),number_number_of_nat(V_16)) )).

fof(fact_344_comm__semiring__1__class_Onormalizing__semiring__rules_I10_J,axiom,(
    ! [A_81] : hAPP_int_int(times_times_int(A_81),zero_zero_int) = zero_zero_int )).
...
fof(fact_239_mult__number__of__left,axiom,(
    ! [V_14,W_13,Z_8] : hAPP_int_int(times_times_int(number_number_of_int(hAPP_int_int(times_times_int(V_14),W_13))),Z_8) = hAPP_int_int(times_times_int(number_number_of_int(V_14)),hAPP_int_int(times_times_int(number_number_of_int(W_13)),Z_8)) )).

fof(fact_727_add__diff__add,axiom,(
    ! [A_43,C_21,B_40,D_7] : hAPP_real_real(minus_minus_real(hAPP_real_real(plus_plus_real(A_43),C_21)),hAPP_real_real(plus_plus_real(B_40),D_7)) = hAPP_real_real(plus_plus_real(hAPP_real_real(minus_minus_real(A_43),B_40)),hAPP_real_real(minus_minus_real(C_21),D_7)) )).
...
fof(fact_184_comm__semiring__1__class_Onormalizing__semiring__rules_I34_J,axiom,(
    ! [X_21,Y_18,Z_9] : hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(X_21),Y_18)),hAPP_real_real(times_times_real(X_21),Z_9)) = hAPP_real_real(times_times_real(X_21),hAPP_real_real(plus_plus_real(Y_18),Z_9)) )).
...
fof(fact_23_power2__eq__square,axiom,(
    ! [A_112] : hAPP_nat_real(power_power_real(A_112),number_number_of_nat(bit0(bit1(pls)))) = hAPP_real_real(times_times_real(A_112),A_112) )).
...
fof(fact_175_comm__semiring__1__class_Onormalizing__semiring__rules_I1_J,axiom,(
    ! [A_102,M_13,B_59] : hAPP_real_real(times_times_real(hAPP_real_real(plus_plus_real(A_102),B_59)),M_13) = hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(A_102),M_13)),hAPP_real_real(times_times_real(B_59),M_13)) )).

fof(fact_718_combine__common__factor,axiom,(
    ! [A_46,E,B_42,C_23] : hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(hAPP_real_real(plus_plus_real(A_46),B_42)),E)),C_23) = hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(A_46),E)),hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(B_42),E)),C_23)) )).
...
fof(fact_28_add__special_I2_J,axiom,(
    ! [W_15] : hAPP_int_int(plus_plus_int(one_one_int),number_number_of_int(W_15)) = number_number_of_int(hAPP_int_int(plus_plus_int(bit1(pls)),W_15)) )).
...
fof(fact_228_comm__semiring__1__class_Onormalizing__semiring__rules_I2_J,axiom,(
    ! [A_97,M_12] : hAPP_real_real(times_times_real(hAPP_real_real(plus_plus_real(A_97),one_one_real)),M_12) = hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(A_97),M_12)),M_12) )).
...
fof(fact_202_mult__Bit0,axiom,(
    ! [K_1,L] : bit0(hAPP_int_int(times_times_int(K_1),L)) = hAPP_int_int(times_times_int(bit0(K_1)),L) )).
...
fof(fact_708_mult__zero__right,axiom,(
    ! [A_48] : zero_zero_int = hAPP_int_int(times_times_int(A_48),zero_zero_int) )).
...
fof(fact_201_mult__Pls,axiom,(
    ! [W] : pls = hAPP_int_int(times_times_int(pls),W) )).
...
fof(fact_190_comm__semiring__1__class_Onormalizing__semiring__rules_I11_J,axiom,(
    ! [A_99] : A_99 = hAPP_real_real(times_times_real(one_one_real),A_99) )).
...
fof(fact_614_diff__bin__simps_I1_J,axiom,(
    ! [K_1] :
      ( is_int(K_1)
     => K_1 = hAPP_int_int(minus_minus_int(K_1),pls) ) )).
...
fof(fact_343_comm__semiring__1__class_Onormalizing__semiring__rules_I9_J,axiom,(
    ! [A_82] : hAPP_real_real(times_times_real(zero_zero_real),A_82) = zero_zero_real )).
...
fof(fact_1184_StandardRes__def,axiom,(
    ! [M,X_1] : hAPP_int_int(div_mod_int(X_1),M) = standardRes(M,X_1) )).
...
fof(fact_456_sum__power2__eq__zero__iff,axiom,(
    ! [X_2,Y_2] :
      ( ( zero_zero_int = hAPP_int_int(plus_plus_int(hAPP_nat_int(power_power_int(X_2),number_number_of_nat(bit0(bit1(pls))))),hAPP_nat_int(power_power_int(Y_2),number_number_of_nat(bit0(bit1(pls)))))
      <=> ( zero_zero_int = X_2
          & zero_zero_int = Y_2 ) )
     <= ( is_int(Y_2)
        & is_int(X_2) ) ) )).
...
fof(fact_274_quartic__square__square,axiom,(
    ! [X_1] : hAPP_nat_int(power_power_int(X_1),number_number_of_nat(bit0(bit0(bit1(pls))))) = hAPP_nat_int(power_power_int(hAPP_nat_int(power_power_int(X_1),number_number_of_nat(bit0(bit1(pls))))),number_number_of_nat(bit0(bit1(pls)))) )).
    ...
    ! [A,N_1] :
     ...
     => ( hBOOL(hAPP_real_bool(hAPP_r1134773055l_bool(ord_less_real,zero_zero_real),A))
       => ? [X] :
            ...
            & A = hAPP_nat_real(power_power_real(X),N_1)
...
fof(fact_42_comm__semiring__1__class_Onormalizing__semiring__rules_I31_J,axiom,(
    ! [X_24,P_7,Q_7] : hAPP_nat_real(power_power_real(hAPP_nat_real(power_power_real(X_24),P_7)),Q_7) = hAPP_nat_real(power_power_real(X_24),hAPP_nat_nat(times_times_nat(P_7),Q_7)) )).
...
fof(fact_698_divisors__zero,axiom,(
    ! [A_50,B_44] :
      ( zero_zero_real = hAPP_real_real(times_times_real(A_50),B_44)
     => ( zero_zero_real = A_50
        | zero_zero_real = B_44 ) ) )).
...
fof(fact_208_zmult__1,axiom,(
    ! [Z] :
      ( Z = hAPP_int_int(times_times_int(one_one_int),Z)
     <= is_int(Z) ) )).
...
fof(fact_209_times__numeral__code_I5_J,axiom,(
    ! [V,W] : number_number_of_int(hAPP_int_int(times_times_int(V),W)) = hAPP_int_int(times_times_int(number_number_of_int(V)),number_number_of_int(W)) )).
...
fof(fact_423_power__one__right,axiom,(
    ! [A_70] :
      ( A_70 = hAPP_nat_int(power_power_int(A_70),one_one_nat)
     <= is_int(A_70) ) )).
...
fof(fact_539_eq__number__of__Pls__Min,axiom,(
    number_number_of_int(min) != number_number_of_int(pls) )).
...
fof(fact_593_power__0__left__number__of,axiom,(
    ! [W_4] :
      ( ( one_one_int = hAPP_nat_int(power_power_int(zero_zero_int),number_number_of_nat(W_4))
       <= number_number_of_nat(W_4) = zero_zero_nat )
...
fof(fact_185_comm__semiring__1__class_Onormalizing__semiring__rules_I12_J,axiom,(
    ! [A_100] :
      ( A_100 = hAPP_int_int(times_times_int(A_100),one_one_int)
     <= is_int(A_100) ) )).
...
fof(fact_254_number__of__Bit1,axiom,(
    ! [W_7] : number_number_of_int(bit1(W_7)) = hAPP_int_int(plus_plus_int(hAPP_int_int(plus_plus_int(one_one_int),number_number_of_int(W_7))),number_number_of_int(W_7)) )).

fof(fact_1149_zmod__zmult1__eq,axiom,(
    ! [A,B,C] : hAPP_int_int(div_mod_int(hAPP_int_int(times_times_int(A),B)),C) = hAPP_int_int(div_mod_int(hAPP_int_int(times_times_int(A),hAPP_int_int(div_mod_int(B),C))),C) )).

fof(fact_102_comm__semiring__1__class_Onormalizing__semiring__rules_I16_J,axiom,(
    ! [Lx_3,Ly_1,Rx_3] : hAPP_real_real(times_times_real(hAPP_real_real(times_times_real(Lx_3),Rx_3)),Ly_1) = hAPP_real_real(times_times_real(hAPP_real_real(times_times_real(Lx_3),Ly_1)),Rx_3) )).
...
fof(fact_9_power2__sum,axiom,(
    ! [X_2,Y_2] : hAPP_int_int(plus_plus_int(hAPP_int_int(plus_plus_int(hAPP_nat_int(power_power_int(X_2),number_number_of_nat(bit0(bit1(pls))))),hAPP_nat_int(power_power_int(Y_2),number_number_of_nat(bit0(bit1(pls)))))),hAPP_int_int(times_times_int(hAPP_int_int(times_times_int(number_number_of_int(bit0(bit1(pls)))),X_2)),Y_2)) = hAPP_nat_int(power_power_int(hAPP_int_int(plus_plus_int(X_2),Y_2)),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_1017_add__mult__distrib,axiom,(
    ! [M,N_1,K_1] : hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(M),K_1)),hAPP_nat_nat(times_times_nat(N_1),K_1)) = hAPP_nat_nat(times_times_nat(hAPP_nat_nat(plus_plus_nat(M),N_1)),K_1) )).
...
fof(fact_237_add__numeral__0__right,axiom,(
    ! [A_94] :
      ( A_94 = hAPP_int_int(plus_plus_int(A_94),number_number_of_int(pls))
     <= is_int(A_94) ) )).
...
fof(fact_230_comm__semiring__1__class_Onormalizing__semiring__rules_I3_J,axiom,(
    ! [M_11,A_96] : hAPP_nat_nat(plus_plus_nat(M_11),hAPP_nat_nat(times_times_nat(A_96),M_11)) = hAPP_nat_nat(times_times_nat(hAPP_nat_nat(plus_plus_nat(A_96),one_one_nat)),M_11) )).
...
fof(fact_311_power__eq__0__iff,axiom,(
    ! [A_2,N] :
     ...
     => ( ( zero_zero_int = A_2
          & N != zero_zero_nat )
      <=> zero_zero_int = hAPP_nat_int(power_power_int(A_2),N) ) ) )).
...
fof(fact_110_comm__semiring__1__class_Onormalizing__semiring__rules_I19_J,axiom,(
    ! [Lx,Rx,Ry] : hAPP_nat_nat(times_times_nat(Rx),hAPP_nat_nat(times_times_nat(Lx),Ry)) = hAPP_nat_nat(times_times_nat(Lx),hAPP_nat_nat(times_times_nat(Rx),Ry)) )).
...
fof(fact_279_mult__2,axiom,(
    ! [Z_5] : hAPP_real_real(plus_plus_real(Z_5),Z_5) = hAPP_real_real(times_times_real(number267125858f_real(bit0(bit1(pls)))),Z_5) )).
...
fof(fact_170_crossproduct__eq,axiom,(
    ! [W_1,Y_2,X_2,Z_1] :
     ...
     => ( ( W_1 = X_2
          | Z_1 = Y_2 )
      <=> hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(W_1),Z_1)),hAPP_int_int(times_times_int(X_2),Y_2)) = hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(W_1),Y_2)),hAPP_int_int(times_times_int(X_2),Z_1)) ) ) )).
...
fof(fact_346_comm__semiring__1__class_Onormalizing__semiring__rules_I10_J,axiom,(
    ! [A_81] : hAPP_real_real(times_times_real(A_81),zero_zero_real) = zero_zero_real )).
...
fof(fact_649_power2__diff,axiom,(
    ! [X_7,Y_6] : hAPP_int_int(minus_minus_int(hAPP_int_int(plus_plus_int(hAPP_nat_int(power_power_int(X_7),number_number_of_nat(bit0(bit1(pls))))),hAPP_nat_int(power_power_int(Y_6),number_number_of_nat(bit0(bit1(pls)))))),hAPP_int_int(times_times_int(hAPP_int_int(times_times_int(number_number_of_int(bit0(bit1(pls)))),X_7)),Y_6)) = hAPP_nat_int(power_power_int(hAPP_int_int(minus_minus_int(X_7),Y_6)),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_467_power__one,axiom,(
    ! [N_15] : one_one_nat = hAPP_nat_nat(power_power_nat(one_one_nat),N_15) )).
    ...
    ! [V_1,U_2,Y_5,X_6,A_54] :
     ...
     => ( ( hBOOL(hAPP_int_bool(hAPP_i1948725293t_bool(ord_less_eq_int,zero_zero_int),U_2))
         => ( ( hBOOL(hAPP_int_bool(hAPP_i1948725293t_bool(ord_less_int,hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(U_2),X_6)),hAPP_int_int(times_times_int(V_1),Y_5))),A_54))
             <= one_one_int = hAPP_int_int(plus_plus_int(U_2),V_1) )
...
fof(fact_13_power2__eq__square__number__of,axiom,(
    ! [W_16] : hAPP_real_real(times_times_real(number267125858f_real(W_16)),number267125858f_real(W_16)) = hAPP_nat_real(power_power_real(number267125858f_real(W_16)),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_22_power2__eq__square,axiom,(
    ! [A_112] : hAPP_int_int(times_times_int(A_112),A_112) = hAPP_nat_int(power_power_int(A_112),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_160_power__even__eq,axiom,(
    ! [A_103,N_39] : hAPP_nat_real(power_power_real(hAPP_nat_real(power_power_real(A_103),N_39)),number_number_of_nat(bit0(bit1(pls)))) = hAPP_nat_real(power_power_real(A_103),hAPP_nat_nat(times_times_nat(number_number_of_nat(bit0(bit1(pls)))),N_39)) )).
...
fof(fact_463_power__add,axiom,(
    ! [A_65,M_5,N_16] : hAPP_nat_nat(times_times_nat(hAPP_nat_nat(power_power_nat(A_65),M_5)),hAPP_nat_nat(power_power_nat(A_65),N_16)) = hAPP_nat_nat(power_power_nat(A_65),hAPP_nat_nat(plus_plus_nat(M_5),N_16)) )).
...
fof(fact_348_comm__semiring__1__class_Onormalizing__semiring__rules_I5_J,axiom,(
    ! [A_80] : hAPP_nat_nat(plus_plus_nat(zero_zero_nat),A_80) = A_80 )).
...
fof(fact_259_mult__numeral__1__right,axiom,(
    ! [A_92] : hAPP_real_real(times_times_real(A_92),number267125858f_real(bit1(pls))) = A_92 )).
...
fof(fact_29_add__special_I2_J,axiom,(
    ! [W_15] : hAPP_real_real(plus_plus_real(one_one_real),number267125858f_real(W_15)) = number267125858f_real(hAPP_int_int(plus_plus_int(bit1(pls)),W_15)) )).
...
fof(fact_341_comm__semiring__1__class_Onormalizing__semiring__rules_I9_J,axiom,(
    ! [A_82] : zero_zero_int = hAPP_int_int(times_times_int(zero_zero_int),A_82) )).
...
fof(fact_1053_nat__diff__add__eq1,axiom,(
    ! [U_1,M,N_1,J_1,I_1] :
      ( hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(hAPP_nat_nat(minus_minus_nat(I_1),J_1)),U_1)),M)),N_1) = hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(I_1),U_1)),M)),hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(J_1),U_1)),N_1))
...
fof(fact_349_comm__semiring__1__class_Onormalizing__semiring__rules_I5_J,axiom,(
    ! [A_80] : hAPP_real_real(plus_plus_real(zero_zero_real),A_80) = A_80 )).
...
fof(fact_248_add__number__of__eq,axiom,(
    ! [V_10,W_9] : hAPP_real_real(plus_plus_real(number267125858f_real(V_10)),number267125858f_real(W_9)) = number267125858f_real(hAPP_int_int(plus_plus_int(V_10),W_9)) )).
...
fof(fact_688_real__mult__assoc,axiom,(
    ! [Z1,Z2,Z3] : hAPP_real_real(times_times_real(Z1),hAPP_real_real(times_times_real(Z2),Z3)) = hAPP_real_real(times_times_real(hAPP_real_real(times_times_real(Z1),Z2)),Z3) )).
...
fof(fact_258_mult__numeral__1__right,axiom,(
    ! [A_92] :
      ( hAPP_int_int(times_times_int(A_92),number_number_of_int(bit1(pls))) = A_92
     <= is_int(A_92) ) )).
...
fof(fact_134_comm__semiring__1__class_Onormalizing__semiring__rules_I24_J,axiom,(
    ! [A_104,C_30] : hAPP_real_real(plus_plus_real(C_30),A_104) = hAPP_real_real(plus_plus_real(A_104),C_30) )).
...
fof(fact_143_zmult__commute,axiom,(
    ! [Z,W] : hAPP_int_int(times_times_int(W),Z) = hAPP_int_int(times_times_int(Z),W) )).
...
fof(fact_1026_nat__mult__1__right,axiom,(
    ! [N_1] : N_1 = hAPP_nat_nat(times_times_nat(N_1),one_one_nat) )).
...
fof(fact_930_nat__add__left__cancel,axiom,(
    ! [K,Ma,N] :
      ( hAPP_nat_nat(plus_plus_nat(K),N) = hAPP_nat_nat(plus_plus_nat(K),Ma)
    <=> Ma = N ) )).
...
fof(fact_179_crossproduct__noteq,axiom,(
    ! [C_2,D,A_2,B_2] :
     ...
     => ( ( C_2 != D
          & B_2 != A_2 )
      <=> hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(A_2),D)),hAPP_int_int(times_times_int(B_2),C_2)) != hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(A_2),C_2)),hAPP_int_int(times_times_int(B_2),D)) ) ) )).
...
fof(fact_172_crossproduct__eq,axiom,(
    ! [W_1,Y_2,X_2,Z_1] :
      ( hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(W_1),Z_1)),hAPP_real_real(times_times_real(X_2),Y_2)) = hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(W_1),Y_2)),hAPP_real_real(times_times_real(X_2),Z_1))
    <=> ( Z_1 = Y_2
        | W_1 = X_2 ) ) )).
...
fof(fact_1110_d22set__eq__wset,axiom,(
    ! [P_3] :
      ( wset(hAPP_int_int(minus_minus_int(P_3),number_number_of_int(bit0(bit1(pls)))),P_3) = d22set(hAPP_int_int(minus_minus_int(P_3),number_number_of_int(bit0(bit1(pls)))))
     <= hBOOL(hAPP_int_bool(zprime,P_3)) ) )).
...
fof(fact_123_comm__semiring__1__class_Onormalizing__semiring__rules_I21_J,axiom,(
    ! [A_107,B_60,C_33] : hAPP_int_int(plus_plus_int(hAPP_int_int(plus_plus_int(A_107),B_60)),C_33) = hAPP_int_int(plus_plus_int(A_107),hAPP_int_int(plus_plus_int(B_60),C_33)) )).

fof(fact_284_mult__2__right,axiom,(
    ! [Z_3] : hAPP_real_real(plus_plus_real(Z_3),Z_3) = hAPP_real_real(times_times_real(Z_3),number267125858f_real(bit0(bit1(pls)))) )).
...
fof(fact_700_divisors__zero,axiom,(
    ! [A_50,B_44] :
      ( ( zero_zero_int = hAPP_int_int(times_times_int(A_50),B_44)
       => ( zero_zero_int = B_44
          | zero_zero_int = A_50 ) )
     <= ( is_int(B_44)
        & is_int(A_50) ) ) )).
...
fof(fact_632_Euler_Oaux1,axiom,(
    ! [A,X_1] :
      ( is_int(X_1)
     => ( ( ( hAPP_int_int(minus_minus_int(A),one_one_int) != X_1
...
fof(fact_56_comm__semiring__1__class_Onormalizing__semiring__rules_I26_J,axiom,(
    ! [X_22,P_6,Q_6] : hAPP_int_int(times_times_int(hAPP_nat_int(power_power_int(X_22),P_6)),hAPP_nat_int(power_power_int(X_22),Q_6)) = hAPP_nat_int(power_power_int(X_22),hAPP_nat_nat(plus_plus_nat(P_6),Q_6)) )).
...
fof(fact_250_number__of__add,axiom,(
    ! [V_9,W_8] : hAPP_real_real(plus_plus_real(number267125858f_real(V_9)),number267125858f_real(W_8)) = number267125858f_real(hAPP_int_int(plus_plus_int(V_9),W_8)) )).
...
fof(fact_580_power__m1__even,axiom,(
    ! [N_4] : hAPP_nat_real(power_power_real(number267125858f_real(min)),hAPP_nat_nat(times_times_nat(number_number_of_nat(bit0(bit1(pls)))),N_4)) = one_one_real )).
...
fof(fact_1060_is__sum2sq__def,axiom,(
    ! [X_2] :
     ...
     => ( hBOOL(hAPP_int_bool(twoSqu1154269391sum2sq,X_2))
      <=> ? [A_3,B_3] :
            ( is_int(A_3)
            & twoSqu1241645765sum2sq(product_Pair_int_int(A_3,B_3)) = X_2
            & is_int(B_3) ) ) ) )).
...
fof(fact_641_zcong__square__zless,axiom,(
    ! [A,P_1] :
      ( ( ( hBOOL(hAPP_int_bool(hAPP_i1948725293t_bool(ord_less_int,zero_zero_int),A))
         => ( hBOOL(hAPP_int_bool(hAPP_i1948725293t_bool(ord_less_int,A),P_1))
           => ( ( A = one_one_int
                | hAPP_int_int(minus_minus_int(P_1),one_one_int) = A )
...
fof(fact_583_power__eq__0__iff__number__of,axiom,(
    ! [A_2,W_1] :
      ( zero_zero_nat = hAPP_nat_nat(power_power_nat(A_2),number_number_of_nat(W_1))
    <=> ( number_number_of_nat(W_1) != zero_zero_nat
        & zero_zero_nat = A_2 ) ) )).

fof(fact_130_comm__semiring__1__class_Onormalizing__semiring__rules_I22_J,axiom,(
    ! [A_105,C_31,D_9] : hAPP_nat_nat(plus_plus_nat(C_31),hAPP_nat_nat(plus_plus_nat(A_105),D_9)) = hAPP_nat_nat(plus_plus_nat(A_105),hAPP_nat_nat(plus_plus_nat(C_31),D_9)) )).
...
fof(fact_243_number__of__mult,axiom,(
    ! [V_12,W_11] : hAPP_int_int(times_times_int(number_number_of_int(V_12)),number_number_of_int(W_11)) = number_number_of_int(hAPP_int_int(times_times_int(V_12),W_11)) )).
...
fof(fact_360_zadd__0,axiom,(
    ! [Z] :
      ( Z = hAPP_int_int(plus_plus_int(zero_zero_int),Z)
     <= is_int(Z) ) )).
...
fof(fact_887_diffs0__imp__equal,axiom,(
    ! [M,N_1] :
      ( ( N_1 = M
       <= zero_zero_nat = hAPP_nat_nat(minus_minus_nat(N_1),M) )
...
fof(fact_1006_diff__diff__right,axiom,(
    ! [I_1,K_1,J_1] :
      ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,K_1),J_1))
     => hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(plus_plus_nat(I_1),K_1)),J_1) = hAPP_nat_nat(minus_minus_nat(I_1),hAPP_nat_nat(minus_minus_nat(J_1),K_1)) ) )).
...
fof(fact_1156_zmod__zdvd__zmod,axiom,(
    ! [A,B,M] :
      ( hBOOL(hAPP_int_bool(hAPP_i1948725293t_bool(ord_less_int,zero_zero_int),M))
     => ( hAPP_int_int(div_mod_int(A),M) = hAPP_int_int(div_mod_int(hAPP_int_int(div_mod_int(A),B)),M)
...
fof(fact_387_add__scale__eq__noteq,axiom,(
    ! [C_27,D_8,A_72,B_50,R_4] :
      ( ( R_4 != zero_zero_int
       => ( hAPP_int_int(plus_plus_int(B_50),hAPP_int_int(times_times_int(R_4),D_8)) != hAPP_int_int(plus_plus_int(A_72),hAPP_int_int(times_times_int(R_4),C_27))
         <= ( C_27 != D_8
            & B_50 = A_72 ) ) )
     <= ( is_int(C_27)
        & is_int(R_4)
...
fof(fact_46_comm__semiring__1__class_Onormalizing__semiring__rules_I33_J,axiom,(
    ! [X_23] : hAPP_nat_nat(power_power_nat(X_23),one_one_nat) = X_23 )).
...
fof(fact_622_left__diff__distrib__number__of,axiom,(
    ! [A_55,B_46,V_3] : hAPP_real_real(minus_minus_real(hAPP_real_real(times_times_real(A_55),number267125858f_real(V_3))),hAPP_real_real(times_times_real(B_46),number267125858f_real(V_3))) = hAPP_real_real(times_times_real(hAPP_real_real(minus_minus_real(A_55),B_46)),number267125858f_real(V_3)) )).

fof(fact_91_comm__semiring__1__class_Onormalizing__semiring__rules_I13_J,axiom,(
    ! [Lx_6,Ly_4,Rx_6,Ry_4] : hAPP_int_int(times_times_int(hAPP_int_int(times_times_int(Lx_6),Rx_6)),hAPP_int_int(times_times_int(Ly_4),Ry_4)) = hAPP_int_int(times_times_int(hAPP_int_int(times_times_int(Lx_6),Ly_4)),hAPP_int_int(times_times_int(Rx_6),Ry_4)) )).

fof(fact_109_comm__semiring__1__class_Onormalizing__semiring__rules_I19_J,axiom,(
    ! [Lx,Rx,Ry] : hAPP_int_int(times_times_int(Rx),hAPP_int_int(times_times_int(Lx),Ry)) = hAPP_int_int(times_times_int(Lx),hAPP_int_int(times_times_int(Rx),Ry)) )).
...
fof(fact_635_diff__bin__simps_I5_J,axiom,(
    ! [L] : bit1(hAPP_int_int(minus_minus_int(min),L)) = hAPP_int_int(minus_minus_int(min),bit0(L)) )).

fof(fact_293_four__x__squared,axiom,(
    ! [X_1] : hAPP_nat_real(power_power_real(hAPP_real_real(times_times_real(number267125858f_real(bit0(bit1(pls)))),X_1)),number_number_of_nat(bit0(bit1(pls)))) = hAPP_real_real(times_times_real(number267125858f_real(bit0(bit0(bit1(pls))))),hAPP_nat_real(power_power_real(X_1),number_number_of_nat(bit0(bit1(pls))))) )).
...
fof(fact_723_comm__semiring__class_Odistrib,axiom,(
    ! [A_45,B_41,C_22] : hAPP_int_int(times_times_int(hAPP_int_int(plus_plus_int(A_45),B_41)),C_22) = hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(A_45),C_22)),hAPP_int_int(times_times_int(B_41),C_22)) )).
...
fof(fact_728_add__diff__add,axiom,(
    ! [A_43,C_21,B_40,D_7] : hAPP_int_int(minus_minus_int(hAPP_int_int(plus_plus_int(A_43),C_21)),hAPP_int_int(plus_plus_int(B_40),D_7)) = hAPP_int_int(plus_plus_int(hAPP_int_int(minus_minus_int(A_43),B_40)),hAPP_int_int(minus_minus_int(C_21),D_7)) )).

fof(fact_186_comm__semiring__1__class_Onormalizing__semiring__rules_I12_J,axiom,(
    ! [A_100] : A_100 = hAPP_nat_nat(times_times_nat(A_100),one_one_nat) )).
...
fof(fact_720_combine__common__factor,axiom,(
    ! [A_46,E,B_42,C_23] : hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(hAPP_int_int(plus_plus_int(A_46),B_42)),E)),C_23) = hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(A_46),E)),hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(B_42),E)),C_23)) )).
...
fof(fact_879_diff__commute,axiom,(
    ! [I_1,J_1,K_1] : hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(minus_minus_nat(I_1),K_1)),J_1) = hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(minus_minus_nat(I_1),J_1)),K_1) )).
...
fof(fact_642_zspecial__product,axiom,(
    ! [A,B] : hAPP_int_int(minus_minus_int(hAPP_nat_int(power_power_int(A),number_number_of_nat(bit0(bit1(pls))))),hAPP_nat_int(power_power_int(B),number_number_of_nat(bit0(bit1(pls))))) = hAPP_int_int(times_times_int(hAPP_int_int(plus_plus_int(A),B)),hAPP_int_int(minus_minus_int(A),B)) )).
...
fof(fact_176_comm__semiring__1__class_Onormalizing__semiring__rules_I8_J,axiom,(
    ! [A_101,B_58,C_29] : hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(A_101),C_29)),hAPP_int_int(times_times_int(B_58),C_29)) = hAPP_int_int(times_times_int(hAPP_int_int(plus_plus_int(A_101),B_58)),C_29) )).
...
fof(fact_707_mult__zero__right,axiom,(
    ! [A_48] : zero_zero_nat = hAPP_nat_nat(times_times_nat(A_48),zero_zero_nat) )).
...
fof(fact_357_double__eq__0__iff,axiom,(
    ! [A_2] :
      ( zero_zero_real = hAPP_real_real(plus_plus_real(A_2),A_2)
    <=> zero_zero_real = A_2 ) )).
...
fof(fact_103_comm__semiring__1__class_Onormalizing__semiring__rules_I17_J,axiom,(
    ! [Lx_2,Ly,Rx_2] : hAPP_int_int(times_times_int(Lx_2),hAPP_int_int(times_times_int(Ly),Rx_2)) = hAPP_int_int(times_times_int(hAPP_int_int(times_times_int(Lx_2),Ly)),Rx_2) )).
...
fof(fact_120_comm__semiring__1__class_Onormalizing__semiring__rules_I23_J,axiom,(
    ! [A_108,B_61,C_34] : hAPP_int_int(plus_plus_int(hAPP_int_int(plus_plus_int(A_108),B_61)),C_34) = hAPP_int_int(plus_plus_int(hAPP_int_int(plus_plus_int(A_108),C_34)),B_61) )).
...
fof(fact_936_diff__cancel2,axiom,(
    ! [M,K_1,N_1] : hAPP_nat_nat(minus_minus_nat(M),N_1) = hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(plus_plus_nat(M),K_1)),hAPP_nat_nat(plus_plus_nat(N_1),K_1)) )).
...
fof(fact_207_zmult__1__right,axiom,(
    ! [Z] :
      ( is_int(Z)
     => Z = hAPP_int_int(times_times_int(Z),one_one_int) ) )).
...
fof(fact_870_divides__div__not,axiom,(
    ! [X_1,Q_1,N_1,R_1] :
      ( hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(Q_1),N_1)),R_1) = X_1
...
fof(fact_1172_neq__one__mod__two,axiom,(
    ...
    <=> one_one_int = hAPP_int_int(div_mod_int(X_2),number_number_of_int(bit0(bit1(pls)))) ) )).
...
fof(fact_469_power__mult,axiom,(
    ! [A_64,M_4,N_14] : hAPP_nat_nat(power_power_nat(hAPP_nat_nat(power_power_nat(A_64),M_4)),N_14) = hAPP_nat_nat(power_power_nat(A_64),hAPP_nat_nat(times_times_nat(M_4),N_14)) )).
...
fof(fact_457_power__commutes,axiom,(
    ! [A_67,N_18] : hAPP_nat_nat(times_times_nat(hAPP_nat_nat(power_power_nat(A_67),N_18)),A_67) = hAPP_nat_nat(times_times_nat(A_67),hAPP_nat_nat(power_power_nat(A_67),N_18)) )).
...
fof(fact_25_comm__semiring__1__class_Onormalizing__semiring__rules_I36_J,axiom,(
    ! [X_25,N_40] : hAPP_nat_int(power_power_int(X_25),hAPP_nat_nat(times_times_nat(number_number_of_nat(bit0(bit1(pls)))),N_40)) = hAPP_int_int(times_times_int(hAPP_nat_int(power_power_int(X_25),N_40)),hAPP_nat_int(power_power_int(X_25),N_40)) )).
...
fof(fact_61_nat__mult__2__right,axiom,(
    ! [Z] : hAPP_nat_nat(plus_plus_nat(Z),Z) = hAPP_nat_nat(times_times_nat(Z),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_171_crossproduct__eq,axiom,(
    ! [W_1,Y_2,X_2,Z_1] :
      ( ( Y_2 = Z_1
        | X_2 = W_1 )
    <=> hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(W_1),Z_1)),hAPP_nat_nat(times_times_nat(X_2),Y_2)) = hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(W_1),Y_2)),hAPP_nat_nat(times_times_nat(X_2),Z_1)) ) )).
...
fof(fact_183_comm__semiring__1__class_Onormalizing__semiring__rules_I34_J,axiom,(
    ! [X_21,Y_18,Z_9] : hAPP_nat_nat(plus_plus_nat(hAPP_nat_nat(times_times_nat(X_21),Y_18)),hAPP_nat_nat(times_times_nat(X_21),Z_9)) = hAPP_nat_nat(times_times_nat(X_21),hAPP_nat_nat(plus_plus_nat(Y_18),Z_9)) )).
...
fof(fact_133_comm__semiring__1__class_Onormalizing__semiring__rules_I24_J,axiom,(
    ! [A_104,C_30] : hAPP_nat_nat(plus_plus_nat(A_104),C_30) = hAPP_nat_nat(plus_plus_nat(C_30),A_104) )).
...
fof(fact_1142_zmod__eq__dvd__iff,axiom,(
    ...
    <=> hAPP_int_int(div_mod_int(Y_2),N) = hAPP_int_int(div_mod_int(X_2),N) ) )).
...
fof(fact_43_comm__semiring__1__class_Onormalizing__semiring__rules_I31_J,axiom,(
    ! [X_24,P_7,Q_7] : hAPP_nat_nat(power_power_nat(hAPP_nat_nat(power_power_nat(X_24),P_7)),Q_7) = hAPP_nat_nat(power_power_nat(X_24),hAPP_nat_nat(times_times_nat(P_7),Q_7)) )).
...
fof(fact_932_diff__add__inverse2,axiom,(
    ! [M,N_1] : M = hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(plus_plus_nat(M),N_1)),N_1) )).
...
fof(fact_161_power__even__eq,axiom,(
    ! [A_103,N_39] : hAPP_nat_nat(power_power_nat(A_103),hAPP_nat_nat(times_times_nat(number_number_of_nat(bit0(bit1(pls)))),N_39)) = hAPP_nat_nat(power_power_nat(hAPP_nat_nat(power_power_nat(A_103),N_39)),number_number_of_nat(bit0(bit1(pls)))) )).

fof(fact_460_power__mult__distrib,axiom,(
    ! [A_66,B_49,N_17] : hAPP_nat_nat(power_power_nat(hAPP_nat_nat(times_times_nat(A_66),B_49)),N_17) = hAPP_nat_nat(times_times_nat(hAPP_nat_nat(power_power_nat(A_66),N_17)),hAPP_nat_nat(power_power_nat(B_49),N_17)) )).
...
fof(fact_271_power3__eq__cube,axiom,(
    ! [A_91] : hAPP_int_int(times_times_int(hAPP_int_int(times_times_int(A_91),A_91)),A_91) = hAPP_nat_int(power_power_int(A_91),number_number_of_nat(bit1(bit1(pls)))) )).
...
fof(fact_721_comm__semiring__class_Odistrib,axiom,(
    ! [A_45,B_41,C_22] : hAPP_real_real(times_times_real(hAPP_real_real(plus_plus_real(A_45),B_41)),C_22) = hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(A_45),C_22)),hAPP_real_real(times_times_real(B_41),C_22)) )).
...
fof(fact_566_nat__number__of__mult__left,axiom,(
    ! [V_6,K_1,V] :
      ( ( hAPP_nat_nat(times_times_nat(number_number_of_nat(V)),hAPP_nat_nat(times_times_nat(number_number_of_nat(V_6)),K_1)) = hAPP_nat_nat(times_times_nat(number_number_of_nat(hAPP_int_int(times_times_int(V),V_6))),K_1)
       <= ~ hBOOL(hAPP_int_bool(hAPP_i1948725293t_bool(ord_less_int,V),pls)) )
      & ( zero_zero_nat = hAPP_nat_nat(times_times_nat(number_number_of_nat(V)),hAPP_nat_nat(times_times_nat(number_number_of_nat(V_6)),K_1))
       <= hBOOL(hAPP_int_bool(hAPP_i1948725293t_bool(ord_less_int,V),pls)) ) ) )).
...
fof(fact_135_eq__number__of,axiom,(
    ! [X_2,Y_2] :
      ( ( is_int(Y_2)
        & is_int(X_2) )
     => ( number_number_of_int(Y_2) = number_number_of_int(X_2)
      <=> X_2 = Y_2 ) ) )).
...
fof(fact_178_comm__semiring__1__class_Onormalizing__semiring__rules_I8_J,axiom,(
    ! [A_101,B_58,C_29] : hAPP_real_real(times_times_real(hAPP_real_real(plus_plus_real(A_101),B_58)),C_29) = hAPP_real_real(plus_plus_real(hAPP_real_real(times_times_real(A_101),C_29)),hAPP_real_real(times_times_real(B_58),C_29)) )).
...
fof(fact_255_number__of__Bit1,axiom,(
    ! [W_7] : hAPP_real_real(plus_plus_real(hAPP_real_real(plus_plus_real(one_one_real),number267125858f_real(W_7))),number267125858f_real(W_7)) = number267125858f_real(bit1(W_7)) )).

fof(fact_1171_divmod__int__rel__mod__eq,axiom,(
    ! [A_1,B_1,Q_3,Y_1] :
      ( ( A_1 = hAPP_int_int(plus_plus_int(hAPP_int_int(times_times_int(B_1),Q_3)),Y_1)
       => ( ( Y_1 = hAPP_int_int(div_mod_int(A_1),B_1)
           <= zero_zero_int != B_1 )
...
fof(fact_466_power__one,axiom,(
    ! [N_15] : one_one_real = hAPP_nat_real(power_power_real(one_one_real),N_15) )).

fof(fact_631_add__number__of__diff1,axiom,(
    ! [V_2,W_2,C_25] : hAPP_int_int(minus_minus_int(number_number_of_int(hAPP_int_int(plus_plus_int(V_2),W_2))),C_25) = hAPP_int_int(plus_plus_int(number_number_of_int(V_2)),hAPP_int_int(minus_minus_int(number_number_of_int(W_2)),C_25)) )).

fof(fact_96_comm__semiring__1__class_Onormalizing__semiring__rules_I15_J,axiom,(
    ! [Lx_5,Ly_3,Rx_5,Ry_3] : hAPP_real_real(times_times_real(Rx_5),hAPP_real_real(times_times_real(hAPP_real_real(times_times_real(Lx_5),Ly_3)),Ry_3)) = hAPP_real_real(times_times_real(hAPP_real_real(times_times_real(Lx_5),Ly_3)),hAPP_real_real(times_times_real(Rx_5),Ry_3)) )).

fof(fact_697_diff__square,axiom,(
    ! [X_1,Y_1] : hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(power_power_nat(X_1),number_number_of_nat(bit0(bit1(pls))))),hAPP_nat_nat(power_power_nat(Y_1),number_number_of_nat(bit0(bit1(pls))))) = hAPP_nat_nat(times_times_nat(hAPP_nat_nat(plus_plus_nat(X_1),Y_1)),hAPP_nat_nat(minus_minus_nat(X_1),Y_1)) )).
...
fof(fact_129_comm__semiring__1__class_Onormalizing__semiring__rules_I22_J,axiom,(
    ! [A_105,C_31,D_9] : hAPP_int_int(plus_plus_int(C_31),hAPP_int_int(plus_plus_int(A_105),D_9)) = hAPP_int_int(plus_plus_int(A_105),hAPP_int_int(plus_plus_int(C_31),D_9)) )).
...
fof(fact_458_power__commutes,axiom,(
    ! [A_67,N_18] : hAPP_real_real(times_times_real(hAPP_nat_real(power_power_real(A_67),N_18)),A_67) = hAPP_real_real(times_times_real(A_67),hAPP_nat_real(power_power_real(A_67),N_18)) )).
