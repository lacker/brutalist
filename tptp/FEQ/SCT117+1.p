...
fof(fact_measure__def,axiom,(
    ! [T_a] : c_Relation_Oinv__image(tc_Nat_Onat,T_a,c_Wellfounded_Oless__than) = c_Wellfounded_Omeasure(T_a) )).
...
fof(fact_def__wfrec,axiom,(
    ! [V_a_2,V_H_2,V_r_2,T_b,T_a,V_f_2] :
      ( ( c_Wellfounded_Owf(T_a,V_r_2)
       => hAPP(hAPP(V_H_2,c_Recdef_Ocut(T_a,T_b,V_f_2,V_r_2,V_a_2)),V_a_2) = hAPP(V_f_2,V_a_2) )
...
fof(fact_Image__Un,axiom,(
    ! [V_B_2,V_A_2,V_R_2,T_a,T_b] : c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),c_Relation_OImage(T_b,T_a,V_R_2,V_A_2),c_Relation_OImage(T_b,T_a,V_R_2,V_B_2)) = c_Relation_OImage(T_b,T_a,V_R_2,c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_b,tc_HOL_Obool),V_A_2,V_B_2)) )).
...
fof(fact_rtrancl__converse,axiom,(
    ! [V_r_2,T_a] : c_Relation_Oconverse(T_a,T_a,c_Transitive__Closure_Ortrancl(T_a,V_r_2)) = c_Transitive__Closure_Ortrancl(T_a,c_Relation_Oconverse(T_a,T_a,V_r_2)) )).
...
fof(fact_le__iff__sup,axiom,(
    ! [V_ya_2,V_xa_2,T_a] :
      ( class_Lattices_Osemilattice__sup(T_a)
     => ( c_Orderings_Oord__class_Oless__eq(T_a,V_xa_2,V_ya_2)
      <=> V_ya_2 = c_Lattices_Osemilattice__sup__class_Osup(T_a,V_xa_2,V_ya_2) ) ) )).
...
fof(fact_tfl__wfrec,axiom,(
    ! [T_b,T_a,B_M,B_R] :
     ...
     => ! [B_x] : hAPP(hAPP(B_M,c_Recdef_Ocut(T_a,T_b,c_Recdef_Owfrec(T_a,T_b,B_R,B_M),B_R,B_x)),B_x) = hAPP(c_Recdef_Owfrec(T_a,T_b,B_R,B_M),B_x) ) )).
