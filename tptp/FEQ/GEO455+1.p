...
fof(aVECTORu_MULu_LCANCEL,axiom,(
    ...
    <=> ( s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(real,A5)
        | s(cart(real,Q102424),Y) = s(cart(real,Q102424),X) ) ) )).
    ...
    ! [A,N,F0,U,V] :
      ( ( p(s(bool,i(s(fun(fun(A,bool),bool),i(s(fun(fun(A,bool),fun(fun(A,bool),bool)),subset),s(fun(A,bool),U))),s(fun(A,bool),V))))
        & ! [X] :
           ...
           <= ( ~ p(s(bool,i(s(fun(fun(A,bool),bool),i(s(fun(A,fun(fun(A,bool),bool)),in),s(A,X))),s(fun(A,bool),U))))
              & p(s(bool,i(s(fun(fun(A,bool),bool),i(s(fun(A,fun(fun(A,bool),bool)),in),s(A,X))),s(fun(A,bool),V)))) ) ) )
     => s(cart(real,N),i(s(fun(fun(A,cart(real,N)),cart(real,N)),i(s(fun(fun(A,bool),fun(fun(A,cart(real,N)),cart(real,N))),vsum),s(fun(A,bool),U))),s(fun(A,cart(real,N)),F0))) = s(cart(real,N),i(s(fun(fun(A,cart(real,N)),cart(real,N)),i(s(fun(fun(A,bool),fun(fun(A,cart(real,N)),cart(real,N))),vsum),s(fun(A,bool),V))),s(fun(A,cart(real,N)),F0))) ) )).
...
fof(aLINEARu_COMPONENTWISE,axiom,(
    ! [M,N,U_0] :
      ( ! [X,F0,J0,I0] : s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_mul),s(real,i(s(fun(num,real),i(s(fun(cart(real,M),fun(num,real)),d_),s(cart(real,M),X))),s(num,I0))))),s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),F0),s(cart(real,M),i(s(fun(num,cart(real,M)),basis),s(num,I0))))))),s(num,J0))))) = s(real,i(s(fun(num,real),i(s(fun(num,fun(num,real)),i(s(fun(fun(cart(real,M),cart(real,N)),fun(num,fun(num,real))),i(s(fun(cart(real,M),fun(fun(cart(real,M),cart(real,N)),fun(num,fun(num,real)))),U_0),s(cart(real,M),X))),s(fun(cart(real,M),cart(real,N)),F0))),s(num,J0))),s(num,I0)))
     => ! [F0] :
          ( ! [X,J0] :
              ( ( p(s(bool,i(s(fun(num,bool),i(s(fun(num,fun(num,bool)),l_a_),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))),s(num,J0))))
                & p(s(bool,i(s(fun(num,bool),i(s(fun(num,fun(num,bool)),l_a_),s(num,J0))),s(num,i(s(fun(fun(N,bool),num),dimindex),s(fun(N,bool),univ)))))) )
...
fof(aBASISu_EXPANSIONu_UNIQUE,axiom,(
    ! [N,U_0] :
      ( ! [F0,X] :
          ( ! [I0] :
              ( s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),X))),s(num,I0))) = s(real,i(s(fun(num,real),F0),s(num,I0)))
             <= ( p(s(bool,i(s(fun(num,bool),i(s(fun(num,fun(num,bool)),l_a_),s(num,I0))),s(num,i(s(fun(fun(N,bool),num),dimindex),s(fun(N,bool),univ))))))
                & p(s(bool,i(s(fun(num,bool),i(s(fun(num,fun(num,bool)),l_a_),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))),s(num,I0)))) ) )
...
fof(aMATRIXu_ID,axiom,(
    ! [Q117856,U_0] :
      ( ! [X] : s(cart(real,Q117856),X) = s(cart(real,Q117856),i(s(fun(cart(real,Q117856),cart(real,Q117856)),U_0),s(cart(real,Q117856),X)))
...
fof(aLINEARu_EQu_MATRIX,axiom,(
    ! [Q117887,Q117888,F0,G0] :
     ...
     => s(fun(cart(real,Q117887),cart(real,Q117888)),G0) = s(fun(cart(real,Q117887),cart(real,Q117888)),F0) ) )).
...
fof(amatrixu_neg,axiom,(
    ! [N,M,U_1] :
     ...
     <= ! [A5,I0,J0] : s(real,i(s(fun(real,real),realu_neg),s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),d_),s(cart(cart(real,N),M),A5))),s(num,I0))))),s(num,J0))))) = s(real,i(s(fun(num,real),i(s(fun(num,fun(num,real)),i(s(fun(cart(cart(real,N),M),fun(num,fun(num,real))),U_1),s(cart(cart(real,N),M),A5))),s(num,I0))),s(num,J0))) ) )).
...
fof(arows,axiom,(
    ! [N,M,U_0] :
     ...
     => ! [A5] : s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),gspec),s(fun(cart(real,N),bool),i(s(fun(cart(cart(real,N),M),fun(cart(real,N),bool)),U_0),s(cart(cart(real,N),M),A5))))) = s(fun(cart(real,N),bool),i(s(fun(cart(cart(real,N),M),fun(cart(real,N),bool)),rows),s(cart(cart(real,N),M),A5))) ) )).
