...
fof(fact_420_map__filter__simps_I1_J,axiom,(
    ! [F,X_1,Xs] : option306705938at_nat(map_filter_bool_nat(F,Xs),hAPP_l383341732st_nat(cOMBC_1204473209st_nat(cons_nat),map_filter_bool_nat(F,Xs)),hAPP_bool_option_nat(F,X_1)) = map_filter_bool_nat(F,hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),Xs)) )).
...
fof(fact_523_take__0,axiom,(
    ! [Xs_45] : nil_nat = hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,zero_zero_nat),Xs_45) )).
...
fof(fact_265_takeWhile__dropWhile__id,axiom,(
    ! [P_1,Xs] : Xs = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,takeWh536362254le_alt(P_1,Xs)),dropWh156852662le_alt(P_1,Xs)) )).

fof(fact_864_length__splice,axiom,(
    ! [Xs_32,Ys_9] : hAPP_l1872264749lt_nat(size_s1873794948le_alt,splice360969192le_alt(Xs_32,Ys_9)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_32)),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Ys_9)) )).
    ...
    ! [J_1,I_1,Xs] :
     ...
     => ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,I_1),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs)))
       => ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,J_1),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs)))
         => ( hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs),J_1) = hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs),I_1)
          <=> I_1 = J_1 ) ) ) ) )).
...
fof(fact_580_add__Suc__shift,axiom,(
    ! [M,N] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,M),hAPP_nat_nat(suc,N)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(suc,M)),N) )).
...
fof(fact_605_sort__key__simps_I2_J,axiom,(
    ! [F,X_1,Xs] : linord852754176at_nat(F,hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Xs)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(linord1850739451at_nat(F),X_1),linord852754176at_nat(F,Xs)) )).
...
fof(fact_102_append__Nil2,axiom,(
    ! [Xs_79] : hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_79),nil_Ar126264853le_alt) = Xs_79 )).
...
fof(fact_42_splice__Nil2,axiom,(
    ! [Xs_92] : splice360969192le_alt(Xs_92,nil_Ar126264853le_alt) = Xs_92 )).

fof(fact_853_take__replicate,axiom,(
    ! [I_10,K_5,X_38] : hAPP_nat_list_nat(replicate_nat(hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,I_10),K_5)),X_38) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,I_10),hAPP_nat_list_nat(replicate_nat(K_5),X_38)) )).
...
fof(fact_312_takeWhile__not__last,axiom,(
    ! [Xs] :
      ( ( takeWh536362254le_alt(cOMBB_2104979073le_alt(fNot,hAPP_A1664620203t_bool(cOMBC_1628726426t_bool(fequal1160105444le_alt),hAPP_l1105242632le_alt(last_A57386030le_alt,Xs))),Xs) = butlas1262502241le_alt(Xs)
       <= hBOOL(hAPP_l1386638586t_bool(distin1223878664le_alt,Xs)) )
...
fof(fact_609_foldl__foldr1__lemma,axiom,(
    ! [Aa,Xs] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,Aa),hAPP_nat_nat(foldr_nat_nat(plus_plus_nat,Xs),zero_zero_nat)) = foldl_nat_nat(plus_plus_nat,Aa,Xs) )).
...
fof(fact_435_split__list,axiom,(
    ! [X_1,Xs] :
      ( hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),hAPP_l1821533378t_bool(set_nat,Xs)))
     => ? [Ys_6,Zs_2] : Xs = hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Ys_6),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Zs_2)) ) )).

fof(gsy_c_fFalse,axiom,(
    is_bool(fFalse) )).

fof(fact_534_take__Cons,axiom,(
    ! [N_1,X_1,Xs] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,N_1),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Xs)) = hAPP_nat_list_nat(nat_case_list_nat(nil_nat,cOMBB_850496866at_nat(hAPP_n280362926st_nat(cons_nat,X_1),hAPP_l383341732st_nat(cOMBC_1204473209st_nat(take_nat),Xs))),N_1) )).

fof(fact_594_comm__semiring__1__class_Onormalizing__semiring__rules_I5_J,axiom,(
    ! [A_73] : A_73 = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,zero_zero_nat),A_73) )).
...
fof(fact_1035_list__eq__iff__nth__eq,axiom,(
    ! [Xs,Ys] :
      ( Xs = Ys
    <=> ( hAPP_list_nat_nat(size_size_list_nat,Ys) = hAPP_list_nat_nat(size_size_list_nat,Xs)
        & ! [I_4] :
...
fof(fact_164_rev__eq__Cons__iff,axiom,(
    ...
    <=> hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,rev_Ar2093961333le_alt(Ys)),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_2),nil_Ar126264853le_alt)) = Xs ) )).
...
fof(fact_159_replicate__append__same,axiom,(
    ! [I_13,X_110] : hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,hAPP_nat_list_nat(replicate_nat(I_13),X_110)),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_110),nil_nat)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_110),hAPP_nat_list_nat(replicate_nat(I_13),X_110)) )).
...
fof(fact_557_rev__foldl__cons,axiom,(
    ! [Xs] : rev_Ar2093961333le_alt(Xs) = foldl_1200072380le_alt(cOMBC_1919297930le_alt(cons_A1216297413le_alt),nil_Ar126264853le_alt,Xs) )).
...
fof(fact_94_append__Cons,axiom,(
    ! [X_115,Xs_81,Ys_24] : hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_115),Xs_81)),Ys_24) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_115),hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs_81),Ys_24)) )).

fof(fact_181_rev__rev__ident,axiom,(
    ! [Xs_66] : Xs_66 = rev_nat(rev_nat(Xs_66)) )).

fof(fact_433_split__list,axiom,(
    ! [X_1,Xs] :
      ( ? [Ys_6,Zs_2] : hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,Ys_6),hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),Zs_2)) = Xs
     <= hBOOL(hAPP_f387058535l_bool(hAPP_b1787118453l_bool(member_bool,X_1),hAPP_l96088310l_bool(set_bool,Xs))) ) )).
...
fof(fact_780_min__max_Osup__inf__distrib1,axiom,(
    ! [X_48,Y_33,Z_17] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_48),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,Y_33),Z_17)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_48),Y_33)),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_48),Z_17)) )).
...
fof(fact_1120_Skolem__list__nth,axiom,(
    ! [P_1,K_3] :
      ( ? [Xs_19] :
          ( K_3 = hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_19)
          & ! [I_4] :
...
fof(fact_27_insert__Nil,axiom,(
    ! [X_1] : hAPP_l1189022293t_bool(hAPP_b994696797t_bool(insert_bool,X_1),nil_bool) = hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),nil_bool) )).
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__fun_Itc__HOL__Obool_Mtc__HOL__Oboo_003,axiom,(
    ! [P,Q,R] : hAPP_A822657487l_bool(cOMBB_803794783le_alt(P,Q),R) = hAPP_b589554111l_bool(P,hAPP_A862370221t_bool(Q,R)) )).

fof(help_COMBS_1_1_COMBS_000tc__Arrow____Order____Mirabelle____tpnfnnbpuu__Oalt_000t,axiom,(
    ! [P,Q,R] : hAPP_bool_bool(hAPP_A822657487l_bool(P,R),hAPP_A862370221t_bool(Q,R)) = hAPP_A862370221t_bool(cOMBS_1393264256l_bool(P,Q),R) )).
...
fof(fact_882_length__Suc__conv,axiom,(
    ...
    <=> ? [Y_25,Ys_6] :
          ...
          & N_1 = hAPP_l1872264749lt_nat(size_s1873794948le_alt,Ys_6)
...
fof(fact_1184_map__Suc__upt,axiom,(
    ! [M_1,N_1] : hAPP_nat_list_nat(upt(hAPP_nat_nat(suc,M_1)),hAPP_nat_nat(suc,N_1)) = map_nat_nat(suc,hAPP_nat_list_nat(upt(M_1),N_1)) )).
...
fof(fact_769_min__max_Oinf_Oidem,axiom,(
    ! [A_36] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,A_36),A_36) = A_36 )).
...
fof(fact_20_not__Cons__self2,axiom,(
    ! [X_125,Xs_96] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_125),Xs_96) != Xs_96 )).
...
fof(fact_411_takeWhile__cong,axiom,(
    ! [Q_1,P_1,L_2,K_3] :
      ( ( ! [X_4] :
       ...
       => takeWh536362254le_alt(Q_1,K_3) = takeWh536362254le_alt(P_1,L_2) )
     <= L_2 = K_3 ) )).
...
fof(fact_776_min__max_Oinf_Oassoc,axiom,(
    ! [A_32,B_33,C_17] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,A_32),B_33)),C_17) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,A_32),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,B_33),C_17)) )).
...
fof(fact_501_remove1_Osimps_I1_J,axiom,(
    ! [X_92] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(remove1_nat,X_92),nil_nat) = nil_nat )).
...
fof(fact_544_list_Osize_I2_J,axiom,(
    ! [Fa,Aa,List_1] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_bool_nat(Fa,Aa)),list_size_bool(Fa,List_1))),hAPP_nat_nat(suc,zero_zero_nat)) = list_size_bool(Fa,hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,Aa),List_1)) )).
...
fof(fact_382_dropWhile__eq__Nil__conv,axiom,(
    ! [P_1,Xs] :
      ( ! [X_4] :
         ...
         => ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_4),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs)))
           => hBOOL(hAPP_A862370221t_bool(P_1,X_4)) ) )
    <=> dropWh156852662le_alt(P_1,Xs) = nil_Ar126264853le_alt ) )).

fof(fact_33_distinct__butlast,axiom,(
    ! [Xs_95] :
      ( Xs_95 != nil_Ar126264853le_alt
...
fof(fact_602_comm__semiring__1__class_Onormalizing__semiring__rules_I25_J,axiom,(
    ! [A_68,C_36,D_8] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_68),C_36)),D_8) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_68),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,C_36),D_8)) )).

fof(fact_770_min__max_Oinf_Ocommute,axiom,(
    ! [A_35,B_36] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,A_35),B_36) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,B_36),A_35) )).
...
fof(fact_753_list_Osize_I4_J,axiom,(
    ! [A_42,List] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_list_nat_nat(size_size_list_nat,List)),hAPP_nat_nat(suc,zero_zero_nat)) = hAPP_list_nat_nat(size_size_list_nat,hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,A_42),List)) )).
...
fof(fact_419_map__filter__simps_I1_J,axiom,(
    ! [F,X_1,Xs] : map_fi1996871376le_alt(F,hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),Xs)) = option468438226le_alt(map_fi1996871376le_alt(F,Xs),hAPP_l618618165le_alt(cOMBC_1919297930le_alt(cons_A1216297413le_alt),map_fi1996871376le_alt(F,Xs)),hAPP_b803953466le_alt(F,X_1)) )).
...
fof(fact_283_replicate__eq__replicate,axiom,(
    ! [M_1,X_1,N_1,Y_2] :
     ...
     => ( ( M_1 = N_1
          & ( X_1 = Y_2
           <= M_1 != zero_zero_nat ) )
      <=> hAPP_A832564074le_alt(replic351609551le_alt(M_1),X_1) = hAPP_A832564074le_alt(replic351609551le_alt(N_1),Y_2) ) ) )).
...
fof(fact_205_tl_Osimps_I2_J,axiom,(
    ! [X_106,Xs_61] : tl_Arr1453005548le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_106),Xs_61)) = Xs_61 )).
...
fof(fact_47_butlast_Osimps_I2_J,axiom,(
    ! [X_121,Xs_91] :
      ( ( butlas1262502241le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_121),Xs_91)) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_121),butlas1262502241le_alt(Xs_91))
       <= nil_Ar126264853le_alt != Xs_91 )
      & ( butlas1262502241le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_121),Xs_91)) = nil_Ar126264853le_alt
       <= nil_Ar126264853le_alt = Xs_91 ) ) )).
...
fof(fact_5_list_Osimps_I2_J,axiom,(
    ! [A_85,List_4] : nil_nat != hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,A_85),List_4) )).

fof(help_COMBB_1_1_COMBB_000tc__List__Olist_Itc__HOL__Obool_J_000tc__List__Olist_Itc,axiom,(
    ! [P,Q,R] : hAPP_l1189022293t_bool(P,hAPP_nat_list_bool(Q,R)) = hAPP_nat_list_bool(cOMBB_1891801486ol_nat(P,Q),R) )).
...
fof(fact_1061_in__set__conv__nth,axiom,(
    ! [X_1,Xs] :
      ( ? [I_4] :
          ( X_1 = hAPP_nat_nat(nth_nat(Xs),I_4)
          & hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,I_4),hAPP_list_nat_nat(size_size_list_nat,Xs))) )
    <=> hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),hAPP_l1821533378t_bool(set_nat,Xs))) ) )).
...
fof(fact_206_tl_Osimps_I2_J,axiom,(
    ! [X_106,Xs_61] : Xs_61 = tl_nat(hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_106),Xs_61)) )).
...
fof(fact_779_min__max_Oinf__sup__absorb,axiom,(
    ! [X_49,Y_34] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,X_49),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_49),Y_34)) = X_49 )).
...
fof(fact_341_in__set__insert,axiom,(
    ! [X_1,Xs] :
      ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_1),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs)))
     => hAPP_l726444215le_alt(hAPP_A408086601le_alt(insert960637483le_alt,X_1),Xs) = Xs ) )).
...
fof(fact_442_sublist__Cons,axiom,(
    ! [X_1,L_2,A] : sublist_bool(hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),L_2),A) = hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,if_list_bool(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,zero_zero_nat),A),hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),nil_bool),nil_bool)),sublist_bool(L_2,collect_nat(hAPP_f800510211t_bool(cOMBC_226598744l_bool(cOMBB_1146692694ol_nat(member_nat,suc)),A)))) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Arrow____Order____Mirabelle____tpnfnnbpuu__Oalt_000t,axiom,(
    ! [P,Q,R] : hAPP_A862370221t_bool(hAPP_A1664620203t_bool(cOMBC_1628726426t_bool(P),Q),R) = hAPP_A862370221t_bool(hAPP_A1664620203t_bool(P,R),Q) )).
...
fof(fact_627_max__add__distrib__left,axiom,(
    ! [X_88,Y_62,Z_26] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_88),Y_62)),Z_26) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,X_88),Z_26)),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,Y_62),Z_26)) )).
...
fof(fact_556_rev__foldl__cons,axiom,(
    ! [Xs] : foldl_list_nat_nat(cOMBC_1204473209st_nat(cons_nat),nil_nat,Xs) = rev_nat(Xs) )).

fof(fact_143_rev__cases,axiom,(
    ! [Xs] :
      ( Xs != nil_bool
     => ~ ! [Ys_6,Y_25] :
            ( hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,Ys_6),hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,Y_25),nil_bool)) != Xs
           <= is_bool(Y_25) ) ) )).
...
fof(fact_330_set__rev,axiom,(
    ! [Xs] : hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs) = hAPP_l82377208t_bool(set_Ar1565008694le_alt,rev_Ar2093961333le_alt(Xs)) )).
...
fof(fact_597_sum__eq__0__conv,axiom,(
    ! [M_1,Ns] :
      ( zero_zero_nat = foldl_nat_nat(plus_plus_nat,M_1,Ns)
    <=> ( ! [X_4] :
            ( zero_zero_nat = X_4
...
fof(fact_668_insort__key_Osimps_I2_J,axiom,(
    ! [Ys,F,X_1,Y_2] :
      ...
      & ( hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_2),hAPP_l248265089st_nat(hAPP_n280362926st_nat(linord1850739451at_nat(F),X_1),Ys)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(linord1850739451at_nat(F),X_1),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_2),Ys))
       <= ~ hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,hAPP_nat_nat(F,X_1)),hAPP_nat_nat(F,Y_2))) ) ) )).
...
fof(fact_574_add__0,axiom,(
    ! [A_76] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,zero_zero_nat),A_76) = A_76 )).
...
fof(fact_1144_nth__via__drop,axiom,(
    ! [N_15,Xs_15,Y_1,Ys_2] :
      ( ( hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_1),Ys_2) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(drop_A186780501le_alt,N_15),Xs_15)
       => Y_1 = hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs_15),N_15) )
...
fof(fact_565_ab__semigroup__add__class_Oadd__ac_I1_J,axiom,(
    ! [A_79,B_67,C_40] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_79),B_67)),C_40) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_79),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,B_67),C_40)) )).
...
fof(fact_7_list_Osimps_I3_J,axiom,(
    ! [A_84,List_2] : nil_Ar126264853le_alt != hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,A_84),List_2) )).
...
fof(fact_754_list_Osize_I4_J,axiom,(
    ! [A_42,List] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_l1872264749lt_nat(size_s1873794948le_alt,List)),hAPP_nat_nat(suc,zero_zero_nat)) = hAPP_l1872264749lt_nat(size_s1873794948le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,A_42),List)) )).
...
fof(fact_87_maps__simps_I1_J,axiom,(
    ! [F,X_1,Xs] : maps_n2115510812le_alt(F,hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Xs)) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_n1875670159le_alt(F,X_1)),maps_n2115510812le_alt(F,Xs)) )).
...
fof(fact_1199_upt__add__eq__append,axiom,(
    ! [K,I,J] :
      ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,I),J))
     => hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,hAPP_nat_list_nat(upt(I),J)),hAPP_nat_list_nat(upt(J),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,J),K))) = hAPP_nat_list_nat(upt(I),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,J),K)) ) )).
...
fof(fact_1094_dropWhile__nth,axiom,(
    ! [J_1,P_1,Xs] :
      ( hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,J_1),hAPP_l1872264749lt_nat(size_s1873794948le_alt,takeWh536362254le_alt(P_1,Xs)))) = hAPP_n401316912le_alt(nth_Ar1113433366le_alt(dropWh156852662le_alt(P_1,Xs)),J_1)
...
fof(fact_115_eq__Nil__appendI,axiom,(
    ! [Xs_78,Ys_21] :
      ( hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,nil_nat),Ys_21) = Xs_78
     <= Ys_21 = Xs_78 ) )).
...
fof(fact_282_replicate__eq__replicate,axiom,(
    ! [M_1,X_1,N_1,Y_2] :
      ( ( ( Y_2 = X_1
         <= M_1 != zero_zero_nat )
        & N_1 = M_1 )
    <=> hAPP_nat_list_nat(replicate_nat(N_1),Y_2) = hAPP_nat_list_nat(replicate_nat(M_1),X_1) ) )).
...
fof(fact_470_nat__case__Suc,axiom,(
    ! [F1,F2,Nat_3] : hAPP_nat_nat(F2,Nat_3) = hAPP_nat_nat(nat_case_nat(F1,F2),hAPP_nat_nat(suc,Nat_3)) )).

fof(fact_873_Max_Oidem,axiom,(
    ! [X_36] : X_36 = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_36),X_36) )).
...
fof(fact_35_butlast_Osimps_I1_J,axiom,(
    nil_Ar126264853le_alt = butlas1262502241le_alt(nil_Ar126264853le_alt) )).
...
fof(fact_1146_take__drop,axiom,(
    ! [N_14,M_4,Xs_14] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(drop_nat,M_4),hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,N_14),M_4)),Xs_14)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,N_14),hAPP_l248265089st_nat(hAPP_n280362926st_nat(drop_nat,M_4),Xs_14)) )).
...
fof(fact_793_minus__nat_Odiff__0,axiom,(
    ! [M] : M = hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,M),zero_zero_nat) )).

fof(fact_82_last__appendR,axiom,(
    ! [Xs_84,Ys_26] :
      ( nil_Ar126264853le_alt != Ys_26
...
fof(fact_154_not__distinct__decomp,axiom,(
    ! [Ws_1] :
     ...
     => ? [Xs_19,Ys_6,Zs_2,Y_25] :
          ( Ws_1 = hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,Xs_19),hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,Y_25),nil_bool)),hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,Ys_6),hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,Y_25),nil_bool)),Zs_2))))
          & is_bool(Y_25) ) ) )).
...
fof(fact_254_dropWhile_Osimps_I1_J,axiom,(
    ! [P_1] : dropWh156852662le_alt(P_1,nil_Ar126264853le_alt) = nil_Ar126264853le_alt )).
...
fof(fact_41_splice_Osimps_I3_J,axiom,(
    ! [X_122,Xs_93,Y_67,Ys_31] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_122),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_67),splice_nat(Xs_93,Ys_31))) = splice_nat(hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_122),Xs_93),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_67),Ys_31)) )).
...
fof(fact_729_min__max_Osup__assoc,axiom,(
    ! [X_72,Y_50,Z_22] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_72),Y_50)),Z_22) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_72),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,Y_50),Z_22)) )).
...
fof(fact_756_min__Suc2,axiom,(
    ! [M_1,N_1] : hAPP_nat_nat(nat_case_nat(zero_zero_nat,cOMBB_nat_nat_nat(suc,hAPP_nat_fun_nat_nat(cOMBC_nat_nat_nat(ord_min_nat),N_1))),M_1) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,M_1),hAPP_nat_nat(suc,N_1)) )).

fof(fact_195_last__rev,axiom,(
    ! [Xs_64] :
      ( hAPP_l1105242632le_alt(last_A57386030le_alt,rev_Ar2093961333le_alt(Xs_64)) = hAPP_l1105242632le_alt(hd_Arr805754088le_alt,Xs_64)
     <= Xs_64 != nil_Ar126264853le_alt ) )).

fof(fact_208_tl_Osimps_I1_J,axiom,(
    nil_nat = tl_nat(nil_nat) )).
...
fof(fact_797_diff__Suc__Suc,axiom,(
    ! [M,N] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,M),N) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,hAPP_nat_nat(suc,M)),hAPP_nat_nat(suc,N)) )).
...
fof(fact_1118_nth__equalityI,axiom,(
    ! [Xs_20,Ys_3] :
      ( hAPP_list_nat_nat(size_size_list_nat,Ys_3) = hAPP_list_nat_nat(size_size_list_nat,Xs_20)
     => ( ! [I_4] :
...
fof(fact_260_dropWhile__eq__Cons__conv,axiom,(
    ! [P_1,Xs,Y_2,Ys] :
      ( ( ~ hBOOL(hAPP_A862370221t_bool(P_1,Y_2))
        & Xs = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,takeWh536362254le_alt(P_1,Xs)),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_2),Ys)) )
...
fof(fact_8_list_Osimps_I3_J,axiom,(
    ! [A_84,List_2] : nil_nat != hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,A_84),List_2) )).

fof(fact_13_list_Oexhaust,axiom,(
    ! [Y_68] :
      ( Y_68 != nil_Ar126264853le_alt
     => ~ ! [A_74,List_3] :
            ( hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,A_74),List_3) != Y_68
...
fof(fact_789_min__0L,axiom,(
    ! [N] : zero_zero_nat = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,zero_zero_nat),N) )).
...
fof(fact_881_length__Suc__conv,axiom,(
    ! [Xs,N_1] :
      ( ? [Y_25,Ys_6] :
          ...
          & N_1 = hAPP_list_nat_nat(size_size_list_nat,Ys_6) )
    <=> hAPP_list_nat_nat(size_size_list_nat,Xs) = hAPP_nat_nat(suc,N_1) ) )).

fof(fact_207_tl_Osimps_I1_J,axiom,(
    tl_Arr1453005548le_alt(nil_Ar126264853le_alt) = nil_Ar126264853le_alt )).
...
fof(fact_112_append__self__conv2,axiom,(
    ! [Xs,Ys] :
      ( Xs = nil_Ar126264853le_alt
    <=> hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs),Ys) = Ys ) )).
...
fof(help_COMBC_1_1_COMBC_000tc__List__Olist_Itc__Nat__Onat_J_000tc__List__Olist_Itc_,axiom,(
    ! [P,Q,R] : hAPP_l248265089st_nat(hAPP_l710375585st_nat(P,R),Q) = hAPP_l248265089st_nat(hAPP_l710375585st_nat(cOMBC_950362600st_nat(P),Q),R) )).
     ...
     => ( ! [X_4] :
            ( ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_4),hAPP_l82377208t_bool(set_Ar1565008694le_alt,L_2)))
             => ( hBOOL(hAPP_A862370221t_bool(Q_1,X_4))
              <=> hBOOL(hAPP_A862370221t_bool(P_1,X_4)) ) )
           <= is_Arr1861959080le_alt(X_4) )
       => dropWh156852662le_alt(P_1,L_2) = dropWh156852662le_alt(Q_1,K_3) ) ) )).
...
fof(fact_62_butlast__snoc,axiom,(
    ! [Xs,X_1] : Xs = butlast_bool(hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,Xs),hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),nil_bool))) )).

fof(help_COMBB_1_1_COMBB_000tc__List__Olist_Itc__Nat__Onat_J_000tc__fun_Itc__List__O,axiom,(
    ! [P,Q,R] : hAPP_n280362926st_nat(cOMBB_472649634at_nat(P,Q),R) = hAPP_l710375585st_nat(P,hAPP_nat_list_nat(Q,R)) )).
...
fof(fact_564_add__left__cancel,axiom,(
    ! [Aa,Ba,C_2] :
      ( hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,Aa),C_2) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,Aa),Ba)
    <=> Ba = C_2 ) )).
...
fof(fact_162_rev_Osimps_I2_J,axiom,(
    ! [X_109,Xs_70] : hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,rev_nat(Xs_70)),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_109),nil_nat)) = rev_nat(hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_109),Xs_70)) )).

fof(fact_226_replicate__app__Cons__same,axiom,(
    ! [N_42,X_104,Xs_57] : hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_A832564074le_alt(replic351609551le_alt(N_42),X_104)),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_104),Xs_57)) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_104),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_A832564074le_alt(replic351609551le_alt(N_42),X_104)),Xs_57)) )).
...
fof(fact_1041_nth__replicate,axiom,(
    ! [X_5,I_6,N_24] :
     ...
     => X_5 = hAPP_nat_nat(nth_nat(hAPP_nat_list_nat(replicate_nat(N_24),X_5)),I_6) ) )).
...
fof(fact_131_butlast__append,axiom,(
    ! [Xs_76,Ys_19] :
      ( ( nil_Ar126264853le_alt != Ys_19
       => hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_76),butlas1262502241le_alt(Ys_19)) = butlas1262502241le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_76),Ys_19)) )
      & ( butlas1262502241le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_76),Ys_19)) = butlas1262502241le_alt(Xs_76)
       <= nil_Ar126264853le_alt = Ys_19 ) ) )).
...
fof(fact_821_length__replicate,axiom,(
    ! [N_28,X_42] : hAPP_l1872264749lt_nat(size_s1873794948le_alt,hAPP_A832564074le_alt(replic351609551le_alt(N_28),X_42)) = N_28 )).
...
fof(fact_395_takeWhile__append2,axiom,(
    ! [Ys,P_1,Xs] :
      ( takeWh536362254le_alt(P_1,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs),Ys)) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs),takeWh536362254le_alt(P_1,Ys))
     <= ! [X_4] :
          ( is_Arr1861959080le_alt(X_4)
         => ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_4),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs)))
           => hBOOL(hAPP_A862370221t_bool(P_1,X_4)) ) ) ) )).
...
fof(fact_76_append__same__eq,axiom,(
    ! [Ys,Xs,Zs] :
      ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Zs),Xs) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys),Xs)
    <=> Zs = Ys ) )).
...
fof(fact_569_nat__add__assoc,axiom,(
    ! [M,N,K] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,M),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,N),K)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,M),N)),K) )).
...
fof(fact_29_insert__Nil,axiom,(
    ! [X_124] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(insert_nat,X_124),nil_nat) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_124),nil_nat) )).
...
fof(fact_800_diff__diff__left,axiom,(
    ! [I,J,K] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,I),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,J),K)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,I),J)),K) )).

fof(fact_601_comm__semiring__1__class_Onormalizing__semiring__rules_I21_J,axiom,(
    ! [A_69,B_64,C_37] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_69),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,B_64),C_37)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_69),B_64)),C_37) )).

fof(fact_575_add__0__left,axiom,(
    ! [A_75] : A_75 = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,zero_zero_nat),A_75) )).
...
fof(fact_428_split__list__first,axiom,(
    ! [X_1,Xs] :
      ( ? [Ys_6,Zs_2] :
          ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys_6),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Zs_2)) = Xs
...
fof(fact_318_insort__left__comm,axiom,(
    ! [X_1,Y_2,Xs] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(linord1850739451at_nat(cOMBI_nat),X_1),hAPP_l248265089st_nat(hAPP_n280362926st_nat(linord1850739451at_nat(cOMBI_nat),Y_2),Xs)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(linord1850739451at_nat(cOMBI_nat),Y_2),hAPP_l248265089st_nat(hAPP_n280362926st_nat(linord1850739451at_nat(cOMBI_nat),X_1),Xs)) )).
...
fof(fact_1091_rev__nth,axiom,(
    ! [N_21,Xs_23] :
      ( hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs_23),hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_23)),hAPP_nat_nat(suc,N_21))) = hAPP_n401316912le_alt(nth_Ar1113433366le_alt(rev_Ar2093961333le_alt(Xs_23)),N_21)
...
fof(fact_261_dropWhile__eq__Cons__conv,axiom,(
    ! [P_1,Xs,Y_2,Ys] :
      ( ( hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,takeWhile_nat(P_1,Xs)),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_2),Ys)) = Xs
...
fof(fact_537_remove1__append,axiom,(
    ! [Ys,X_1,Xs] :
      ( ( ~ hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),hAPP_l1821533378t_bool(set_nat,Xs)))
       => hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs),hAPP_l248265089st_nat(hAPP_n280362926st_nat(remove1_nat,X_1),Ys)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(remove1_nat,X_1),hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs),Ys)) )
      & ( hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),hAPP_l1821533378t_bool(set_nat,Xs)))
...
fof(fact_1151_append__take__drop__id,axiom,(
    ! [N_12,Xs_12] : Xs_12 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_12),Xs_12)),hAPP_l726444215le_alt(hAPP_n2139729636le_alt(drop_A186780501le_alt,N_12),Xs_12)) )).
...
fof(fact_280_takeWhile_Osimps_I1_J,axiom,(
    ! [P_1] : takeWh536362254le_alt(P_1,nil_Ar126264853le_alt) = nil_Ar126264853le_alt )).

fof(fact_309_hd__conv__nth,axiom,(
    ! [Xs_54] :
      ( hAPP_l1105242632le_alt(hd_Arr805754088le_alt,Xs_54) = hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs_54),zero_zero_nat)
     <= Xs_54 != nil_Ar126264853le_alt ) )).
...
fof(fact_902_take__Suc__conv__app__nth,axiom,(
    ! [I_9,Xs_29] :
      ( hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,I_9),Xs_29)),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,hAPP_nat_nat(nth_nat(Xs_29),I_9)),nil_nat)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,hAPP_nat_nat(suc,I_9)),Xs_29)
...
fof(fact_775_min__max_Oinf__left__commute,axiom,(
    ! [X_52,Y_37,Z_19] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,Y_37),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,X_52),Z_19)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,X_52),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,Y_37),Z_19)) )).
...
fof(fact_506_remove1__idem,axiom,(
    ! [X_1,Xs] :
      ( Xs = hAPP_l726444215le_alt(hAPP_A408086601le_alt(remove430413995le_alt,X_1),Xs)
     <= ~ hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_1),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs))) ) )).
...
fof(fact_590_foldl__rev,axiom,(
    ! [S_2,Xs,F] :
     ...
     => foldl_nat_nat(F,S_2,Xs) = foldl_nat_nat(F,S_2,rev_nat(Xs)) ) )).

fof(fact_833_Suc__diff__le,axiom,(
    ! [N,M] :
      ( hAPP_nat_nat(suc,hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,M),N)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,hAPP_nat_nat(suc,M)),N)
...
fof(fact_220_singleton__rev__conv,axiom,(
    ! [X_1,Xs] :
      ( rev_Ar2093961333le_alt(Xs) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),nil_Ar126264853le_alt)
...
fof(fact_339_set__rotate1,axiom,(
    ! [Xs] : hAPP_l82377208t_bool(set_Ar1565008694le_alt,rotate1322903650le_alt(Xs)) = hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs) )).
...
fof(fact_305_list_Osize_I1_J,axiom,(
    ! [Fa] : list_s1237850263le_alt(Fa,nil_Ar126264853le_alt) = zero_zero_nat )).

fof(fact_1136_take__hd__drop,axiom,(
    ! [N_1,Xs] :
      ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,N_1),hAPP_list_bool_nat(size_size_list_bool,Xs)))
     => hAPP_l1189022293t_bool(hAPP_n479129736t_bool(take_bool,hAPP_nat_nat(suc,N_1)),Xs) = hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,hAPP_l1189022293t_bool(hAPP_n479129736t_bool(take_bool,N_1),Xs)),hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,hAPP_list_bool_bool(hd_bool,hAPP_l1189022293t_bool(hAPP_n479129736t_bool(drop_bool,N_1),Xs))),nil_bool)) ) )).
...
fof(fact_98_append__Nil,axiom,(
    ! [Ys_22] : hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,nil_Ar126264853le_alt),Ys_22) = Ys_22 )).
...
fof(fact_96_Cons__eq__appendI,axiom,(
    ! [Xs_80,Zs_4,X_114,Xs1,Ys_23] :
     ...
     => ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys_23),Zs_4) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_114),Xs_80)
       <= Xs_80 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs1),Zs_4) ) ) )).

fof(fact_856_length__insort,axiom,(
    ! [F,X_1,Xs] : hAPP_list_nat_nat(size_size_list_nat,hAPP_l248265089st_nat(hAPP_n280362926st_nat(linord1850739451at_nat(F),X_1),Xs)) = hAPP_nat_nat(suc,hAPP_list_nat_nat(size_size_list_nat,Xs)) )).
...
fof(fact_448_replicate__Suc,axiom,(
    ! [N_1,X_1] : hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),hAPP_bool_list_bool(replicate_bool(N_1),X_1)) = hAPP_bool_list_bool(replicate_bool(hAPP_nat_nat(suc,N_1)),X_1) )).
...
fof(fact_358_sublist__nil,axiom,(
    ! [A] : sublis888024346le_alt(nil_Ar126264853le_alt,A) = nil_Ar126264853le_alt )).
...
fof(fact_573_add__0__right,axiom,(
    ! [A_77] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_77),zero_zero_nat) = A_77 )).
...
fof(fact_1197_upt__Suc,axiom,(
    ! [I,J] :
      ( ( nil_nat = hAPP_nat_list_nat(upt(I),hAPP_nat_nat(suc,J))
       <= ~ hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,I),J)) )
      & ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,I),J))
...
fof(fact_252_dropWhile_Osimps_I2_J,axiom,(
    ! [Xs,P_1,X_1] :
      ( ( dropWh156852662le_alt(P_1,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Xs)) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Xs)
       <= ~ hBOOL(hAPP_A862370221t_bool(P_1,X_1)) )
      & ( hBOOL(hAPP_A862370221t_bool(P_1,X_1))
       => dropWh156852662le_alt(P_1,Xs) = dropWh156852662le_alt(P_1,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Xs)) ) ) )).
...
fof(fact_1188_upt__rec,axiom,(
    ! [I,J] :
      ( ( hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,I),hAPP_nat_list_nat(upt(hAPP_nat_nat(suc,I)),J)) = hAPP_nat_list_nat(upt(I),J)
       <= hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,I),J)) )
...
fof(fact_603_comm__semiring__1__class_Onormalizing__semiring__rules_I22_J,axiom,(
    ! [A_67,C_35,D_7] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_67),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,C_35),D_7)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,C_35),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_67),D_7)) )).
...
fof(fact_48_butlast_Osimps_I2_J,axiom,(
    ! [X_121,Xs_91] :
      ( ( butlast_nat(hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_121),Xs_91)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_121),butlast_nat(Xs_91))
       <= nil_nat != Xs_91 )
      & ( nil_nat = butlast_nat(hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_121),Xs_91))
       <= Xs_91 = nil_nat ) ) )).
...
fof(fact_175_rev__swap,axiom,(
    ! [Xs,Ys] :
      ( Xs = rev_Ar2093961333le_alt(Ys)
    <=> rev_Ar2093961333le_alt(Xs) = Ys ) )).

fof(fact_834_impossible__Cons,axiom,(
    ! [X_1,Xs,Ys] :
      ( hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),Ys) != Xs
...
fof(fact_294_takeWhile_Osimps_I2_J,axiom,(
    ! [Xs,P_1,X_1] :
      ( ( takeWh536362254le_alt(P_1,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Xs)) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),takeWh536362254le_alt(P_1,Xs))
       <= hBOOL(hAPP_A862370221t_bool(P_1,X_1)) )
      & ( ~ hBOOL(hAPP_A862370221t_bool(P_1,X_1))
...
fof(fact_599_comm__semiring__1__class_Onormalizing__semiring__rules_I20_J,axiom,(
    ! [A_71,B_66,C_39,D_9] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_71),B_66)),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,C_39),D_9)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_71),C_39)),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,B_66),D_9)) )).
    ...
    ! [P_1,Aa,Ba] :
      ( ( ( hBOOL(hAPP_nat_bool(P_1,zero_zero_nat))
        ...
        & ! [D] :
           ...
           <= hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,Ba),D) = Aa ) )
...
fof(fact_1055_Suc__pred,axiom,(
    ! [N] :
     ...
     => N = hAPP_nat_nat(suc,hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,N),hAPP_nat_nat(suc,zero_zero_nat))) ) )).
...
fof(fact_957_less__add__eq__less,axiom,(
    ! [M,N,K,L] :
      ( ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,M),N))
       <= hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,K),N) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,M),L) )
...
fof(fact_316_List_Oinsert__def,axiom,(
    ! [X_1,Xs] :
      ( ( hAPP_l248265089st_nat(hAPP_n280362926st_nat(insert_nat,X_1),Xs) = Xs
       <= hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),hAPP_l1821533378t_bool(set_nat,Xs))) )
      & ( ~ hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),hAPP_l1821533378t_bool(set_nat,Xs)))
       => hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Xs) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(insert_nat,X_1),Xs) ) ) )).
...
fof(fact_297_takeWhile__tail,axiom,(
    ! [Xs,L_2,P_1,X_1] :
      ( takeWh536362254le_alt(P_1,Xs) = takeWh536362254le_alt(P_1,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),L_2)))
     <= ~ hBOOL(hAPP_A862370221t_bool(P_1,X_1)) ) )).
...
fof(help_COMBB_1_1_COMBB_000tc__Nat__Onat_000tc__Nat__Onat_000tc__Nat__Onat_U,axiom,(
    ! [P,Q,R] : hAPP_nat_nat(cOMBB_nat_nat_nat(P,Q),R) = hAPP_nat_nat(P,hAPP_nat_nat(Q,R)) )).
...
fof(fact_416_map__filter__simps_I1_J,axiom,(
    ! [F,X_1,Xs] : option718651152l_bool(map_filter_nat_bool(F,Xs),hAPP_l1045755451t_bool(cOMBC_80330970t_bool(cons_bool),map_filter_nat_bool(F,Xs)),hAPP_nat_option_bool(F,X_1)) = map_filter_nat_bool(F,hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Xs)) )).
...
fof(fact_393_dropWhile__append2,axiom,(
    ! [Ys,P_1,Xs] :
      ( dropWh156852662le_alt(P_1,Ys) = dropWh156852662le_alt(P_1,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs),Ys))
     <= ! [X_4] :
          ( ( hBOOL(hAPP_A862370221t_bool(P_1,X_4))
           <= hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_4),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs))) )
         <= is_Arr1861959080le_alt(X_4) ) ) )).
...
fof(fact_78_append__eq__appendI,axiom,(
    ! [Ys_28,Us,Xs_86,Xs1_2,Zs_5] :
      ( ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_86),Ys_28) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Zs_5),Us)
       <= Ys_28 = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs1_2),Us) )
...
fof(fact_796_Suc__diff__diff,axiom,(
    ! [M,N,K] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,M),N)),K) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,hAPP_nat_nat(suc,M)),N)),hAPP_nat_nat(suc,K)) )).
...
fof(fact_204_tl_Osimps_I2_J,axiom,(
    ! [X_1,Xs] : Xs = tl_bool(hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),Xs)) )).
...
fof(fact_255_dropWhile_Osimps_I1_J,axiom,(
    ! [P_1] : nil_nat = dropWhile_nat(P_1,nil_nat) )).
...
fof(fact_619_bool_Osize_I2_J,axiom,(
    zero_zero_nat = hAPP_bool_nat(bool_size,fFalse) )).
...
fof(fact_123_append__eq__Cons__conv,axiom,(
    ...
    <=> ( ? [Ys_20] :
            ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys_20),Zs) = Xs
            & hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Ys_20) = Ys )
        | ( Ys = nil_Ar126264853le_alt
          & Zs = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Xs) ) ) ) )).
...
fof(fact_1037_nth__take,axiom,(
    ! [Xs_27,I_7,N_25] :
      ( hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs_27),I_7) = hAPP_n401316912le_alt(nth_Ar1113433366le_alt(hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_25),Xs_27)),I_7)
...
fof(fact_1167_drop__drop,axiom,(
    ! [N_6,M_2,Xs_6] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(drop_nat,N_6),hAPP_l248265089st_nat(hAPP_n280362926st_nat(drop_nat,M_2),Xs_6)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(drop_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,N_6),M_2)),Xs_6) )).
...
fof(fact_810_take__take,axiom,(
    ! [N_29,M_6,Xs_37] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,N_29),hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,M_6),Xs_37)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,N_29),M_6)),Xs_37) )).

fof(fact_883_min__max_Odistrib__imp2,axiom,(
    ! [X_35,Y_26,Z_10] :
      ( hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,X_35),Y_26)),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,X_35),Z_10)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,X_35),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,Y_26),Z_10))
...
fof(fact_542_take__equalityI,axiom,(
    ! [Xs_42,Ys_14] :
      ( Xs_42 = Ys_14
     <= ! [I_4] : hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,I_4),Ys_14) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,I_4),Xs_42) ) )).
...
fof(fact_1105_nth__take__lemma,axiom,(
    ! [Ys_4,K_4,Xs_21] :
     ...
     => ( ( hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,K_4),Ys_4) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,K_4),Xs_21)
         <= ! [I_4] :
...
fof(fact_1194_take__upt,axiom,(
    ! [I,M,N] :
     ...
     => hAPP_nat_list_nat(upt(I),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,I),M)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,M),hAPP_nat_list_nat(upt(I),N)) ) )).
...
fof(fact_1095_dropWhile__nth,axiom,(
    ! [J_1,P_1,Xs] :
     ...
     => hAPP_nat_nat(nth_nat(Xs),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,J_1),hAPP_list_nat_nat(size_size_list_nat,takeWhile_nat(P_1,Xs)))) = hAPP_nat_nat(nth_nat(dropWhile_nat(P_1,Xs)),J_1) ) )).
...
fof(fact_786_take__append,axiom,(
    ! [N_31,Xs_40,Ys_13] : hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_31),Xs_40)),hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,N_31),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_40))),Ys_13)) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_31),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_40),Ys_13)) )).
...
fof(fact_457_nth_Osimps,axiom,(
    ! [X_1,Xs,N_1] : hAPP_nat_list_nat(nat_case_list_nat(X_1,nth_list_nat(Xs)),N_1) = hAPP_nat_list_nat(nth_list_nat(hAPP_l1734754389st_nat(hAPP_l1872445307st_nat(cons_list_nat,X_1),Xs)),N_1) )).
...
fof(fact_782_min__max_Osup__inf__distrib2,axiom,(
    ! [Y_31,Z_15,X_46] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,Y_31),Z_15)),X_46) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,Y_31),X_46)),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,Z_15),X_46)) )).
...
fof(fact_499_remove1_Osimps_I2_J,axiom,(
    ! [Xs_48,X_93,Y_63] :
      ( ( Y_63 != X_93
       => hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_63),hAPP_l248265089st_nat(hAPP_n280362926st_nat(remove1_nat,X_93),Xs_48)) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(remove1_nat,X_93),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_63),Xs_48)) )
      & ( Y_63 = X_93
       => Xs_48 = hAPP_l248265089st_nat(hAPP_n280362926st_nat(remove1_nat,X_93),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_63),Xs_48)) ) ) )).
...
fof(fact_90_last__snoc,axiom,(
    ! [Xs_82,X_116] :
      ( X_116 = hAPP_l1105242632le_alt(last_A57386030le_alt,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_82),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_116),nil_Ar126264853le_alt)))
...
fof(fact_585_foldl__append,axiom,(
    ! [F,Aa,Xs,Ys] : foldl_nat_nat(F,Aa,hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs),Ys)) = foldl_nat_nat(F,foldl_nat_nat(F,Aa,Xs),Ys) )).

fof(fact_851_take__all,axiom,(
    ! [Xs_33,N_27] :
      ( Xs_33 = hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,N_27),Xs_33)
...
fof(help_COMBC_1_1_COMBC_000tc__Nat__Onat_000tc__List__Olist_Itc__Nat__Onat_J_000tc_,axiom,(
    ! [P,Q,R] : hAPP_nat_list_nat(hAPP_l383341732st_nat(cOMBC_1204473209st_nat(P),Q),R) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(P,R),Q) )).
...
fof(fact_1181_append__eq__conv__conj,axiom,(
    ! [Xs,Ys,Zs] :
      ( ( Ys = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(drop_A186780501le_alt,hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs)),Zs)
    ...
    <=> hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs),Ys) = Zs ) )).

fof(fact_582_add__Suc__right,axiom,(
    ! [M,N] : hAPP_nat_nat(suc,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,M),N)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,M),hAPP_nat_nat(suc,N)) )).
...
fof(fact_860_takeWhile__eq__take,axiom,(
    ! [P_1,Xs] : takeWh536362254le_alt(P_1,Xs) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,hAPP_l1872264749lt_nat(size_s1873794948le_alt,takeWh536362254le_alt(P_1,Xs))),Xs) )).

fof(fact_314_List_Oinsert__def,axiom,(
    ! [X_1,Xs] :
      ( ( Xs = hAPP_l1189022293t_bool(hAPP_b994696797t_bool(insert_bool,X_1),Xs)
       <= hBOOL(hAPP_f387058535l_bool(hAPP_b1787118453l_bool(member_bool,X_1),hAPP_l96088310l_bool(set_bool,Xs))) )
...
fof(fact_434_split__list,axiom,(
    ! [X_1,Xs] :
      ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_1),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs)))
     => ? [Ys_6,Zs_2] : Xs = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys_6),hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Zs_2)) ) )).
...
fof(help_COMBS_1_1_COMBS_000tc__HOL__Obool_000tc__HOL__Obool_000tc__HOL__Obool_U,axiom,(
    ! [P,Q,R] : hAPP_bool_bool(cOMBS_bool_bool_bool(P,Q),R) = hAPP_bool_bool(hAPP_b589554111l_bool(P,R),hAPP_bool_bool(Q,R)) )).
...
fof(fact_721_min__max_Osup_Oidem,axiom,(
    ! [A_50] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,A_50),A_50) = A_50 )).
...
fof(fact_862_dual__max,axiom,(
    ord_min_nat = max_nat(cOMBC_nat_nat_bool(ord_less_eq_nat)) )).
...
fof(fact_412_takeWhile__cong,axiom,(
    ! [Q_1,P_1,L_2,K_3] :
      ( ( takeWhile_nat(Q_1,K_3) = takeWhile_nat(P_1,L_2)
       <= ! [X_4] :
            ( ( hBOOL(hAPP_nat_bool(P_1,X_4))
...
fof(fact_270_last__replicate,axiom,(
    ! [X_99,N_40] :
      ( ( X_99 = hAPP_l1105242632le_alt(last_A57386030le_alt,hAPP_A832564074le_alt(replic351609551le_alt(N_40),X_99))
       <= zero_zero_nat != N_40 )
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__fun_Itc__HOL__Obool_Mtc__HOL__Oboo_002,axiom,(
    ! [P,Q,R] : hAPP_b589554111l_bool(cOMBB_1914122979l_bool(P,Q),R) = hAPP_b589554111l_bool(P,hAPP_bool_bool(Q,R)) )).
...
fof(fact_165_rev__eq__Cons__iff,axiom,(
    ! [Xs,Y_2,Ys] :
      ( hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,rev_nat(Ys)),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_2),nil_nat)) = Xs
    <=> hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_2),Ys) = rev_nat(Xs) ) )).
...
fof(fact_1196_upt__eq__Nil__conv,axiom,(
    ! [I_1,J_1] :
      ( nil_nat = hAPP_nat_list_nat(upt(I_1),J_1)
    <=> ( zero_zero_nat = J_1
...
fof(fact_849_length__append,axiom,(
    ! [Xs_34,Ys_10] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_list_nat_nat(size_size_list_nat,Xs_34)),hAPP_list_nat_nat(size_size_list_nat,Ys_10)) = hAPP_list_nat_nat(size_size_list_nat,hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs_34),Ys_10)) )).
...
fof(fact_268_hd__replicate,axiom,(
    ! [X_100,N_41] :
      ( zero_zero_nat != N_41
     => X_100 = hAPP_list_nat_nat(hd_nat,hAPP_nat_list_nat(replicate_nat(N_41),X_100)) ) )).
...
fof(fact_253_dropWhile_Osimps_I2_J,axiom,(
    ! [Xs,P_1,X_1] :
      ( ( hBOOL(hAPP_nat_bool(P_1,X_1))
       => dropWhile_nat(P_1,Xs) = dropWhile_nat(P_1,hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Xs)) )
      & ( ~ hBOOL(hAPP_nat_bool(P_1,X_1))
...
fof(fact_464_nat__case__0,axiom,(
    ! [F1,F2] :
     ...
     => F1 = hAPP_n401316912le_alt(nat_ca391302041le_alt(F1,F2),zero_zero_nat) ) )).
...
fof(fact_613_foldr__foldl,axiom,(
    ! [F,Xs,Aa] : foldl_nat_nat(cOMBC_nat_nat_nat(F),Aa,rev_nat(Xs)) = hAPP_nat_nat(foldr_nat_nat(F,Xs),Aa) )).
...
fof(fact_300_sublist__singleton,axiom,(
    ! [X_1,A] :
      ( ( nil_Ar126264853le_alt = sublis888024346le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),nil_Ar126264853le_alt),A)
       <= ~ hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,zero_zero_nat),A)) )
      & ( hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,zero_zero_nat),A))
...
fof(fact_394_dropWhile__append2,axiom,(
    ! [Ys,P_1,Xs] :
      ( ! [X_4] :
          ( hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_4),hAPP_l1821533378t_bool(set_nat,Xs)))
         => hBOOL(hAPP_nat_bool(P_1,X_4)) )
     => dropWhile_nat(P_1,Ys) = dropWhile_nat(P_1,hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs),Ys)) ) )).
...
fof(fact_1098_takeWhile__eq__take__P__nth,axiom,(
    ! [P_1,Xs,N_1] :
      ( ! [I_4] :
         ...
         => ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,I_4),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs)))
           => hBOOL(hAPP_A862370221t_bool(P_1,hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs),I_4))) ) )
     => ( hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_1),Xs) = takeWh536362254le_alt(P_1,Xs)
       <= ( ~ hBOOL(hAPP_A862370221t_bool(P_1,hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs),N_1)))
         <= hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,N_1),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs))) ) ) ) )).
...
fof(fact_189_rev_Osimps_I1_J,axiom,(
    nil_Ar126264853le_alt = rev_Ar2093961333le_alt(nil_Ar126264853le_alt) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Nat__Onat_000tc__List__Olist_Itc__Arrow____Order____,axiom,(
    ! [P,Q,R] : hAPP_n1875670159le_alt(hAPP_l382792410le_alt(cOMBC_1511969967le_alt(P),Q),R) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(P,R),Q) )).
...
fof(fact_827_list_Osize_I3_J,axiom,(
    zero_zero_nat = hAPP_list_nat_nat(size_size_list_nat,nil_nat) )).
...
fof(fact_414_map__filter__simps_I1_J,axiom,(
    ! [F,X_1,Xs] : map_fi2015041583lt_nat(F,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Xs)) = option306705938at_nat(map_fi2015041583lt_nat(F,Xs),hAPP_l383341732st_nat(cOMBC_1204473209st_nat(cons_nat),map_fi2015041583lt_nat(F,Xs)),hAPP_A1356081999on_nat(F,X_1)) )).
...
fof(fact_259_dropWhile__eq__Cons__conv,axiom,(
    ...
    <=> hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,Y_2),Ys) = dropWhile_bool(P_1,Xs) ) )).
...
fof(fact_91_last__snoc,axiom,(
    ! [Xs_82,X_116] : X_116 = hAPP_list_nat_nat(last_nat,hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs_82),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_116),nil_nat))) )).
...
fof(fact_303_listrelp_Osimps,axiom,(
    ! [R_2,A1,A2] :
      ( ( ? [X_4,Y_25,Xs_19,Ys_6] :
            ( A2 = hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_25),Ys_6)
...
fof(fact_530_take__tl,axiom,(
    ! [N_33,Xs_43] : tl_Arr1453005548le_alt(hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,hAPP_nat_nat(suc,N_33)),Xs_43)) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_33),tl_Arr1453005548le_alt(Xs_43)) )).
...
fof(fact_737_min__max_Osup__absorb1,axiom,(
    ! [Y_46,X_66] :
      ( X_66 = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_66),Y_46)
...
fof(fact_1040_nth__replicate,axiom,(
    ! [X_5,I_6,N_24] :
      ( ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,I_6),N_24))
       => hAPP_n401316912le_alt(nth_Ar1113433366le_alt(hAPP_A832564074le_alt(replic351609551le_alt(N_24),X_5)),I_6) = X_5 )
...
fof(fact_192_rev__append,axiom,(
    ! [Xs_65,Ys_15] : rev_nat(hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs_65),Ys_15)) = hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,rev_nat(Ys_15)),rev_nat(Xs_65)) )).
...
fof(fact_562_add__left__imp__eq,axiom,(
    ! [A_80,B_68,C_41] :
      ( hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_80),C_41) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,A_80),B_68)
     => C_41 = B_68 ) )).
...
fof(fact_772_min__max_Oinf_Oleft__idem,axiom,(
    ! [A_34,B_35] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,A_34),B_35) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,A_34),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,A_34),B_35)) )).
...
fof(fact_461_nth_Osimps,axiom,(
    ! [X_1,Xs,N_1] : hAPP_nat_nat(nth_nat(hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Xs)),N_1) = hAPP_nat_nat(nat_case_nat(X_1,nth_nat(Xs)),N_1) )).
     ...
     => ( hBOOL(hAPP_l1386638586t_bool(listMe1065601537le_alt(A1),A2))
      <=> ( ? [X_4,Xs_19,Y_25] :
          ...
          | ? [X_4,Xs_19] :
              ( is_Arr1861959080le_alt(X_4)
              & A1 = X_4
              & hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_4),Xs_19) = A2 ) ) ) ) )).
...
fof(fact_469_nat__case__Suc,axiom,(
    ! [F1,F2,Nat_3] : hAPP_n401316912le_alt(nat_ca391302041le_alt(F1,F2),hAPP_nat_nat(suc,Nat_3)) = hAPP_n401316912le_alt(F2,Nat_3) )).
...
fof(help_If_2_1_If_000tc__List__Olist_Itc__Arrow____Order____Mirabelle____tpnfnnbpuu,axiom,(
    ! [X,Y] : if_lis1340954026le_alt(fFalse,X,Y) = Y )).

fof(fact_859_nat__minus__add__max,axiom,(
    ! [N,M] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,N),M) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,N),M)),M) )).
...
fof(fact_1069_distinct__conv__nth,axiom,(
    ...
    <=> ! [I_4] :
          ( ! [J_2] :
             ...
             => ( J_2 != I_4
               => hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs),J_2) != hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs),I_4) ) )
         <= hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,I_4),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs))) ) ) )).
...
fof(fact_830_length__0__conv,axiom,(
    ! [Xs] :
      ( hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs) = zero_zero_nat
    <=> Xs = nil_Ar126264853le_alt ) )).
...
fof(fact_659_max__Suc2,axiom,(
    ! [M_1,N_1] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,M_1),hAPP_nat_nat(suc,N_1)) = hAPP_nat_nat(nat_case_nat(hAPP_nat_nat(suc,N_1),cOMBB_nat_nat_nat(suc,hAPP_nat_fun_nat_nat(cOMBC_nat_nat_nat(ord_max_nat),N_1))),M_1) )).
...
fof(fact_1172_drop__tl,axiom,(
    ! [N_4,Xs_3] : hAPP_l726444215le_alt(hAPP_n2139729636le_alt(drop_A186780501le_alt,N_4),tl_Arr1453005548le_alt(Xs_3)) = tl_Arr1453005548le_alt(hAPP_l726444215le_alt(hAPP_n2139729636le_alt(drop_A186780501le_alt,N_4),Xs_3)) )).

fof(fact_649_le__iff__add,axiom,(
    ! [M_1,N_1] :
      ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,M_1),N_1))
    <=> ? [K_2] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,M_1),K_2) = N_1 ) )).

fof(fact_227_replicate__app__Cons__same,axiom,(
    ! [N_42,X_104,Xs_57] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_104),hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,hAPP_nat_list_nat(replicate_nat(N_42),X_104)),Xs_57)) = hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,hAPP_nat_list_nat(replicate_nat(N_42),X_104)),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_104),Xs_57)) )).
...
fof(fact_251_dropWhile_Osimps_I2_J,axiom,(
    ! [Xs,P_1,X_1] :
      ...
      & ( ~ hBOOL(hAPP_bool_bool(P_1,X_1))
       => hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),Xs) = dropWhile_bool(P_1,hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),Xs)) ) ) )).
...
fof(fact_16_not__Cons__self,axiom,(
    ! [Xs_97,X_126] : hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_126),Xs_97) != Xs_97 )).
...
fof(fact_163_rev__eq__Cons__iff,axiom,(
    ! [Xs,Y_2,Ys] :
      ( hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,Y_2),Ys) = rev_bool(Xs)
...
fof(fact_725_min__max_Osup__left__idem,axiom,(
    ! [X_74,Y_52] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_74),Y_52) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_74),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_74),Y_52)) )).
...
fof(fact_806_length__take,axiom,(
    ! [N_30,Xs_39] : hAPP_l1872264749lt_nat(size_s1873794948le_alt,hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_30),Xs_39)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_39)),N_30) )).

fof(fact_67_last__ConsL,axiom,(
    ! [X_117,Xs_88] :
      ( ( hAPP_l1105242632le_alt(last_A57386030le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_117),Xs_88)) = X_117
       <= Xs_88 = nil_Ar126264853le_alt )
     <= is_Arr1861959080le_alt(X_117) ) )).

fof(fact_179_rev__replicate,axiom,(
    ! [N_44,X_108] : rev_nat(hAPP_nat_list_nat(replicate_nat(N_44),X_108)) = hAPP_nat_list_nat(replicate_nat(N_44),X_108) )).

fof(fact_155_not__distinct__decomp,axiom,(
    ! [Ws] :
      ( ? [Xs_19,Ys_6,Zs_2,Y_25] :
          ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_19),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_25),nil_Ar126264853le_alt)),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Ys_6),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Y_25),nil_Ar126264853le_alt)),Zs_2)))) = Ws
          & is_Arr1861959080le_alt(Y_25) )
...
fof(fact_1080_take__butlast,axiom,(
    ! [N_23,Xs_26] :
      ( hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_23),butlas1262502241le_alt(Xs_26)) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_23),Xs_26)
...
fof(fact_490_take__Nil,axiom,(
    ! [N_36] : nil_Ar126264853le_alt = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_36),nil_Ar126264853le_alt) )).
...
fof(help_COMBC_1_1_COMBC_000tc__Nat__Onat_000tc__Nat__Onat_000tc__Nat__Onat_U,axiom,(
    ! [P,Q,R] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(P,R),Q) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(cOMBC_nat_nat_nat(P),Q),R) )).
...
fof(fact_379_takeWhile__append1,axiom,(
    ! [Ys,P_1,X_1,Xs] :
      ( hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),hAPP_l1821533378t_bool(set_nat,Xs)))
     => ( ~ hBOOL(hAPP_nat_bool(P_1,X_1))
       => takeWhile_nat(P_1,Xs) = takeWhile_nat(P_1,hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs),Ys)) ) ) )).
...
fof(fact_12_list_Oexhaust,axiom,(
    ! [Y_2] :
      ( ~ ! [A_74,List_3] :
            ( is_bool(A_74)
           => Y_2 != hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,A_74),List_3) )
     <= nil_bool != Y_2 ) )).
...
fof(fact_1117_nth__equalityI,axiom,(
    ! [Xs_20,Ys_3] :
     ...
     <= hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_20) = hAPP_l1872264749lt_nat(size_s1873794948le_alt,Ys_3) ) )).
...
fof(fact_15_not__Cons__self,axiom,(
    ! [Xs,X_1] : Xs != hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),Xs) )).
...
fof(fact_1099_takeWhile__eq__take__P__nth,axiom,(
    ! [P_1,Xs,N_1] :
      ( ( hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,N_1),Xs) = takeWhile_nat(P_1,Xs)
       <= ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,N_1),hAPP_list_nat_nat(size_size_list_nat,Xs)))
         => ~ hBOOL(hAPP_nat_bool(P_1,hAPP_nat_nat(nth_nat(Xs),N_1))) ) )
     <= ! [I_4] :
          ( ( hBOOL(hAPP_nat_bool(P_1,hAPP_nat_nat(nth_nat(Xs),I_4)))
...
fof(fact_84_last__append,axiom,(
    ! [Xs_83,Ys_25] :
      ( ( hAPP_l1105242632le_alt(last_A57386030le_alt,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_83),Ys_25)) = hAPP_l1105242632le_alt(last_A57386030le_alt,Xs_83)
...
fof(fact_747_min__max_OSup__fin__set__fold,axiom,(
    ! [X_1,Xs] : foldl_nat_nat(ord_max_nat,X_1,Xs) = big_Sup_fin_nat(ord_max_nat,hAPP_l1821533378t_bool(set_nat,hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Xs))) )).
...
fof(fact_100_Nil__is__append__conv,axiom,(
    ! [Xs,Ys] :
      ( nil_Ar126264853le_alt = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs),Ys)
    <=> ( Ys = nil_Ar126264853le_alt
        & Xs = nil_Ar126264853le_alt ) ) )).
...
fof(fact_723_min__max_Osup__commute,axiom,(
    ! [X_75,Y_53] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,Y_53),X_75) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,X_75),Y_53) )).
...
fof(fact_566_foldl__assoc,axiom,(
    ! [X_1,Y_2,Zs] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,X_1),foldl_nat_nat(plus_plus_nat,Y_2,Zs)) = foldl_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,X_1),Y_2),Zs) )).
...
fof(fact_446_nth__Cons__Suc,axiom,(
    ! [X_96,Xs_52,N_39] : hAPP_n401316912le_alt(nth_Ar1113433366le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_96),Xs_52)),hAPP_nat_nat(suc,N_39)) = hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs_52),N_39) )).
...
fof(fact_306_list_Osize_I1_J,axiom,(
    ! [Fa] : zero_zero_nat = list_size_nat(Fa,nil_nat) )).

fof(fact_92_append__Cons,axiom,(
    ! [X_1,Xs,Ys] : hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),Xs)),Ys) = hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,X_1),hAPP_l1189022293t_bool(hAPP_l1947611924t_bool(append_bool,Xs),Ys)) )).
...
fof(fact_728_min__max_Osup_Oassoc,axiom,(
    ! [A_46,B_45,C_20] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,A_46),B_45)),C_20) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,A_46),hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_max_nat,B_45),C_20)) )).
...
fof(fact_743_Max__fin__set__fold,axiom,(
    ! [X_1,Xs] : big_linorder_Max_nat(hAPP_l1821533378t_bool(set_nat,hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_1),Xs))) = foldl_nat_nat(ord_max_nat,X_1,Xs) )).
...
fof(fact_546_list_Osize_I2_J,axiom,(
    ! [Fa,Aa,List_1] : list_size_nat(Fa,hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Aa),List_1)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(Fa,Aa)),list_size_nat(Fa,List_1))),hAPP_nat_nat(suc,zero_zero_nat)) )).
...
fof(fact_1191_hd__upt,axiom,(
    ! [I,J] :
      ( I = hAPP_list_nat_nat(hd_nat,hAPP_nat_list_nat(upt(I),J))
     <= hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,I),J)) ) )).
...
fof(fact_415_map__filter__simps_I1_J,axiom,(
    ! [F,X_1,Xs] : option468438226le_alt(map_fi695734538le_alt(F,Xs),hAPP_l618618165le_alt(cOMBC_1919297930le_alt(cons_A1216297413le_alt),map_fi695734538le_alt(F,Xs)),hAPP_A373227306le_alt(F,X_1)) = map_fi695734538le_alt(F,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),Xs)) )).

fof(fact_809_take__take,axiom,(
    ! [N_29,M_6,Xs_37] : hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,N_29),hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,M_6),Xs_37)) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,N_29),M_6)),Xs_37) )).
...
fof(fact_805_Min_Oidem,axiom,(
    ! [X_43] : X_43 = hAPP_nat_nat(hAPP_nat_fun_nat_nat(ord_min_nat,X_43),X_43) )).

fof(fact_26_splice_Osimps_I2_J,axiom,(
    ! [V,Va] : splice_nat(hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,V),Va),nil_nat) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,V),Va) )).
...
fof(fact_826_diff__add__0,axiom,(
    ! [N,M] : zero_zero_nat = hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,N),hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,N),M)) )).
...
fof(fact_191_rev__append,axiom,(
    ! [Xs_65,Ys_15] : rev_Ar2093961333le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_65),Ys_15)) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,rev_Ar2093961333le_alt(Ys_15)),rev_Ar2093961333le_alt(Xs_65)) )).
...
fof(fact_1104_nth__take__lemma,axiom,(
    ! [Ys_4,K_4,Xs_21] :
      ( ( ( ! [I_4] :
         ...
         => hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,K_4),Ys_4) = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(take_A1601602045le_alt,K_4),Xs_21) )
...
fof(fact_1034_list__eq__iff__nth__eq,axiom,(
    ...
    <=> ( hAPP_l1872264749lt_nat(size_s1873794948le_alt,Ys) = hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs)
        & ! [I_4] :
            ( hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Xs),I_4) = hAPP_n401316912le_alt(nth_Ar1113433366le_alt(Ys),I_4)
           <= hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_nat,I_4),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs))) ) ) ) )).
...
fof(fact_815_eq__diff__iff,axiom,(
    ! [N_1,K_3,M_1] :
      ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,K_3),M_1))
     => ( ( N_1 = M_1
        <=> hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,N_1),K_3) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(minus_minus_nat,M_1),K_3) )
       <= hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,K_3),N_1)) ) ) )).
...
fof(fact_168_hd__append,axiom,(
    ! [Ys_17,Xs_68] :
      ...
      & ( hAPP_l1105242632le_alt(hd_Arr805754088le_alt,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_68),Ys_17)) = hAPP_l1105242632le_alt(hd_Arr805754088le_alt,Ys_17)
       <= nil_Ar126264853le_alt = Xs_68 ) ) )).
...
fof(fact_536_remove1__append,axiom,(
    ! [Ys,X_1,Xs] :
      ( ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_1),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs)))
       => hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(remove430413995le_alt,X_1),Xs)),Ys) = hAPP_l726444215le_alt(hAPP_A408086601le_alt(remove430413995le_alt,X_1),hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs),Ys)) )
      & ( ~ hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_1),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs)))
...
fof(fact_388_dropWhile__append1,axiom,(
    ! [Ys,P_1,X_1,Xs] :
      ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_1),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs)))
     => ( dropWh156852662le_alt(P_1,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs),Ys)) = hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,dropWh156852662le_alt(P_1,Xs)),Ys)
       <= ~ hBOOL(hAPP_A862370221t_bool(P_1,X_1)) ) ) )).
...
fof(fact_64_butlast__snoc,axiom,(
    ! [Xs_89,X_119] : butlast_nat(hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs_89),hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_119),nil_nat))) = Xs_89 )).
...
fof(fact_4_list_Osimps_I2_J,axiom,(
    ! [A_85,List_4] : hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,A_85),List_4) != nil_Ar126264853le_alt )).
...
fof(fact_366_nth__Cons__0,axiom,(
    ! [X_97,Xs_53] :
     ...
     => hAPP_n401316912le_alt(nth_Ar1113433366le_alt(hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_97),Xs_53)),zero_zero_nat) = X_97 ) )).

fof(fact_861_takeWhile__eq__take,axiom,(
    ! [P_1,Xs] : takeWhile_nat(P_1,Xs) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(take_nat,hAPP_list_nat_nat(size_size_list_nat,takeWhile_nat(P_1,Xs))),Xs) )).
...
fof(fact_588_replicate__add,axiom,(
    ! [N_32,M_8,X_89] : hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,hAPP_A832564074le_alt(replic351609551le_alt(N_32),X_89)),hAPP_A832564074le_alt(replic351609551le_alt(M_8),X_89)) = hAPP_A832564074le_alt(replic351609551le_alt(hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,N_32),M_8)),X_89) )).
...
fof(fact_1178_drop__all,axiom,(
    ! [Xs_2,N_3] :
      ( nil_Ar126264853le_alt = hAPP_l726444215le_alt(hAPP_n2139729636le_alt(drop_A186780501le_alt,N_3),Xs_2)
...
fof(fact_848_length__append,axiom,(
    ! [Xs_34,Ys_10] : hAPP_l1872264749lt_nat(size_s1873794948le_alt,hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_34),Ys_10)) = hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_l1872264749lt_nat(size_s1873794948le_alt,Xs_34)),hAPP_l1872264749lt_nat(size_s1873794948le_alt,Ys_10)) )).
...
fof(fact_170_tl__append2,axiom,(
    ! [Ys_16,Xs_67] :
      ( hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,tl_Arr1453005548le_alt(Xs_67)),Ys_16) = tl_Arr1453005548le_alt(hAPP_l726444215le_alt(hAPP_l568342716le_alt(append1166636842le_alt,Xs_67),Ys_16))
     <= Xs_67 != nil_Ar126264853le_alt ) )).
...
fof(fact_450_replicate__Suc,axiom,(
    ! [N_38,X_95] : hAPP_nat_list_nat(replicate_nat(hAPP_nat_nat(suc,N_38)),X_95) = hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,X_95),hAPP_nat_list_nat(replicate_nat(N_38),X_95)) )).

fof(fact_14_list_Oexhaust,axiom,(
    ! [Y_68] :
      ( nil_nat != Y_68
     => ~ ! [A_74,List_3] : hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,A_74),List_3) != Y_68 ) )).
...
fof(fact_210_hd_Osimps,axiom,(
    ! [X_105,Xs_60] :
     ...
     => X_105 = hAPP_l1105242632le_alt(hd_Arr805754088le_alt,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_105),Xs_60)) ) )).
...
fof(fact_331_set__rev,axiom,(
    ! [Xs] : hAPP_l1821533378t_bool(set_nat,Xs) = hAPP_l1821533378t_bool(set_nat,rev_nat(Xs)) )).
...
fof(fact_545_list_Osize_I2_J,axiom,(
    ! [Fa,Aa,List_1] : hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,hAPP_A2113590458lt_nat(Fa,Aa)),list_s1237850263le_alt(Fa,List_1))),hAPP_nat_nat(suc,zero_zero_nat)) = list_s1237850263le_alt(Fa,hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,Aa),List_1)) )).

fof(fact_44_splice_Osimps_I1_J,axiom,(
    ! [Ys_30] : splice360969192le_alt(nil_Ar126264853le_alt,Ys_30) = Ys_30 )).
...
fof(fact_262_ListMem_Osimps,axiom,(
    ...
    <=> ( ? [X_4,Xs_19,Y_25] :
            ...
            & hAPP_l1189022293t_bool(hAPP_b994696797t_bool(cons_bool,Y_25),Xs_19) = A2
            & ( hBOOL(A1)
            <=> hBOOL(X_4) )
            & is_bool(Y_25) )
        | ? [X_4,Xs_19] :
...
fof(fact_354_dropWhile__neq__rev,axiom,(
    ! [X_1,Xs] :
      ( ( hBOOL(hAPP_f2013399995l_bool(hAPP_A297543629l_bool(member1071917752le_alt,X_1),hAPP_l82377208t_bool(set_Ar1565008694le_alt,Xs)))
       => hAPP_l726444215le_alt(hAPP_A408086601le_alt(cons_A1216297413le_alt,X_1),rev_Ar2093961333le_alt(takeWh536362254le_alt(cOMBB_2104979073le_alt(fNot,hAPP_A1664620203t_bool(cOMBC_1628726426t_bool(fequal1160105444le_alt),X_1)),Xs))) = dropWh156852662le_alt(cOMBB_2104979073le_alt(fNot,hAPP_A1664620203t_bool(cOMBC_1628726426t_bool(fequal1160105444le_alt),X_1)),rev_Ar2093961333le_alt(Xs)) )
     <= hBOOL(hAPP_l1386638586t_bool(distin1223878664le_alt,Xs)) ) )).
...
fof(fact_326_tl__append,axiom,(
    ! [Xs,Ys] : list_c554461815at_nat(tl_nat(Ys),cOMBK_1717478773at_nat(hAPP_l710375585st_nat(cOMBC_950362600st_nat(append_nat),Ys)),Xs) = tl_nat(hAPP_l248265089st_nat(hAPP_l710375585st_nat(append_nat,Xs),Ys)) )).
...
fof(fact_844_le__imp__diff__is__add,axiom,(
    ! [K_3,I_1,J_1] :
      ( ( hAPP_nat_nat(hAPP_nat_fun_nat_nat(plus_plus_nat,K_3),I_1) = J_1
...
fof(fact_304_listrelp_Osimps,axiom,(
    ...
    <=> ( ( A1 = nil_nat
        ...
        | ? [X_4,Y_25,Xs_19,Ys_6] :
            ...
            & hAPP_l248265089st_nat(hAPP_n280362926st_nat(cons_nat,Y_25),Ys_6) = A2 ) ) ) )).
