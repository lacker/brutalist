...
fof(fact_467_power__mult,axiom,(
    ! [A_10,M_3,N_12] : power_power_nat(power_power_nat(A_10,M_3),N_12) = power_power_nat(A_10,times_times_nat(M_3,N_12)) )).
...
fof(fact_575_power__m1__even,axiom,(
    ! [N_2] : one_one_int = power_power_int(number_number_of_int(min),times_times_nat(number_number_of_nat(bit0(bit1(pls))),N_2)) )).
...
fof(fact_21_comm__semiring__1__class_Onormalizing__semiring__rules_I29_J,axiom,(
    ! [X_21] : power_power_int(X_21,number_number_of_nat(bit0(bit1(pls)))) = times_times_int(X_21,X_21) )).

fof(fact_246_add__number__of__eq,axiom,(
    ! [V_6,W_8] : number_number_of_int(plus_plus_int(V_6,W_8)) = plus_plus_int(number_number_of_int(V_6),number_number_of_int(W_8)) )).
...
fof(fact_345_comm__semiring__1__class_Onormalizing__semiring__rules_I5_J,axiom,(
    ! [A_26] : A_26 = plus_plus_real(zero_zero_real,A_26) )).
...
fof(fact_601_diff__bin__simps_I3_J,axiom,(
    ! [L] : bit0(minus_minus_int(pls,L)) = minus_minus_int(pls,bit0(L)) )).
...
fof(fact_541_power__0,axiom,(
    ! [A_3] : one_one_int = power_power_int(A_3,zero_zero_nat) )).

fof(fact_457_power__commutes,axiom,(
    ! [A_13,N_16] : times_times_int(A_13,power_power_int(A_13,N_16)) = times_times_int(power_power_int(A_13,N_16),A_13) )).

fof(fact_182_comm__semiring__1__class_Onormalizing__semiring__rules_I34_J,axiom,(
    ! [X_16,Y_14,Z_8] : plus_plus_int(times_times_int(X_16,Y_14),times_times_int(X_16,Z_8)) = times_times_int(X_16,plus_plus_int(Y_14,Z_8)) )).
...
fof(fact_112_comm__semiring__1__class_Onormalizing__semiring__rules_I7_J,axiom,(
    ! [A_56,B_17] : times_times_real(B_17,A_56) = times_times_real(A_56,B_17) )).
...
fof(fact_423_power__one__right,axiom,(
    ! [A_16] :
      ( A_16 = power_power_int(A_16,one_one_nat)
     <= is_int(A_16) ) )).
...
fof(fact_57_comm__semiring__1__class_Onormalizing__semiring__rules_I26_J,axiom,(
    ! [X_17,P_2,Q_3] : power_power_real(X_17,plus_plus_nat(P_2,Q_3)) = times_times_real(power_power_real(X_17,P_2),power_power_real(X_17,Q_3)) )).
...
fof(fact_331_field__power__not__zero,axiom,(
    ! [N_28,A_30] :
      ( ( zero_zero_int != power_power_int(A_30,N_28)
       <= zero_zero_int != A_30 )
     <= is_int(A_30) ) )).
...
fof(fact_129_comm__semiring__1__class_Onormalizing__semiring__rules_I22_J,axiom,(
    ! [A_51,C_6,D_3] : plus_plus_int(C_6,plus_plus_int(A_51,D_3)) = plus_plus_int(A_51,plus_plus_int(C_6,D_3)) )).
...
fof(fact_268_double__number__of__Bit0,axiom,(
    ! [W_5] : number_number_of_int(bit0(W_5)) = times_times_int(plus_plus_int(one_one_int,one_one_int),number_number_of_int(W_5)) )).
...
fof(fact_122_comm__semiring__1__class_Onormalizing__semiring__rules_I21_J,axiom,(
    ! [A_53,B_14,C_8] : plus_plus_nat(A_53,plus_plus_nat(B_14,C_8)) = plus_plus_nat(plus_plus_nat(A_53,B_14),C_8) )).
...
fof(fact_632_nat__mult__eq__one,axiom,(
    ! [N_1,Ma] :
      ( one_one_nat = times_times_nat(N_1,Ma)
    <=> ( one_one_nat = Ma
        & N_1 = one_one_nat ) ) )).
...
fof(fact_291_four__x__squared,axiom,(
    ! [X_1] : power_power_real(times_times_real(number267125858f_real(bit0(bit1(pls))),X_1),number_number_of_nat(bit0(bit1(pls)))) = times_times_real(number267125858f_real(bit0(bit0(bit1(pls)))),power_power_real(X_1,number_number_of_nat(bit0(bit1(pls))))) )).
...
fof(fact_248_number__of__add,axiom,(
    ! [V_5,W_7] : plus_plus_int(number_number_of_int(V_5),number_number_of_int(W_7)) = number_number_of_int(plus_plus_int(V_5,W_7)) )).
...
fof(fact_266_mult__Bit1,axiom,(
    ! [K,L] : plus_plus_int(bit0(times_times_int(K,L)),L) = times_times_int(bit1(K),L) )).
...
fof(fact_200_mult__Bit0,axiom,(
    ! [K,L] : bit0(times_times_int(K,L)) = times_times_int(bit0(K),L) )).
...
fof(fact_9_power2__sum,axiom,(
    ! [X_2,Y_2] : plus_plus_real(plus_plus_real(power_power_real(X_2,number_number_of_nat(bit0(bit1(pls)))),power_power_real(Y_2,number_number_of_nat(bit0(bit1(pls))))),times_times_real(times_times_real(number267125858f_real(bit0(bit1(pls))),X_2),Y_2)) = power_power_real(plus_plus_real(X_2,Y_2),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_536_comm__semiring__1__class_Onormalizing__semiring__rules_I32_J,axiom,(
    ! [X_5] : one_one_real = power_power_real(X_5,zero_zero_nat) )).
...
fof(fact_580_zcong__iff__lin,axiom,(
    ! [A_1,B_2,Ma] :
      ( ( zcong(A_1,B_2,Ma)
      <=> ? [K_2] :
            ( plus_plus_int(A_1,times_times_int(Ma,K_2)) = B_2
            & is_int(K_2) ) )
     <= is_int(B_2) ) )).
...
fof(fact_23_power2__eq__square,axiom,(
    ! [A_57] : times_times_real(A_57,A_57) = power_power_real(A_57,number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_383_sum__squares__eq__zero__iff,axiom,(
    ! [X_2,Y_2] :
      ( ( zero_zero_real = Y_2
        & X_2 = zero_zero_real )
    <=> zero_zero_real = plus_plus_real(times_times_real(X_2,X_2),times_times_real(Y_2,Y_2)) ) )).
...
fof(fact_173_comm__semiring__1__class_Onormalizing__semiring__rules_I1_J,axiom,(
    ! [A_48,M_12,B_13] : times_times_int(plus_plus_int(A_48,B_13),M_12) = plus_plus_int(times_times_int(A_48,M_12),times_times_int(B_13,M_12)) )).
...
fof(fact_538_comm__semiring__1__class_Onormalizing__semiring__rules_I32_J,axiom,(
    ! [X_5] : one_one_int = power_power_int(X_5,zero_zero_nat) )).
...
fof(fact_344_comm__semiring__1__class_Onormalizing__semiring__rules_I10_J,axiom,(
    ! [A_27] : zero_zero_int = times_times_int(A_27,zero_zero_int) )).
...
fof(fact_469_power__mult,axiom,(
    ! [A_10,M_3,N_12] : power_power_int(power_power_int(A_10,M_3),N_12) = power_power_int(A_10,times_times_nat(M_3,N_12)) )).

fof(fact_103_comm__semiring__1__class_Onormalizing__semiring__rules_I17_J,axiom,(
    ! [Lx_2,Ly,Rx_2] : times_times_real(Lx_2,times_times_real(Ly,Rx_2)) = times_times_real(times_times_real(Lx_2,Ly),Rx_2) )).
...
fof(fact_386_add__scale__eq__noteq,axiom,(
    ! [C_2,D_2,A_18,B_4,R_3] :
      ( R_3 != zero_zero_nat
     => ( plus_plus_nat(B_4,times_times_nat(R_3,D_2)) != plus_plus_nat(A_18,times_times_nat(R_3,C_2))
       <= ( B_4 = A_18
          & C_2 != D_2 ) ) ) )).
...
fof(fact_252_number__of__Bit1,axiom,(
    ! [W_6] : plus_plus_real(plus_plus_real(one_one_real,number267125858f_real(W_6)),number267125858f_real(W_6)) = number267125858f_real(bit1(W_6)) )).
...
fof(fact_250_add__Bit0__Bit1,axiom,(
    ! [K,L] : bit1(plus_plus_int(K,L)) = plus_plus_int(bit0(K),bit1(L)) )).
...
fof(fact_333_power__0__left,axiom,(
    ! [N_27] :
      ...
      & ( zero_zero_nat != N_27
       => zero_zero_nat = power_power_nat(zero_zero_nat,N_27) ) ) )).
...
fof(fact_387_add__scale__eq__noteq,axiom,(
    ! [C_2,D_2,A_18,B_4,R_3] :
     ...
     => ( ( ( D_2 != C_2
            & B_4 = A_18 )
         => plus_plus_int(B_4,times_times_int(R_3,D_2)) != plus_plus_int(A_18,times_times_int(R_3,C_2)) )
       <= R_3 != zero_zero_int ) ) )).
...
fof(fact_94_comm__semiring__1__class_Onormalizing__semiring__rules_I15_J,axiom,(
    ! [Lx_5,Ly_3,Rx_5,Ry_3] : times_times_real(Rx_5,times_times_real(times_times_real(Lx_5,Ly_3),Ry_3)) = times_times_real(times_times_real(Lx_5,Ly_3),times_times_real(Rx_5,Ry_3)) )).
...
fof(fact_463_power__add,axiom,(
    ! [A_11,M_4,N_14] : times_times_int(power_power_int(A_11,M_4),power_power_int(A_11,N_14)) = power_power_int(A_11,plus_plus_nat(M_4,N_14)) )).
...
fof(fact_271_power3__eq__cube,axiom,(
    ! [A_37] : times_times_int(times_times_int(A_37,A_37),A_37) = power_power_int(A_37,number_number_of_nat(bit1(bit1(pls)))) )).

fof(fact_232_comm__semiring__1__class_Onormalizing__semiring__rules_I4_J,axiom,(
    ! [M_9] : times_times_int(plus_plus_int(one_one_int,one_one_int),M_9) = plus_plus_int(M_9,M_9) )).
...
fof(fact_670_real__mult__right__cancel,axiom,(
    ! [A_1,B_2,C] :
      ( C != zero_zero_real
     => ( times_times_real(B_2,C) = times_times_real(A_1,C)
      <=> B_2 = A_1 ) ) )).

fof(fact_16_one__power2,axiom,(
    one_one_real = power_power_real(one_one_real,number_number_of_nat(bit0(bit1(pls)))) )).

fof(fact_29_add__special_I2_J,axiom,(
    ! [W_14] : number_number_of_int(plus_plus_int(bit1(pls),W_14)) = plus_plus_int(one_one_int,number_number_of_int(W_14)) )).

fof(fact_237_mult__number__of__left,axiom,(
    ! [V_10,W_12,Z_7] : times_times_real(number267125858f_real(times_times_int(V_10,W_12)),Z_7) = times_times_real(number267125858f_real(V_10),times_times_real(number267125858f_real(W_12),Z_7)) )).

fof(fact_244_add__number__of__left,axiom,(
    ! [V_7,W_9,Z_6] : plus_plus_int(number_number_of_int(plus_plus_int(V_7,W_9)),Z_6) = plus_plus_int(number_number_of_int(V_7),plus_plus_int(number_number_of_int(W_9),Z_6)) )).
...
fof(fact_574_power__m1__even,axiom,(
    ! [N_2] : one_one_real = power_power_real(number267125858f_real(min),times_times_nat(number_number_of_nat(bit0(bit1(pls))),N_2)) )).
...
fof(fact_613_zcong__square__zless,axiom,(
    ! [A,P] :
      ( ( zprime(P)
       => ( ( ord_less_int(A,P)
           => ( ( minus_minus_int(P,one_one_int) = A
                | A = one_one_int )
...
fof(fact_106_comm__semiring__1__class_Onormalizing__semiring__rules_I18_J,axiom,(
    ! [Lx_1,Rx_1,Ry_1] : times_times_real(times_times_real(Lx_1,Rx_1),Ry_1) = times_times_real(Lx_1,times_times_real(Rx_1,Ry_1)) )).
...
fof(fact_490_power__inject__exp,axiom,(
    ! [Ma,N_1,A_1] :
      ( ( power_power_nat(A_1,N_1) = power_power_nat(A_1,Ma)
      <=> Ma = N_1 )
...
fof(fact_230_comm__semiring__1__class_Onormalizing__semiring__rules_I4_J,axiom,(
    ! [M_9] : times_times_real(plus_plus_real(one_one_real,one_one_real),M_9) = plus_plus_real(M_9,M_9) )).

fof(fact_278_semiring__mult__2__right,axiom,(
    ! [Z_3] : plus_plus_real(Z_3,Z_3) = times_times_real(Z_3,number267125858f_real(bit0(bit1(pls)))) )).
...
fof(fact_168_crossproduct__eq,axiom,(
    ! [W_1,Y_2,X_2,Z_1] :
      ( ( W_1 = X_2
        | Y_2 = Z_1 )
    <=> plus_plus_real(times_times_real(W_1,Z_1),times_times_real(X_2,Y_2)) = plus_plus_real(times_times_real(W_1,Y_2),times_times_real(X_2,Z_1)) ) )).
...
fof(fact_188_comm__semiring__1__class_Onormalizing__semiring__rules_I11_J,axiom,(
    ! [A_45] :
      ( A_45 = times_times_int(one_one_int,A_45)
     <= is_int(A_45) ) )).

fof(fact_456_power__commutes,axiom,(
    ! [A_13,N_16] : times_times_real(A_13,power_power_real(A_13,N_16)) = times_times_real(power_power_real(A_13,N_16),A_13) )).
...
fof(fact_649_exp__eq__1,axiom,(
    ! [X_2,N_1] :
      ( ( one_one_nat = X_2
        | zero_zero_nat = N_1 )
    <=> one_one_nat = power_power_nat(X_2,N_1) ) )).
...
fof(fact_455_power__commutes,axiom,(
    ! [A_13,N_16] : times_times_nat(A_13,power_power_nat(A_13,N_16)) = times_times_nat(power_power_nat(A_13,N_16),A_13) )).
...
fof(fact_247_number__of__add,axiom,(
    ! [V_5,W_7] : plus_plus_real(number267125858f_real(V_5),number267125858f_real(W_7)) = number267125858f_real(plus_plus_int(V_5,W_7)) )).
...
fof(fact_212_semiring__mult__number__of,axiom,(
    ! [V_16,V_15] :
      ( ord_less_eq_int(pls,V_15)
     => ( number_number_of_nat(times_times_int(V_15,V_16)) = times_times_nat(number_number_of_nat(V_15),number_number_of_nat(V_16))
       <= ord_less_eq_int(pls,V_16) ) ) )).
...
fof(fact_626_power__eq__if,axiom,(
    ! [P,M] :
      ( ( times_times_nat(P,power_power_nat(P,minus_minus_nat(M,one_one_nat))) = power_power_nat(P,M)
       <= zero_zero_nat != M )
      & ( M = zero_zero_nat
       => one_one_nat = power_power_nat(P,M) ) ) )).
...
fof(fact_460_power__mult__distrib,axiom,(
    ! [A_12,B_3,N_15] : times_times_int(power_power_int(A_12,N_15),power_power_int(B_3,N_15)) = power_power_int(times_times_int(A_12,B_3),N_15) )).
...
fof(fact_323_power__eq__imp__eq__base,axiom,(
    ! [A_31,N_30,B_8] :
     ...
     => ( ( ( ord_less_eq_int(zero_zero_int,B_8)
       ...
       <= power_power_int(B_8,N_30) = power_power_int(A_31,N_30) ) ) )).
...
fof(fact_465_power__one,axiom,(
    ! [N_13] : one_one_nat = power_power_nat(one_one_nat,N_13) )).

fof(fact_177_crossproduct__noteq,axiom,(
    ! [C,D,A_1,B_2] :
      ( plus_plus_real(times_times_real(A_1,D),times_times_real(B_2,C)) != plus_plus_real(times_times_real(A_1,C),times_times_real(B_2,D))
    <=> ( A_1 != B_2
        & D != C ) ) )).
...
fof(fact_7_zadd__power2,axiom,(
    ! [A,B_1] : plus_plus_int(plus_plus_int(power_power_int(A,number_number_of_nat(bit0(bit1(pls)))),times_times_int(times_times_int(number_number_of_int(bit0(bit1(pls))),A),B_1)),power_power_int(B_1,number_number_of_nat(bit0(bit1(pls))))) = power_power_int(plus_plus_int(A,B_1),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_334_power__0__left,axiom,(
    ! [N_27] :
      ( ( zero_zero_int = power_power_int(zero_zero_int,N_27)
       <= zero_zero_nat != N_27 )
      & ( zero_zero_nat = N_27
...
fof(fact_659_realpow__two__sum__zero__iff,axiom,(
    ! [X_2,Y_2] :
      ( zero_zero_real = plus_plus_real(power_power_real(X_2,number_number_of_nat(bit0(bit1(pls)))),power_power_real(Y_2,number_number_of_nat(bit0(bit1(pls)))))
    <=> ( zero_zero_real = X_2
        & Y_2 = zero_zero_real ) ) )).
...
fof(fact_190_comm__semiring__1__class_Onormalizing__semiring__rules_I30_J,axiom,(
    ! [X_15,Y_13,Q_2] : times_times_real(power_power_real(X_15,Q_2),power_power_real(Y_13,Q_2)) = power_power_real(times_times_real(X_15,Y_13),Q_2) )).
...
fof(fact_332_power__0__left,axiom,(
    ! [N_27] :
      ( ( zero_zero_real = power_power_real(zero_zero_real,N_27)
       <= zero_zero_nat != N_27 )
      & ( N_27 = zero_zero_nat
...
fof(fact_30_add__special_I3_J,axiom,(
    ! [V_17] : number267125858f_real(plus_plus_int(V_17,bit1(pls))) = plus_plus_real(number267125858f_real(V_17),one_one_real) )).

fof(fact_101_comm__semiring__1__class_Onormalizing__semiring__rules_I16_J,axiom,(
    ! [Lx_3,Ly_1,Rx_3] : times_times_nat(times_times_nat(Lx_3,Rx_3),Ly_1) = times_times_nat(times_times_nat(Lx_3,Ly_1),Rx_3) )).
...
fof(fact_561_nat__number__of__mult__left,axiom,(
    ! [V_2,K,V_1] :
      ...
      & ( ord_less_int(V_1,pls)
       => zero_zero_nat = times_times_nat(number_number_of_nat(V_1),times_times_nat(number_number_of_nat(V_2),K)) ) ) )).
...
fof(fact_447_power2__eq__imp__eq,axiom,(
    ! [X_9,Y_7] :
     ...
     <= power_power_nat(Y_7,number_number_of_nat(bit0(bit1(pls)))) = power_power_nat(X_9,number_number_of_nat(bit0(bit1(pls)))) ) )).
...
fof(fact_581_power__0__left__number__of,axiom,(
    ! [W_3] :
      ( ( one_one_real = power_power_real(zero_zero_real,number_number_of_nat(W_3))
       <= number_number_of_nat(W_3) = zero_zero_nat )
      & ( number_number_of_nat(W_3) != zero_zero_nat
...
fof(fact_114_comm__semiring__1__class_Onormalizing__semiring__rules_I7_J,axiom,(
    ! [A_56,B_17] : times_times_int(B_17,A_56) = times_times_int(A_56,B_17) )).

fof(fact_281_mult__2__right,axiom,(
    ! [Z_2] : plus_plus_real(Z_2,Z_2) = times_times_real(Z_2,number267125858f_real(bit0(bit1(pls)))) )).
...
fof(fact_249_add__Bit1__Bit0,axiom,(
    ! [K,L] : bit1(plus_plus_int(K,L)) = plus_plus_int(bit1(K),bit0(L)) )).
...
fof(fact_210_plus__numeral__code_I9_J,axiom,(
    ! [V_1,W] : number_number_of_int(plus_plus_int(V_1,W)) = plus_plus_int(number_number_of_int(V_1),number_number_of_int(W)) )).
...
fof(fact_596_zdiff__zmult__distrib2,axiom,(
    ! [W,Z1,Z2] : minus_minus_int(times_times_int(W,Z1),times_times_int(W,Z2)) = times_times_int(W,minus_minus_int(Z1,Z2)) )).
...
fof(fact_102_comm__semiring__1__class_Onormalizing__semiring__rules_I16_J,axiom,(
    ! [Lx_3,Ly_1,Rx_3] : times_times_int(times_times_int(Lx_3,Rx_3),Ly_1) = times_times_int(times_times_int(Lx_3,Ly_1),Rx_3) )).
...
fof(fact_611_mult__sum2sq,axiom,(
    ! [A,B_1,P,Q] : twoSqu140629262sum2sq(product_Pair_int_int(plus_plus_int(times_times_int(A,P),times_times_int(B_1,Q)),minus_minus_int(times_times_int(A,Q),times_times_int(B_1,P)))) = times_times_int(twoSqu140629262sum2sq(product_Pair_int_int(A,B_1)),twoSqu140629262sum2sq(product_Pair_int_int(P,Q))) )).
...
fof(fact_343_comm__semiring__1__class_Onormalizing__semiring__rules_I10_J,axiom,(
    ! [A_27] : zero_zero_nat = times_times_nat(A_27,zero_zero_nat) )).
...
fof(fact_117_comm__semiring__1__class_Onormalizing__semiring__rules_I20_J,axiom,(
    ! [A_55,B_16,C_10,D_5] : plus_plus_int(plus_plus_int(A_55,C_10),plus_plus_int(B_16,D_5)) = plus_plus_int(plus_plus_int(A_55,B_16),plus_plus_int(C_10,D_5)) )).
...
fof(fact_220_left__distrib__number__of,axiom,(
    ! [A_44,B_11,V_12] : plus_plus_int(times_times_int(A_44,number_number_of_int(V_12)),times_times_int(B_11,number_number_of_int(V_12))) = times_times_int(plus_plus_int(A_44,B_11),number_number_of_int(V_12)) )).
...
fof(fact_341_comm__semiring__1__class_Onormalizing__semiring__rules_I9_J,axiom,(
    ! [A_28] : zero_zero_int = times_times_int(zero_zero_int,A_28) )).
...
fof(fact_654_divides__div__not,axiom,(
    ! [X_1,Q,N,R_1] :
      ( ( ord_less_nat(zero_zero_nat,R_1)
       => ( ord_less_nat(R_1,N)
         => ~ dvd_dvd_nat(N,X_1) ) )
     <= plus_plus_nat(times_times_nat(Q,N),R_1) = X_1 ) )).
...
fof(fact_251_Bit1__def,axiom,(
    ! [K] : plus_plus_int(plus_plus_int(one_one_int,K),K) = bit1(K) )).
...
fof(fact_17_one__power2,axiom,(
    one_one_nat = power_power_nat(one_one_nat,number_number_of_nat(bit0(bit1(pls)))) )).

fof(fact_44_comm__semiring__1__class_Onormalizing__semiring__rules_I33_J,axiom,(
    ! [X_18] : X_18 = power_power_nat(X_18,one_one_nat) )).

fof(fact_537_comm__semiring__1__class_Onormalizing__semiring__rules_I32_J,axiom,(
    ! [X_5] : one_one_nat = power_power_nat(X_5,zero_zero_nat) )).

fof(fact_193_rel__simps_I39_J,axiom,(
    ! [L] : bit1(L) != pls )).

fof(fact_458_power__mult__distrib,axiom,(
    ! [A_12,B_3,N_15] : times_times_nat(power_power_nat(A_12,N_15),power_power_nat(B_3,N_15)) = power_power_nat(times_times_nat(A_12,B_3),N_15) )).
...
fof(fact_15_cube__square,axiom,(
    ! [A] : power_power_int(A,number_number_of_nat(bit1(bit1(pls)))) = times_times_int(A,power_power_int(A,number_number_of_nat(bit0(bit1(pls))))) )).
...
fof(fact_540_power__0,axiom,(
    ! [A_3] : one_one_nat = power_power_nat(A_3,zero_zero_nat) )).
...
fof(fact_233_add__numeral__0,axiom,(
    ! [A_41] : A_41 = plus_plus_real(number267125858f_real(pls),A_41) )).
...
fof(fact_175_comm__semiring__1__class_Onormalizing__semiring__rules_I8_J,axiom,(
    ! [A_47,B_12,C_4] : plus_plus_nat(times_times_nat(A_47,C_4),times_times_nat(B_12,C_4)) = times_times_nat(plus_plus_nat(A_47,B_12),C_4) )).
...
fof(fact_2__0961_A_060_At_A_061_061_062_AEX_Ax_Ay_O_Ax_A_094_A2_A_L_Ay_A_094_A2_A_06,axiom,
    ( ? [X,Y] :
        ( plus_plus_int(times_times_int(number_number_of_int(bit0(bit0(bit1(pls)))),m),one_one_int) = plus_plus_int(power_power_int(X,number_number_of_nat(bit0(bit1(pls)))),power_power_int(Y,number_number_of_nat(bit0(bit1(pls)))))
        & is_int(Y)
        & is_int(X) )
...
fof(fact_682_zdiv__mono2__lemma,axiom,(
    ! [B_1,Q,R_1,B,Q_1,R_2] :
     ...
     <= plus_plus_int(times_times_int(B,Q_1),R_2) = plus_plus_int(times_times_int(B_1,Q),R_1) ) )).
...
fof(fact_322_power__eq__imp__eq__base,axiom,(
    ! [A_31,N_30,B_8] :
     ...
     <= power_power_nat(B_8,N_30) = power_power_nat(A_31,N_30) ) )).
...
fof(fact_218_left__distrib__number__of,axiom,(
    ! [A_44,B_11,V_12] : plus_plus_real(times_times_real(A_44,number267125858f_real(V_12)),times_times_real(B_11,number267125858f_real(V_12))) = times_times_real(plus_plus_real(A_44,B_11),number267125858f_real(V_12)) )).
...
fof(fact_283_semiring__one__add__one__is__two,axiom,(
    number267125858f_real(bit0(bit1(pls))) = plus_plus_real(one_one_real,one_one_real) )).
...
fof(fact_667_real__mult__assoc,axiom,(
    ! [Z1,Z2,Z3] : times_times_real(Z1,times_times_real(Z2,Z3)) = times_times_real(times_times_real(Z1,Z2),Z3) )).
...
fof(fact_605_Euler_Oaux1,axiom,(
    ! [A,X_1] :
      ( ( ord_less_int(zero_zero_int,X_1)
       => ( ( minus_minus_int(A,one_one_int) != X_1
...
fof(fact_228_comm__semiring__1__class_Onormalizing__semiring__rules_I3_J,axiom,(
    ! [M_10,A_42] : times_times_nat(plus_plus_nat(A_42,one_one_nat),M_10) = plus_plus_nat(M_10,times_times_nat(A_42,M_10)) )).
...
fof(fact_184_comm__semiring__1__class_Onormalizing__semiring__rules_I12_J,axiom,(
    ! [A_46] : A_46 = times_times_nat(A_46,one_one_nat) )).

fof(fact_209_zadd__zmult__distrib2,axiom,(
    ! [W,Z1,Z2] : plus_plus_int(times_times_int(W,Z1),times_times_int(W,Z2)) = times_times_int(W,plus_plus_int(Z1,Z2)) )).
...
fof(fact_187_comm__semiring__1__class_Onormalizing__semiring__rules_I11_J,axiom,(
    ! [A_45] : A_45 = times_times_nat(one_one_nat,A_45) )).
...
fof(fact_590__096s_A_094_A2_A_N_A_N1_A_061_As_A_094_A2_A_L_A1_096,axiom,(
    plus_plus_int(power_power_int(s,number_number_of_nat(bit0(bit1(pls)))),one_one_int) = minus_minus_int(power_power_int(s,number_number_of_nat(bit0(bit1(pls)))),number_number_of_int(min)) )).

fof(fact_225_comm__semiring__1__class_Onormalizing__semiring__rules_I2_J,axiom,(
    ! [A_43,M_11] : times_times_nat(plus_plus_nat(A_43,one_one_nat),M_11) = plus_plus_nat(times_times_nat(A_43,M_11),M_11) )).
...
fof(fact_130_comm__semiring__1__class_Onormalizing__semiring__rules_I24_J,axiom,(
    ! [A_50,C_5] : plus_plus_real(C_5,A_50) = plus_plus_real(A_50,C_5) )).
...
fof(fact_468_power__mult,axiom,(
    ! [A_10,M_3,N_12] : power_power_real(power_power_real(A_10,M_3),N_12) = power_power_real(A_10,times_times_nat(M_3,N_12)) )).
...
fof(fact_257_mult__numeral__1__right,axiom,(
    ! [A_38] :
      ( A_38 = times_times_int(A_38,number_number_of_int(bit1(pls)))
     <= is_int(A_38) ) )).
...
fof(fact_56_comm__semiring__1__class_Onormalizing__semiring__rules_I26_J,axiom,(
    ! [X_17,P_2,Q_3] : power_power_nat(X_17,plus_plus_nat(P_2,Q_3)) = times_times_nat(power_power_nat(X_17,P_2),power_power_nat(X_17,Q_3)) )).
...
fof(fact_625_mult__eq__if,axiom,(
    ! [N,M] :
      ( ( times_times_nat(M,N) = zero_zero_nat
       <= M = zero_zero_nat )
      & ( plus_plus_nat(N,times_times_nat(minus_minus_nat(M,one_one_nat),N)) = times_times_nat(M,N)
       <= zero_zero_nat != M ) ) )).
...
fof(fact_637_nat__power__eq__0__iff,axiom,(
    ! [Ma,N_1] :
      ( zero_zero_nat = power_power_nat(Ma,N_1)
    <=> ( N_1 != zero_zero_nat
        & zero_zero_nat = Ma ) ) )).
...
fof(fact_448_power2__eq__imp__eq,axiom,(
    ! [X_9,Y_7] :
      ( ( ( ord_less_eq_int(zero_zero_int,X_9)
       ...
       <= power_power_int(Y_7,number_number_of_nat(bit0(bit1(pls)))) = power_power_int(X_9,number_number_of_nat(bit0(bit1(pls)))) )
     <= ( is_int(Y_7)
        & is_int(X_9) ) ) )).
...
fof(fact_454_sum__power2__eq__zero__iff,axiom,(
    ! [X_2,Y_2] :
     ...
     => ( ( zero_zero_int = Y_2
          & zero_zero_int = X_2 )
      <=> zero_zero_int = plus_plus_int(power_power_int(X_2,number_number_of_nat(bit0(bit1(pls)))),power_power_int(Y_2,number_number_of_nat(bit0(bit1(pls))))) ) ) )).
...
fof(fact_288_prime__g__5,axiom,(
    ! [P] :
      ( ( ( number_number_of_int(bit0(bit1(pls))) != P
         => ( number_number_of_int(bit1(bit1(pls))) != P
...
fof(fact_214_semiring__add__number__of,axiom,(
    ! [V_14,V_13] :
      ( ( ord_less_eq_int(pls,V_14)
       => number267125858f_real(plus_plus_int(V_13,V_14)) = plus_plus_real(number267125858f_real(V_13),number267125858f_real(V_14)) )
     <= ord_less_eq_int(pls,V_13) ) )).

fof(fact_609_diff__bin__simps_I5_J,axiom,(
    ! [L] : bit1(minus_minus_int(min,L)) = minus_minus_int(min,bit0(L)) )).
...
fof(fact_607_diff__bin__simps_I4_J,axiom,(
    ! [L] : bit1(minus_minus_int(min,L)) = minus_minus_int(pls,bit1(L)) )).
...
fof(fact_115_comm__semiring__1__class_Onormalizing__semiring__rules_I20_J,axiom,(
    ! [A_55,B_16,C_10,D_5] : plus_plus_real(plus_plus_real(A_55,C_10),plus_plus_real(B_16,D_5)) = plus_plus_real(plus_plus_real(A_55,B_16),plus_plus_real(C_10,D_5)) )).
...
fof(fact_669_real__mult__left__cancel,axiom,(
    ! [A_1,B_2,C] :
      ( ( A_1 = B_2
      <=> times_times_real(C,B_2) = times_times_real(C,A_1) )
     <= C != zero_zero_real ) )).
...
fof(fact_347_comm__semiring__1__class_Onormalizing__semiring__rules_I5_J,axiom,(
    ! [A_26] :
      ( A_26 = plus_plus_int(zero_zero_int,A_26)
     <= is_int(A_26) ) )).

fof(fact_118_comm__semiring__1__class_Onormalizing__semiring__rules_I23_J,axiom,(
    ! [A_54,B_15,C_9] : plus_plus_real(plus_plus_real(A_54,C_9),B_15) = plus_plus_real(plus_plus_real(A_54,B_15),C_9) )).
...
fof(fact_104_comm__semiring__1__class_Onormalizing__semiring__rules_I17_J,axiom,(
    ! [Lx_2,Ly,Rx_2] : times_times_nat(Lx_2,times_times_nat(Ly,Rx_2)) = times_times_nat(times_times_nat(Lx_2,Ly),Rx_2) )).

fof(fact_595_zdiff__zmult__distrib,axiom,(
    ! [Z1,Z2,W] : minus_minus_int(times_times_int(Z1,W),times_times_int(Z2,W)) = times_times_int(minus_minus_int(Z1,Z2),W) )).
...
fof(fact_126_comm__semiring__1__class_Onormalizing__semiring__rules_I25_J,axiom,(
    ! [A_52,C_7,D_4] : plus_plus_int(plus_plus_int(A_52,C_7),D_4) = plus_plus_int(A_52,plus_plus_int(C_7,D_4)) )).
...
fof(fact_113_comm__semiring__1__class_Onormalizing__semiring__rules_I7_J,axiom,(
    ! [A_56,B_17] : times_times_nat(B_17,A_56) = times_times_nat(A_56,B_17) )).
...
fof(fact_116_comm__semiring__1__class_Onormalizing__semiring__rules_I20_J,axiom,(
    ! [A_55,B_16,C_10,D_5] : plus_plus_nat(plus_plus_nat(A_55,C_10),plus_plus_nat(B_16,D_5)) = plus_plus_nat(plus_plus_nat(A_55,B_16),plus_plus_nat(C_10,D_5)) )).
...
fof(fact_119_comm__semiring__1__class_Onormalizing__semiring__rules_I23_J,axiom,(
    ! [A_54,B_15,C_9] : plus_plus_nat(plus_plus_nat(A_54,C_9),B_15) = plus_plus_nat(plus_plus_nat(A_54,B_15),C_9) )).
...
fof(fact_562_mult__nat__number__of,axiom,(
    ! [V_2,V_1] :
      ( ( ord_less_int(V_1,pls)
       => zero_zero_nat = times_times_nat(number_number_of_nat(V_1),number_number_of_nat(V_2)) )
      & ( number_number_of_nat(times_times_int(V_1,V_2)) = times_times_nat(number_number_of_nat(V_1),number_number_of_nat(V_2))
       <= ~ ord_less_int(V_1,pls) ) ) )).
...
fof(fact_582_power__0__left__number__of,axiom,(
    ! [W_3] :
      ( ( zero_zero_nat = power_power_nat(zero_zero_nat,number_number_of_nat(W_3))
       <= number_number_of_nat(W_3) != zero_zero_nat )
...
fof(fact_109_comm__semiring__1__class_Onormalizing__semiring__rules_I19_J,axiom,(
    ! [Lx,Rx,Ry] : times_times_real(Rx,times_times_real(Lx,Ry)) = times_times_real(Lx,times_times_real(Rx,Ry)) )).
...
fof(fact_255_mult__numeral__1,axiom,(
    ! [A_39] :
      ( A_39 = times_times_int(number_number_of_int(bit1(pls)),A_39)
     <= is_int(A_39) ) )).
...
fof(fact_98_comm__semiring__1__class_Onormalizing__semiring__rules_I14_J,axiom,(
    ! [Lx_4,Ly_2,Rx_4,Ry_2] : times_times_nat(Lx_4,times_times_nat(Ly_2,times_times_nat(Rx_4,Ry_2))) = times_times_nat(times_times_nat(Lx_4,Ly_2),times_times_nat(Rx_4,Ry_2)) )).
...
fof(fact_157_power__even__eq,axiom,(
    ! [A_49,N_37] : power_power_nat(power_power_nat(A_49,N_37),number_number_of_nat(bit0(bit1(pls)))) = power_power_nat(A_49,times_times_nat(number_number_of_nat(bit0(bit1(pls))),N_37)) )).

fof(fact_340_comm__semiring__1__class_Onormalizing__semiring__rules_I9_J,axiom,(
    ! [A_28] : zero_zero_nat = times_times_nat(zero_zero_nat,A_28) )).

fof(fact_245_add__number__of__eq,axiom,(
    ! [V_6,W_8] : number267125858f_real(plus_plus_int(V_6,W_8)) = plus_plus_real(number267125858f_real(V_6),number267125858f_real(W_8)) )).

fof(fact_279_semiring__mult__2__right,axiom,(
    ! [Z_3] : plus_plus_nat(Z_3,Z_3) = times_times_nat(Z_3,number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_272_quartic__square__square,axiom,(
    ! [X_1] : power_power_int(X_1,number_number_of_nat(bit0(bit0(bit1(pls))))) = power_power_int(power_power_int(X_1,number_number_of_nat(bit0(bit1(pls)))),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_226_comm__semiring__1__class_Onormalizing__semiring__rules_I2_J,axiom,(
    ! [A_43,M_11] : times_times_int(plus_plus_int(A_43,one_one_int),M_11) = plus_plus_int(times_times_int(A_43,M_11),M_11) )).
...
fof(fact_666_real__mult__commute,axiom,(
    ! [Z,W] : times_times_real(W,Z) = times_times_real(Z,W) )).
...
fof(fact_181_comm__semiring__1__class_Onormalizing__semiring__rules_I34_J,axiom,(
    ! [X_16,Y_14,Z_8] : plus_plus_nat(times_times_nat(X_16,Y_14),times_times_nat(X_16,Z_8)) = times_times_nat(X_16,plus_plus_nat(Y_14,Z_8)) )).
...
fof(fact_20_comm__semiring__1__class_Onormalizing__semiring__rules_I29_J,axiom,(
    ! [X_21] : power_power_real(X_21,number_number_of_nat(bit0(bit1(pls)))) = times_times_real(X_21,X_21) )).
...
fof(fact_186_comm__semiring__1__class_Onormalizing__semiring__rules_I11_J,axiom,(
    ! [A_45] : A_45 = times_times_real(one_one_real,A_45) )).
...
fof(fact_208_zadd__zmult__distrib,axiom,(
    ! [Z1,Z2,W] : plus_plus_int(times_times_int(Z1,W),times_times_int(Z2,W)) = times_times_int(plus_plus_int(Z1,Z2),W) )).
...
fof(fact_321_power__eq__imp__eq__base,axiom,(
    ! [A_31,N_30,B_8] :
     ...
     <= power_power_real(B_8,N_30) = power_power_real(A_31,N_30) ) )).
...
fof(fact_330_field__power__not__zero,axiom,(
    ! [N_28,A_30] :
      ( zero_zero_real != A_30
     => zero_zero_real != power_power_real(A_30,N_28) ) )).
...
fof(fact_159_power__even__eq,axiom,(
    ! [A_49,N_37] : power_power_int(power_power_int(A_49,N_37),number_number_of_nat(bit0(bit1(pls)))) = power_power_int(A_49,times_times_nat(number_number_of_nat(bit0(bit1(pls))),N_37)) )).

fof(fact_219_left__distrib__number__of,axiom,(
    ! [A_44,B_11,V_12] : plus_plus_nat(times_times_nat(A_44,number_number_of_nat(V_12)),times_times_nat(B_11,number_number_of_nat(V_12))) = times_times_nat(plus_plus_nat(A_44,B_11),number_number_of_nat(V_12)) )).
...
fof(fact_170_crossproduct__eq,axiom,(
    ! [W_1,Y_2,X_2,Z_1] :
      ( ( ( Y_2 = Z_1
          | X_2 = W_1 )
      <=> plus_plus_int(times_times_int(W_1,Z_1),times_times_int(X_2,Y_2)) = plus_plus_int(times_times_int(W_1,Y_2),times_times_int(X_2,Z_1)) )
     <= ( is_int(W_1)
        & is_int(X_2)
        & is_int(Z_1)
        & is_int(Y_2) ) ) )).
...
fof(fact_180_comm__semiring__1__class_Onormalizing__semiring__rules_I34_J,axiom,(
    ! [X_16,Y_14,Z_8] : plus_plus_real(times_times_real(X_16,Y_14),times_times_real(X_16,Z_8)) = times_times_real(X_16,plus_plus_real(Y_14,Z_8)) )).
...
fof(fact_489_power__inject__exp,axiom,(
    ! [Ma,N_1,A_1] :
     ...
     => ( N_1 = Ma
      <=> power_power_real(A_1,N_1) = power_power_real(A_1,Ma) ) ) )).

fof(fact_127_comm__semiring__1__class_Onormalizing__semiring__rules_I22_J,axiom,(
    ! [A_51,C_6,D_3] : plus_plus_real(C_6,plus_plus_real(A_51,D_3)) = plus_plus_real(A_51,plus_plus_real(C_6,D_3)) )).
...
fof(fact_275_semiring__mult__2,axiom,(
    ! [Z_5] : plus_plus_int(Z_5,Z_5) = times_times_int(number_number_of_int(bit0(bit1(pls))),Z_5) )).
...
fof(fact_25_comm__semiring__1__class_Onormalizing__semiring__rules_I36_J,axiom,(
    ! [X_20,N_38] : times_times_nat(power_power_nat(X_20,N_38),power_power_nat(X_20,N_38)) = power_power_nat(X_20,times_times_nat(number_number_of_nat(bit0(bit1(pls))),N_38)) )).

fof(fact_614_zspecial__product,axiom,(
    ! [A,B_1] : minus_minus_int(power_power_int(A,number_number_of_nat(bit0(bit1(pls)))),power_power_int(B_1,number_number_of_nat(bit0(bit1(pls))))) = times_times_int(plus_plus_int(A,B_1),minus_minus_int(A,B_1)) )).
...
fof(fact_189_comm__semiring__1__class_Onormalizing__semiring__rules_I30_J,axiom,(
    ! [X_15,Y_13,Q_2] : times_times_nat(power_power_nat(X_15,Q_2),power_power_nat(Y_13,Q_2)) = power_power_nat(times_times_nat(X_15,Y_13),Q_2) )).

fof(fact_348_comm__semiring__1__class_Onormalizing__semiring__rules_I6_J,axiom,(
    ! [A_25] : A_25 = plus_plus_real(A_25,zero_zero_real) )).
...
fof(fact_207_times__numeral__code_I5_J,axiom,(
    ! [V_1,W] : number_number_of_int(times_times_int(V_1,W)) = times_times_int(number_number_of_int(V_1),number_number_of_int(W)) )).
...
fof(fact_621_Legendre__def,axiom,(
    ! [A,P] :
      ...
      & ( ( ( legendre(A,P) = number_number_of_int(min)
           <= ~ quadRes(P,A) )
          & ( quadRes(P,A)
           => one_one_int = legendre(A,P) ) )
       <= ~ zcong(A,zero_zero_int,P) ) ) )).

fof(fact_227_comm__semiring__1__class_Onormalizing__semiring__rules_I3_J,axiom,(
    ! [M_10,A_42] : times_times_real(plus_plus_real(A_42,one_one_real),M_10) = plus_plus_real(M_10,times_times_real(A_42,M_10)) )).
...
fof(fact_290_real__sum__squared__expand,axiom,(
    ! [X_1,Y_1] : plus_plus_real(plus_plus_real(power_power_real(X_1,number_number_of_nat(bit0(bit1(pls)))),power_power_real(Y_1,number_number_of_nat(bit0(bit1(pls))))),times_times_real(times_times_real(number267125858f_real(bit0(bit1(pls))),X_1),Y_1)) = power_power_real(plus_plus_real(X_1,Y_1),number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_438_zero__power2,axiom,(
    zero_zero_int = power_power_int(zero_zero_int,number_number_of_nat(bit0(bit1(pls)))) )).
...
fof(fact_58_comm__semiring__1__class_Onormalizing__semiring__rules_I26_J,axiom,(
    ! [X_17,P_2,Q_3] : power_power_int(X_17,plus_plus_nat(P_2,Q_3)) = times_times_int(power_power_int(X_17,P_2),power_power_int(X_17,Q_3)) )).
...
fof(fact_97_comm__semiring__1__class_Onormalizing__semiring__rules_I14_J,axiom,(
    ! [Lx_4,Ly_2,Rx_4,Ry_2] : times_times_real(Lx_4,times_times_real(Ly_2,times_times_real(Rx_4,Ry_2))) = times_times_real(times_times_real(Lx_4,Ly_2),times_times_real(Rx_4,Ry_2)) )).
