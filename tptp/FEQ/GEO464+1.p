...
fof(aONORMu_EQu_0,axiom,(
    ! [M,N,F0] :
      ( ( ! [X] : s(cart(real,N),i(s(fun(num,cart(real,N)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),F0),s(cart(real,M),X)))
...
fof(aLIFTu_CMUL,axiom,(
    ! [X,C0] : s(cart(real,n10),i(s(fun(cart(real,n10),cart(real,n10)),i(s(fun(real,fun(cart(real,n10),cart(real,n10))),r_),s(real,C0))),s(cart(real,n10),i(s(fun(real,cart(real,n10)),lift),s(real,X))))) = s(cart(real,n10),i(s(fun(real,cart(real,n10)),lift),s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_mul),s(real,C0))),s(real,X))))) )).
...
fof(aLIFTu_EQ,axiom,(
    ! [X,Y] :
      ( s(real,X) = s(real,Y)
    <=> s(cart(real,n10),i(s(fun(real,cart(real,n10)),lift),s(real,Y))) = s(cart(real,n10),i(s(fun(real,cart(real,n10)),lift),s(real,X))) ) )).

fof(alift,axiom,(
    ! [U_0] :
      ( ! [X,I0] : s(real,X) = s(real,i(s(fun(num,real),i(s(fun(real,fun(num,real)),U_0),s(real,X))),s(num,I0)))
     => ! [X] : s(cart(real,n10),i(s(fun(fun(num,real),cart(real,n10)),lambda),s(fun(num,real),i(s(fun(real,fun(num,real)),U_0),s(real,X))))) = s(cart(real,n10),i(s(fun(real,cart(real,n10)),lift),s(real,X))) ) )).
...
fof(aONORMu_I,axiom,(
    ! [N] : s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))) = s(real,i(s(fun(fun(cart(real,N),cart(real,N)),real),onorm),s(fun(cart(real,N),cart(real,N)),i1))) )).
...
fof(aPASTECARTu_EQu_VEC,axiom,(
    ! [Q120795,Q120800,X,Y,N0] :
      ( ( s(cart(real,Q120795),i(s(fun(num,cart(real,Q120795)),vec),s(num,N0))) = s(cart(real,Q120795),X)
        & s(cart(real,Q120800),i(s(fun(num,cart(real,Q120800)),vec),s(num,N0))) = s(cart(real,Q120800),Y) )
...
fof(aDROPu_EQ,axiom,(
    ...
    <=> s(cart(real,n10),Y) = s(cart(real,n10),X) ) )).

fof(aLINEARu_MATRIXu_EXISTS,axiom,(
    ! [N,M,F0] :
      ( ? [A5] :
        ! [X] : s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),i(s(fun(cart(cart(real,M),N),fun(cart(real,M),cart(real,N))),matrixu_vectoru_mul),s(cart(cart(real,M),N),A5))),s(cart(real,M),X))) = s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),F0),s(cart(real,M),X)))
    <=> p(s(bool,i(s(fun(fun(cart(real,M),cart(real,N)),bool),linear),s(fun(cart(real,M),cart(real,N)),F0)))) ) )).
...
fof(aMATRIXu_ADJOINT,axiom,(
    ! [Q117843,Q117844,F0] :
      ( s(cart(cart(real,Q117844),Q117843),i(s(fun(cart(cart(real,Q117843),Q117844),cart(cart(real,Q117844),Q117843)),transp),s(cart(cart(real,Q117843),Q117844),i(s(fun(fun(cart(real,Q117843),cart(real,Q117844)),cart(cart(real,Q117843),Q117844)),matrix),s(fun(cart(real,Q117843),cart(real,Q117844)),F0))))) = s(cart(cart(real,Q117844),Q117843),i(s(fun(fun(cart(real,Q117844),cart(real,Q117843)),cart(cart(real,Q117844),Q117843)),matrix),s(fun(cart(real,Q117844),cart(real,Q117843)),i(s(fun(fun(cart(real,Q117843),cart(real,Q117844)),fun(cart(real,Q117844),cart(real,Q117843))),adjoint),s(fun(cart(real,Q117843),cart(real,Q117844)),F0)))))
...
fof(aVSUMu_OFFSET,axiom,(
    ! [Q108605,U_0] :
     ...
     <= ! [F0,P0,I0] : s(cart(real,Q108605),i(s(fun(num,cart(real,Q108605)),F0),s(num,i(s(fun(num,num),i(s(fun(num,fun(num,num)),p_),s(num,I0))),s(num,P0))))) = s(cart(real,Q108605),i(s(fun(num,cart(real,Q108605)),i(s(fun(num,fun(num,cart(real,Q108605))),i(s(fun(fun(num,cart(real,Q108605)),fun(num,fun(num,cart(real,Q108605)))),U_0),s(fun(num,cart(real,Q108605)),F0))),s(num,P0))),s(num,I0))) ) )).
...
fof(amatrixu_inv,axiom,(
    ! [N,M,U_0] :
      ( ! [A5] : s(cart(cart(real,M),N),i(s(fun(fun(cart(cart(real,M),N),bool),cart(cart(real,M),N)),h_),s(fun(cart(cart(real,M),N),bool),i(s(fun(cart(cart(real,N),M),fun(cart(cart(real,M),N),bool)),U_0),s(cart(cart(real,N),M),A5))))) = s(cart(cart(real,M),N),i(s(fun(cart(cart(real,N),M),cart(cart(real,M),N)),matrixu_inv),s(cart(cart(real,N),M),A5)))
     <= ! [A5,AI_] :
...
fof(aorthogonal,axiom,(
    ! [Q110633,X,Y] :
      ( s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(real,i(s(fun(cart(real,Q110633),real),i(s(fun(cart(real,Q110633),fun(cart(real,Q110633),real)),dot),s(cart(real,Q110633),X))),s(cart(real,Q110633),Y)))
...
fof(aREALu_ABSu_NORM,axiom,(
    ! [Q102710,X] : s(real,i(s(fun(cart(real,Q102710),real),vectoru_norm),s(cart(real,Q102710),X))) = s(real,i(s(fun(real,real),realu_abs),s(real,i(s(fun(cart(real,Q102710),real),vectoru_norm),s(cart(real,Q102710),X))))) )).
...
fof(aMATRIXu_NEGu_EQu_0,axiom,(
    ! [N,M,A5] :
      ( s(cart(cart(real,N),M),i(s(fun(num,cart(cart(real,N),M)),mat),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(cart(real,N),M),A5)
...
fof(aVSUMu_SWAPu_NUMSEG,axiom,(
    ! [Q109392,U_2] :
     ...
     => ! [U_1] :
          ( ! [U_0] :
              ( ! [C0,D0,F0,I0] : s(cart(real,Q109392),i(s(fun(fun(num,cart(real,Q109392)),cart(real,Q109392)),i(s(fun(fun(num,bool),fun(fun(num,cart(real,Q109392)),cart(real,Q109392))),vsum),s(fun(num,bool),i(s(fun(num,fun(num,bool)),i(s(fun(num,fun(num,fun(num,bool))),o_o_),s(num,C0))),s(num,D0))))),s(fun(num,cart(real,Q109392)),i(s(fun(num,fun(num,cart(real,Q109392))),F0),s(num,I0))))) = s(cart(real,Q109392),i(s(fun(num,cart(real,Q109392)),i(s(fun(fun(num,fun(num,cart(real,Q109392))),fun(num,cart(real,Q109392))),i(s(fun(num,fun(fun(num,fun(num,cart(real,Q109392))),fun(num,cart(real,Q109392)))),i(s(fun(num,fun(num,fun(fun(num,fun(num,cart(real,Q109392))),fun(num,cart(real,Q109392))))),U_0),s(num,C0))),s(num,D0))),s(fun(num,fun(num,cart(real,Q109392))),F0))),s(num,I0)))
...
fof(aLINEARu_INJECTIVEu_0u_SUBSPACE,axiom,(
    ! [N,M,F0,S0] :
     ...
     => ( ! [X,Y] :
      ...
      <=> ! [X] :
            ( s(cart(real,M),i(s(fun(num,cart(real,M)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,M),X)
           <= ( p(s(bool,i(s(fun(fun(cart(real,M),bool),bool),i(s(fun(cart(real,M),fun(fun(cart(real,M),bool),bool)),in),s(cart(real,M),X))),s(fun(cart(real,M),bool),S0))))
...
fof(aONORMu_POSu_LT,axiom,(
    ! [Q118333,Q118355,F0] :
     ...
     => ( ~ ! [X] : s(cart(real,Q118355),i(s(fun(num,cart(real,Q118355)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,Q118355),i(s(fun(cart(real,Q118333),cart(real,Q118355)),F0),s(cart(real,Q118333),X)))
...
fof(aVSUMu_NORMu_TRIANGLE,axiom,(
    ! [Q106736,Q106745,U_0] :
      ( ! [F0,A5] : s(real,i(s(fun(cart(real,Q106745),real),vectoru_norm),s(cart(real,Q106745),i(s(fun(Q106736,cart(real,Q106745)),F0),s(Q106736,A5))))) = s(real,i(s(fun(Q106736,real),i(s(fun(fun(Q106736,cart(real,Q106745)),fun(Q106736,real)),U_0),s(fun(Q106736,cart(real,Q106745)),F0))),s(Q106736,A5)))
     => ! [S0,F0,B0] :
...
fof(aPASTECARTu_VSUM,axiom,(
    ! [Q120760,Q120763,Q120761,U_0] :
     ...
     <= ! [X,Y,I0] : s(cart(real,finite_sum(Q120760,Q120761)),i(s(fun(cart(real,Q120761),cart(real,finite_sum(Q120760,Q120761))),i(s(fun(cart(real,Q120760),fun(cart(real,Q120761),cart(real,finite_sum(Q120760,Q120761)))),pastecart),s(cart(real,Q120760),i(s(fun(Q120763,cart(real,Q120760)),X),s(Q120763,I0))))),s(cart(real,Q120761),i(s(fun(Q120763,cart(real,Q120761)),Y),s(Q120763,I0))))) = s(cart(real,finite_sum(Q120760,Q120761)),i(s(fun(Q120763,cart(real,finite_sum(Q120760,Q120761))),i(s(fun(fun(Q120763,cart(real,Q120761)),fun(Q120763,cart(real,finite_sum(Q120760,Q120761)))),i(s(fun(fun(Q120763,cart(real,Q120760)),fun(fun(Q120763,cart(real,Q120761)),fun(Q120763,cart(real,finite_sum(Q120760,Q120761))))),U_0),s(fun(Q120763,cart(real,Q120760)),X))),s(fun(Q120763,cart(real,Q120761)),Y))),s(Q120763,I0))) ) )).
...
fof(aVECTORu_ADDu_LID,axiom,(
    ! [Q99561,X] : s(cart(real,Q99561),X) = s(cart(real,Q99561),i(s(fun(cart(real,Q99561),cart(real,Q99561)),i(s(fun(cart(real,Q99561),fun(cart(real,Q99561),cart(real,Q99561))),vectoru_add),s(cart(real,Q99561),i(s(fun(num,cart(real,Q99561)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))),s(cart(real,Q99561),X))) )).
...
fof(aLINEARu_LIFTu_COMPONENT,axiom,(
    ! [N,U_0] :
     ...
     <= ! [K0,X] : s(cart(real,n10),i(s(fun(real,cart(real,n10)),lift),s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),X))),s(num,K0))))) = s(cart(real,n10),i(s(fun(cart(real,N),cart(real,n10)),i(s(fun(num,fun(cart(real,N),cart(real,n10))),U_0),s(num,K0))),s(cart(real,N),X))) ) )).
...
fof(aNORMu_EQu_0u_IMP,axiom,(
    ! [Q102346,X] :
     ...
     <= s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(real,i(s(fun(cart(real,Q102346),real),vectoru_norm),s(cart(real,Q102346),X))) ) )).
...
fof(aONORMu_ID,axiom,(
    ! [N,U_0] :
     ...
     => s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))) = s(real,i(s(fun(fun(cart(real,N),cart(real,N)),real),onorm),s(fun(cart(real,N),cart(real,N)),U_0))) ) )).
...
fof(aVSUMu_EQ,axiom,(
    ! [Q106171,Q106182,F0,G0,S0] :
     ...
     <= ! [X] :
          ( s(cart(real,Q106182),i(s(fun(Q106171,cart(real,Q106182)),G0),s(Q106171,X))) = s(cart(real,Q106182),i(s(fun(Q106171,cart(real,Q106182)),F0),s(Q106171,X)))
...
fof(aSUBSETu_DROPu_IMAGE,axiom,(
    ! [S0,T0] : s(bool,i(s(fun(fun(cart(real,n10),bool),bool),i(s(fun(fun(cart(real,n10),bool),fun(fun(cart(real,n10),bool),bool)),subset),s(fun(cart(real,n10),bool),S0))),s(fun(cart(real,n10),bool),T0))) = s(bool,i(s(fun(fun(real,bool),bool),i(s(fun(fun(real,bool),fun(fun(real,bool),bool)),subset),s(fun(real,bool),i(s(fun(fun(cart(real,n10),bool),fun(real,bool)),i(s(fun(fun(cart(real,n10),real),fun(fun(cart(real,n10),bool),fun(real,bool))),image),s(fun(cart(real,n10),real),drop))),s(fun(cart(real,n10),bool),S0))))),s(fun(real,bool),i(s(fun(fun(cart(real,n10),bool),fun(real,bool)),i(s(fun(fun(cart(real,n10),real),fun(fun(cart(real,n10),bool),fun(real,bool))),image),s(fun(cart(real,n10),real),drop))),s(fun(cart(real,n10),bool),T0))))) )).
...
fof(aADJOINTu_UNIQUE,axiom,(
    ! [Q113333,Q113332,F0,FI_] :
     ...
     => s(fun(cart(real,Q113332),cart(real,Q113333)),i(s(fun(fun(cart(real,Q113333),cart(real,Q113332)),fun(cart(real,Q113332),cart(real,Q113333))),adjoint),s(fun(cart(real,Q113333),cart(real,Q113332)),F0))) = s(fun(cart(real,Q113332),cart(real,Q113333)),FI_) ) )).
...
fof(aVSUMu_CLAUSESu_NUMSEGu_conjunct0,axiom,(
    ...
    ? [V] :
      ...
      & ( p(s(bool,V))
      <=> s(num,i(s(fun(num,num),numeral),s(num,u_0))) = s(num,M0) ) ) )).
    ...
    ! [M,N,P,U_1] :
      ( ! [U_0] :
         ...
         => ! [F0,G0,H0,M0,N0] :
              ( s(cart(real,P),i(s(fun(fun(num,cart(real,P)),cart(real,P)),i(s(fun(fun(num,bool),fun(fun(num,cart(real,P)),cart(real,P))),vsum),s(fun(num,bool),i(s(fun(num,fun(num,bool)),i(s(fun(num,fun(num,fun(num,bool))),o_o_),s(num,M0))),s(num,N0))))),s(fun(num,cart(real,P)),i(s(fun(fun(num,cart(real,N)),fun(num,cart(real,P))),i(s(fun(fun(num,cart(real,M)),fun(fun(num,cart(real,N)),fun(num,cart(real,P)))),i(s(fun(fun(cart(real,M),fun(cart(real,N),cart(real,P))),fun(fun(num,cart(real,M)),fun(fun(num,cart(real,N)),fun(num,cart(real,P))))),U_0),s(fun(cart(real,M),fun(cart(real,N),cart(real,P))),H0))),s(fun(num,cart(real,M)),F0))),s(fun(num,cart(real,N)),G0))))) = s(cart(real,P),i(s(fun(cart(real,P),cart(real,P)),i(s(fun(cart(real,P),fun(cart(real,P),cart(real,P))),i(s(fun(bool,fun(cart(real,P),fun(cart(real,P),cart(real,P)))),cond),s(bool,i(s(fun(num,bool),i(s(fun(num,fun(num,bool)),l_a_),s(num,M0))),s(num,N0))))),s(cart(real,P),i(s(fun(cart(real,P),cart(real,P)),i(s(fun(cart(real,P),fun(cart(real,P),cart(real,P))),vectoru_sub),s(cart(real,P),i(s(fun(cart(real,P),cart(real,P)),i(s(fun(cart(real,P),fun(cart(real,P),cart(real,P))),vectoru_sub),s(cart(real,P),i(s(fun(cart(real,N),cart(real,P)),i(s(fun(cart(real,M),fun(cart(real,N),cart(real,P))),H0),s(cart(real,M),i(s(fun(num,cart(real,M)),F0),s(num,i(s(fun(num,num),i(s(fun(num,fun(num,num)),p_),s(num,N0))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))))),s(cart(real,N),i(s(fun(num,cart(real,N)),G0),s(num,N0))))))),s(cart(real,P),i(s(fun(cart(real,N),cart(real,P)),i(s(fun(cart(real,M),fun(cart(real,N),cart(real,P))),H0),s(cart(real,M),i(s(fun(num,cart(real,M)),F0),s(num,M0))))),s(cart(real,N),i(s(fun(num,cart(real,N)),G0),s(num,i(s(fun(num,num),i(s(fun(num,fun(num,num)),m_),s(num,M0))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))))))))),s(cart(real,P),i(s(fun(fun(num,cart(real,P)),cart(real,P)),i(s(fun(fun(num,bool),fun(fun(num,cart(real,P)),cart(real,P))),vsum),s(fun(num,bool),i(s(fun(num,fun(num,bool)),i(s(fun(num,fun(num,fun(num,bool))),o_o_),s(num,M0))),s(num,N0))))),s(fun(num,cart(real,P)),i(s(fun(fun(num,cart(real,N)),fun(num,cart(real,P))),i(s(fun(fun(num,cart(real,M)),fun(fun(num,cart(real,N)),fun(num,cart(real,P)))),i(s(fun(fun(cart(real,M),fun(cart(real,N),cart(real,P))),fun(fun(num,cart(real,M)),fun(fun(num,cart(real,N)),fun(num,cart(real,P))))),U_1),s(fun(cart(real,M),fun(cart(real,N),cart(real,P))),H0))),s(fun(num,cart(real,M)),F0))),s(fun(num,cart(real,N)),G0))))))))),s(cart(real,P),i(s(fun(num,cart(real,P)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0)))))))
             <= p(s(bool,i(s(fun(fun(cart(real,M),fun(cart(real,N),cart(real,P))),bool),bilinear),s(fun(cart(real,M),fun(cart(real,N),cart(real,P))),H0)))) ) )
     <= ! [H0,F0,G0,K0] : s(cart(real,P),i(s(fun(cart(real,N),cart(real,P)),i(s(fun(cart(real,M),fun(cart(real,N),cart(real,P))),H0),s(cart(real,M),i(s(fun(cart(real,M),cart(real,M)),i(s(fun(cart(real,M),fun(cart(real,M),cart(real,M))),vectoru_sub),s(cart(real,M),i(s(fun(num,cart(real,M)),F0),s(num,i(s(fun(num,num),i(s(fun(num,fun(num,num)),p_),s(num,K0))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))))),s(cart(real,M),i(s(fun(num,cart(real,M)),F0),s(num,K0))))))),s(cart(real,N),i(s(fun(num,cart(real,N)),G0),s(num,K0))))) = s(cart(real,P),i(s(fun(num,cart(real,P)),i(s(fun(fun(num,cart(real,N)),fun(num,cart(real,P))),i(s(fun(fun(num,cart(real,M)),fun(fun(num,cart(real,N)),fun(num,cart(real,P)))),i(s(fun(fun(cart(real,M),fun(cart(real,N),cart(real,P))),fun(fun(num,cart(real,M)),fun(fun(num,cart(real,N)),fun(num,cart(real,P))))),U_1),s(fun(cart(real,M),fun(cart(real,N),cart(real,P))),H0))),s(fun(num,cart(real,M)),F0))),s(fun(num,cart(real,N)),G0))),s(num,K0))) ) )).
...
fof(aonorm,axiom,(
    ! [M,N,U_0] :
     ...
     => ! [F0] : s(real,i(s(fun(fun(real,bool),real),sup),s(fun(real,bool),i(s(fun(fun(real,bool),fun(real,bool)),gspec),s(fun(real,bool),i(s(fun(fun(cart(real,M),cart(real,N)),fun(real,bool)),U_0),s(fun(cart(real,M),cart(real,N)),F0))))))) = s(real,i(s(fun(fun(cart(real,M),cart(real,N)),real),onorm),s(fun(cart(real,M),cart(real,N)),F0))) ) )).
...
fof(aTRANSPu_EQ,axiom,(
    ...
    <=> s(cart(cart(real,N),M),i(s(fun(cart(cart(real,M),N),cart(cart(real,N),M)),transp),s(cart(cart(real,M),N),B0))) = s(cart(cart(real,N),M),i(s(fun(cart(cart(real,M),N),cart(cart(real,N),M)),transp),s(cart(cart(real,M),N),A5))) ) )).
...
fof(aVECTORu_1,axiom,(
    ! [A] : s(A,x) = s(A,i(s(fun(num,A),i(s(fun(cart(A,n10),fun(num,A)),d_),s(cart(A,n10),i(s(fun(list(A),cart(A,n10)),vector),s(list(A),i(s(fun(list(A),list(A)),i(s(fun(A,fun(list(A),list(A))),cons),s(A,x))),s(list(A),nil))))))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))) )).
