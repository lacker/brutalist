...
fof(aVSUMu_CLAUSESu_NUMSEGu_conjunct0,axiom,(
    ! [Q106879,M0] :
    ? [V] :
      ( s(cart(real,Q106879),i(s(fun(cart(real,Q106879),cart(real,Q106879)),i(s(fun(cart(real,Q106879),fun(cart(real,Q106879),cart(real,Q106879))),i(s(fun(bool,fun(cart(real,Q106879),fun(cart(real,Q106879),cart(real,Q106879)))),cond),s(bool,V))),s(cart(real,Q106879),i(s(fun(num,cart(real,Q106879)),f),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))),s(cart(real,Q106879),i(s(fun(num,cart(real,Q106879)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))) = s(cart(real,Q106879),i(s(fun(fun(num,cart(real,Q106879)),cart(real,Q106879)),i(s(fun(fun(num,bool),fun(fun(num,cart(real,Q106879)),cart(real,Q106879))),vsum),s(fun(num,bool),i(s(fun(num,fun(num,bool)),i(s(fun(num,fun(num,fun(num,bool))),o_o_),s(num,M0))),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))),s(fun(num,cart(real,Q106879)),f)))
...
fof(aLINEARu_ZERO,axiom,(
    ! [Q111694,Q111699,U_0] :
     ...
     <= ! [X] : s(cart(real,Q111699),i(s(fun(num,cart(real,Q111699)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,Q111699),i(s(fun(cart(real,Q111694),cart(real,Q111699)),U_0),s(cart(real,Q111694),X))) ) )).
...
fof(aDROPu_VEC,axiom,(
    ! [N0] : s(real,i(s(fun(num,real),realu_ofu_num),s(num,N0))) = s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),i(s(fun(num,cart(real,n10)),vec),s(num,N0))))) )).

fof(aMATRIXu_I,axiom,(
    ! [Q117867] : s(cart(cart(real,Q117867),Q117867),i(s(fun(num,cart(cart(real,Q117867),Q117867)),mat),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))) = s(cart(cart(real,Q117867),Q117867),i(s(fun(fun(cart(real,Q117867),cart(real,Q117867)),cart(cart(real,Q117867),Q117867)),matrix),s(fun(cart(real,Q117867),cart(real,Q117867)),i1))) )).
...
fof(aLINEARu_0,axiom,(
    ! [Q111807,Q111809,F0] :
     ...
     => s(cart(real,Q111809),i(s(fun(num,cart(real,Q111809)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,Q111809),i(s(fun(cart(real,Q111807),cart(real,Q111809)),F0),s(cart(real,Q111807),i(s(fun(num,cart(real,Q111807)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))) ) )).
    ...
    ! [Q112022,Q112025,Q112011,U_1] :
     ...
     => ! [U_0] :
          ( ! [F0,S0,C0,V] :
             ...
             => s(cart(real,Q112022),i(s(fun(fun(Q112025,cart(real,Q112022)),cart(real,Q112022)),i(s(fun(fun(Q112025,bool),fun(fun(Q112025,cart(real,Q112022)),cart(real,Q112022))),vsum),s(fun(Q112025,bool),S0))),s(fun(Q112025,cart(real,Q112022)),i(s(fun(fun(Q112025,cart(real,Q112011)),fun(Q112025,cart(real,Q112022))),i(s(fun(fun(cart(real,Q112011),cart(real,Q112022)),fun(fun(Q112025,cart(real,Q112011)),fun(Q112025,cart(real,Q112022)))),i(s(fun(fun(Q112025,real),fun(fun(cart(real,Q112011),cart(real,Q112022)),fun(fun(Q112025,cart(real,Q112011)),fun(Q112025,cart(real,Q112022))))),U_1),s(fun(Q112025,real),C0))),s(fun(cart(real,Q112011),cart(real,Q112022)),F0))),s(fun(Q112025,cart(real,Q112011)),V))))) = s(cart(real,Q112022),i(s(fun(cart(real,Q112011),cart(real,Q112022)),F0),s(cart(real,Q112011),i(s(fun(fun(Q112025,cart(real,Q112011)),cart(real,Q112011)),i(s(fun(fun(Q112025,bool),fun(fun(Q112025,cart(real,Q112011)),cart(real,Q112011))),vsum),s(fun(Q112025,bool),S0))),s(fun(Q112025,cart(real,Q112011)),i(s(fun(fun(Q112025,cart(real,Q112011)),fun(Q112025,cart(real,Q112011))),i(s(fun(fun(Q112025,real),fun(fun(Q112025,cart(real,Q112011)),fun(Q112025,cart(real,Q112011)))),U_0),s(fun(Q112025,real),C0))),s(fun(Q112025,cart(real,Q112011)),V))))))) )
...
fof(aSPANu_EMPTY,axiom,(
    ! [Q122165] : s(fun(cart(real,Q122165),bool),i(s(fun(fun(cart(real,Q122165),bool),fun(cart(real,Q122165),bool)),i(s(fun(cart(real,Q122165),fun(fun(cart(real,Q122165),bool),fun(cart(real,Q122165),bool))),insert),s(cart(real,Q122165),i(s(fun(num,cart(real,Q122165)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))),s(fun(cart(real,Q122165),bool),empty))) = s(fun(cart(real,Q122165),bool),i(s(fun(fun(cart(real,Q122165),bool),fun(cart(real,Q122165),bool)),span),s(fun(cart(real,Q122165),bool),empty))) )).
...
fof(aVSUMu_0,axiom,(
    ! [Q105615,Q105619,U_0] :
      ( ! [X] : s(cart(real,Q105619),i(s(fun(num,cart(real,Q105619)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,Q105619),i(s(fun(Q105615,cart(real,Q105619)),U_0),s(Q105615,X)))
...
fof(aMATRIXu_NEGu_EQu_0,axiom,(
    ...
    <=> s(cart(cart(real,N),M),i(s(fun(num,cart(cart(real,N),M)),mat),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(cart(real,N),M),i(s(fun(cart(cart(real,N),M),cart(cart(real,N),M)),matrixu_neg),s(cart(cart(real,N),M),A5))) ) )).

fof(amatrixu_sub,axiom,(
    ! [N,M,U_1] :
      ( ! [A5,B0,I0,J0] : s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_sub),s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),d_),s(cart(cart(real,N),M),A5))),s(num,I0))))),s(num,J0))))),s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),d_),s(cart(cart(real,N),M),B0))),s(num,I0))))),s(num,J0))))) = s(real,i(s(fun(num,real),i(s(fun(num,fun(num,real)),i(s(fun(cart(cart(real,N),M),fun(num,fun(num,real))),i(s(fun(cart(cart(real,N),M),fun(cart(cart(real,N),M),fun(num,fun(num,real)))),U_1),s(cart(cart(real,N),M),A5))),s(cart(cart(real,N),M),B0))),s(num,I0))),s(num,J0)))
     => ! [U_0] :
...
fof(aVECTORu_MULu_EQu_0,axiom,(
    ! [Q102400,A5,X] :
      ( s(cart(real,Q102400),i(s(fun(num,cart(real,Q102400)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,Q102400),i(s(fun(cart(real,Q102400),cart(real,Q102400)),i(s(fun(real,fun(cart(real,Q102400),cart(real,Q102400))),r_),s(real,A5))),s(cart(real,Q102400),X)))
...
fof(aDEPENDENTu_LINEARu_IMAGEu_EQ,axiom,(
    ! [N,M,F0,S0] :
      ( ( ! [X,Y] :
           ...
           => s(cart(real,M),Y) = s(cart(real,M),X) )
        & p(s(bool,i(s(fun(fun(cart(real,M),cart(real,N)),bool),linear),s(fun(cart(real,M),cart(real,N)),F0)))) )
...
fof(amatrix,axiom,(
    ! [M,N,U_1] :
      ( ! [U_0] :
         ...
         => ! [F0] : s(cart(cart(real,M),N),i(s(fun(fun(num,cart(real,M)),cart(cart(real,M),N)),lambda),s(fun(num,cart(real,M)),i(s(fun(fun(cart(real,M),cart(real,N)),fun(num,cart(real,M))),U_0),s(fun(cart(real,M),cart(real,N)),F0))))) = s(cart(cart(real,M),N),i(s(fun(fun(cart(real,M),cart(real,N)),cart(cart(real,M),N)),matrix),s(fun(cart(real,M),cart(real,N)),F0))) )
...
fof(aMATRIXu_ADDu_COMPONENT,axiom,(
    ! [N,M,A5,B0,I0,J0] : s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_add),s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),d_),s(cart(cart(real,N),M),A5))),s(num,I0))))),s(num,J0))))),s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),d_),s(cart(cart(real,N),M),B0))),s(num,I0))))),s(num,J0))))) = s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),d_),s(cart(cart(real,N),M),i(s(fun(cart(cart(real,N),M),cart(cart(real,N),M)),i(s(fun(cart(cart(real,N),M),fun(cart(cart(real,N),M),cart(cart(real,N),M))),matrixu_add),s(cart(cart(real,N),M),A5))),s(cart(cart(real,N),M),B0))))),s(num,I0))))),s(num,J0))) )).
...
fof(aSPANu_UNIV,axiom,(
    ! [N] : s(fun(cart(real,N),bool),univ) = s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),span),s(fun(cart(real,N),bool),univ))) )).
...
fof(amatrixu_neg,axiom,(
    ! [N,M,U_1] :
     ...
     => ! [U_0] :
          ( ! [A5] : s(cart(cart(real,N),M),i(s(fun(fun(num,cart(real,N)),cart(cart(real,N),M)),lambda),s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),U_0),s(cart(cart(real,N),M),A5))))) = s(cart(cart(real,N),M),i(s(fun(cart(cart(real,N),M),cart(cart(real,N),M)),matrixu_neg),s(cart(cart(real,N),M),A5)))
...
fof(aDROPu_CMUL,axiom,(
    ! [X,C0] : s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_mul),s(real,C0))),s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),X))))) = s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),i(s(fun(cart(real,n10),cart(real,n10)),i(s(fun(real,fun(cart(real,n10),cart(real,n10))),r_),s(real,C0))),s(cart(real,n10),X))))) )).
...
fof(aSQRTu_MUL,axiom,(
    ! [X,Y] :
      ( ( p(s(bool,i(s(fun(real,bool),i(s(fun(real,fun(real,bool)),realu_le),s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))),s(real,X))))
        & p(s(bool,i(s(fun(real,bool),i(s(fun(real,fun(real,bool)),realu_le),s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))),s(real,Y)))) )
     => s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_mul),s(real,i(s(fun(real,real),sqrt),s(real,X))))),s(real,i(s(fun(real,real),sqrt),s(real,Y))))) = s(real,i(s(fun(real,real),sqrt),s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_mul),s(real,X))),s(real,Y))))) ) )).
...
fof(aVSUMu_ADDu_NUMSEG,axiom,(
    ! [Q107272,U_0] :
      ( ! [F0,G0,I0] : s(cart(real,Q107272),i(s(fun(cart(real,Q107272),cart(real,Q107272)),i(s(fun(cart(real,Q107272),fun(cart(real,Q107272),cart(real,Q107272))),vectoru_add),s(cart(real,Q107272),i(s(fun(num,cart(real,Q107272)),F0),s(num,I0))))),s(cart(real,Q107272),i(s(fun(num,cart(real,Q107272)),G0),s(num,I0))))) = s(cart(real,Q107272),i(s(fun(num,cart(real,Q107272)),i(s(fun(fun(num,cart(real,Q107272)),fun(num,cart(real,Q107272))),i(s(fun(fun(num,cart(real,Q107272)),fun(fun(num,cart(real,Q107272)),fun(num,cart(real,Q107272)))),U_0),s(fun(num,cart(real,Q107272)),F0))),s(fun(num,cart(real,Q107272)),G0))),s(num,I0)))
...
fof(aDROPu_EQu_0,axiom,(
    ! [X] :
      ( s(cart(real,n10),i(s(fun(num,cart(real,n10)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,n10),X)
...
fof(aVSUMu_EQu_0,axiom,(
    ! [A,Q105605,F0,S0] :
      ( s(cart(real,Q105605),i(s(fun(num,cart(real,Q105605)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,Q105605),i(s(fun(fun(A,cart(real,Q105605)),cart(real,Q105605)),i(s(fun(fun(A,bool),fun(fun(A,cart(real,Q105605)),cart(real,Q105605))),vsum),s(fun(A,bool),S0))),s(fun(A,cart(real,Q105605)),F0)))
     <= ! [X] :
          ( p(s(bool,i(s(fun(fun(A,bool),bool),i(s(fun(A,fun(fun(A,bool),bool)),in),s(A,X))),s(fun(A,bool),S0))))
...
fof(aSUBSPACEu_TRANSLATIONu_SELFu_EQ,axiom,(
    ! [N,U_0] :
     ...
     <= ! [A5,X] : s(cart(real,N),i(s(fun(cart(real,N),cart(real,N)),i(s(fun(cart(real,N),fun(cart(real,N),cart(real,N))),vectoru_add),s(cart(real,N),A5))),s(cart(real,N),X))) = s(cart(real,N),i(s(fun(cart(real,N),cart(real,N)),i(s(fun(cart(real,N),fun(cart(real,N),cart(real,N))),U_0),s(cart(real,N),A5))),s(cart(real,N),X))) ) )).
...
fof(aMATRIXu_ID,axiom,(
    ! [Q117856,U_0] :
     ...
     => s(cart(cart(real,Q117856),Q117856),i(s(fun(num,cart(cart(real,Q117856),Q117856)),mat),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))) = s(cart(cart(real,Q117856),Q117856),i(s(fun(fun(cart(real,Q117856),cart(real,Q117856)),cart(cart(real,Q117856),Q117856)),matrix),s(fun(cart(real,Q117856),cart(real,Q117856)),U_0))) ) )).
    ...
    ! [Q109978,U_0] :
      ( ! [K0,I0] :
        ? [V] :
          ...
          & ( p(s(bool,V))
          <=> s(num,I0) = s(num,K0) ) )
     => ! [K0] : s(cart(real,Q109978),i(s(fun(fun(num,real),cart(real,Q109978)),lambda),s(fun(num,real),i(s(fun(num,fun(num,real)),U_0),s(num,K0))))) = s(cart(real,Q109978),i(s(fun(num,cart(real,Q109978)),basis),s(num,K0))) ) )).
...
fof(aIMAGEu_LIFTu_UNIV,axiom,(
    s(fun(cart(real,n10),bool),univ) = s(fun(cart(real,n10),bool),i(s(fun(fun(real,bool),fun(cart(real,n10),bool)),i(s(fun(fun(real,cart(real,n10)),fun(fun(real,bool),fun(cart(real,n10),bool))),image),s(fun(real,cart(real,n10)),lift))),s(fun(real,bool),univ))) )).
...
fof(aDROPu_WLOGu_LE,axiom,
   ...
   <= ( ! [X,Y] : s(bool,i(s(fun(cart(real,n10),bool),i(s(fun(cart(real,n10),fun(cart(real,n10),bool)),p0),s(cart(real,n10),Y))),s(cart(real,n10),X))) = s(bool,i(s(fun(cart(real,n10),bool),i(s(fun(cart(real,n10),fun(cart(real,n10),bool)),p0),s(cart(real,n10),X))),s(cart(real,n10),Y)))
      & ! [X,Y] :
...
fof(aONORMu_NEG,axiom,(
    ! [M,N,U_0] :
     ...
     <= ! [F0,X] : s(cart(real,N),i(s(fun(cart(real,N),cart(real,N)),vectoru_neg),s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),F0),s(cart(real,M),X))))) = s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),i(s(fun(fun(cart(real,M),cart(real,N)),fun(cart(real,M),cart(real,N))),U_0),s(fun(cart(real,M),cart(real,N)),F0))),s(cart(real,M),X))) ) )).
...
fof(aINDEPENDENTu_SPANu_BOUND,conjecture,(
    ! [Q125545,S0,T0] :
...
fof(aSPANu_EXPLICIT,axiom,(
    ! [N,U_1] :
     ...
     => ! [U_0] :
          ( ! [P0] : s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),gspec),s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),U_0),s(fun(cart(real,N),bool),P0))))) = s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),span),s(fun(cart(real,N),bool),P0)))
         <= ! [P0,GENR_PVARR_304] :
            ...
            <=> ? [Y,V] :
                  ...
                  & ( ? [S0,U] :
                        ( p(s(bool,i(s(fun(fun(cart(real,N),bool),bool),i(s(fun(fun(cart(real,N),bool),fun(fun(cart(real,N),bool),bool)),subset),s(fun(cart(real,N),bool),S0))),s(fun(cart(real,N),bool),P0))))
                        & s(cart(real,N),Y) = s(cart(real,N),i(s(fun(fun(cart(real,N),cart(real,N)),cart(real,N)),i(s(fun(fun(cart(real,N),bool),fun(fun(cart(real,N),cart(real,N)),cart(real,N))),vsum),s(fun(cart(real,N),bool),S0))),s(fun(cart(real,N),cart(real,N)),i(s(fun(fun(cart(real,N),real),fun(cart(real,N),cart(real,N))),U_1),s(fun(cart(real,N),real),U)))))
                        & p(s(bool,i(s(fun(fun(cart(real,N),bool),bool),finite),s(fun(cart(real,N),bool),S0)))) )
                  <=> p(s(bool,V)) ) ) ) ) ) )).
...
fof(aDROPu_NEG,axiom,(
    ! [X] : s(real,i(s(fun(real,real),realu_neg),s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),X))))) = s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),i(s(fun(cart(real,n10),cart(real,n10)),vectoru_neg),s(cart(real,n10),X))))) )).
...
fof(aSPANu_FINITE,axiom,(
    ! [N,U_1] :
     ...
     => ! [U_0] :
          ( ! [S0] :
              ( s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),gspec),s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),U_0),s(fun(cart(real,N),bool),S0))))) = s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),span),s(fun(cart(real,N),bool),S0)))
             <= p(s(bool,i(s(fun(fun(cart(real,N),bool),bool),finite),s(fun(cart(real,N),bool),S0)))) )
         <= ! [S0,GENR_PVARR_307] :
              ( ? [Y,V] :
                  ...
                  & ( p(s(bool,V))
                  <=> ? [U] : s(cart(real,N),Y) = s(cart(real,N),i(s(fun(fun(cart(real,N),cart(real,N)),cart(real,N)),i(s(fun(fun(cart(real,N),bool),fun(fun(cart(real,N),cart(real,N)),cart(real,N))),vsum),s(fun(cart(real,N),bool),S0))),s(fun(cart(real,N),cart(real,N)),i(s(fun(fun(cart(real,N),real),fun(cart(real,N),cart(real,N))),U_1),s(fun(cart(real,N),real),U))))) ) )
...
fof(aDROPu_LAMBDA,axiom,(
    ! [U_0] :
      ( ! [X] : s(real,i(s(fun(num,real),X),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))) = s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),i(s(fun(fun(num,real),cart(real,n10)),lambda),s(fun(num,real),i(s(fun(fun(num,real),fun(num,real)),U_0),s(fun(num,real),X)))))))
...
fof(aLINEARu_INJECTIVEu_0u_SUBSPACE,axiom,(
    ! [N,M,F0,S0] :
      ...
      <=> ! [X,Y] :
            ( ( p(s(bool,i(s(fun(fun(cart(real,M),bool),bool),i(s(fun(cart(real,M),fun(fun(cart(real,M),bool),bool)),in),s(cart(real,M),X))),s(fun(cart(real,M),bool),S0))))
              & p(s(bool,i(s(fun(fun(cart(real,M),bool),bool),i(s(fun(cart(real,M),fun(fun(cart(real,M),bool),bool)),in),s(cart(real,M),Y))),s(fun(cart(real,M),bool),S0))))
              & s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),F0),s(cart(real,M),Y))) = s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),F0),s(cart(real,M),X))) )
           => s(cart(real,M),Y) = s(cart(real,M),X) ) )
     <= ( p(s(bool,i(s(fun(fun(cart(real,M),cart(real,N)),bool),linear),s(fun(cart(real,M),cart(real,N)),F0))))
...
fof(aVSUMu_NORM,axiom,(
    ! [Q106640,Q106632,U_0] :
     ...
     <= ! [F0,X] : s(real,i(s(fun(cart(real,Q106632),real),vectoru_norm),s(cart(real,Q106632),i(s(fun(Q106640,cart(real,Q106632)),F0),s(Q106640,X))))) = s(real,i(s(fun(Q106640,real),i(s(fun(fun(Q106640,cart(real,Q106632)),fun(Q106640,real)),U_0),s(fun(Q106640,cart(real,Q106632)),F0))),s(Q106640,X))) ) )).

fof(aMATRIXu_NEGu_COMPONENT,axiom,(
    ! [N,M,A5,I0,J0] : s(real,i(s(fun(real,real),realu_neg),s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),d_),s(cart(cart(real,N),M),A5))),s(num,I0))))),s(num,J0))))) = s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),d_),s(cart(cart(real,N),M),i(s(fun(cart(cart(real,N),M),cart(cart(real,N),M)),matrixu_neg),s(cart(cart(real,N),M),A5))))),s(num,I0))))),s(num,J0))) )).
...
fof(aDROPu_EQ,axiom,(
    ...
    <=> s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),Y))) = s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),X))) ) )).
...
fof(aSPANu_UNION,axiom,(
    ! [N,U_0] :
      ( ! [S0,T0] : s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),gspec),s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),i(s(fun(fun(cart(real,N),bool),fun(fun(cart(real,N),bool),fun(cart(real,N),bool))),U_0),s(fun(cart(real,N),bool),S0))),s(fun(cart(real,N),bool),T0))))) = s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),span),s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),i(s(fun(fun(cart(real,N),bool),fun(fun(cart(real,N),bool),fun(cart(real,N),bool))),union),s(fun(cart(real,N),bool),S0))),s(fun(cart(real,N),bool),T0)))))
...
fof(aVECTORu_EQ,axiom,(
    ! [Q104636,X,Y] :
      ( ( s(real,i(s(fun(cart(real,Q104636),real),i(s(fun(cart(real,Q104636),fun(cart(real,Q104636),real)),dot),s(cart(real,Q104636),X))),s(cart(real,Q104636),Y))) = s(real,i(s(fun(cart(real,Q104636),real),i(s(fun(cart(real,Q104636),fun(cart(real,Q104636),real)),dot),s(cart(real,Q104636),X))),s(cart(real,Q104636),X)))
...
fof(aDOTu_LZERO,axiom,(
    ! [Q100457,X] : s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(real,i(s(fun(cart(real,Q100457),real),i(s(fun(cart(real,Q100457),fun(cart(real,Q100457),real)),dot),s(cart(real,Q100457),i(s(fun(num,cart(real,Q100457)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))),s(cart(real,Q100457),X))) )).
...
fof(aSPANu_SING,axiom,(
    ! [Q123656,U_0] :
     ...
     => ! [A5] : s(fun(cart(real,Q123656),bool),i(s(fun(fun(cart(real,Q123656),bool),fun(cart(real,Q123656),bool)),gspec),s(fun(cart(real,Q123656),bool),i(s(fun(cart(real,Q123656),fun(cart(real,Q123656),bool)),U_0),s(cart(real,Q123656),A5))))) = s(fun(cart(real,Q123656),bool),i(s(fun(fun(cart(real,Q123656),bool),fun(cart(real,Q123656),bool)),span),s(fun(cart(real,Q123656),bool),i(s(fun(fun(cart(real,Q123656),bool),fun(cart(real,Q123656),bool)),i(s(fun(cart(real,Q123656),fun(fun(cart(real,Q123656),bool),fun(cart(real,Q123656),bool))),insert),s(cart(real,Q123656),A5))),s(fun(cart(real,Q123656),bool),empty))))) ) )).
...
fof(aSPANNINGu_SUBSETu_INDEPENDENT,axiom,(
    ! [N,S0,T0] :
      ( ( p(s(bool,i(s(fun(fun(cart(real,N),bool),bool),i(s(fun(fun(cart(real,N),bool),fun(fun(cart(real,N),bool),bool)),subset),s(fun(cart(real,N),bool),S0))),s(fun(cart(real,N),bool),i(s(fun(fun(cart(real,N),bool),fun(cart(real,N),bool)),span),s(fun(cart(real,N),bool),T0))))))
        & p(s(bool,i(s(fun(fun(cart(real,N),bool),bool),independent),s(fun(cart(real,N),bool),S0))))
        & p(s(bool,i(s(fun(fun(cart(real,N),bool),bool),i(s(fun(fun(cart(real,N),bool),fun(fun(cart(real,N),bool),bool)),subset),s(fun(cart(real,N),bool),T0))),s(fun(cart(real,N),bool),S0)))) )
     => s(fun(cart(real,N),bool),T0) = s(fun(cart(real,N),bool),S0) ) )).
...
fof(aDISTu_NZ,axiom,(
    ...
    <=> s(cart(real,Q104879),Y) != s(cart(real,Q104879),X) ) )).
...
fof(aADJOINTu_CLAUSES,axiom,(
    ! [N,M,F0] :
      ( ( ! [X,Y] : s(real,i(s(fun(cart(real,N),real),i(s(fun(cart(real,N),fun(cart(real,N),real)),dot),s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),F0),s(cart(real,M),X))))),s(cart(real,N),Y))) = s(real,i(s(fun(cart(real,M),real),i(s(fun(cart(real,M),fun(cart(real,M),real)),dot),s(cart(real,M),X))),s(cart(real,M),i(s(fun(cart(real,N),cart(real,M)),i(s(fun(fun(cart(real,M),cart(real,N)),fun(cart(real,N),cart(real,M))),adjoint),s(fun(cart(real,M),cart(real,N)),F0))),s(cart(real,N),Y)))))
        & ! [X,Y] : s(real,i(s(fun(cart(real,N),real),i(s(fun(cart(real,N),fun(cart(real,N),real)),dot),s(cart(real,N),Y))),s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),F0),s(cart(real,M),X))))) = s(real,i(s(fun(cart(real,M),real),i(s(fun(cart(real,M),fun(cart(real,M),real)),dot),s(cart(real,M),i(s(fun(cart(real,N),cart(real,M)),i(s(fun(fun(cart(real,M),cart(real,N)),fun(cart(real,N),cart(real,M))),adjoint),s(fun(cart(real,M),cart(real,N)),F0))),s(cart(real,N),Y))))),s(cart(real,M),X))) )
     <= p(s(bool,i(s(fun(fun(cart(real,M),cart(real,N)),bool),linear),s(fun(cart(real,M),cart(real,N)),F0)))) ) )).
...
fof(aLINEARu_INJECTIVEu_0,axiom,(
    ! [Q112067,Q112072,F0] :
     ...
     => ( ! [X] :
            ( s(cart(real,Q112072),i(s(fun(num,cart(real,Q112072)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,Q112072),X)
      ...
      <=> ! [X,Y] :
           ...
           => s(cart(real,Q112072),Y) = s(cart(real,Q112072),X) ) ) ) )).
...
fof(aONORMu_CONST,axiom,(
    ! [M,N,U_0] :
     ...
     <= ! [Y,X] : s(cart(real,N),Y) = s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),i(s(fun(cart(real,N),fun(cart(real,M),cart(real,N))),U_0),s(cart(real,N),Y))),s(cart(real,M),X))) ) )).
...
fof(aIMAGEu_LIFTu_DROPu_conjunct1,axiom,(
    ! [S0] : s(fun(real,bool),S0) = s(fun(real,bool),i(s(fun(fun(real,bool),fun(real,bool)),i(s(fun(fun(real,real),fun(fun(real,bool),fun(real,bool))),image),s(fun(real,real),i(s(fun(fun(real,cart(real,n10)),fun(real,real)),i(s(fun(fun(cart(real,n10),real),fun(fun(real,cart(real,n10)),fun(real,real))),o),s(fun(cart(real,n10),real),drop))),s(fun(real,cart(real,n10)),lift))))),s(fun(real,bool),S0))) )).
...
fof(amat,axiom,(
    ! [M,N,U_1] :
      ( ! [U_0] :
          ( ! [K0,I0] : s(cart(real,N),i(s(fun(fun(num,real),cart(real,N)),lambda),s(fun(num,real),i(s(fun(num,fun(num,real)),i(s(fun(num,fun(num,fun(num,real))),U_1),s(num,I0))),s(num,K0))))) = s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(num,fun(num,cart(real,N))),U_0),s(num,K0))),s(num,I0)))
...
fof(aDROPu_VSUM,axiom,(
    ! [Q119533,K0,X] :
     ...
     => s(real,i(s(fun(fun(Q119533,real),real),i(s(fun(fun(Q119533,bool),fun(fun(Q119533,real),real)),sum),s(fun(Q119533,bool),K0))),s(fun(Q119533,real),i(s(fun(fun(Q119533,cart(real,n10)),fun(Q119533,real)),i(s(fun(fun(cart(real,n10),real),fun(fun(Q119533,cart(real,n10)),fun(Q119533,real))),o),s(fun(cart(real,n10),real),drop))),s(fun(Q119533,cart(real,n10)),X))))) = s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),i(s(fun(fun(Q119533,cart(real,n10)),cart(real,n10)),i(s(fun(fun(Q119533,bool),fun(fun(Q119533,cart(real,n10)),cart(real,n10))),vsum),s(fun(Q119533,bool),K0))),s(fun(Q119533,cart(real,n10)),X))))) ) )).
...
fof(aMATu_COMPONENT,axiom,(
    ! [N,M,N0,I0,J0] :
     ...
     => ? [V] :
          ( ( s(num,I0) = s(num,J0)
          <=> p(s(bool,V)) )
          & s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),i(s(fun(bool,fun(real,fun(real,real))),cond),s(bool,V))),s(real,i(s(fun(num,real),realu_ofu_num),s(num,N0))))),s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))) = s(real,i(s(fun(num,real),i(s(fun(cart(real,N),fun(num,real)),d_),s(cart(real,N),i(s(fun(num,cart(real,N)),i(s(fun(cart(cart(real,N),M),fun(num,cart(real,N))),d_),s(cart(cart(real,N),M),i(s(fun(num,cart(cart(real,N),M)),mat),s(num,N0))))),s(num,I0))))),s(num,J0))) ) ) )).
...
fof(aSPANu_MULu_EQ,axiom,(
    ! [N,X,C0,S0] :
     ...
     <= s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) != s(real,C0) ) )).
...
fof(aSNDCARTu_VEC,axiom,(
    ! [Q120272,Q120278,N0] : s(cart(real,Q120278),i(s(fun(num,cart(real,Q120278)),vec),s(num,N0))) = s(cart(real,Q120278),i(s(fun(cart(real,finite_sum(Q120272,Q120278)),cart(real,Q120278)),sndcart),s(cart(real,finite_sum(Q120272,Q120278)),i(s(fun(num,cart(real,finite_sum(Q120272,Q120278))),vec),s(num,N0))))) )).
...
fof(aNORMu_PASTECARTu_0u_conjunct0,axiom,(
    ! [Q121218,Q121215,X] : s(real,i(s(fun(cart(real,Q121215),real),vectoru_norm),s(cart(real,Q121215),X))) = s(real,i(s(fun(cart(real,finite_sum(Q121215,Q121218)),real),vectoru_norm),s(cart(real,finite_sum(Q121215,Q121218)),i(s(fun(cart(real,Q121218),cart(real,finite_sum(Q121215,Q121218))),i(s(fun(cart(real,Q121215),fun(cart(real,Q121218),cart(real,finite_sum(Q121215,Q121218)))),pastecart),s(cart(real,Q121215),X))),s(cart(real,Q121218),i(s(fun(num,cart(real,Q121218)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))))) )).
...
fof(aVECTORu_EQu_ADDR,axiom,(
    ! [Q99907] :
      ( s(cart(real,Q99907),i(s(fun(num,cart(real,Q99907)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,Q99907),y)
...
fof(aSPANu_INSERTu_0,axiom,(
    ! [Q123623,S0] : s(fun(cart(real,Q123623),bool),i(s(fun(fun(cart(real,Q123623),bool),fun(cart(real,Q123623),bool)),span),s(fun(cart(real,Q123623),bool),S0))) = s(fun(cart(real,Q123623),bool),i(s(fun(fun(cart(real,Q123623),bool),fun(cart(real,Q123623),bool)),span),s(fun(cart(real,Q123623),bool),i(s(fun(fun(cart(real,Q123623),bool),fun(cart(real,Q123623),bool)),i(s(fun(cart(real,Q123623),fun(fun(cart(real,Q123623),bool),fun(cart(real,Q123623),bool))),insert),s(cart(real,Q123623),i(s(fun(num,cart(real,Q123623)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))))),s(fun(cart(real,Q123623),bool),S0))))) )).
...
fof(aLINEARu_1,axiom,(
    ! [F0] :
      ( ? [C0] :
        ! [X] : s(cart(real,n10),i(s(fun(cart(real,n10),cart(real,n10)),i(s(fun(real,fun(cart(real,n10),cart(real,n10))),r_),s(real,C0))),s(cart(real,n10),X))) = s(cart(real,n10),i(s(fun(cart(real,n10),cart(real,n10)),F0),s(cart(real,n10),X)))
...
fof(aVECTORu_2u_conjunct0,axiom,(
    ! [A] : s(A,x) = s(A,i(s(fun(num,A),i(s(fun(cart(A,n20),fun(num,A)),d_),s(cart(A,n20),i(s(fun(list(A),cart(A,n20)),vector),s(list(A),i(s(fun(list(A),list(A)),i(s(fun(A,fun(list(A),list(A))),cons),s(A,x))),s(list(A),i(s(fun(list(A),list(A)),i(s(fun(A,fun(list(A),list(A))),cons),s(A,y))),s(list(A),nil))))))))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))) )).

fof(aMATRIXu_VECTORu_MULu_LID,axiom,(
    ! [N,X] : s(cart(real,N),X) = s(cart(real,N),i(s(fun(cart(real,N),cart(real,N)),i(s(fun(cart(cart(real,N),N),fun(cart(real,N),cart(real,N))),matrixu_vectoru_mul),s(cart(cart(real,N),N),i(s(fun(num,cart(cart(real,N),N)),mat),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))),s(cart(real,N),X))) )).
...
fof(aVSUMu_UNIONu_RZERO,axiom,(
    ! [A,N,F0,U,V] :
     ...
     => s(cart(real,N),i(s(fun(fun(A,cart(real,N)),cart(real,N)),i(s(fun(fun(A,bool),fun(fun(A,cart(real,N)),cart(real,N))),vsum),s(fun(A,bool),U))),s(fun(A,cart(real,N)),F0))) = s(cart(real,N),i(s(fun(fun(A,cart(real,N)),cart(real,N)),i(s(fun(fun(A,bool),fun(fun(A,cart(real,N)),cart(real,N))),vsum),s(fun(A,bool),i(s(fun(fun(A,bool),fun(A,bool)),i(s(fun(fun(A,bool),fun(fun(A,bool),fun(A,bool))),union),s(fun(A,bool),U))),s(fun(A,bool),V))))),s(fun(A,cart(real,N)),F0))) ) )).
...
fof(aVECTORu_2u_conjunct1,axiom,(
    ! [A] : s(A,y) = s(A,i(s(fun(num,A),i(s(fun(cart(A,n20),fun(num,A)),d_),s(cart(A,n20),i(s(fun(list(A),cart(A,n20)),vector),s(list(A),i(s(fun(list(A),list(A)),i(s(fun(A,fun(list(A),list(A))),cons),s(A,x))),s(list(A),i(s(fun(list(A),list(A)),i(s(fun(A,fun(list(A),list(A))),cons),s(A,y))),s(list(A),nil))))))))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit0),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))) )).
...
fof(aNORMu_LE,axiom,(
    ! [Q103249,Q103251,X,Y] : s(bool,i(s(fun(real,bool),i(s(fun(real,fun(real,bool)),realu_le),s(real,i(s(fun(cart(real,Q103249),real),i(s(fun(cart(real,Q103249),fun(cart(real,Q103249),real)),dot),s(cart(real,Q103249),X))),s(cart(real,Q103249),X))))),s(real,i(s(fun(cart(real,Q103251),real),i(s(fun(cart(real,Q103251),fun(cart(real,Q103251),real)),dot),s(cart(real,Q103251),Y))),s(cart(real,Q103251),Y))))) = s(bool,i(s(fun(real,bool),i(s(fun(real,fun(real,bool)),realu_le),s(real,i(s(fun(cart(real,Q103249),real),vectoru_norm),s(cart(real,Q103249),X))))),s(real,i(s(fun(cart(real,Q103251),real),vectoru_norm),s(cart(real,Q103251),Y))))) )).
