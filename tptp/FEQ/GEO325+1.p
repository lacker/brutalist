...
fof('ass(cond(conseq(348), 1), 6)',axiom,
   ...
   => vf(vd1288,vskolem1306) = vf(vd1299,vd1289) )).
...
fof('ass(cond(conseq(348), 1), 10)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1288,vd1287,vd1289) = vangle(vd1299,vd1287,vd1289) )).
...
fof('holds(conjunct1(375), 1343, 0)',axiom,(
    vf(vd1302,vd1288) = vf(vd1329,vd1289) )).
...
fof('holds(conjunct2(conjunct2(375)), 1345, 0)',axiom,(
    vangle(vd1287,vd1289,vd1329) = vangle(vd1287,vd1288,vd1302) )).
...
fof('ass(cond(conseq(348), 1), 8)',axiom,
    ( vangle(vd1287,vd1299,vd1289) = vangle(vd1287,vskolem1306,vd1288)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).
...
fof('holds(conjunct1(conjunct2(375)), 1344, 0)',axiom,(
    vangle(vd1287,vd1329,vd1289) = vangle(vd1287,vd1302,vd1288) )).
...
fof('ass(cond(conseq(348), 1), 7)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1287,vd1289,vd1299) = vangle(vd1287,vd1288,vskolem1306) )).
...
fof('ass(cond(conseq(348), 1), 4)',axiom,
    ( vf(vd1289,vskolem1306) = vf(vd1288,vd1299)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).
...
fof('ass(cond(conseq(348), 1), 1)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vplus(vangle(vd1288,vd1289,vd1299),vangle(vd1287,vd1289,vd1288)) = vangle(vd1287,vd1289,vd1299) )).
...
fof('holds(374, 1342, 0)',axiom,(
    vangle(vd1289,vd1287,vd1288) = vangle(vd1302,vd1287,vd1288) )).

fof('ass(cond(conseq(348), 1), 9)',axiom,
    ( vf(vskolem1306,vd1288) = vf(vd1299,vd1289)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).
...
fof('holds(conjunct2(367), 1331, 0)',axiom,(
    vf(vd1287,vd1329) = vf(vd1287,vd1302) )).
...
fof('ass(cond(conseq(348), 1), 2)',axiom,
    ( rless(vf(vd1287,vd1299),vf(vd1287,vd1302))
   => vangle(vd1289,vd1288,vskolem1306) = vangle(vd1288,vd1289,vd1299) )).
...
fof('ass(cond(conseq(348), 1), 11)',axiom,
    ( vangle(vd1288,vd1287,vd1289) = vangle(vd1288,vd1287,vskolem1306)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).
...
fof('ass(cond(conseq(348), 1), 3)',axiom,
    ( vangle(vskolem1306,vd1289,vd1288) = vangle(vd1299,vd1288,vd1289)
   <= rless(vf(vd1287,vd1299),vf(vd1287,vd1302)) )).

fof('holds(conjunct2(376), 1346, 0)',conjecture,(
    vangle(vd1288,vd1329,vd1289) = vangle(vd1289,vd1302,vd1288) )).
...
fof('and(holds(conjunct2(345), 1294, 0), and(pred(conjunct1(345), 9), and(pred(conjunct1(345), 8), and(pred(conjunct1(345), 7), and(qe(s3(plural(345))), and(qe(s2(plural(345))), qe(s1(plural(345)))))))))',axiom,
    ( vf(vd1287,vd1289) = vf(vd1287,vd1288)
    & vd1289 != vd1288
    & vd1287 != vd1289
    & vd1287 != vd1288
    & ? [Vd1292] :
