...
fof(fact_Image__Id,axiom,(
    ! [V_A_2,T_a] : V_A_2 = c_Relation_OImage(T_a,T_a,c_Relation_OId(T_a),V_A_2) )).

fof(fact_prod_Orecs,axiom,(
    ! [V_b_2,V_a_2,V_f1_2,T_a,T_c,T_b] : hAPP(hAPP(V_f1_2,V_a_2),V_b_2) = c_Product__Type_Oprod_Oprod__rec(T_b,T_c,T_a,V_f1_2,c_Product__Type_OPair(T_b,T_c,V_a_2,V_b_2)) )).
...
fof(fact_insert__commute,axiom,(
    ! [V_A_2,V_ya_2,V_xa_2,T_a] : c_Set_Oinsert(T_a,V_ya_2,c_Set_Oinsert(T_a,V_xa_2,V_A_2)) = c_Set_Oinsert(T_a,V_xa_2,c_Set_Oinsert(T_a,V_ya_2,V_A_2)) )).
...
fof(fact_sup_Oleft__commute,axiom,(
    ! [V_c,V_a,V_b,T_a] :
      ( class_Lattices_Osemilattice__sup(T_a)
     => c_Lattices_Osemilattice__sup__class_Osup(T_a,V_a,c_Lattices_Osemilattice__sup__class_Osup(T_a,V_b,V_c)) = c_Lattices_Osemilattice__sup__class_Osup(T_a,V_b,c_Lattices_Osemilattice__sup__class_Osup(T_a,V_a,V_c)) ) )).
...
fof(fact_the__elem__eq,axiom,(
    ! [V_xa_2,T_a] : V_xa_2 = c_Set_Othe__elem(T_a,c_Set_Oinsert(T_a,V_xa_2,c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)))) )).
...
fof(conj_2,conjecture,
    ( ! [B_x,B_y] :
        ( ( ( c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,B_x,v_y),v_L)
            & v_x != B_x
            & v_x = B_y )
         => ! [B_z] :
             ...
             <= ( c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,v_y,B_z),v_L)
                & B_z != v_x ) ) )
        & ( ! [B_z] :
              ( ( B_z = v_x
               => ~ c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,B_y,v_y),v_L) )
              & ( ( c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,v_y,B_z),v_L)
                  | v_y = B_z )
               <= ( v_x != B_z
         ...
         <= ( v_x != B_y
            & c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,v_y,B_y),v_L)
            & B_x = v_x ) )
        & ( ! [B_z] :
              ( ( ( c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,B_y,B_z),v_L)
                  & v_x != B_z )
    ...
    & ! [B_x,B_y] :
       ...
       => ( ( v_x = B_x
          ...
          | ( B_x = v_x
            ...
            & B_y != v_x )
          | ( v_x != B_x
            & c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,v_y,B_x),v_L)
            & B_y = v_x )
          | ( v_x = B_y
            & v_y = B_x )
          | ( c_member(tc_prod(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt),c_Product__Type_OPair(tc_Arrow__Order__Mirabelle_Oalt,tc_Arrow__Order__Mirabelle_Oalt,v_y,B_y),v_L)
...
fof(fact_cut__apply,axiom,(
    ! [V_f_2,T_b,V_r_2,V_a_2,V_xa_2,T_a] :
      ( c_member(tc_prod(T_a,T_a),c_Product__Type_OPair(T_a,T_a,V_xa_2,V_a_2),V_r_2)
     => hAPP(V_f_2,V_xa_2) = hAPP(c_Recdef_Ocut(T_a,T_b,V_f_2,V_r_2,V_a_2),V_xa_2) ) )).
...
fof(fact_Diff__insert2,axiom,(
    ! [V_B_2,V_a_2,V_A_2,T_a] : c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool),c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool),V_A_2,c_Set_Oinsert(T_a,V_a_2,c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)))),V_B_2) = c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool),V_A_2,c_Set_Oinsert(T_a,V_a_2,V_B_2)) )).
...
fof(fact_trancl__id,axiom,(
    ! [V_r_2,T_a] :
      ( c_Relation_Otrans(T_a,V_r_2)
     => V_r_2 = c_Transitive__Closure_Otrancl(T_a,V_r_2) ) )).
...
fof(fact_converse__inv__image,axiom,(
    ! [V_f_2,V_R_2,T_b,T_a] : hAPP(c_Relation_Oinv__image(T_b,T_a,c_Relation_Oconverse(T_b,T_b,V_R_2)),V_f_2) = c_Relation_Oconverse(T_a,T_a,hAPP(c_Relation_Oinv__image(T_b,T_a,V_R_2),V_f_2)) )).
...
fof(fact_minus__apply,axiom,(
    ! [V_xa_2,V_B_2,V_A_2,T_b,T_a] :
      ( c_Groups_Ominus__class_Ominus(T_a,hAPP(V_A_2,V_xa_2),hAPP(V_B_2,V_xa_2)) = hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_b,T_a),V_A_2,V_B_2),V_xa_2)
